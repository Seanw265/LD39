...
@:keep @:bind #if display private #end class __ASSET__assets_data_map_tmx extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_sprites_tsx extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_test_json extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_tileset_tsx extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_visitor2_eot extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_visitor2_ttf extends flash.text.Font { }
...
@:keep @:bind #if display private #end class __ASSET__assets_music_ld39_mp3 extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_music_ld39_ogg extends flash.media.Sound { }
...
@:file("/usr/local/lib/haxelib/flixel/4,3,0/assets/sounds/beep.mp3") #if display private #end class __ASSET__flixel_sounds_beep_mp3 extends lime.utils.Bytes {}
@:file("/usr/local/lib/haxelib/flixel/4,3,0/assets/sounds/flixel.mp3") #if display private #end class __ASSET__flixel_sounds_flixel_mp3 extends lime.utils.Bytes {}
