...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/data/visitor2.eot", "assets/data/visitor2.eot");
		type.set ("assets/data/visitor2.eot", AssetType.TEXT);
		path.set ("assets/data/visitor2.ttf", "assets/data/visitor2.ttf");
		...
		path.set ("assets/images/Buy.png", "assets/images/Buy.png");
		type.set ("assets/images/Buy.png", AssetType.IMAGE);
		path.set ("assets/images/CloseButton.png", "assets/images/CloseButton.png");
		...
		path.set ("assets/images/Sell5.png", "assets/images/Sell5.png");
		type.set ("assets/images/Sell5.png", AssetType.IMAGE);
		path.set ("assets/images/Sell50.png", "assets/images/Sell50.png");
		type.set ("assets/images/Sell50.png", AssetType.IMAGE);
		path.set ("assets/images/Sell500.png", "assets/images/Sell500.png");
		...
		path.set ("assets/music/LD39.mp3", "assets/music/LD39.mp3");
		type.set ("assets/music/LD39.mp3", AssetType.MUSIC);
		path.set ("assets/music/LD39.ogg", "assets/music/LD39.ogg");
...
@:keep #if display private #end class __ASSET__assets_data_visitor2_ttf extends lime.text.Font { public function new () { __fontPath = #if (ios || tvos) "assets/" + #end "assets/data/visitor2.ttf"; name = "Visitor TT2 BRK"; super (); }}
...
#if (openfl && !flash)
@:keep #if display private #end class __ASSET__OPENFL__assets_data_visitor2_ttf extends openfl.text.Font { public function new () { __fontPath = #if (ios || tvos) "assets/" + #end "assets/data/visitor2.ttf"; name = "Visitor TT2 BRK"; super (); }}
