...
class HXCPP_CLASS_ATTRIBUTES __ASSET__flixel_images_ui_button_png_obj : public  ::lime::graphics::Image_obj
{
	...
	public:
		...
		static hx::ObjectPtr< __ASSET__flixel_images_ui_button_png_obj > __new( ::lime::graphics::ImageBuffer buffer, ::Dynamic offsetX, ::Dynamic offsetY, ::Dynamic width, ::Dynamic height, ::Dynamic color,::hx::EnumBase type);
