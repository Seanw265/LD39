...
class HXCPP_CLASS_ATTRIBUTES EditableTextField_obj : public  ::openfl::text::TextField_obj
{
	...
	public:
		void __construct(Bool allowEditing, ::openfl::text::TextFormat defaultFormat, ::Dynamic submitValue,::hx::EnumBase expectedType);
		...
		static hx::ObjectPtr< EditableTextField_obj > __new(Bool allowEditing, ::openfl::text::TextFormat defaultFormat, ::Dynamic submitValue,::hx::EnumBase expectedType);
