...
class HXCPP_CLASS_ATTRIBUTES DebuggerFrontEnd_obj : public hx::Object
{
	...
	public:
		...
		::Dynamic resetLayout_dyn();
		 ...
		 ::flixel::_hx_system::ui::FlxSystemButton addButton(::hx::EnumBase Alignment, ::openfl::display::BitmapData Icon, ::Dynamic UpHandler,hx::Null< Bool >  ToggleMode,hx::Null< Bool >  UpdateLayout);
