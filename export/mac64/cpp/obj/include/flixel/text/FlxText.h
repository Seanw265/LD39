...
class HXCPP_CLASS_ATTRIBUTES FlxText_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		::Dynamic clearFormats_dyn();
		 ...
		 ::flixel::text::FlxText setFormat(::String Font,hx::Null< Int >  Size,hx::Null< Int >  Color,::String Alignment,::hx::EnumBase BorderStyle,hx::Null< Int >  BorderColor,hx::Null< Bool >  EmbeddedFont);
