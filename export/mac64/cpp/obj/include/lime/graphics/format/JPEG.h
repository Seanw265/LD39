...
class HXCPP_CLASS_ATTRIBUTES JPEG_obj : public hx::Object
{
	...
	public:
		...
		static ::cpp::Function<   ::hx::Object *( ::hx::Object *,Bool) > &cffi_lime_jpeg_decode_bytes_dyn() { return cffi_lime_jpeg_decode_bytes;}
		static ::cpp::Function<   ::hx::Object *(::String,Bool) > cffi_lime_jpeg_decode_file;
		static ::cpp::Function<   ::hx::Object *(::String,Bool) > &cffi_lime_jpeg_decode_file_dyn() { return cffi_lime_jpeg_decode_file;}
		static ::cpp::Function<   ::hx::Object *( ::hx::Object *,Int,Int) > cffi_lime_image_encode;
		static ::cpp::Function<   ::hx::Object *( ::hx::Object *,Int,Int) > &cffi_lime_image_encode_dyn() { return cffi_lime_image_encode;}
};
