...
class HXCPP_CLASS_ATTRIBUTES PNG_obj : public hx::Object
{
	...
	public:
		...
		static ::cpp::Function<   ::hx::Object *( ::hx::Object *,Bool) > &cffi_lime_png_decode_bytes_dyn() { return cffi_lime_png_decode_bytes;}
		static ::cpp::Function<   ::hx::Object *(::String,Bool) > cffi_lime_png_decode_file;
		static ::cpp::Function<   ::hx::Object *(::String,Bool) > &cffi_lime_png_decode_file_dyn() { return cffi_lime_png_decode_file;}
