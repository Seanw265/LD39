...
class HXCPP_CLASS_ATTRIBUTES GL_obj : public hx::Object
{
	...
	public:
		...
		static ::cpp::Function<  void(Int,Int) > &cffi_lime_gl_attach_shader_dyn() { return cffi_lime_gl_attach_shader;}
		static ::cpp::Function<  void(Int,Int,::String) > cffi_lime_gl_bind_attrib_location;
		static ::cpp::Function<  void(Int,Int,::String) > &cffi_lime_gl_bind_attrib_location_dyn() { return cffi_lime_gl_bind_attrib_location;}
		static ::cpp::Function<  void(Int,Int) > cffi_lime_gl_bind_buffer;
		static ::cpp::Function<  void(Int,Int) > &cffi_lime_gl_bind_buffer_dyn() { return cffi_lime_gl_bind_buffer;}
		static ::cpp::Function<  void(Int,Int) > cffi_lime_gl_bind_framebuffer;
		static ::cpp::Function<  void(Int,Int) > &cffi_lime_gl_bind_framebuffer_dyn() { return cffi_lime_gl_bind_framebuffer;}
		static ::cpp::Function<  void(Int,Int) > cffi_lime_gl_bind_renderbuffer;
		static ::cpp::Function<  void(Int,Int) > &cffi_lime_gl_bind_renderbuffer_dyn() { return cffi_lime_gl_bind_renderbuffer;}
		static ::cpp::Function<  void(Int,Int) > cffi_lime_gl_bind_texture;
		static ::cpp::Function<  void(Int,Int) > &cffi_lime_gl_bind_texture_dyn() { return cffi_lime_gl_bind_texture;}
		...
		static ::cpp::Function<  void(Int) > &cffi_lime_gl_compile_shader_dyn() { return cffi_lime_gl_compile_shader;}
		...
		static ::cpp::Function<  Int() > &cffi_lime_gl_create_buffer_dyn() { return cffi_lime_gl_create_buffer;}
		static ::cpp::Function<  Int() > cffi_lime_gl_create_framebuffer;
		static ::cpp::Function<  Int() > &cffi_lime_gl_create_framebuffer_dyn() { return cffi_lime_gl_create_framebuffer;}
		static ::cpp::Function<  Int() > cffi_lime_gl_create_program;
		static ::cpp::Function<  Int() > &cffi_lime_gl_create_program_dyn() { return cffi_lime_gl_create_program;}
		static ::cpp::Function<  Int() > cffi_lime_gl_create_render_buffer;
		static ::cpp::Function<  Int() > &cffi_lime_gl_create_render_buffer_dyn() { return cffi_lime_gl_create_render_buffer;}
		static ::cpp::Function<  Int(Int) > cffi_lime_gl_create_shader;
		static ::cpp::Function<  Int(Int) > &cffi_lime_gl_create_shader_dyn() { return cffi_lime_gl_create_shader;}
		static ::cpp::Function<  Int() > cffi_lime_gl_create_texture;
		static ::cpp::Function<  Int() > &cffi_lime_gl_create_texture_dyn() { return cffi_lime_gl_create_texture;}
		...
		static ::cpp::Function<  void(Int) > &cffi_lime_gl_delete_buffer_dyn() { return cffi_lime_gl_delete_buffer;}
		static ::cpp::Function<  void(Int) > cffi_lime_gl_delete_framebuffer;
		static ::cpp::Function<  void(Int) > &cffi_lime_gl_delete_framebuffer_dyn() { return cffi_lime_gl_delete_framebuffer;}
		static ::cpp::Function<  void(Int) > cffi_lime_gl_delete_program;
		static ::cpp::Function<  void(Int) > &cffi_lime_gl_delete_program_dyn() { return cffi_lime_gl_delete_program;}
		static ::cpp::Function<  void(Int) > cffi_lime_gl_delete_render_buffer;
		static ::cpp::Function<  void(Int) > &cffi_lime_gl_delete_render_buffer_dyn() { return cffi_lime_gl_delete_render_buffer;}
		static ::cpp::Function<  void(Int) > cffi_lime_gl_delete_shader;
		static ::cpp::Function<  void(Int) > &cffi_lime_gl_delete_shader_dyn() { return cffi_lime_gl_delete_shader;}
		static ::cpp::Function<  void(Int) > cffi_lime_gl_delete_texture;
		static ::cpp::Function<  void(Int) > &cffi_lime_gl_delete_texture_dyn() { return cffi_lime_gl_delete_texture;}
		...
		static ::cpp::Function<  void(Int,Int) > &cffi_lime_gl_detach_shader_dyn() { return cffi_lime_gl_detach_shader;}
		...
		static ::cpp::Function<  void(Int,Int,Int,Int) > &cffi_lime_gl_framebuffer_renderbuffer_dyn() { return cffi_lime_gl_framebuffer_renderbuffer;}
		static ::cpp::Function<  void(Int,Int,Int,Int,Int) > cffi_lime_gl_framebuffer_texture2D;
		static ::cpp::Function<  void(Int,Int,Int,Int,Int) > &cffi_lime_gl_framebuffer_texture2D_dyn() { return cffi_lime_gl_framebuffer_texture2D;}
		...
		static ::cpp::Function<   ::hx::Object *(Int,Int) > &cffi_lime_gl_get_active_attrib_dyn() { return cffi_lime_gl_get_active_attrib;}
		static ::cpp::Function<   ::hx::Object *(Int,Int) > cffi_lime_gl_get_active_uniform;
		static ::cpp::Function<   ::hx::Object *(Int,Int) > &cffi_lime_gl_get_active_uniform_dyn() { return cffi_lime_gl_get_active_uniform;}
		static ::cpp::Function<  Int(Int,::String) > cffi_lime_gl_get_attrib_location;
		static ::cpp::Function<  Int(Int,::String) > &cffi_lime_gl_get_attrib_location_dyn() { return cffi_lime_gl_get_attrib_location;}
		...
		static ::cpp::Function<  ::String(Int) > &cffi_lime_gl_get_program_info_log_dyn() { return cffi_lime_gl_get_program_info_log;}
		static ::cpp::Function<  Int(Int,Int) > cffi_lime_gl_get_program_parameter;
		static ::cpp::Function<  Int(Int,Int) > &cffi_lime_gl_get_program_parameter_dyn() { return cffi_lime_gl_get_program_parameter;}
		...
		static ::cpp::Function<  ::String(Int) > &cffi_lime_gl_get_shader_info_log_dyn() { return cffi_lime_gl_get_shader_info_log;}
		static ::cpp::Function<  Int(Int,Int) > cffi_lime_gl_get_shader_parameter;
		static ::cpp::Function<  Int(Int,Int) > &cffi_lime_gl_get_shader_parameter_dyn() { return cffi_lime_gl_get_shader_parameter;}
		...
		static ::cpp::Function<   ::hx::Object *(Int) > &cffi_lime_gl_get_shader_source_dyn() { return cffi_lime_gl_get_shader_source;}
		...
		static ::cpp::Function<   ::hx::Object *(Int,Int) > &cffi_lime_gl_get_uniform_dyn() { return cffi_lime_gl_get_uniform;}
		static ::cpp::Function<  Int(Int,::String) > cffi_lime_gl_get_uniform_location;
		static ::cpp::Function<  Int(Int,::String) > &cffi_lime_gl_get_uniform_location_dyn() { return cffi_lime_gl_get_uniform_location;}
		...
		static ::cpp::Function<  Bool(Int) > &cffi_lime_gl_is_buffer_dyn() { return cffi_lime_gl_is_buffer;}
		...
		static ::cpp::Function<  Bool(Int) > &cffi_lime_gl_is_framebuffer_dyn() { return cffi_lime_gl_is_framebuffer;}
		static ::cpp::Function<  Bool(Int) > cffi_lime_gl_is_program;
		static ::cpp::Function<  Bool(Int) > &cffi_lime_gl_is_program_dyn() { return cffi_lime_gl_is_program;}
		static ::cpp::Function<  Bool(Int) > cffi_lime_gl_is_renderbuffer;
		static ::cpp::Function<  Bool(Int) > &cffi_lime_gl_is_renderbuffer_dyn() { return cffi_lime_gl_is_renderbuffer;}
		static ::cpp::Function<  Bool(Int) > cffi_lime_gl_is_shader;
		static ::cpp::Function<  Bool(Int) > &cffi_lime_gl_is_shader_dyn() { return cffi_lime_gl_is_shader;}
		static ::cpp::Function<  Bool(Int) > cffi_lime_gl_is_texture;
		static ::cpp::Function<  Bool(Int) > &cffi_lime_gl_is_texture_dyn() { return cffi_lime_gl_is_texture;}
		...
		static ::cpp::Function<  void(Int) > &cffi_lime_gl_link_program_dyn() { return cffi_lime_gl_link_program;}
		...
		static ::cpp::Function<  void(Int,::String) > &cffi_lime_gl_shader_source_dyn() { return cffi_lime_gl_shader_source;}
		...
		static ::cpp::Function<  void(Int) > &cffi_lime_gl_use_program_dyn() { return cffi_lime_gl_use_program;}
		static ::cpp::Function<  void(Int) > cffi_lime_gl_validate_program;
		static ::cpp::Function<  void(Int) > &cffi_lime_gl_validate_program_dyn() { return cffi_lime_gl_validate_program;}
