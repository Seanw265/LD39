...
class HXCPP_CLASS_ATTRIBUTES DrawCommandReader_obj : public hx::Object
{
	...
	public:
		...
		::Dynamic readDrawEllipse_dyn();
		 ...
		 ::openfl::_internal::renderer::DrawCommandReader readDrawPath();
		...
		::Dynamic readDrawRoundRect_dyn();
		 ...
		 ::openfl::_internal::renderer::DrawCommandReader readDrawTiles();
		...
		::Dynamic skip_dyn();
		 ...
		 ::openfl::display::Tilesheet tileSheet(Int index);
