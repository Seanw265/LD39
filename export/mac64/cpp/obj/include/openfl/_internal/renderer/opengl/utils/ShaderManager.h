...
class HXCPP_CLASS_ATTRIBUTES ShaderManager_obj : public hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"openfl._internal.renderer.opengl.utils.ShaderManager"); }
		...
		Bool setShader( ::openfl::_internal::renderer::opengl::shaders2::Shader shader, ::Dynamic force);
