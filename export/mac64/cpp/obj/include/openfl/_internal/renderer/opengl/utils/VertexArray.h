...
class HXCPP_CLASS_ATTRIBUTES VertexArray_obj : public hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"openfl._internal.renderer.opengl.utils.VertexArray"); }
		...
		void upload( ::lime::utils::ArrayBufferView view);
		::Dynamic upload_dyn();

		void destroy();
		::Dynamic destroy_dyn();

		void setContext( ::lime::graphics::GLRenderContext gl, ::lime::utils::ArrayBufferView view);
