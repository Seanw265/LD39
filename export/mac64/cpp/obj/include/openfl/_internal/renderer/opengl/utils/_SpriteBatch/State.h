...
class HXCPP_CLASS_ATTRIBUTES State_obj : public hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"openfl._internal.renderer.opengl.utils._SpriteBatch.State"); }
		...
		Bool equals( ::openfl::_internal::renderer::opengl::utils::_SpriteBatch::State other);
		::Dynamic equals_dyn();
