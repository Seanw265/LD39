...
class HXCPP_CLASS_ATTRIBUTES DisplayObject_obj : public  ::openfl::events::EventDispatcher_obj
{
	...
	public:
		...
		static Bool _hx___cacheAsBitmapMode;
		 ::Dynamic blendMode;
		...
		Float mouseY;
		 ...
		 ::openfl::geom::Point _hx___worldOffset;
		...
		Bool _hx___isMask;
		 ...
		 ::openfl::display::Graphics _hx___maskGraphics;
		Bool _hx___maskCached;
		::String _hx___name;
		 ::openfl::geom::Transform _hx___objectTransform;
		 ::openfl::geom::Point _hx___offset;
		...
		Bool _hx___cacheAsBitmapSmooth;
		Bool _hx___forceCacheAsBitmap;
		Bool _hx___updateCachedBitmap;
		 ::openfl::display::BitmapData _hx___cachedBitmap;
		 ::openfl::geom::Rectangle _hx___cachedBitmapBounds;
		 ::openfl::geom::Rectangle _hx___cachedFilterBounds;
		 ::openfl::geom::Matrix _hx___cacheGLMatrix;
		Bool _hx___updateFilters;
		...
		virtual Bool _hx___broadcast( ::openfl::events::Event event,Bool notifyChilden);
		...
		void _hx___drawGraphicsGL( ::openfl::_internal::renderer::RenderSession renderSession);
		::Dynamic _hx___drawGraphicsGL_dyn();

		void _hx___preRenderGL( ::openfl::_internal::renderer::RenderSession renderSession);
		::Dynamic _hx___preRenderGL_dyn();

		void _hx___postRenderGL( ::openfl::_internal::renderer::RenderSession renderSession);
		::Dynamic _hx___postRenderGL_dyn();

		void _hx___cacheGL( ::openfl::_internal::renderer::RenderSession renderSession);
		::Dynamic _hx___cacheGL_dyn();
		...
		Bool get_cacheAsBitmapSmooth();
		::Dynamic get_cacheAsBitmapSmooth_dyn();

		Bool set_cacheAsBitmapSmooth(Bool value);
