...
class HXCPP_CLASS_ATTRIBUTES Context3D_obj : public hx::Object
{
	...
	public:
		...
		void setGLSLProgramConstantsFromByteArray(::String locationName, ::openfl::utils::ByteArrayData data,hx::Null< Int >  byteArrayOffset);
		...
		void setProgramConstantsFromByteArray(::hx::EnumBase programType,Int firstRegister,Int numRegisters, ::openfl::utils::ByteArrayData data,Int byteArrayOffset);
