...
class HXCPP_CLASS_ATTRIBUTES Texture_obj : public  ::openfl::display3D::textures::TextureBase_obj
{
	...
	public:
		...
		void uploadFromBitmapData( ::openfl::display::BitmapData bitmapData,hx::Null< Int >  miplevel);
		...
		void uploadFromUInt8Array( ::lime::utils::ArrayBufferView data,hx::Null< Int >  miplevel);
