...
void __ASSET__OPENFL__flixel_fonts_monsterrat_ttf_obj::__construct(){
            	HX_STACK_FRAME("__ASSET__OPENFL__flixel_fonts_monsterrat_ttf","new",0x4d419742,"__ASSET__OPENFL__flixel_fonts_monsterrat_ttf.new","DefaultAssetLibrary.hx",1117,0x0fc48912)
            	HX_STACK_THIS(this)
HXLINE(1117)		HX_VARI(  ::__ASSET__flixel_fonts_monsterrat_ttf,font) =  ::__ASSET__flixel_fonts_monsterrat_ttf_obj::__new();
HXDLIN(1117)		this->src = font->src;
HXDLIN(1117)		this->name = font->name;
HXDLIN(1117)		super::__construct(null());
            	}
