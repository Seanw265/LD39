...
void __ASSET__OPENFL__flixel_fonts_nokiafc22_ttf_obj::__construct(){
            	HX_STACK_FRAME("__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf","new",0xcba1a9da,"__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf.new","DefaultAssetLibrary.hx",1116,0x0fc48912)
            	HX_STACK_THIS(this)
HXLINE(1116)		HX_VARI(  ::__ASSET__flixel_fonts_nokiafc22_ttf,font) =  ::__ASSET__flixel_fonts_nokiafc22_ttf_obj::__new();
HXDLIN(1116)		this->src = font->src;
HXDLIN(1116)		this->name = font->name;
