...
void __ASSET__flixel_fonts_monsterrat_ttf_obj::__construct(){
            	HX_STACK_FRAME("__ASSET__flixel_fonts_monsterrat_ttf","new",0x5ab5a7f2,"__ASSET__flixel_fonts_monsterrat_ttf.new","lime/Assets.hx",1402,0x48c77341)
            	HX_STACK_THIS(this)
HXLINE(1404)		super::__construct(null());
HXLINE(1406)		 ::haxe::io::Bytes _hx_tmp = ::haxe::Resource_obj::getBytes(::__ASSET__flixel_fonts_monsterrat_ttf_obj::resourceName);
...
{
{
            	HX_STACK_FRAME("__ASSET__flixel_fonts_monsterrat_ttf","boot",0xfc564c60,"__ASSET__flixel_fonts_monsterrat_ttf.boot","lime/text/Font.hx",25,0x3be57807)
HXLINE(  25)		resourceName = HX_("LIME_font___ASSET__flixel_fonts_monsterrat_ttf",c6,95,44,8e);
            	}
}
