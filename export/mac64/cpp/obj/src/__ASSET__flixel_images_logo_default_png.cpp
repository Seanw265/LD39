...
void __ASSET__flixel_images_logo_default_png_obj::__construct( ::lime::graphics::ImageBuffer buffer, ::Dynamic offsetX, ::Dynamic offsetY, ::Dynamic width, ::Dynamic height, ::Dynamic color,::hx::EnumBase type){
            	HX_STACK_FRAME("__ASSET__flixel_images_logo_default_png","new",0xe2ac399d,"__ASSET__flixel_images_logo_default_png.new","lime/Assets.hx",1431,0x48c77341)
            	HX_STACK_THIS(this)
...
HXLINE(1468)		super::__construct(null(),null(),null(),null(),null(),null(),null());
HXLINE(1473)		 ::haxe::io::Bytes _hx_tmp = ::haxe::Resource_obj::getBytes(::__ASSET__flixel_images_logo_default_png_obj::resourceName);
HXDLIN(1473)		this->_hx___fromBytes(_hx_tmp,null());
            	}

Dynamic __ASSET__flixel_images_logo_default_png_obj::__CreateEmpty() { return new __ASSET__flixel_images_logo_default_png_obj; }

hx::ObjectPtr< __ASSET__flixel_images_logo_default_png_obj > __ASSET__flixel_images_logo_default_png_obj::__new( ::lime::graphics::ImageBuffer buffer, ::Dynamic offsetX, ::Dynamic offsetY, ::Dynamic width, ::Dynamic height, ::Dynamic color,::hx::EnumBase type)
{
	hx::ObjectPtr< __ASSET__flixel_images_logo_default_png_obj > _hx_result = new __ASSET__flixel_images_logo_default_png_obj();
	_hx_result->__construct(buffer,offsetX,offsetY,width,height,color,type);
	return _hx_result;
}
...
{
{
            	HX_STACK_FRAME("__ASSET__flixel_images_logo_default_png","boot",0x6c1f3055,"__ASSET__flixel_images_logo_default_png.boot","lime/graphics/Image.hx",55,0xc7b862ad)
HXLINE(  55)		resourceName = HX_("__ASSET__:image___ASSET__flixel_images_logo_default_png",5d,c4,77,3f);
            	}
}
