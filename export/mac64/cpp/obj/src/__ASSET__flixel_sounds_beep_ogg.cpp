...
void __ASSET__flixel_sounds_beep_ogg_obj::__construct(Int length,::Array< unsigned char > bytesData){
            	HX_STACK_FRAME("__ASSET__flixel_sounds_beep_ogg","new",0x0aaf31f8,"__ASSET__flixel_sounds_beep_ogg.new","lime/Assets.hx",1173,0x48c77341)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(length,"length")
            	HX_STACK_ARG(bytesData,"bytesData")
HXLINE(1175)		HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::Resource_obj::getBytes(::__ASSET__flixel_sounds_beep_ogg_obj::resourceName);
...
hx::ObjectPtr< __ASSET__flixel_sounds_beep_ogg_obj > __ASSET__flixel_sounds_beep_ogg_obj::__new(Int length,::Array< unsigned char > bytesData)
{
...
{
{
            	HX_STACK_FRAME("__ASSET__flixel_sounds_beep_ogg","boot",0x46b5879a,"__ASSET__flixel_sounds_beep_ogg.boot","lime/utils/Bytes.hx",11,0x9fbf972b)
HXLINE(  11)		resourceName = HX_("__ASSET__:file___ASSET__flixel_sounds_beep_ogg",6d,0a,6e,70);
            	}
}
