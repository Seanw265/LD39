...
void FlxBasic_obj::destroy(){
            	HX_STACK_FRAME("flixel.FlxBasic","destroy",0xc50151da,"flixel.FlxBasic.destroy","flixel/FlxBasic.hx",77,0xd8d6cfcf)
            	HX_STACK_THIS(this)
...
void FlxBasic_obj::kill(){
            	HX_STACK_FRAME("flixel.FlxBasic","kill",0x1748eebe,"flixel.FlxBasic.kill","flixel/FlxBasic.hx",89,0xd8d6cfcf)
            	HX_STACK_THIS(this)
...
void FlxBasic_obj::revive(){
            	HX_STACK_FRAME("flixel.FlxBasic","revive",0xb3f01175,"flixel.FlxBasic.revive","flixel/FlxBasic.hx",99,0xd8d6cfcf)
            	HX_STACK_THIS(this)
...
void FlxBasic_obj::update(Float elapsed){
            	HX_STACK_FRAME("flixel.FlxBasic","update",0x307e9d29,"flixel.FlxBasic.update","flixel/FlxBasic.hx",109,0xd8d6cfcf)
            	HX_STACK_THIS(this)
...
void FlxBasic_obj::draw(){
            	HX_STACK_FRAME("flixel.FlxBasic","draw",0x12af3b24,"flixel.FlxBasic.draw","flixel/FlxBasic.hx",120,0xd8d6cfcf)
            	HX_STACK_THIS(this)
            	}
...
::String FlxBasic_obj::toString(){
            	HX_STACK_FRAME("flixel.FlxBasic","toString",0x03b3efcc,"flixel.FlxBasic.toString","flixel/FlxBasic.hx",128,0xd8d6cfcf)
            	HX_STACK_THIS(this)
HXLINE( 129)		 ::Dynamic value = this->active;
HXDLIN( 129)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 129)		_this->label = HX_("active",c6,41,46,16);
HXDLIN( 129)		_this->value = value;
HXLINE( 130)		 ::Dynamic value1 = this->visible;
HXDLIN( 130)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 130)		_this1->label = HX_("visible",72,78,24,a3);
HXDLIN( 130)		_this1->value = value1;
HXLINE( 131)		 ::Dynamic value2 = this->alive;
HXDLIN( 131)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this2,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 131)		_this2->label = HX_("alive",cd,63,91,21);
HXDLIN( 131)		_this2->value = value2;
HXLINE( 132)		 ::Dynamic value3 = this->exists;
HXDLIN( 132)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this3,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
...
Bool FlxBasic_obj::set_visible(Bool Value){
            	HX_STACK_FRAME("flixel.FlxBasic","set_visible",0x942af475,"flixel.FlxBasic.set_visible","flixel/FlxBasic.hx",138,0xd8d6cfcf)
            	HX_STACK_THIS(this)
...
Bool FlxBasic_obj::set_active(Bool Value){
            	HX_STACK_FRAME("flixel.FlxBasic","set_active",0x086e7723,"flixel.FlxBasic.set_active","flixel/FlxBasic.hx",144,0xd8d6cfcf)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
...
Bool FlxBasic_obj::set_exists(Bool Value){
            	HX_STACK_FRAME("flixel.FlxBasic","set_exists",0xb2085339,"flixel.FlxBasic.set_exists","flixel/FlxBasic.hx",150,0xd8d6cfcf)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
...
Bool FlxBasic_obj::set_alive(Bool Value){
            	HX_STACK_FRAME("flixel.FlxBasic","set_alive",0x59c1c910,"flixel.FlxBasic.set_alive","flixel/FlxBasic.hx",156,0xd8d6cfcf)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
...
HX_DEFINE_DYNAMIC_FUNC1(FlxBasic_obj,set_alive,return )
 ...
 ::flixel::FlxCamera FlxBasic_obj::get_camera(){
            	HX_STACK_FRAME("flixel.FlxBasic","get_camera",0xa636dd8e,"flixel.FlxBasic.get_camera","flixel/FlxBasic.hx",162,0xd8d6cfcf)
            	HX_STACK_THIS(this)
HXLINE( 162)		Bool _hx_tmp;
HXDLIN( 162)		Bool _hx_tmp1 = hx::IsNotNull( this->_cameras );
...
HX_DEFINE_DYNAMIC_FUNC0(FlxBasic_obj,get_camera,return )
 ...
 ::flixel::FlxCamera FlxBasic_obj::set_camera( ::flixel::FlxCamera Value){
            	HX_STACK_FRAME("flixel.FlxBasic","set_camera",0xa9b47c02,"flixel.FlxBasic.set_camera","flixel/FlxBasic.hx",167,0xd8d6cfcf)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
HXLINE( 168)		Bool _hx_tmp = hx::IsNull( this->_cameras );
...
::Array< ::Dynamic> FlxBasic_obj::get_cameras(){
            	HX_STACK_FRAME("flixel.FlxBasic","get_cameras",0xc9caff25,"flixel.FlxBasic.get_cameras","flixel/FlxBasic.hx",178,0xd8d6cfcf)
            	HX_STACK_THIS(this)
HXLINE( 178)		Bool _hx_tmp = hx::IsNull( this->_cameras );
...
::Array< ::Dynamic> FlxBasic_obj::set_cameras(::Array< ::Dynamic> Value){
            	HX_STACK_FRAME("flixel.FlxBasic","set_cameras",0xd4380631,"flixel.FlxBasic.set_cameras","flixel/FlxBasic.hx",184,0xd8d6cfcf)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
