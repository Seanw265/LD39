...
Float Zoom = __o_Zoom.Default(0);
            	HX_STACK_FRAME("flixel.FlxCamera","new",0x0e8a9f77,"flixel.FlxCamera.new","flixel/FlxCamera.hx",43,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(X,"X")
            	HX_STACK_ARG(Y,"Y")
...
HXLINE( 408)		this->_helperPoint =  ::openfl::geom::Point_obj::__new(null(),null());
HXLINE( 406)		this->_helperMatrix =  ::flixel::math::FlxMatrix_obj::__new(null(),null(),null(),null(),null(),null());
HXLINE( 386)		Float X1 = (int)0;
HXDLIN( 386)		Float Y1 = (int)0;
HXDLIN( 386)		Float Width1 = (int)0;
HXDLIN( 386)		Float Height1 = (int)0;
HXDLIN( 386)		HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 386)		_this->x = X1;
HXDLIN( 386)		_this->y = Y1;
HXDLIN( 386)		_this->width = Width1;
HXDLIN( 386)		_this->height = Height1;
HXDLIN( 386)		_this->_inPool = false;
HXDLIN( 386)		this->_bounds = _this;
HXLINE( 381)		this->_scrollRect =  ::openfl::display::Sprite_obj::__new();
HXLINE( 361)		this->initialZoom = ((Float)1);
HXLINE( 352)		HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE( 310)		HX_VARI_NAME(  ::flixel::math::FlxPoint,point1,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE( 282)		HX_VARI_NAME(  ::flixel::math::FlxPoint,point2,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 282)		point2->_inPool = false;
HXDLIN( 282)		this->_flashOffset = point2;
HXLINE( 274)		this->_flashPoint =  ::openfl::geom::Point_obj::__new(null(),null());
HXLINE( 260)		this->filtersEnabled = true;
HXLINE( 256)		HX_VARI_NAME(  ::flixel::math::FlxPoint,point3,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE( 229)		this->_blitMatrix =  ::flixel::math::FlxMatrix_obj::__new(null(),null(),null(),null(),null(),null());
...
HXLINE( 181)		this->flashSprite =  ::openfl::display::Sprite_obj::__new();
HXLINE( 171)		this->useBgAlphaBlending = false;
HXLINE( 136)		HX_VARI_NAME(  ::flixel::math::FlxPoint,point4,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE(  99)		HX_VARI_NAME(  ::flixel::math::FlxPoint,point5,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE( 872)		this->_flashRect =  ::openfl::geom::Rectangle_obj::__new((int)0,(int)0,this->width,this->height);
HXLINE( 874)		this->flashSprite->addChild(this->_scrollRect);
HXLINE( 875)		this->_scrollRect->set_scrollRect( ::openfl::geom::Rectangle_obj::__new(null(),null(),null(),null()));
HXLINE( 877)		this->pixelPerfectRender = ::flixel::FlxG_obj::renderBlit;
HXLINE( 879)		Bool _hx_tmp2 = ::flixel::FlxG_obj::renderBlit;
HXDLIN( 879)		if (_hx_tmp2) {
HXLINE( 881)			this->screen =  ::flixel::FlxSprite_obj::__new(null(),null(),null());
HXLINE( 882)			this->buffer =  ::openfl::display::BitmapData_obj::__new(this->width,this->height,true,(int)0);
HXLINE( 883)			this->screen->set_pixels(this->buffer);
HXLINE( 884)			this->screen->origin->set(null(),null());
HXLINE( 885)			this->_flashBitmap =  ::openfl::display::Bitmap_obj::__new(this->buffer,null(),null());
HXLINE( 886)			this->_scrollRect->addChild(this->_flashBitmap);
HXLINE( 887)			this->_fill =  ::openfl::display::BitmapData_obj::__new(this->width,this->height,true,(int)0);
            		}
            		else {
HXLINE( 891)			this->canvas =  ::openfl::display::Sprite_obj::__new();
...
Dynamic FlxCamera_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::flixel::graphics::tile::FlxDrawTilesItem FlxCamera_obj::startQuadBatch( ::flixel::graphics::FlxGraphic graphic,Bool colored,hx::Null< Bool >  __o_hasColorOffsets, ::Dynamic blend,hx::Null< Bool >  __o_smooth, ::openfl::display::Shader shader){
Bool hasColorOffsets = __o_hasColorOffsets.Default(false);
Bool smooth = __o_smooth.Default(false);
            	HX_STACK_FRAME("flixel.FlxCamera","startQuadBatch",0xe17326fa,"flixel.FlxCamera.startQuadBatch","flixel/FlxCamera.hx",455,0xe7aeb95a)
            	HX_STACK_THIS(this)
...
HXLINE( 459)		HX_VARI(  ::flixel::graphics::tile::FlxDrawTilesItem,itemToReturn) = null();
HXLINE( 460)		HX_VARI( Int,blendInt) = ::flixel::graphics::tile::FlxDrawBaseItem_obj::blendToInt(blend);
...
HXDLIN( 462)		Bool _hx_tmp7 = hx::IsNotNull( this->_currentDrawItem );
...
HXLINE( 473)		Bool _hx_tmp8 = hx::IsNotNull( ::flixel::FlxCamera_obj::_storageTilesHead );
HXDLIN( 473)		if (_hx_tmp8) {
HXLINE( 475)			itemToReturn = ::flixel::FlxCamera_obj::_storageTilesHead;
HXLINE( 476)			HX_VARI(  ::flixel::graphics::tile::FlxDrawTilesItem,newHead) = ( ( ::flixel::graphics::tile::FlxDrawTilesItem)(::flixel::FlxCamera_obj::_storageTilesHead->nextTyped) );
HXLINE( 477)			itemToReturn->reset();
HXLINE( 478)			::flixel::FlxCamera_obj::_storageTilesHead = newHead;
            		}
            		else {
HXLINE( 482)			itemToReturn =  ::flixel::graphics::tile::FlxDrawTilesItem_obj::__new();
            		}
...
HXLINE( 495)		Bool _hx_tmp9 = hx::IsNull( this->_headOfDrawStack );
HXDLIN( 495)		if (_hx_tmp9) {
HXLINE( 497)			this->_headOfDrawStack = itemToReturn;
            		}
HXLINE( 500)		Bool _hx_tmp10 = hx::IsNotNull( this->_currentDrawItem );
...
Bool isColored = __o_isColored.Default(false);
            	HX_STACK_FRAME("flixel.FlxCamera","startTrianglesBatch",0xb3a3b828,"flixel.FlxCamera.startTrianglesBatch","flixel/FlxCamera.hx",514,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(graphic,"graphic")
            	HX_STACK_ARG(smoothing,"smoothing")
            	HX_STACK_ARG(isColored,"isColored")
            	HX_STACK_ARG(blend,"blend")
HXLINE( 515)		HX_VARI( Int,blendInt) = ::flixel::graphics::tile::FlxDrawBaseItem_obj::blendToInt(blend);
HXLINE( 517)		Bool _hx_tmp;
HXDLIN( 517)		Bool _hx_tmp1;
HXDLIN( 517)		Bool _hx_tmp2;
HXDLIN( 517)		Bool _hx_tmp3;
HXDLIN( 517)		Bool _hx_tmp4;
HXDLIN( 517)		Bool _hx_tmp5 = hx::IsNotNull( this->_currentDrawItem );
...
Bool smoothing = __o_smoothing.Default(false);
Bool isColored = __o_isColored.Default(false);
            	HX_STACK_FRAME("flixel.FlxCamera","getNewDrawTrianglesItem",0xcd894887,"flixel.FlxCamera.getNewDrawTrianglesItem","flixel/FlxCamera.hx",532,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(graphic,"graphic")
            	HX_STACK_ARG(smoothing,"smoothing")
            	HX_STACK_ARG(isColored,"isColored")
            	HX_STACK_ARG(blend,"blend")
HXLINE( 533)		HX_VARI(  ::flixel::graphics::tile::FlxDrawTrianglesItem,itemToReturn) = null();
HXLINE( 534)		HX_VARI( Int,blendInt) = ::flixel::graphics::tile::FlxDrawBaseItem_obj::blendToInt(blend);
HXLINE( 536)		Bool _hx_tmp = hx::IsNotNull( ::flixel::FlxCamera_obj::_storageTrianglesHead );
HXDLIN( 536)		if (_hx_tmp) {
HXLINE( 538)			itemToReturn = ::flixel::FlxCamera_obj::_storageTrianglesHead;
HXLINE( 539)			HX_VARI(  ::flixel::graphics::tile::FlxDrawTrianglesItem,newHead) = ( ( ::flixel::graphics::tile::FlxDrawTrianglesItem)(::flixel::FlxCamera_obj::_storageTrianglesHead->nextTyped) );
HXLINE( 540)			itemToReturn->reset();
HXLINE( 541)			::flixel::FlxCamera_obj::_storageTrianglesHead = newHead;
            		}
            		else {
HXLINE( 545)			itemToReturn =  ::flixel::graphics::tile::FlxDrawTrianglesItem_obj::__new();
            		}
...
HXLINE( 556)		Bool _hx_tmp1 = hx::IsNull( this->_headOfDrawStack );
HXDLIN( 556)		if (_hx_tmp1) {
HXLINE( 558)			this->_headOfDrawStack = itemToReturn;
            		}
HXLINE( 561)		Bool _hx_tmp2 = hx::IsNotNull( this->_currentDrawItem );
...
void FlxCamera_obj::clearDrawStack(){
            	HX_STACK_FRAME("flixel.FlxCamera","clearDrawStack",0x8d7c5ba0,"flixel.FlxCamera.clearDrawStack","flixel/FlxCamera.hx",573,0xe7aeb95a)
            	HX_STACK_THIS(this)
HXLINE( 574)		HX_VARI(  ::flixel::graphics::tile::FlxDrawTilesItem,currTiles) = this->_headTiles;
HXLINE( 575)		HX_VAR(  ::flixel::graphics::tile::FlxDrawTilesItem,newTilesHead);
HXLINE( 577)		while(true){
HXLINE( 577)			Bool _hx_tmp = !(hx::IsNotNull( currTiles ));
HXDLIN( 577)			if (_hx_tmp) {
HXLINE( 577)				goto _hx_goto_0;
            			}
...
HXLINE( 583)			currTiles = newTilesHead;
            		...
            		_hx_goto_0:;
HXLINE( 586)		HX_VARI(  ::flixel::graphics::tile::FlxDrawTrianglesItem,currTriangles) = this->_headTriangles;
HXLINE( 587)		HX_VAR(  ::flixel::graphics::tile::FlxDrawTrianglesItem,newTrianglesHead);
HXLINE( 589)		while(true){
HXLINE( 589)			Bool _hx_tmp1 = !(hx::IsNotNull( currTriangles ));
HXDLIN( 589)			if (_hx_tmp1) {
HXLINE( 589)				goto _hx_goto_1;
            			}
...
void FlxCamera_obj::render(){
            	HX_STACK_FRAME("flixel.FlxCamera","render",0x1f11e49f,"flixel.FlxCamera.render","flixel/FlxCamera.hx",606,0xe7aeb95a)
            	HX_STACK_THIS(this)
HXLINE( 607)		HX_VARI(  ::flixel::graphics::tile::FlxDrawBaseItem,currItem) = this->_headOfDrawStack;
HXLINE( 608)		while(true){
HXLINE( 608)			Bool _hx_tmp = !(hx::IsNotNull( currItem ));
...
void FlxCamera_obj::drawPixels( ::flixel::graphics::frames::FlxFrame frame, ::openfl::display::BitmapData pixels, ::flixel::math::FlxMatrix matrix, ::openfl::geom::ColorTransform transform, ::Dynamic blend, ::Dynamic __o_smoothing, ::openfl::display::Shader shader){
 ::Dynamic smoothing = __o_smoothing.Default(false);
            	HX_STACK_FRAME("flixel.FlxCamera","drawPixels",0x80c6bc1a,"flixel.FlxCamera.drawPixels","flixel/FlxCamera.hx",618,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	...
            	HX_STACK_ARG(smoothing,"smoothing")
            	HX_STACK_ARG(shader,"shader")
HXLINE( 618)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
HXDLIN( 618)		if (_hx_tmp) {
HXLINE( 620)			this->_helperMatrix->copyFrom(matrix);
HXLINE( 622)			Bool _hx_tmp1 = this->_useBlitMatrix;
...
HXLINE( 625)					_hx_tmp2 = this->antialiasing;
            				}
            				else {
HXLINE( 625)					_hx_tmp2 = true;
            				}
HXDLIN( 625)				this->buffer->draw(pixels,this->_helperMatrix,null(),null(),null(),_hx_tmp2);
            			}
            			else {
HXLINE( 629)				this->_helperMatrix->translate(-(this->viewOffsetX),-(this->viewOffsetY));
HXLINE( 630)				Bool _hx_tmp3;
HXDLIN( 630)				if (!(smoothing)) {
HXLINE( 630)					_hx_tmp3 = this->antialiasing;
            				}
            				else {
HXLINE( 630)					_hx_tmp3 = true;
            				}
HXDLIN( 630)				this->buffer->draw(pixels,this->_helperMatrix,null(),blend,null(),_hx_tmp3);
            			}
            		}
            		else {
HXLINE( 635)			HX_VAR( Bool,isColored);
HXDLIN( 635)			Bool _hx_tmp4 = hx::IsNotNull( transform );
HXDLIN( 635)			if (_hx_tmp4) {
...
HXDLIN( 636)			Bool _hx_tmp5 = hx::IsNotNull( transform );
...
HXLINE( 641)			HX_VARI(  ::flixel::graphics::tile::FlxDrawTilesItem,drawItem) = this->startQuadBatch(frame->parent,isColored,hasColorOffsets,blend,smoothing,shader);
...
void FlxCamera_obj::copyPixels( ::flixel::graphics::frames::FlxFrame frame, ::openfl::display::BitmapData pixels, ::openfl::geom::Rectangle sourceRect, ::openfl::geom::Point destPoint, ::openfl::geom::ColorTransform transform, ::Dynamic blend, ::Dynamic __o_smoothing, ::openfl::display::Shader shader){
 ::Dynamic smoothing = __o_smoothing.Default(false);
            	HX_STACK_FRAME("flixel.FlxCamera","copyPixels",0xf4c7a68b,"flixel.FlxCamera.copyPixels","flixel/FlxCamera.hx",650,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(frame,"frame")
            	HX_STACK_ARG(pixels,"pixels")
            	...
            	HX_STACK_ARG(smoothing,"smoothing")
            	HX_STACK_ARG(shader,"shader")
HXLINE( 650)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
HXDLIN( 650)		if (_hx_tmp) {
HXLINE( 652)			Bool _hx_tmp1 = hx::IsNotNull( pixels );
HXDLIN( 652)			if (_hx_tmp1) {
HXLINE( 654)				Bool _hx_tmp2 = this->_useBlitMatrix;
...
HXLINE( 659)					Bool _hx_tmp3;
HXDLIN( 659)					if (!(smoothing)) {
HXLINE( 659)						_hx_tmp3 = this->antialiasing;
            					}
            					else {
HXLINE( 659)						_hx_tmp3 = true;
            					}
HXDLIN( 659)					this->buffer->draw(pixels,this->_helperMatrix,null(),null(),null(),_hx_tmp3);
            				}
            				else {
HXLINE( 663)					Float _hx_tmp4 = destPoint->x;
HXDLIN( 663)					Int _hx_tmp5 = ::Std_obj::_hx_int(this->viewOffsetX);
HXDLIN( 663)					this->_helperPoint->x = (_hx_tmp4 - _hx_tmp5);
HXLINE( 664)					Float _hx_tmp6 = destPoint->y;
HXDLIN( 664)					Int _hx_tmp7 = ::Std_obj::_hx_int(this->viewOffsetY);
HXDLIN( 664)					this->_helperPoint->y = (_hx_tmp6 - _hx_tmp7);
HXLINE( 665)					this->buffer->copyPixels(pixels,sourceRect,this->_helperPoint,null(),null(),true);
            				}
            			}
            			else {
HXLINE( 668)				Bool _hx_tmp8 = hx::IsNotNull( frame );
...
HXLINE( 677)			Float _hx_tmp9 = (destPoint->x + frame->offset->x);
HXDLIN( 677)			Float _hx_tmp10 = (destPoint->y + frame->offset->y);
HXDLIN( 677)			this->_helperMatrix->translate(_hx_tmp9,_hx_tmp10);
HXLINE( 679)			HX_VAR( Bool,isColored);
HXDLIN( 679)			Bool _hx_tmp11 = hx::IsNotNull( transform );
...
HXLINE( 680)			HX_VAR( Bool,hasColorOffsets);
HXDLIN( 680)			Bool _hx_tmp12 = hx::IsNotNull( transform );
HXDLIN( 680)			if (_hx_tmp12) {
...
HXLINE( 683)			HX_VARI(  ::flixel::graphics::tile::FlxDrawTilesItem,drawItem) = this->startQuadBatch(frame->parent,isColored,hasColorOffsets,blend,smoothing,shader);
...
void FlxCamera_obj::drawTriangles( ::flixel::graphics::FlxGraphic graphic,::Array< Float > vertices,::Array< Int > indices,::Array< Float > uvtData,::Array< Int > colors, ::flixel::math::FlxPoint position, ::Dynamic blend,hx::Null< Bool >  __o_repeat,hx::Null< Bool >  __o_smoothing){
Bool repeat = __o_repeat.Default(false);
Bool smoothing = __o_smoothing.Default(false);
            	HX_STACK_FRAME("flixel.FlxCamera","drawTriangles",0x78d375de,"flixel.FlxCamera.drawTriangles","flixel/FlxCamera.hx",695,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(graphic,"graphic")
            	...
            	HX_STACK_ARG(smoothing,"smoothing")
HXLINE( 695)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
HXDLIN( 695)		if (_hx_tmp) {
HXLINE( 697)			Bool _hx_tmp1 = hx::IsNull( position );
HXDLIN( 697)			if (_hx_tmp1) {
HXLINE( 698)				position = ::flixel::FlxCamera_obj::renderPoint->set(null(),null());
            			}
HXLINE( 700)			{
HXLINE( 700)				HX_VARI(  ::flixel::math::FlxRect,_this) = this->_bounds;
HXDLIN( 700)				Float Width = this->width;
HXDLIN( 700)				Float Height = this->height;
HXDLIN( 700)				_this->x = (int)0;
HXDLIN( 700)				_this->y = (int)0;
HXDLIN( 700)				_this->width = Width;
HXDLIN( 700)				_this->height = Height;
            			}
HXLINE( 702)			HX_VARI( Int,verticesLength) = vertices->length;
HXLINE( 703)			HX_VARI( Int,currentVertexPosition) = (int)0;
HXLINE( 705)			HX_VAR( Float,tempX);
HXDLIN( 705)			HX_VAR( Float,tempY);
HXLINE( 706)			HX_VARI( Int,i) = (int)0;
HXLINE( 707)			HX_VARI_NAME(  ::flixel::math::FlxRect,_this1,"_this") = ::flixel::FlxCamera_obj::renderRect;
HXDLIN( 707)			Float X = (int)0;
HXDLIN( 707)			Float Y = (int)0;
HXDLIN( 707)			Float Width1 = (int)0;
HXDLIN( 707)			Float Height1 = (int)0;
HXDLIN( 707)			_this1->x = X;
HXDLIN( 707)			_this1->y = Y;
HXDLIN( 707)			_this1->width = Width1;
HXDLIN( 707)			_this1->height = Height1;
HXLINE( 708)			{
HXLINE( 708)				Int len = ::flixel::FlxCamera_obj::drawVertices->length;
HXDLIN( 708)				::flixel::FlxCamera_obj::drawVertices->removeRange((int)0,len);
            			}
HXLINE( 710)			while((i < verticesLength)){
HXLINE( 712)				tempX = (position->x + vertices->__get(i));
HXLINE( 713)				tempY = (position->y + vertices->__get((i + (int)1)));
HXLINE( 715)				{
HXLINE( 715)					Int index = currentVertexPosition++;
HXDLIN( 715)					::flixel::FlxCamera_obj::drawVertices[index] = tempX;
            				}
HXLINE( 716)				{
HXLINE( 716)					Int index1 = currentVertexPosition++;
HXDLIN( 716)					::flixel::FlxCamera_obj::drawVertices[index1] = tempY;
            				}
HXLINE( 718)				if ((i == (int)0)) {
HXLINE( 720)					_this1->x = tempX;
HXDLIN( 720)					_this1->y = tempY;
HXDLIN( 720)					_this1->width = (int)0;
HXDLIN( 720)					_this1->height = (int)0;
            				}
            				else {
HXLINE( 724)					Bool _hx_tmp2 = (tempX < _this1->x);
HXDLIN( 724)					if (_hx_tmp2) {
HXLINE( 724)						hx::AddEq(_this1->width,(_this1->x - tempX));
HXDLIN( 724)						_this1->x = tempX;
            					}
HXDLIN( 724)					Bool _hx_tmp3 = (tempY < _this1->y);
HXDLIN( 724)					if (_hx_tmp3) {
HXLINE( 724)						hx::AddEq(_this1->height,(_this1->y - tempY));
HXDLIN( 724)						_this1->y = tempY;
            					}
HXDLIN( 724)					Bool _hx_tmp4 = (tempX > (_this1->x + _this1->width));
HXDLIN( 724)					if (_hx_tmp4) {
HXLINE( 724)						_this1->width = (tempX - _this1->x);
            					}
HXDLIN( 724)					Bool _hx_tmp5 = (tempY > (_this1->y + _this1->height));
HXDLIN( 724)					if (_hx_tmp5) {
HXLINE( 724)						_this1->height = (tempY - _this1->y);
            					}
            				}
HXLINE( 727)				hx::AddEq(i,(int)2);
            			}
HXLINE( 730)			Bool _hx_tmp6 = position->_weak;
HXDLIN( 730)			if (_hx_tmp6) {
HXLINE( 730)				position->put();
            			}
HXLINE( 732)			HX_VARI_NAME(  ::flixel::math::FlxRect,_this2,"_this") = this->_bounds;
HXDLIN( 732)			HX_VAR( Bool,result);
HXDLIN( 732)			Bool _hx_tmp7;
HXDLIN( 732)			Bool _hx_tmp8;
HXDLIN( 732)			if (((_this1->x + _this1->width) > _this2->x)) {
HXLINE( 732)				_hx_tmp8 = (_this1->x < (_this2->x + _this2->width));
            			}
            			else {
HXLINE( 732)				_hx_tmp8 = false;
            			}
HXDLIN( 732)			if (_hx_tmp8) {
HXLINE( 732)				_hx_tmp7 = ((_this1->y + _this1->height) > _this2->y);
            			}
            			else {
HXLINE( 732)				_hx_tmp7 = false;
            			}
HXDLIN( 732)			if (_hx_tmp7) {
HXLINE( 732)				result = (_this1->y < (_this2->y + _this2->height));
            			}
            			else {
HXLINE( 732)				result = false;
            			}
HXDLIN( 732)			Bool _hx_tmp9 = _this1->_weak;
HXDLIN( 732)			if (_hx_tmp9) {
HXLINE( 732)				Bool _hx_tmp10 = !(_this1->_inPool);
HXDLIN( 732)				if (_hx_tmp10) {
HXLINE( 732)					_this1->_inPool = true;
HXDLIN( 732)					_this1->_weak = false;
HXDLIN( 732)					::flixel::math::FlxRect_obj::_pool->putUnsafe(_this1);
            				}
            			}
HXDLIN( 732)			if (!(result)) {
HXLINE( 734)				Int pos = (::flixel::FlxCamera_obj::drawVertices->length - verticesLength);
HXDLIN( 734)				::flixel::FlxCamera_obj::drawVertices->removeRange(pos,verticesLength);
            			}
            			else {
...
HXLINE( 740)				::flixel::FlxCamera_obj::trianglesSprite->get_graphics()->drawTriangles(::flixel::FlxCamera_obj::drawVertices,indices,uvtData,null());
HXLINE( 741)				::flixel::FlxCamera_obj::trianglesSprite->get_graphics()->endFill();
HXLINE( 744)				Bool _hx_tmp11 = this->_useBlitMatrix;
...
HXLINE( 766)			Bool _hx_tmp12 = !(_this1->_inPool);
HXDLIN( 766)			if (_hx_tmp12) {
HXLINE( 766)				_this1->_inPool = true;
HXDLIN( 766)				_this1->_weak = false;
HXDLIN( 766)				::flixel::math::FlxRect_obj::_pool->putUnsafe(_this1);
            			}
            		}
            		else {
HXLINE( 770)			{
HXLINE( 770)				HX_VARI_NAME(  ::flixel::math::FlxRect,_this3,"_this") = this->_bounds;
HXDLIN( 770)				Float Width2 = this->width;
HXDLIN( 770)				Float Height2 = this->height;
HXDLIN( 770)				_this3->x = (int)0;
HXDLIN( 770)				_this3->y = (int)0;
HXDLIN( 770)				_this3->width = Width2;
HXDLIN( 770)				_this3->height = Height2;
            			}
HXLINE( 771)			HX_VAR( Bool,isColored);
HXDLIN( 771)			Bool _hx_tmp13 = hx::IsNotNull( colors );
...
HXLINE( 772)			HX_VARI(  ::flixel::graphics::tile::FlxDrawTrianglesItem,drawItem) = this->startTrianglesBatch(graphic,smoothing,isColored,blend);
...
HX_DEFINE_DYNAMIC_FUNC9(FlxCamera_obj,drawTriangles,(void))
 ...
 ::flixel::math::FlxRect FlxCamera_obj::transformRect( ::flixel::math::FlxRect rect){
            	HX_STACK_FRAME("flixel.FlxCamera","transformRect",0x135ffe87,"flixel.FlxCamera.transformRect","flixel/FlxCamera.hx",783,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(rect,"rect")
HXLINE( 784)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
HXDLIN( 784)		if (_hx_tmp) {
HXLINE( 786)			{
HXLINE( 786)				Float dx = -(this->viewOffsetX);
HXDLIN( 786)				Float dy = -(this->viewOffsetY);
HXDLIN( 786)				hx::AddEq(rect->x,dx);
HXDLIN( 786)				hx::AddEq(rect->y,dy);
            			}
HXLINE( 788)			Bool _hx_tmp1 = this->_useBlitMatrix;
HXDLIN( 788)			if (_hx_tmp1) {
HXLINE( 790)				hx::MultEq(rect->x,this->zoom);
HXLINE( 791)				hx::MultEq(rect->y,this->zoom);
HXLINE( 792)				hx::MultEq(rect->width,this->zoom);
HXLINE( 793)				hx::MultEq(rect->height,this->zoom);
            			}
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxCamera_obj,transformRect,return )
 ...
 ::flixel::math::FlxPoint FlxCamera_obj::transformPoint( ::flixel::math::FlxPoint point){
            	HX_STACK_FRAME("flixel.FlxCamera","transformPoint",0xc072398d,"flixel.FlxCamera.transformPoint","flixel/FlxCamera.hx",806,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(point,"point")
HXLINE( 807)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
HXDLIN( 807)		if (_hx_tmp) {
HXLINE( 809)			{
HXLINE( 809)				Float X = this->viewOffsetX;
HXDLIN( 809)				Float Y = this->viewOffsetY;
HXDLIN( 809)				{
HXLINE( 809)					Float _hx_tmp1 = (point->x - X);
HXDLIN( 809)					point->set_x(_hx_tmp1);
            				}
HXDLIN( 809)				{
HXLINE( 809)					Float _hx_tmp2 = (point->y - Y);
HXDLIN( 809)					point->set_y(_hx_tmp2);
            				}
            			}
HXLINE( 811)			Bool _hx_tmp3 = this->_useBlitMatrix;
...
HX_DEFINE_DYNAMIC_FUNC1(FlxCamera_obj,transformPoint,return )
 ...
 ::flixel::math::FlxPoint FlxCamera_obj::transformVector( ::flixel::math::FlxPoint vector){
            	HX_STACK_FRAME("flixel.FlxCamera","transformVector",0x43afc0e6,"flixel.FlxCamera.transformVector","flixel/FlxCamera.hx",824,0xe7aeb95a)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(FlxCamera_obj,transformVector,return )
 ...
 ::openfl::display::DisplayObject FlxCamera_obj::transformObject( ::openfl::display::DisplayObject object){
            	HX_STACK_FRAME("flixel.FlxCamera","transformObject",0xc1918ee2,"flixel.FlxCamera.transformObject","flixel/FlxCamera.hx",839,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(object,"object")
HXLINE( 840)		{
HXLINE( 840)			Float _hx_tmp = object->get_scaleX();
HXDLIN( 840)			Float _hx_tmp1 = (_hx_tmp * this->totalScaleX);
HXDLIN( 840)			object->set_scaleX(_hx_tmp1);
            		}
HXLINE( 841)		{
HXLINE( 841)			Float _hx_tmp2 = object->get_scaleY();
HXDLIN( 841)			Float _hx_tmp3 = (_hx_tmp2 * this->totalScaleY);
HXDLIN( 841)			object->set_scaleY(_hx_tmp3);
            		}
HXLINE( 843)		{
HXLINE( 843)			Float _hx_tmp4 = object->get_x();
HXDLIN( 843)			Float _hx_tmp5 = (_hx_tmp4 - (this->scroll->x * this->totalScaleX));
HXDLIN( 843)			object->set_x(_hx_tmp5);
            		}
HXLINE( 844)		{
HXLINE( 844)			Float _hx_tmp6 = object->get_y();
HXDLIN( 844)			Float _hx_tmp7 = (_hx_tmp6 - (this->scroll->y * this->totalScaleY));
HXDLIN( 844)			object->set_y(_hx_tmp7);
            		}
HXLINE( 846)		{
HXLINE( 846)			Float _hx_tmp8 = object->get_x();
HXDLIN( 846)			Float _hx_tmp9 = (_hx_tmp8 - (((((Float)0.5) * this->width) * (this->scaleX - this->initialZoom)) * ::flixel::FlxG_obj::scaleMode->scale->x));
HXDLIN( 846)			object->set_x(_hx_tmp9);
            		}
HXLINE( 847)		{
HXLINE( 847)			Float _hx_tmp10 = object->get_y();
HXDLIN( 847)			Float _hx_tmp11 = (_hx_tmp10 - (((((Float)0.5) * this->height) * (this->scaleY - this->initialZoom)) * ::flixel::FlxG_obj::scaleMode->scale->y));
HXDLIN( 847)			object->set_y(_hx_tmp11);
            		}
...
void FlxCamera_obj::destroy(){
            	HX_STACK_FRAME("flixel.FlxCamera","destroy",0xb607d391,"flixel.FlxCamera.destroy","flixel/FlxCamera.hx",917,0xe7aeb95a)
            	HX_STACK_THIS(this)
HXLINE( 918)		::flixel::util::FlxDestroyUtil_obj::removeChild(this->flashSprite,this->_scrollRect);
HXLINE( 920)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
...
HXLINE( 936)			Bool _hx_tmp1 = hx::IsNotNull( this->canvas );
HXDLIN( 936)			if (_hx_tmp1) {
HXLINE( 938)				{
HXLINE( 938)					HX_VARI( Int,_g1) = (int)0;
HXDLIN( 938)					HX_VARI( Int,_g) = this->canvas->get_numChildren();
...
HXLINE( 945)			Bool _hx_tmp2 = hx::IsNotNull( this->_headOfDrawStack );
...
void FlxCamera_obj::update(Float elapsed){
            	HX_STACK_FRAME("flixel.FlxCamera","update",0xa0edff52,"flixel.FlxCamera.update","flixel/FlxCamera.hx",976,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(elapsed,"elapsed")
HXLINE( 978)		Bool _hx_tmp = hx::IsNotNull( this->target );
...
HXLINE( 987)		::Array< ::Dynamic> _hx_tmp1;
HXDLIN( 987)		if (this->filtersEnabled) {
HXLINE( 987)			_hx_tmp1 = this->_filters;
            		}
            		else {
HXLINE( 987)			_hx_tmp1 = null();
            		}
HXDLIN( 987)		this->flashSprite->set_filters(_hx_tmp1);
...
void FlxCamera_obj::updateScroll(){
            	HX_STACK_FRAME("flixel.FlxCamera","updateScroll",0x3fd094ff,"flixel.FlxCamera.updateScroll","flixel/FlxCamera.hx",998,0xe7aeb95a)
            	HX_STACK_THIS(this)
HXLINE(1000)		HX_VARI( Float,zoom) = ((Float)this->zoom / (Float)::flixel::FlxG_obj::initialZoom);
HXLINE(1002)		HX_VAR(  ::Dynamic,minX);
HXDLIN(1002)		Bool _hx_tmp = hx::IsNull( this->minScrollX );
HXDLIN(1002)		if (_hx_tmp) {
HXLINE(1002)			minX = null();
            		}
            		else {
HXLINE(1002)			minX = (this->minScrollX - ((Float)((zoom - (int)1) * this->width) / (Float)((int)2 * zoom)));
            		}
HXLINE(1003)		HX_VAR(  ::Dynamic,maxX);
HXDLIN(1003)		Bool _hx_tmp1 = hx::IsNull( this->maxScrollX );
HXDLIN(1003)		if (_hx_tmp1) {
HXLINE(1003)			maxX = null();
            		}
            		else {
HXLINE(1003)			maxX = (this->maxScrollX + ((Float)((zoom - (int)1) * this->width) / (Float)((int)2 * zoom)));
            		}
HXLINE(1004)		HX_VAR(  ::Dynamic,minY);
HXDLIN(1004)		Bool _hx_tmp2 = hx::IsNull( this->minScrollY );
HXDLIN(1004)		if (_hx_tmp2) {
HXLINE(1004)			minY = null();
            		}
            		else {
HXLINE(1004)			minY = (this->minScrollY - ((Float)((zoom - (int)1) * this->height) / (Float)((int)2 * zoom)));
            		}
HXLINE(1005)		HX_VAR(  ::Dynamic,maxY);
HXDLIN(1005)		Bool _hx_tmp3 = hx::IsNull( this->maxScrollY );
HXDLIN(1005)		if (_hx_tmp3) {
HXLINE(1005)			maxY = null();
            		}
            		else {
HXLINE(1005)			maxY = (this->maxScrollY + ((Float)((zoom - (int)1) * this->height) / (Float)((int)2 * zoom)));
            		}
HXLINE(1008)		HX_VARI( Float,Value) = this->scroll->x;
HXDLIN(1008)		HX_VAR(  ::Dynamic,Max);
HXDLIN(1008)		Bool _hx_tmp4 = hx::IsNotNull( maxX );
...
HXDLIN(1008)		HX_VAR( Float,lowerBound);
HXDLIN(1008)		Bool _hx_tmp5;
HXDLIN(1008)		Bool _hx_tmp6 = hx::IsNotNull( minX );
HXDLIN(1008)		if (_hx_tmp6) {
HXLINE(1008)			_hx_tmp5 = hx::IsLess( Value,minX );
            		}
            		else {
HXLINE(1008)			_hx_tmp5 = false;
            		}
...
HXDLIN(1008)		Float _hx_tmp7;
HXDLIN(1008)		Bool _hx_tmp8;
HXDLIN(1008)		Bool _hx_tmp9 = hx::IsNotNull( Max );
HXDLIN(1008)		if (_hx_tmp9) {
HXLINE(1008)			_hx_tmp8 = hx::IsGreater( lowerBound,Max );
            		}
            		else {
HXLINE(1008)			_hx_tmp8 = false;
            		}
HXDLIN(1008)		if (_hx_tmp8) {
HXLINE(1008)			_hx_tmp7 = Max;
            		}
            		else {
HXLINE(1008)			_hx_tmp7 = lowerBound;
            		}
HXDLIN(1008)		this->scroll->set_x(_hx_tmp7);
HXLINE(1009)		HX_VARI_NAME( Float,Value1,"Value") = this->scroll->y;
HXDLIN(1009)		HX_VAR_NAME(  ::Dynamic,Max1,"Max");
HXDLIN(1009)		Bool _hx_tmp10 = hx::IsNotNull( maxY );
HXDLIN(1009)		if (_hx_tmp10) {
HXLINE(1009)			Max1 = (maxY - this->height);
            		}
            		else {
HXLINE(1009)			Max1 = null();
            		}
HXDLIN(1009)		HX_VAR_NAME( Float,lowerBound1,"lowerBound");
HXDLIN(1009)		Bool _hx_tmp11;
HXDLIN(1009)		Bool _hx_tmp12 = hx::IsNotNull( minY );
HXDLIN(1009)		if (_hx_tmp12) {
HXLINE(1009)			_hx_tmp11 = hx::IsLess( Value1,minY );
            		}
            		else {
HXLINE(1009)			_hx_tmp11 = false;
            		}
HXDLIN(1009)		if (_hx_tmp11) {
HXLINE(1009)			lowerBound1 = minY;
            		}
            		else {
HXLINE(1009)			lowerBound1 = Value1;
            		}
HXDLIN(1009)		Float _hx_tmp13;
HXDLIN(1009)		Bool _hx_tmp14;
HXDLIN(1009)		Bool _hx_tmp15 = hx::IsNotNull( Max1 );
HXDLIN(1009)		if (_hx_tmp15) {
HXLINE(1009)			_hx_tmp14 = hx::IsGreater( lowerBound1,Max1 );
            		}
            		else {
HXLINE(1009)			_hx_tmp14 = false;
            		}
HXDLIN(1009)		if (_hx_tmp14) {
HXLINE(1009)			_hx_tmp13 = Max1;
            		}
            		else {
HXLINE(1009)			_hx_tmp13 = lowerBound1;
            		}
HXDLIN(1009)		this->scroll->set_y(_hx_tmp13);
            	}
...
void FlxCamera_obj::updateFollow(){
            	HX_STACK_FRAME("flixel.FlxCamera","updateFollow",0xf2024e63,"flixel.FlxCamera.updateFollow","flixel/FlxCamera.hx",1020,0xe7aeb95a)
            	HX_STACK_THIS(this)
HXLINE(1020)		Bool _hx_tmp = hx::IsNull( this->deadzone );
HXDLIN(1020)		if (_hx_tmp) {
HXLINE(1022)			this->target->getMidpoint(this->_point);
HXLINE(1023)			this->_point->addPoint(this->targetOffset);
HXLINE(1024)			{
HXLINE(1024)				HX_VARI(  ::flixel::math::FlxPoint,point) = this->_point;
HXDLIN(1024)				Float _hx_tmp1 = (point->x - (this->width * ((Float)0.5)));
HXDLIN(1024)				Float _hx_tmp2 = (point->y - (this->height * ((Float)0.5)));
HXDLIN(1024)				this->scroll->set(_hx_tmp1,_hx_tmp2);
HXDLIN(1024)				Bool _hx_tmp3 = point->_weak;
...
HXLINE(1028)			HX_VAR( Float,edge);
HXLINE(1029)			HX_VARI( Float,targetX) = (this->target->x + this->targetOffset->x);
HXLINE(1030)			HX_VARI( Float,targetY) = (this->target->y + this->targetOffset->y);
HXLINE(1032)			if (hx::IsEq( this->style,::flixel::FlxCameraFollowStyle_obj::SCREEN_BY_SCREEN_dyn() )) {
HXLINE(1034)				Bool _hx_tmp4 = (targetX >= (this->scroll->x + this->width));
HXDLIN(1034)				if (_hx_tmp4) {
HXLINE(1036)					HX_VARI(  ::flixel::math::FlxPoint,_g) = this->_scrollTarget;
HXDLIN(1036)					Float _hx_tmp5 = (_g->x + this->width);
HXDLIN(1036)					_g->set_x(_hx_tmp5);
            				}
            				else {
HXLINE(1038)					Bool _hx_tmp6 = (targetX < this->scroll->x);
HXDLIN(1038)					if (_hx_tmp6) {
HXLINE(1040)						HX_VARI_NAME(  ::flixel::math::FlxPoint,_g1,"_g") = this->_scrollTarget;
HXDLIN(1040)						Float _hx_tmp7 = (_g1->x - this->width);
HXDLIN(1040)						_g1->set_x(_hx_tmp7);
            					}
            				}
HXLINE(1043)				Bool _hx_tmp8 = (targetY >= (this->scroll->y + this->height));
HXDLIN(1043)				if (_hx_tmp8) {
HXLINE(1045)					HX_VARI_NAME(  ::flixel::math::FlxPoint,_g2,"_g") = this->_scrollTarget;
HXDLIN(1045)					Float _hx_tmp9 = (_g2->y + this->height);
HXDLIN(1045)					_g2->set_y(_hx_tmp9);
            				}
            				else {
HXLINE(1047)					Bool _hx_tmp10 = (targetY < this->scroll->y);
HXDLIN(1047)					if (_hx_tmp10) {
HXLINE(1049)						HX_VARI_NAME(  ::flixel::math::FlxPoint,_g3,"_g") = this->_scrollTarget;
HXDLIN(1049)						Float _hx_tmp11 = (_g3->y - this->height);
HXDLIN(1049)						_g3->set_y(_hx_tmp11);
            					}
            				}
            			}
            			else {
HXLINE(1054)				edge = (targetX - this->deadzone->x);
HXLINE(1055)				Bool _hx_tmp12 = (this->_scrollTarget->x > edge);
HXDLIN(1055)				if (_hx_tmp12) {
HXLINE(1057)					this->_scrollTarget->set_x(edge);
            				}
HXLINE(1059)				Float _hx_tmp13 = this->target->get_width();
HXDLIN(1059)				edge = (((targetX + _hx_tmp13) - this->deadzone->x) - this->deadzone->width);
HXLINE(1060)				Bool _hx_tmp14 = (this->_scrollTarget->x < edge);
HXDLIN(1060)				if (_hx_tmp14) {
HXLINE(1062)					this->_scrollTarget->set_x(edge);
            				}
HXLINE(1065)				edge = (targetY - this->deadzone->y);
HXLINE(1066)				Bool _hx_tmp15 = (this->_scrollTarget->y > edge);
HXDLIN(1066)				if (_hx_tmp15) {
HXLINE(1068)					this->_scrollTarget->set_y(edge);
            				}
HXLINE(1070)				Float _hx_tmp16 = this->target->get_height();
HXDLIN(1070)				edge = (((targetY + _hx_tmp16) - this->deadzone->y) - this->deadzone->height);
HXLINE(1071)				Bool _hx_tmp17 = (this->_scrollTarget->y < edge);
HXDLIN(1071)				if (_hx_tmp17) {
HXLINE(1073)					this->_scrollTarget->set_y(edge);
            				}
            			}
HXLINE(1077)			Bool _hx_tmp18 = ::Std_obj::is(this->target,hx::ClassOf< ::flixel::FlxSprite >());
HXDLIN(1077)			if (_hx_tmp18) {
HXLINE(1079)				Bool _hx_tmp19 = hx::IsNull( this->_lastTargetPosition );
HXDLIN(1079)				if (_hx_tmp19) {
HXLINE(1081)					Float X = this->target->x;
HXDLIN(1081)					Float Y = this->target->y;
HXDLIN(1081)					HX_VARI_NAME(  ::flixel::math::FlxPoint,point1,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set(X,Y);
HXDLIN(1081)					point1->_inPool = false;
HXDLIN(1081)					this->_lastTargetPosition = point1;
            				}
HXLINE(1083)				{
HXLINE(1083)					HX_VARI_NAME(  ::flixel::math::FlxPoint,_g4,"_g") = this->_scrollTarget;
HXDLIN(1083)					Float _hx_tmp20 = _g4->x;
HXDLIN(1083)					Float _hx_tmp21 = ((this->target->x - this->_lastTargetPosition->x) * this->followLead->x);
HXDLIN(1083)					_g4->set_x((_hx_tmp20 + _hx_tmp21));
            				}
HXLINE(1084)				{
HXLINE(1084)					HX_VARI_NAME(  ::flixel::math::FlxPoint,_g5,"_g") = this->_scrollTarget;
HXDLIN(1084)					Float _hx_tmp22 = _g5->y;
HXDLIN(1084)					Float _hx_tmp23 = ((this->target->y - this->_lastTargetPosition->y) * this->followLead->y);
HXDLIN(1084)					_g5->set_y((_hx_tmp22 + _hx_tmp23));
            				}
HXLINE(1086)				this->_lastTargetPosition->set_x(this->target->x);
HXLINE(1087)				this->_lastTargetPosition->set_y(this->target->y);
            			}
HXLINE(1090)			Bool _hx_tmp24 = (this->followLerp >= ((Float)(int)60 / (Float)::flixel::FlxG_obj::updateFramerate));
HXDLIN(1090)			if (_hx_tmp24) {
HXLINE(1092)				HX_VARI(  ::flixel::math::FlxPoint,_this) = this->scroll;
HXDLIN(1092)				HX_VARI_NAME(  ::flixel::math::FlxPoint,point2,"point") = this->_scrollTarget;
HXDLIN(1092)				_this->set_x(point2->x);
HXDLIN(1092)				_this->set_y(point2->y);
HXDLIN(1092)				Bool _hx_tmp25 = point2->_weak;
HXDLIN(1092)				if (_hx_tmp25) {
HXLINE(1092)					point2->put();
            				}
            			}
            			else {
HXLINE(1096)				{
HXLINE(1096)					HX_VARI_NAME(  ::flixel::math::FlxPoint,_g6,"_g") = this->scroll;
HXDLIN(1096)					Float _hx_tmp26 = _g6->x;
HXDLIN(1096)					Float _hx_tmp27 = ((Float)(((this->_scrollTarget->x - this->scroll->x) * this->followLerp) * ::flixel::FlxG_obj::updateFramerate) / (Float)(int)60);
HXDLIN(1096)					_g6->set_x((_hx_tmp26 + _hx_tmp27));
            				}
HXLINE(1097)				{
HXLINE(1097)					HX_VARI_NAME(  ::flixel::math::FlxPoint,_g7,"_g") = this->scroll;
HXDLIN(1097)					Float _hx_tmp28 = _g7->y;
HXDLIN(1097)					Float _hx_tmp29 = ((Float)(((this->_scrollTarget->y - this->scroll->y) * this->followLerp) * ::flixel::FlxG_obj::updateFramerate) / (Float)(int)60);
HXDLIN(1097)					_g7->set_y((_hx_tmp28 + _hx_tmp29));
            				}
            			}
            		}
            	}
...
void FlxCamera_obj::updateFlash(Float elapsed){
            	HX_STACK_FRAME("flixel.FlxCamera","updateFlash",0x43f2dcfe,"flixel.FlxCamera.updateFlash","flixel/FlxCamera.hx",1105,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(elapsed,"elapsed")
HXLINE(1105)		Bool _hx_tmp = (this->_fxFlashAlpha > ((Float)0.0));
HXDLIN(1105)		if (_hx_tmp) {
HXLINE(1107)			hx::SubEq(this->_fxFlashAlpha,((Float)elapsed / (Float)this->_fxFlashDuration));
...
void FlxCamera_obj::updateFade(Float elapsed){
            	HX_STACK_FRAME("flixel.FlxCamera","updateFade",0xaec3f1ee,"flixel.FlxCamera.updateFade","flixel/FlxCamera.hx",1116,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(elapsed,"elapsed")
HXLINE(1117)		if (this->_fxFadeCompleted) {
HXLINE(1118)			return;
            		}
HXLINE(1120)		Bool _hx_tmp = this->_fxFadeIn;
HXDLIN(1120)		if (_hx_tmp) {
HXLINE(1122)			hx::SubEq(this->_fxFadeAlpha,((Float)elapsed / (Float)this->_fxFadeDuration));
HXLINE(1123)			Bool _hx_tmp1 = (this->_fxFadeAlpha <= ((Float)0.0));
...
HXLINE(1131)			hx::AddEq(this->_fxFadeAlpha,((Float)elapsed / (Float)this->_fxFadeDuration));
HXLINE(1132)			Bool _hx_tmp2 = (this->_fxFadeAlpha >= ((Float)1.0));
...
void FlxCamera_obj::completeFade(){
            	HX_STACK_FRAME("flixel.FlxCamera","completeFade",0xb02048de,"flixel.FlxCamera.completeFade","flixel/FlxCamera.hx",1141,0xe7aeb95a)
            	HX_STACK_THIS(this)
HXLINE(1142)		this->_fxFadeCompleted = true;
HXLINE(1143)		Bool _hx_tmp = hx::IsNotNull( this->_fxFadeComplete );
...
void FlxCamera_obj::updateShake(Float elapsed){
            	HX_STACK_FRAME("flixel.FlxCamera","updateShake",0xbd838614,"flixel.FlxCamera.updateShake","flixel/FlxCamera.hx",1149,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(elapsed,"elapsed")
HXLINE(1149)		Bool _hx_tmp = (this->_fxShakeDuration > (int)0);
HXDLIN(1149)		if (_hx_tmp) {
HXLINE(1151)			hx::SubEq(this->_fxShakeDuration,elapsed);
HXLINE(1152)			Bool _hx_tmp1 = (this->_fxShakeDuration <= (int)0);
HXDLIN(1152)			if (_hx_tmp1) {
HXLINE(1154)				Bool _hx_tmp2 = hx::IsNotNull( this->_fxShakeComplete );
HXDLIN(1154)				if (_hx_tmp2) {
HXLINE(1156)					this->_fxShakeComplete();
            				}
            			}
            			else {
HXLINE(1161)				if (hx::IsNotEq( this->_fxShakeAxes,::flixel::util::FlxAxes_obj::Y_dyn() )) {
HXLINE(1163)					HX_VARI(  ::openfl::display::Sprite,_g) = this->flashSprite;
HXDLIN(1163)					Float _hx_tmp3 = _g->get_x();
HXDLIN(1163)					Float _hx_tmp4 = (-(this->_fxShakeIntensity) * this->width);
HXDLIN(1163)					Float _hx_tmp5 = (this->_fxShakeIntensity * this->width);
HXDLIN(1163)					Float _hx_tmp6 = ::flixel::FlxG_obj::random->_hx_float(_hx_tmp4,_hx_tmp5,null());
HXDLIN(1163)					Float _hx_tmp7 = ((_hx_tmp6 * this->zoom) * ::flixel::FlxG_obj::scaleMode->scale->x);
HXDLIN(1163)					_g->set_x((_hx_tmp3 + _hx_tmp7));
            				}
HXLINE(1165)				if (hx::IsNotEq( this->_fxShakeAxes,::flixel::util::FlxAxes_obj::X_dyn() )) {
HXLINE(1167)					HX_VARI_NAME(  ::openfl::display::Sprite,_g1,"_g") = this->flashSprite;
HXDLIN(1167)					Float _hx_tmp8 = _g1->get_y();
HXDLIN(1167)					Float _hx_tmp9 = (-(this->_fxShakeIntensity) * this->height);
HXDLIN(1167)					Float _hx_tmp10 = (this->_fxShakeIntensity * this->height);
HXDLIN(1167)					Float _hx_tmp11 = ::flixel::FlxG_obj::random->_hx_float(_hx_tmp9,_hx_tmp10,null());
HXDLIN(1167)					Float _hx_tmp12 = ((_hx_tmp11 * this->zoom) * ::flixel::FlxG_obj::scaleMode->scale->y);
HXDLIN(1167)					_g1->set_y((_hx_tmp8 + _hx_tmp12));
            				}
            			}
            		}
            	}
...
void FlxCamera_obj::updateFlashSpritePosition(){
            	HX_STACK_FRAME("flixel.FlxCamera","updateFlashSpritePosition",0x5aef376c,"flixel.FlxCamera.updateFlashSpritePosition","flixel/FlxCamera.hx",1179,0xe7aeb95a)
            	HX_STACK_THIS(this)
HXLINE(1179)		Bool _hx_tmp = hx::IsNotNull( this->flashSprite );
HXDLIN(1179)		if (_hx_tmp) {
HXLINE(1181)			Float _hx_tmp1 = ((this->x * ::flixel::FlxG_obj::scaleMode->scale->x) + this->_flashOffset->x);
HXDLIN(1181)			this->flashSprite->set_x(_hx_tmp1);
HXLINE(1182)			Float _hx_tmp2 = ((this->y * ::flixel::FlxG_obj::scaleMode->scale->y) + this->_flashOffset->y);
HXDLIN(1182)			this->flashSprite->set_y(_hx_tmp2);
            		}
            	}
...
void FlxCamera_obj::updateFlashOffset(){
            	HX_STACK_FRAME("flixel.FlxCamera","updateFlashOffset",0x0e9fbb31,"flixel.FlxCamera.updateFlashOffset","flixel/FlxCamera.hx",1191,0xe7aeb95a)
            	HX_STACK_THIS(this)
HXLINE(1192)		Float _hx_tmp = (((this->width * ((Float)0.5)) * ::flixel::FlxG_obj::scaleMode->scale->x) * this->initialZoom);
HXDLIN(1192)		this->_flashOffset->set_x(_hx_tmp);
HXLINE(1193)		Float _hx_tmp1 = (((this->height * ((Float)0.5)) * ::flixel::FlxG_obj::scaleMode->scale->y) * this->initialZoom);
HXDLIN(1193)		this->_flashOffset->set_y(_hx_tmp1);
            	}
...
void FlxCamera_obj::updateScrollRect(){
            	HX_STACK_FRAME("flixel.FlxCamera","updateScrollRect",0xbf58f9c3,"flixel.FlxCamera.updateScrollRect","flixel/FlxCamera.hx",1205,0xe7aeb95a)
            	HX_STACK_THIS(this)
HXLINE(1206)		HX_VAR(  ::openfl::geom::Rectangle,rect);
HXDLIN(1206)		Bool _hx_tmp = hx::IsNotNull( this->_scrollRect );
...
HXLINE(1208)		Bool _hx_tmp1 = hx::IsNotNull( rect );
HXDLIN(1208)		if (_hx_tmp1) {
HXLINE(1210)			rect->x = (rect->y = (int)0);
HXLINE(1212)			Float _hx_tmp2 = (this->width * this->initialZoom);
HXDLIN(1212)			rect->width = (_hx_tmp2 * ::flixel::FlxG_obj::scaleMode->scale->x);
HXLINE(1213)			Float _hx_tmp3 = (this->height * this->initialZoom);
HXDLIN(1213)			rect->height = (_hx_tmp3 * ::flixel::FlxG_obj::scaleMode->scale->y);
HXLINE(1215)			this->_scrollRect->set_scrollRect(rect);
HXLINE(1217)			Float _hx_tmp4 = (((Float)-0.5) * rect->width);
HXDLIN(1217)			this->_scrollRect->set_x(_hx_tmp4);
HXLINE(1218)			Float _hx_tmp5 = (((Float)-0.5) * rect->height);
HXDLIN(1218)			this->_scrollRect->set_y(_hx_tmp5);
            		}
            	}
...
void FlxCamera_obj::updateInternalSpritePositions(){
            	HX_STACK_FRAME("flixel.FlxCamera","updateInternalSpritePositions",0x7d5baef6,"flixel.FlxCamera.updateInternalSpritePositions","flixel/FlxCamera.hx",1230,0xe7aeb95a)
            	HX_STACK_THIS(this)
HXLINE(1230)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
HXDLIN(1230)		if (_hx_tmp) {
HXLINE(1232)			Bool _hx_tmp1 = hx::IsNotNull( this->_flashBitmap );
...
HXLINE(1240)			Bool _hx_tmp2 = hx::IsNotNull( this->canvas );
HXDLIN(1240)			if (_hx_tmp2) {
HXLINE(1242)				Float _hx_tmp3 = (((((Float)-0.5) * this->width) * (this->scaleX - this->initialZoom)) * ::flixel::FlxG_obj::scaleMode->scale->x);
HXDLIN(1242)				this->canvas->set_x(_hx_tmp3);
HXLINE(1243)				Float _hx_tmp4 = (((((Float)-0.5) * this->height) * (this->scaleY - this->initialZoom)) * ::flixel::FlxG_obj::scaleMode->scale->y);
HXDLIN(1243)				this->canvas->set_y(_hx_tmp4);
...
void FlxCamera_obj::follow( ::flixel::FlxObject Target,::hx::EnumBase Style, ::Dynamic Lerp){
            	HX_STACK_FRAME("flixel.FlxCamera","follow",0x137f0aba,"flixel.FlxCamera.follow","flixel/FlxCamera.hx",1272,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Target,"Target")
            	HX_STACK_ARG(Style,"Style")
            	HX_STACK_ARG(Lerp,"Lerp")
HXLINE(1273)		Bool _hx_tmp = hx::IsNull( Style );
HXDLIN(1273)		if (_hx_tmp) {
HXLINE(1274)			Style = ::flixel::FlxCameraFollowStyle_obj::LOCKON_dyn();
            		}
HXLINE(1276)		Bool _hx_tmp1 = hx::IsNull( Lerp );
...
HXLINE(1282)		HX_VAR( Float,helper);
HXLINE(1283)		HX_VARI( Float,w) = (int)0;
HXLINE(1284)		HX_VARI( Float,h) = (int)0;
HXLINE(1285)		this->_lastTargetPosition = null();
HXLINE(1287)		Int _hx_tmp2 = ( ( ::hx::EnumBase)(Style) )->_hx_getIndex();
HXDLIN(1287)		switch((int)(_hx_tmp2)){
            			case (int)0: {
HXLINE(1290)				Bool _hx_tmp3 = hx::IsNotNull( this->target );
...
HXDLIN(1295)				Float Y = (((Float)(this->height - h) / (Float)(int)2) - (h * ((Float)0.25)));
HXDLIN(1295)				HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN(1295)				_this->x = X;
HXDLIN(1295)				_this->y = Y;
HXDLIN(1295)				_this->width = w;
HXDLIN(1295)				_this->height = h;
HXDLIN(1295)				_this->_inPool = false;
HXDLIN(1295)				this->deadzone = _this;
            			}
            			break;
            			case (int)1: {
HXLINE(1298)				HX_VARI_NAME( Float,w1,"w") = ((Float)this->width / (Float)(int)8);
HXLINE(1299)				HX_VARI_NAME( Float,h1,"h") = ((Float)this->height / (Float)(int)3);
HXLINE(1300)				Float X1 = ((Float)(this->width - w1) / (Float)(int)2);
HXDLIN(1300)				Float Y1 = (((Float)(this->height - h1) / (Float)(int)2) - (h1 * ((Float)0.25)));
HXDLIN(1300)				HX_VARI_NAME(  ::flixel::math::FlxRect,_this1,"_this") = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN(1300)				_this1->x = X1;
HXDLIN(1300)				_this1->y = Y1;
HXDLIN(1300)				_this1->width = w1;
HXDLIN(1300)				_this1->height = h1;
HXDLIN(1300)				_this1->_inPool = false;
HXDLIN(1300)				this->deadzone = _this1;
            			}
            			break;
            			case (int)2: {
HXLINE(1303)				Float _hx_tmp4 = ::Math_obj::max(this->width,this->height);
HXDLIN(1303)				helper = ((Float)_hx_tmp4 / (Float)(int)4);
HXLINE(1304)				Float X2 = ((Float)(this->width - helper) / (Float)(int)2);
HXDLIN(1304)				Float Y2 = ((Float)(this->height - helper) / (Float)(int)2);
HXDLIN(1304)				HX_VARI_NAME(  ::flixel::math::FlxRect,_this2,"_this") = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN(1304)				_this2->x = X2;
HXDLIN(1304)				_this2->y = Y2;
HXDLIN(1304)				_this2->width = helper;
HXDLIN(1304)				_this2->height = helper;
HXDLIN(1304)				_this2->_inPool = false;
HXDLIN(1304)				this->deadzone = _this2;
            			}
            			break;
            			case (int)3: {
HXLINE(1307)				Float _hx_tmp5 = ::Math_obj::max(this->width,this->height);
HXDLIN(1307)				helper = ((Float)_hx_tmp5 / (Float)(int)8);
HXLINE(1308)				Float X3 = ((Float)(this->width - helper) / (Float)(int)2);
HXDLIN(1308)				Float Y3 = ((Float)(this->height - helper) / (Float)(int)2);
HXDLIN(1308)				HX_VARI_NAME(  ::flixel::math::FlxRect,_this3,"_this") = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN(1308)				_this3->x = X3;
HXDLIN(1308)				_this3->y = Y3;
HXDLIN(1308)				_this3->width = helper;
HXDLIN(1308)				_this3->height = helper;
HXDLIN(1308)				_this3->_inPool = false;
HXDLIN(1308)				this->deadzone = _this3;
            			}
            			break;
            			case (int)4: {
HXLINE(1311)				Float Width = this->width;
HXDLIN(1311)				Float Height = this->height;
HXDLIN(1311)				HX_VARI_NAME(  ::flixel::math::FlxRect,_this4,"_this") = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN(1311)				_this4->x = (int)0;
HXDLIN(1311)				_this4->y = (int)0;
HXDLIN(1311)				_this4->width = Width;
HXDLIN(1311)				_this4->height = Height;
HXDLIN(1311)				_this4->_inPool = false;
HXDLIN(1311)				this->deadzone = _this4;
            			}
            			break;
            			case (int)5: {
...
void FlxCamera_obj::snapToTarget(){
            	HX_STACK_FRAME("flixel.FlxCamera","snapToTarget",0x8eeb1d9f,"flixel.FlxCamera.snapToTarget","flixel/FlxCamera.hx",1323,0xe7aeb95a)
            	HX_STACK_THIS(this)
HXLINE(1324)		this->updateFollow();
HXLINE(1325)		{
HXLINE(1325)			HX_VARI(  ::flixel::math::FlxPoint,_this) = this->scroll;
HXDLIN(1325)			HX_VARI(  ::flixel::math::FlxPoint,point) = this->_scrollTarget;
HXDLIN(1325)			_this->set_x(point->x);
HXDLIN(1325)			_this->set_y(point->y);
HXDLIN(1325)			Bool _hx_tmp = point->_weak;
...
void FlxCamera_obj::focusOn( ::flixel::math::FlxPoint point){
            	HX_STACK_FRAME("flixel.FlxCamera","focusOn",0xd304f1ae,"flixel.FlxCamera.focusOn","flixel/FlxCamera.hx",1334,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(point,"point")
HXLINE(1335)		Float _hx_tmp = (point->x - (this->width * ((Float)0.5)));
HXDLIN(1335)		Float _hx_tmp1 = (point->y - (this->height * ((Float)0.5)));
HXDLIN(1335)		this->scroll->set(_hx_tmp,_hx_tmp1);
HXLINE(1336)		Bool _hx_tmp2 = point->_weak;
HXDLIN(1336)		if (_hx_tmp2) {
...
Bool Force = __o_Force.Default(false);
            	HX_STACK_FRAME("flixel.FlxCamera","flash",0x27663887,"flixel.FlxCamera.flash","flixel/FlxCamera.hx",1349,0xe7aeb95a)
            	HX_STACK_THIS(this)
...
HXLINE(1354)		Bool _hx_tmp1 = (Duration <= (int)0);
...
Bool Force = __o_Force.Default(false);
            	HX_STACK_FRAME("flixel.FlxCamera","fade",0xa5741a85,"flixel.FlxCamera.fade","flixel/FlxCamera.hx",1372,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Color,"Color")
            	HX_STACK_ARG(Duration,"Duration")
...
HXLINE(1377)		Bool _hx_tmp1 = (Duration <= (int)0);
...
HXLINE(1384)		Float _hx_tmp2;
HXDLIN(1384)		if (this->_fxFadeIn) {
HXLINE(1384)			_hx_tmp2 = ((Float)0.999999);
            		}
            		else {
HXLINE(1384)			_hx_tmp2 = ((Float)0.000001);
            		}
HXDLIN(1384)		this->_fxFadeAlpha = _hx_tmp2;
...
Bool Force = __o_Force.Default(true);
            	HX_STACK_FRAME("flixel.FlxCamera","shake",0xa0f6e19d,"flixel.FlxCamera.shake","flixel/FlxCamera.hx",1400,0xe7aeb95a)
            	HX_STACK_THIS(this)
...
void FlxCamera_obj::stopFX(){
            	HX_STACK_FRAME("flixel.FlxCamera","stopFX",0x29222b1d,"flixel.FlxCamera.stopFX","flixel/FlxCamera.hx",1417,0xe7aeb95a)
            	HX_STACK_THIS(this)
...
void FlxCamera_obj::setFilters(::Array< ::Dynamic> filters){
            	HX_STACK_FRAME("flixel.FlxCamera","setFilters",0x0e7f1802,"flixel.FlxCamera.setFilters","flixel/FlxCamera.hx",1429,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(filters,"filters")
HXLINE(1429)		this->_filters = filters;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxCamera_obj,setFilters,(void))
 ...
 ::flixel::FlxCamera FlxCamera_obj::copyFrom( ::flixel::FlxCamera Camera){
            	HX_STACK_FRAME("flixel.FlxCamera","copyFrom",0x88512948,"flixel.FlxCamera.copyFrom","flixel/FlxCamera.hx",1439,0xe7aeb95a)
            	HX_STACK_THIS(this)
...
HXLINE(1444)		Bool _hx_tmp = hx::IsNotNull( this->target );
HXDLIN(1444)		if (_hx_tmp) {
HXLINE(1446)			Bool _hx_tmp1 = hx::IsNull( Camera->deadzone );
HXDLIN(1446)			if (_hx_tmp1) {
HXLINE(1448)				this->deadzone = null();
            			}
            			else {
HXLINE(1452)				Bool _hx_tmp2 = hx::IsNull( this->deadzone );
HXDLIN(1452)				if (_hx_tmp2) {
HXLINE(1454)					Float X = (int)0;
HXDLIN(1454)					Float Y = (int)0;
HXDLIN(1454)					Float Width = (int)0;
HXDLIN(1454)					Float Height = (int)0;
HXDLIN(1454)					HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN(1454)					_this->x = X;
HXDLIN(1454)					_this->y = Y;
HXDLIN(1454)					_this->width = Width;
HXDLIN(1454)					_this->height = Height;
HXDLIN(1454)					_this->_inPool = false;
HXDLIN(1454)					this->deadzone = _this;
            				}
HXLINE(1456)				{
HXLINE(1456)					HX_VARI_NAME(  ::flixel::math::FlxRect,_this1,"_this") = this->deadzone;
HXDLIN(1456)					HX_VARI(  ::flixel::math::FlxRect,Rect) = Camera->deadzone;
...
HXDLIN(1456)					Bool _hx_tmp3 = Rect->_weak;
HXDLIN(1456)					if (_hx_tmp3) {
HXLINE(1456)						Bool _hx_tmp4 = !(Rect->_inPool);
...
Float FxAlpha = __o_FxAlpha.Default(((Float)1.0));
            	HX_STACK_FRAME("flixel.FlxCamera","fill",0xa57a338c,"flixel.FlxCamera.fill","flixel/FlxCamera.hx",1470,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Color,"Color")
            	HX_STACK_ARG(BlendAlpha,"BlendAlpha")
            	HX_STACK_ARG(FxAlpha,"FxAlpha")
            	HX_STACK_ARG(graphics,"graphics")
HXLINE(1470)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
...
HXLINE(1489)			HX_VAR(  ::openfl::display::Graphics,targetGraphics);
HXDLIN(1489)			Bool _hx_tmp1 = hx::IsNull( graphics );
...
HXLINE(1494)			Float _hx_tmp2 = (this->viewOffsetX - (int)1);
HXDLIN(1494)			Float _hx_tmp3 = (this->viewOffsetY - (int)1);
HXDLIN(1494)			Float _hx_tmp4 = (this->viewWidth + (int)2);
HXDLIN(1494)			Float _hx_tmp5 = (this->viewHeight + (int)2);
HXDLIN(1494)			targetGraphics->drawRect(_hx_tmp2,_hx_tmp3,_hx_tmp4,_hx_tmp5);
...
void FlxCamera_obj::drawFX(){
            	HX_STACK_FRAME("flixel.FlxCamera","drawFX",0xf9beeb9f,"flixel.FlxCamera.drawFX","flixel/FlxCamera.hx",1504,0xe7aeb95a)
            	HX_STACK_THIS(this)
HXLINE(1505)		HX_VAR( Float,alphaComponent);
HXLINE(1508)		Bool _hx_tmp = (this->_fxFlashAlpha > ((Float)0.0));
HXDLIN(1508)		if (_hx_tmp) {
HXLINE(1510)			alphaComponent = ((int)((int)this->_fxFlashColor >> (int)(int)24) & (int)(int)255);
HXLINE(1512)			Bool _hx_tmp1 = ::flixel::FlxG_obj::renderBlit;
HXDLIN(1512)			if (_hx_tmp1) {
HXLINE(1514)				Float _hx_tmp2;
HXDLIN(1514)				if ((alphaComponent <= (int)0)) {
HXLINE(1514)					_hx_tmp2 = (int)255;
            				}
            				else {
HXLINE(1514)					_hx_tmp2 = alphaComponent;
            				}
HXDLIN(1514)				Float _hx_tmp3 = (_hx_tmp2 * this->_fxFlashAlpha);
HXDLIN(1514)				Int _hx_tmp4 = ::Std_obj::_hx_int(_hx_tmp3);
HXDLIN(1514)				Int _hx_tmp5 = (((int)_hx_tmp4 << (int)(int)24) + ((int)this->_fxFlashColor & (int)(int)16777215));
HXDLIN(1514)				this->fill(_hx_tmp5,null(),null(),null());
            			}
            			else {
HXLINE(1518)				Int _hx_tmp6 = ((int)this->_fxFlashColor & (int)(int)16777215);
HXDLIN(1518)				Float _hx_tmp7;
HXDLIN(1518)				if ((alphaComponent <= (int)0)) {
HXLINE(1518)					_hx_tmp7 = (int)255;
            				}
            				else {
HXLINE(1518)					_hx_tmp7 = alphaComponent;
            				}
HXDLIN(1518)				Float _hx_tmp8 = ((Float)(_hx_tmp7 * this->_fxFlashAlpha) / (Float)(int)255);
HXDLIN(1518)				 ::openfl::display::Graphics _hx_tmp9 = this->canvas->get_graphics();
HXDLIN(1518)				this->fill(_hx_tmp6,true,_hx_tmp8,_hx_tmp9);
            			}
            		}
HXLINE(1523)		Bool _hx_tmp10 = (this->_fxFadeAlpha > ((Float)0.0));
HXDLIN(1523)		if (_hx_tmp10) {
HXLINE(1525)			alphaComponent = ((int)((int)this->_fxFadeColor >> (int)(int)24) & (int)(int)255);
HXLINE(1527)			Bool _hx_tmp11 = ::flixel::FlxG_obj::renderBlit;
HXDLIN(1527)			if (_hx_tmp11) {
HXLINE(1529)				Float _hx_tmp12;
HXDLIN(1529)				if ((alphaComponent <= (int)0)) {
HXLINE(1529)					_hx_tmp12 = (int)255;
            				}
            				else {
HXLINE(1529)					_hx_tmp12 = alphaComponent;
            				}
HXDLIN(1529)				Float _hx_tmp13 = (_hx_tmp12 * this->_fxFadeAlpha);
HXDLIN(1529)				Int _hx_tmp14 = ::Std_obj::_hx_int(_hx_tmp13);
HXDLIN(1529)				Int _hx_tmp15 = (((int)_hx_tmp14 << (int)(int)24) + ((int)this->_fxFadeColor & (int)(int)16777215));
HXDLIN(1529)				this->fill(_hx_tmp15,null(),null(),null());
            			}
            			else {
HXLINE(1533)				Int _hx_tmp16 = ((int)this->_fxFadeColor & (int)(int)16777215);
HXDLIN(1533)				Float _hx_tmp17;
HXDLIN(1533)				if ((alphaComponent <= (int)0)) {
HXLINE(1533)					_hx_tmp17 = (int)255;
            				}
            				else {
HXLINE(1533)					_hx_tmp17 = alphaComponent;
            				}
HXDLIN(1533)				Float _hx_tmp18 = ((Float)(_hx_tmp17 * this->_fxFadeAlpha) / (Float)(int)255);
HXDLIN(1533)				 ::openfl::display::Graphics _hx_tmp19 = this->canvas->get_graphics();
HXDLIN(1533)				this->fill(_hx_tmp16,true,_hx_tmp18,_hx_tmp19);
            			}
            		}
            	}
...
void FlxCamera_obj::checkResize(){
            	HX_STACK_FRAME("flixel.FlxCamera","checkResize",0x465b6af3,"flixel.FlxCamera.checkResize","flixel/FlxCamera.hx",1541,0xe7aeb95a)
            	HX_STACK_THIS(this)
HXLINE(1541)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
HXDLIN(1541)		if (_hx_tmp) {
HXLINE(1543)			Bool _hx_tmp1;
HXDLIN(1543)			if ((this->width == this->buffer->width)) {
HXLINE(1543)				_hx_tmp1 = (this->height != this->buffer->height);
            			}
            			else {
HXLINE(1543)				_hx_tmp1 = true;
            			}
HXDLIN(1543)			if (_hx_tmp1) {
HXLINE(1545)				HX_VARI(  ::flixel::graphics::FlxGraphic,oldBuffer) = this->screen->graphic;
HXLINE(1546)				this->buffer =  ::openfl::display::BitmapData_obj::__new(this->width,this->height,true,(int)0);
HXLINE(1547)				this->screen->set_pixels(this->buffer);
HXLINE(1548)				this->screen->origin->set(null(),null());
HXLINE(1549)				this->_flashBitmap->bitmapData = this->buffer;
...
HXLINE(1553)				this->_fill =  ::openfl::display::BitmapData_obj::__new(this->width,this->height,true,(int)0);
...
HXLINE(1557)					_hx_tmp2 = (this->scaleY < this->initialZoom);
            				}
            				else {
HXLINE(1557)					_hx_tmp2 = true;
            				}
HXDLIN(1557)				this->_useBlitMatrix = _hx_tmp2;
            			}
            		}
            	}
...
void FlxCamera_obj::updateBlitMatrix(){
            	HX_STACK_FRAME("flixel.FlxCamera","updateBlitMatrix",0x8e139648,"flixel.FlxCamera.updateBlitMatrix","flixel/FlxCamera.hx",1562,0xe7aeb95a)
            	HX_STACK_THIS(this)
...
void FlxCamera_obj::setSize(Int Width,Int Height){
            	HX_STACK_FRAME("flixel.FlxCamera","setSize",0xa359881a,"flixel.FlxCamera.setSize","flixel/FlxCamera.hx",1577,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Width,"Width")
            	HX_STACK_ARG(Height,"Height")
...
Float Y = __o_Y.Default(0);
            	HX_STACK_FRAME("flixel.FlxCamera","setPosition",0x5729a882,"flixel.FlxCamera.setPosition","flixel/FlxCamera.hx",1590,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(X,"X")
            	HX_STACK_ARG(Y,"Y")
...
Bool UpdateWorld = __o_UpdateWorld.Default(false);
            	HX_STACK_FRAME("flixel.FlxCamera","setScrollBoundsRect",0xd34a357f,"flixel.FlxCamera.setScrollBoundsRect","flixel/FlxCamera.hx",1606,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(X,"X")
            	HX_STACK_ARG(Y,"Y")
            	HX_STACK_ARG(Width,"Width")
...
HXLINE(1609)			HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::FlxG_obj::worldBounds;
...
void FlxCamera_obj::setScrollBounds( ::Dynamic MinX, ::Dynamic MaxX, ::Dynamic MinY, ::Dynamic MaxY){
            	HX_STACK_FRAME("flixel.FlxCamera","setScrollBounds",0x4d9242bb,"flixel.FlxCamera.setScrollBounds","flixel/FlxCamera.hx",1625,0xe7aeb95a)
            	HX_STACK_THIS(this)
...
void FlxCamera_obj::setScale(Float X,Float Y){
            	HX_STACK_FRAME("flixel.FlxCamera","setScale",0x46f35511,"flixel.FlxCamera.setScale","flixel/FlxCamera.hx",1641,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(X,"X")
            	HX_STACK_ARG(Y,"Y")
...
HXLINE(1648)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
...
HXLINE(1650)					_hx_tmp1 = (this->scaleY < this->initialZoom);
            				}
            				else {
HXLINE(1650)					_hx_tmp1 = true;
            				}
HXDLIN(1650)				this->_useBlitMatrix = _hx_tmp1;
            			}
HXLINE(1652)			Bool _hx_tmp2 = this->_useBlitMatrix;
HXDLIN(1652)			if (_hx_tmp2) {
HXLINE(1654)				Float _hx_tmp3 = (this->initialZoom * ::flixel::FlxG_obj::scaleMode->scale->x);
HXDLIN(1654)				this->_flashBitmap->set_scaleX(_hx_tmp3);
HXLINE(1655)				Float _hx_tmp4 = (this->initialZoom * ::flixel::FlxG_obj::scaleMode->scale->y);
HXDLIN(1655)				this->_flashBitmap->set_scaleY(_hx_tmp4);
            			}
            			else {
...
HXLINE(1664)		{
HXLINE(1664)			Float _hx_tmp5 = ((((Float)0.5) * this->width) * (this->scaleX - this->initialZoom));
HXDLIN(1664)			this->viewOffsetX = ((Float)_hx_tmp5 / (Float)this->scaleX);
HXDLIN(1664)			this->viewOffsetWidth = (this->width - this->viewOffsetX);
HXDLIN(1664)			Int _hx_tmp6 = this->width;
HXDLIN(1664)			Float _hx_tmp7 = ((int)2 * this->viewOffsetX);
HXDLIN(1664)			this->viewWidth = (_hx_tmp6 - _hx_tmp7);
            		}
HXLINE(1665)		{
HXLINE(1665)			Float _hx_tmp8 = ((((Float)0.5) * this->height) * (this->scaleY - this->initialZoom));
HXDLIN(1665)			this->viewOffsetY = ((Float)_hx_tmp8 / (Float)this->scaleY);
HXDLIN(1665)			this->viewOffsetHeight = (this->height - this->viewOffsetY);
HXDLIN(1665)			Int _hx_tmp9 = this->height;
HXDLIN(1665)			Float _hx_tmp10 = ((int)2 * this->viewOffsetY);
HXDLIN(1665)			this->viewHeight = (_hx_tmp9 - _hx_tmp10);
            		}
...
void FlxCamera_obj::onResize(){
            	HX_STACK_FRAME("flixel.FlxCamera","onResize",0xa8186dfc,"flixel.FlxCamera.onResize","flixel/FlxCamera.hx",1678,0xe7aeb95a)
            	HX_STACK_THIS(this)
...
Float width = __o_width.Default(0);
Float height = __o_height.Default(0);
            	HX_STACK_FRAME("flixel.FlxCamera","containsPoint",0x2d56eb88,"flixel.FlxCamera.containsPoint","flixel/FlxCamera.hx",1690,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(point,"point")
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
...
HXLINE(1690)			_hx_tmp1 = (point->x < this->viewOffsetWidth);
            		}
            		else {
HXLINE(1690)			_hx_tmp1 = false;
            		}
HXDLIN(1690)		if (_hx_tmp1) {
HXLINE(1690)			_hx_tmp = ((point->y + height) > this->viewOffsetY);
            		}
            		else {
HXLINE(1690)			_hx_tmp = false;
            		}
HXDLIN(1690)		if (_hx_tmp) {
HXLINE(1690)			return (point->y < this->viewOffsetHeight);
            		}
            		else {
...
Float FlxCamera_obj::set_followLerp(Float Value){
            	HX_STACK_FRAME("flixel.FlxCamera","set_followLerp",0xf2f9b78e,"flixel.FlxCamera.set_followLerp","flixel/FlxCamera.hx",1695,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
HXLINE(1695)		HX_VARI(  ::Dynamic,Max) = ((Float)(int)60 / (Float)::flixel::FlxG_obj::updateFramerate);
HXDLIN(1695)		HX_VAR( Float,lowerBound);
HXDLIN(1695)		if ((Value < (int)0)) {
HXLINE(1695)			lowerBound = (int)0;
            		}
            		else {
HXLINE(1695)			lowerBound = Value;
            		}
HXDLIN(1695)		Float _hx_tmp;
HXDLIN(1695)		Bool _hx_tmp1;
HXDLIN(1695)		Bool _hx_tmp2 = hx::IsNotNull( Max );
HXDLIN(1695)		if (_hx_tmp2) {
HXLINE(1695)			_hx_tmp1 = hx::IsGreater( lowerBound,Max );
            		}
            		else {
HXLINE(1695)			_hx_tmp1 = false;
            		}
HXDLIN(1695)		if (_hx_tmp1) {
HXLINE(1695)			_hx_tmp = Max;
            		}
            		else {
HXLINE(1695)			_hx_tmp = lowerBound;
            		}
...
Int FlxCamera_obj::set_width(Int Value){
            	HX_STACK_FRAME("flixel.FlxCamera","set_width",0x2386b8c0,"flixel.FlxCamera.set_width","flixel/FlxCamera.hx",1699,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
...
HXLINE(1703)			{
HXLINE(1703)				Float _hx_tmp1 = ((((Float)0.5) * this->width) * (this->scaleX - this->initialZoom));
HXDLIN(1703)				this->viewOffsetX = ((Float)_hx_tmp1 / (Float)this->scaleX);
HXDLIN(1703)				this->viewOffsetWidth = (this->width - this->viewOffsetX);
HXDLIN(1703)				Int _hx_tmp2 = this->width;
HXDLIN(1703)				Float _hx_tmp3 = ((int)2 * this->viewOffsetX);
HXDLIN(1703)				this->viewWidth = (_hx_tmp2 - _hx_tmp3);
            			}
...
Int FlxCamera_obj::set_height(Int Value){
            	HX_STACK_FRAME("flixel.FlxCamera","set_height",0xa8aa67ed,"flixel.FlxCamera.set_height","flixel/FlxCamera.hx",1714,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
...
HXLINE(1718)			{
HXLINE(1718)				Float _hx_tmp1 = ((((Float)0.5) * this->height) * (this->scaleY - this->initialZoom));
HXDLIN(1718)				this->viewOffsetY = ((Float)_hx_tmp1 / (Float)this->scaleY);
HXDLIN(1718)				this->viewOffsetHeight = (this->height - this->viewOffsetY);
HXDLIN(1718)				Int _hx_tmp2 = this->height;
HXDLIN(1718)				Float _hx_tmp3 = ((int)2 * this->viewOffsetY);
HXDLIN(1718)				this->viewHeight = (_hx_tmp2 - _hx_tmp3);
            			}
...
Float FlxCamera_obj::set_zoom(Float Zoom){
            	HX_STACK_FRAME("flixel.FlxCamera","set_zoom",0x3f00d599,"flixel.FlxCamera.set_zoom","flixel/FlxCamera.hx",1729,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Zoom,"Zoom")
...
Float FlxCamera_obj::set_alpha(Float Alpha){
            	HX_STACK_FRAME("flixel.FlxCamera","set_alpha",0x7abaaa18,"flixel.FlxCamera.set_alpha","flixel/FlxCamera.hx",1736,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Alpha,"Alpha")
HXLINE(1737)		HX_VAR( Float,lowerBound);
...
HXLINE(1738)		Bool _hx_tmp1 = ::flixel::FlxG_obj::renderBlit;
...
Float FlxCamera_obj::set_angle(Float Angle){
            	HX_STACK_FRAME("flixel.FlxCamera","set_angle",0x7c06468d,"flixel.FlxCamera.set_angle","flixel/FlxCamera.hx",1750,0xe7aeb95a)
            	HX_STACK_THIS(this)
...
Int FlxCamera_obj::set_color(Int Color){
            	HX_STACK_FRAME("flixel.FlxCamera","set_color",0xa380741d,"flixel.FlxCamera.set_color","flixel/FlxCamera.hx",1757,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Color,"Color")
HXLINE(1758)		this->color = Color;
HXLINE(1759)		HX_VAR(  ::openfl::geom::ColorTransform,colorTransform);
HXLINE(1761)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
HXDLIN(1761)		if (_hx_tmp) {
HXLINE(1763)			Bool _hx_tmp1 = hx::IsNull( this->_flashBitmap );
...
HXLINE(1774)		Float _hx_tmp2 = ((Float)((int)((int)this->color >> (int)(int)16) & (int)(int)255) / (Float)(int)255);
HXDLIN(1774)		colorTransform->redMultiplier = _hx_tmp2;
HXLINE(1775)		Float _hx_tmp3 = ((Float)((int)((int)this->color >> (int)(int)8) & (int)(int)255) / (Float)(int)255);
HXDLIN(1775)		colorTransform->greenMultiplier = _hx_tmp3;
HXLINE(1776)		Int _hx_tmp4 = ((int)this->color & (int)(int)255);
HXDLIN(1776)		colorTransform->blueMultiplier = ((Float)_hx_tmp4 / (Float)(int)255);
HXLINE(1778)		Bool _hx_tmp5 = ::flixel::FlxG_obj::renderBlit;
HXDLIN(1778)		if (_hx_tmp5) {
...
Bool FlxCamera_obj::set_antialiasing(Bool Antialiasing){
            	HX_STACK_FRAME("flixel.FlxCamera","set_antialiasing",0x0f9a3f7a,"flixel.FlxCamera.set_antialiasing","flixel/FlxCamera.hx",1791,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Antialiasing,"Antialiasing")
HXLINE(1792)		this->antialiasing = Antialiasing;
HXLINE(1793)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
HXDLIN(1793)		if (_hx_tmp) {
HXLINE(1795)			this->_flashBitmap->smoothing = Antialiasing;
            		}
...
Float FlxCamera_obj::set_x(Float x){
            	HX_STACK_FRAME("flixel.FlxCamera","set_x",0x9f099e32,"flixel.FlxCamera.set_x","flixel/FlxCamera.hx",1801,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
...
Float FlxCamera_obj::set_y(Float y){
            	HX_STACK_FRAME("flixel.FlxCamera","set_y",0x9f099e33,"flixel.FlxCamera.set_y","flixel/FlxCamera.hx",1808,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(y,"y")
...
Bool FlxCamera_obj::set_visible(Bool visible){
            	HX_STACK_FRAME("flixel.FlxCamera","set_visible",0x8f5a1dac,"flixel.FlxCamera.set_visible","flixel/FlxCamera.hx",1815,0xe7aeb95a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(visible,"visible")
HXLINE(1816)		Bool _hx_tmp = hx::IsNotNull( this->flashSprite );
...
void FlxCamera_obj::calcOffsetX(){
            	HX_STACK_FRAME("flixel.FlxCamera","calcOffsetX",0xcf19c367,"flixel.FlxCamera.calcOffsetX","flixel/FlxCamera.hx",1824,0xe7aeb95a)
            	HX_STACK_THIS(this)
HXLINE(1825)		Float _hx_tmp = ((((Float)0.5) * this->width) * (this->scaleX - this->initialZoom));
HXDLIN(1825)		this->viewOffsetX = ((Float)_hx_tmp / (Float)this->scaleX);
HXLINE(1826)		this->viewOffsetWidth = (this->width - this->viewOffsetX);
HXLINE(1827)		Int _hx_tmp1 = this->width;
HXDLIN(1827)		Float _hx_tmp2 = ((int)2 * this->viewOffsetX);
HXDLIN(1827)		this->viewWidth = (_hx_tmp1 - _hx_tmp2);
            	}
...
void FlxCamera_obj::calcOffsetY(){
            	HX_STACK_FRAME("flixel.FlxCamera","calcOffsetY",0xcf19c368,"flixel.FlxCamera.calcOffsetY","flixel/FlxCamera.hx",1831,0xe7aeb95a)
            	HX_STACK_THIS(this)
HXLINE(1832)		Float _hx_tmp = ((((Float)0.5) * this->height) * (this->scaleY - this->initialZoom));
HXDLIN(1832)		this->viewOffsetY = ((Float)_hx_tmp / (Float)this->scaleY);
HXLINE(1833)		this->viewOffsetHeight = (this->height - this->viewOffsetY);
HXLINE(1834)		Int _hx_tmp1 = this->height;
HXDLIN(1834)		Float _hx_tmp2 = ((int)2 * this->viewOffsetY);
HXDLIN(1834)		this->viewHeight = (_hx_tmp1 - _hx_tmp2);
            	}
...
{
{
            	HX_STACK_FRAME("flixel.FlxCamera","boot",0xa2d9e93b,"flixel.FlxCamera.boot","flixel/FlxCamera.hx",440,0xe7aeb95a)
HXLINE( 440)		HX_VARI_NAME( ::Array< Float >,this1,"this") = ::Array_obj< Float >::__new();
HXDLIN( 440)		this1->__SetSizeExact(null());
HXDLIN( 440)		drawVertices = this1;
            	}
{
            	HX_STACK_FRAME("flixel.FlxCamera","boot",0xa2d9e93b,"flixel.FlxCamera.boot","flixel/FlxCamera.hx",444,0xe7aeb95a)
HXLINE( 444)		trianglesSprite =  ::openfl::display::Sprite_obj::__new();
            	}
{
            	HX_STACK_FRAME("flixel.FlxCamera","boot",0xa2d9e93b,"flixel.FlxCamera.boot","flixel/FlxCamera.hx",449,0xe7aeb95a)
HXLINE( 449)		HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 449)		point->_inPool = false;
HXDLIN( 449)		renderPoint = point;
            	}
{
            	HX_STACK_FRAME("flixel.FlxCamera","boot",0xa2d9e93b,"flixel.FlxCamera.boot","flixel/FlxCamera.hx",450,0xe7aeb95a)
HXLINE( 450)		Float X = (int)0;
HXDLIN( 450)		Float Y = (int)0;
HXDLIN( 450)		Float Width = (int)0;
HXDLIN( 450)		Float Height = (int)0;
HXDLIN( 450)		HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 450)		_this->x = X;
HXDLIN( 450)		_this->y = Y;
HXDLIN( 450)		_this->width = Width;
HXDLIN( 450)		_this->height = Height;
HXDLIN( 450)		_this->_inPool = false;
HXDLIN( 450)		renderRect = _this;
            	}
}
