...
void FlxG_obj::resizeGame(Int Width,Int Height){
            	HX_STACK_FRAME("flixel.FlxG","resizeGame",0x80aafe0d,"flixel.FlxG.resizeGame","flixel/FlxG.hx",312,0x8e176836)
...
void FlxG_obj::resizeWindow(Int Width,Int Height){
            	HX_STACK_FRAME("flixel.FlxG","resizeWindow",0x41839acb,"flixel.FlxG.resizeWindow","flixel/FlxG.hx",324,0x8e176836)
            	HX_STACK_ARG(Width,"Width")
            	HX_STACK_ARG(Height,"Height")
HXLINE( 324)		::openfl::Lib_obj::application->windows->__get((int)0).StaticCast<  ::lime::ui::Window >()->resize(Width,Height);
            	}
...
void FlxG_obj::resetGame(){
            	HX_STACK_FRAME("flixel.FlxG","resetGame",0x7560e13a,"flixel.FlxG.resetGame","flixel/FlxG.hx",334,0x8e176836)
HXLINE( 334)		::flixel::FlxG_obj::game->_resetGame = true;
            	}
...
void FlxG_obj::switchState( ::flixel::FlxState nextState){
            	HX_STACK_FRAME("flixel.FlxG","switchState",0xbec45396,"flixel.FlxG.switchState","flixel/FlxG.hx",343,0x8e176836)
            	HX_STACK_ARG(nextState,"nextState")
HXLINE( 343)		Bool _hx_tmp = ::flixel::FlxG_obj::game->_state->switchTo(nextState);
...
void FlxG_obj::resetState(){
            	HX_STACK_FRAME("flixel.FlxG","resetState",0x34b927c9,"flixel.FlxG.resetState","flixel/FlxG.hx",353,0x8e176836)
HXLINE( 353)		hx::Class _hx_tmp = ::Type_obj::getClass(::flixel::FlxG_obj::game->_state);
HXDLIN( 353)		HX_VARI(  ::flixel::FlxState,nextState) = ( ( ::flixel::FlxState)(::Type_obj::createInstance(_hx_tmp,::cpp::VirtualArray_obj::__new(0))) );
HXDLIN( 353)		Bool _hx_tmp1 = ::flixel::FlxG_obj::game->_state->switchTo(nextState);
HXDLIN( 353)		if (_hx_tmp1) {
HXLINE( 353)			::flixel::FlxG_obj::game->_requestedState = nextState;
            		}
            	}
...
Bool FlxG_obj::overlap( ::flixel::FlxBasic ObjectOrGroup1, ::flixel::FlxBasic ObjectOrGroup2, ::Dynamic NotifyCallback, ::Dynamic ProcessCallback){
            	HX_STACK_FRAME("flixel.FlxG","overlap",0x37194f20,"flixel.FlxG.overlap","flixel/FlxG.hx",382,0x8e176836)
...
HXLINE( 383)		Bool _hx_tmp = hx::IsNull( ObjectOrGroup1 );
HXDLIN( 383)		if (_hx_tmp) {
HXLINE( 384)			ObjectOrGroup1 = ::flixel::FlxG_obj::game->_state;
            		}
HXLINE( 385)		Bool _hx_tmp1 = hx::IsEq( ObjectOrGroup2,ObjectOrGroup1 );
...
HXLINE( 389)		HX_VARI(  ::flixel::_hx_system::FlxQuadTree,quadTree) = ::flixel::_hx_system::FlxQuadTree_obj::recycle(::flixel::FlxG_obj::worldBounds->x,::flixel::FlxG_obj::worldBounds->y,::flixel::FlxG_obj::worldBounds->width,::flixel::FlxG_obj::worldBounds->height,null());
HXLINE( 390)		quadTree->load(ObjectOrGroup1,ObjectOrGroup2,NotifyCallback,ProcessCallback);
HXLINE( 391)		HX_VARI( Bool,result) = quadTree->execute();
...
Int AlphaTolerance = __o_AlphaTolerance.Default(255);
            	HX_STACK_FRAME("flixel.FlxG","pixelPerfectOverlap",0x4d139839,"flixel.FlxG.pixelPerfectOverlap","flixel/FlxG.hx",413,0x8e176836)
            	HX_STACK_ARG(Sprite1,"Sprite1")
            	HX_STACK_ARG(Sprite2,"Sprite2")
            	HX_STACK_ARG(AlphaTolerance,"AlphaTolerance")
            	HX_STACK_ARG(Camera,"Camera")
HXLINE( 413)		return ::flixel::util::FlxCollision_obj::pixelPerfectCheck(Sprite1,Sprite2,AlphaTolerance,Camera);
            	}
...
Bool FlxG_obj::collide( ::flixel::FlxBasic ObjectOrGroup1, ::flixel::FlxBasic ObjectOrGroup2, ::Dynamic NotifyCallback){
            	HX_STACK_FRAME("flixel.FlxG","collide",0x7b6cbb17,"flixel.FlxG.collide","flixel/FlxG.hx",437,0x8e176836)
            	HX_STACK_ARG(ObjectOrGroup1,"ObjectOrGroup1")
            	HX_STACK_ARG(ObjectOrGroup2,"ObjectOrGroup2")
            	HX_STACK_ARG(NotifyCallback,"NotifyCallback")
HXLINE( 437)		return ::flixel::FlxG_obj::overlap(ObjectOrGroup1,ObjectOrGroup2,NotifyCallback,::flixel::FlxObject_obj::separate_dyn());
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(FlxG_obj,collide,return )
 ...
 ::flixel::effects::postprocess::PostProcess FlxG_obj::addPostProcess( ::flixel::effects::postprocess::PostProcess postProcess){
            	HX_STACK_FRAME("flixel.FlxG","addPostProcess",0x527e22d5,"flixel.FlxG.addPostProcess","flixel/FlxG.hx",474,0x8e176836)
            	HX_STACK_ARG(postProcess,"postProcess")
HXLINE( 476)		if (::openfl::display::OpenGLView_obj::get_isSupported()) {
HXLINE( 478)			HX_VARI( ::Array< ::Dynamic>,postProcesses) = ::flixel::FlxG_obj::game->postProcesses;
HXLINE( 481)			HX_VARI( Int,length) = postProcesses->length;
...
void FlxG_obj::removePostProcess( ::flixel::effects::postprocess::PostProcess postProcess){
            	HX_STACK_FRAME("flixel.FlxG","removePostProcess",0x4ea610e4,"flixel.FlxG.removePostProcess","flixel/FlxG.hx",500,0x8e176836)
            	HX_STACK_ARG(postProcess,"postProcess")
HXLINE( 503)		Bool _hx_tmp = ::flixel::FlxG_obj::game->postProcesses->remove(postProcess);
...
void FlxG_obj::chainPostProcesses(){
            	HX_STACK_FRAME("flixel.FlxG","chainPostProcesses",0xe504cb63,"flixel.FlxG.chainPostProcesses","flixel/FlxG.hx",515,0x8e176836)
HXLINE( 516)		HX_VARI( ::Array< ::Dynamic>,postProcesses) = ::flixel::FlxG_obj::game->postProcesses;
HXLINE( 518)		Bool _hx_tmp = (postProcesses->length > (int)0);
HXDLIN( 518)		if (_hx_tmp) {
HXLINE( 520)			{
HXLINE( 520)				HX_VARI( Int,_g1) = (int)0;
HXDLIN( 520)				HX_VARI( Int,_g) = (postProcesses->length - (int)1);
HXDLIN( 520)				while((_g1 < _g)){
HXLINE( 520)					HX_VARI( Int,i) = _g1++;
HXLINE( 522)					 ::flixel::effects::postprocess::PostProcess _hx_tmp1 = postProcesses->__get((i + (int)1)).StaticCast<  ::flixel::effects::postprocess::PostProcess >();
HXDLIN( 522)					postProcesses->__get(i).StaticCast<  ::flixel::effects::postprocess::PostProcess >()->set_to(_hx_tmp1);
            				}
            			}
...
::String Target = __o_Target.Default(HX_HCSTRING("_blank","\x95","\x26","\xd9","\xb0"));
            	HX_STACK_FRAME("flixel.FlxG","openURL",0xce3ec95e,"flixel.FlxG.openURL","flixel/FlxG.hx",537,0x8e176836)
            	HX_STACK_ARG(URL,"URL")
            	HX_STACK_ARG(Target,"Target")
HXLINE( 538)		HX_VARI( ::String,prefix) = HX_("",00,00,00,00);
HXLINE( 540)		Bool _hx_tmp = !( ::EReg_obj::__new(HX_("^https?://",48,ee,dd,38),HX_("",00,00,00,00))->match(URL));
HXDLIN( 540)		if (_hx_tmp) {
HXLINE( 541)			prefix = HX_("http://",52,75,cd,5a);
            		}
HXLINE( 542)		::openfl::Lib_obj::getURL( ::openfl::net::URLRequest_obj::__new((prefix + URL)),Target);
            	}
...
void FlxG_obj::init( ::flixel::FlxGame Game,Int Width,Int Height,Float Zoom){
            	HX_STACK_FRAME("flixel.FlxG","init",0x1141e5d7,"flixel.FlxG.init","flixel/FlxG.hx",550,0x8e176836)
            	HX_STACK_ARG(Game,"Game")
            	HX_STACK_ARG(Width,"Width")
            	HX_STACK_ARG(Height,"Height")
            	HX_STACK_ARG(Zoom,"Zoom")
HXLINE( 551)		::flixel::FlxG_obj::game = Game;
HXLINE( 552)		Float _hx_tmp = ::Math_obj::abs(Width);
HXDLIN( 552)		::flixel::FlxG_obj::width = ::Std_obj::_hx_int(_hx_tmp);
HXLINE( 553)		Float _hx_tmp1 = ::Math_obj::abs(Height);
HXDLIN( 553)		::flixel::FlxG_obj::height = ::Std_obj::_hx_int(_hx_tmp1);
...
HXLINE( 561)		{
HXLINE( 561)			Int Width1 = ::openfl::Lib_obj::current->stage->stageWidth;
HXDLIN( 561)			Int Height1 = ::openfl::Lib_obj::current->stage->stageHeight;
HXDLIN( 561)			::flixel::FlxG_obj::scaleMode->onMeasure(Width1,Height1);
            		}
HXLINE( 565)		::flixel::FlxG_obj::keys = ::flixel::FlxG_obj::inputs->add_flixel_input_keyboard_FlxKeyboard( ::flixel::input::keyboard::FlxKeyboard_obj::__new());
HXLINE( 569)		 ::flixel::input::mouse::FlxMouse _hx_tmp2 = ::flixel::FlxG_obj::inputs->add_flixel_input_mouse_FlxMouse( ::flixel::input::mouse::FlxMouse_obj::__new(::flixel::FlxG_obj::game->_inputContainer));
HXDLIN( 569)		::flixel::FlxG_obj::set_mouse(_hx_tmp2);
HXLINE( 577)		::flixel::FlxG_obj::gamepads = ::flixel::FlxG_obj::inputs->add_flixel_input_gamepad_FlxGamepadManager( ::flixel::input::gamepad::FlxGamepadManager_obj::__new());
HXLINE( 587)		::flixel::FlxG_obj::save->bind(HX_("flixel",5c,42,70,3d));
HXLINE( 589)		::flixel::FlxG_obj::plugins =  ::flixel::_hx_system::frontEnds::PluginFrontEnd_obj::__new();
HXLINE( 590)		::flixel::FlxG_obj::vcr =  ::flixel::_hx_system::frontEnds::VCRFrontEnd_obj::__new();
HXLINE( 593)		::flixel::FlxG_obj::sound =  ::flixel::_hx_system::frontEnds::SoundFrontEnd_obj::__new();
            	}
...
void FlxG_obj::initRenderMethod(){
            	HX_STACK_FRAME("flixel.FlxG","initRenderMethod",0x7472134e,"flixel.FlxG.initRenderMethod","flixel/FlxG.hx",598,0x8e176836)
HXLINE( 599)		::flixel::FlxG_obj::renderMethod = ::flixel::FlxRenderMethod_obj::BLITTING_dyn();
HXLINE( 602)		Bool _hx_tmp = !(( (Bool)( ::Dynamic(::openfl::Lib_obj::application->config->__Field(HX_("windows",83,de,74,e8),hx::paccDynamic))->__GetItem((int)0)->__Field(HX_("hardware",a8,e2,d3,75),hx::paccDynamic)) ));
HXDLIN( 602)		if (_hx_tmp) {
HXLINE( 604)			::flixel::FlxG_obj::renderMethod = ::flixel::FlxRenderMethod_obj::BLITTING_dyn();
            		}
            		else {
HXLINE( 608)			HX_VARI( ::hx::EnumBase,_g) = ::openfl::Lib_obj::current->stage->window->renderer->type;
HXDLIN( 608)			::hx::EnumBase _hx_tmp1;
HXDLIN( 608)			Int _hx_tmp2 = ( ( ::hx::EnumBase)(_g) )->_hx_getIndex();
HXDLIN( 608)			switch((int)(_hx_tmp2)){
            				case (int)0: case (int)5: {
HXLINE( 608)					_hx_tmp1 = ::flixel::FlxRenderMethod_obj::DRAW_TILES_dyn();
            				}
            				break;
            				case (int)1: case (int)3: case (int)4: {
HXLINE( 608)					_hx_tmp1 = ::flixel::FlxRenderMethod_obj::BLITTING_dyn();
            				}
            				break;
            				default:{
HXLINE( 608)					_hx_tmp1 = ::flixel::FlxRenderMethod_obj::BLITTING_dyn();
...
HXDLIN( 608)			::flixel::FlxG_obj::renderMethod = _hx_tmp1;
            		}
...
void FlxG_obj::reset(){
            	HX_STACK_FRAME("flixel.FlxG","reset",0x31170d28,"flixel.FlxG.reset","flixel/FlxG.hx",634,0x8e176836)
HXLINE( 635)		{
HXLINE( 635)			HX_VARI(  ::flixel::math::FlxRandom,_this) = ::flixel::FlxG_obj::random;
HXDLIN( 635)			{
HXLINE( 635)				Float _hx_tmp = ::Math_obj::random();
HXDLIN( 635)				HX_VARI( Int,Value) = ::Std_obj::_hx_int((_hx_tmp * (int)2147483647));
HXDLIN( 635)				HX_VAR( Float,lowerBound);
...
HXDLIN( 635)				 ::Dynamic _hx_tmp1;
HXDLIN( 635)				if ((lowerBound > (int)2147483646)) {
HXLINE( 635)					_hx_tmp1 = (int)2147483646;
            				}
            				else {
HXLINE( 635)					_hx_tmp1 = lowerBound;
            				}
HXDLIN( 635)				HX_VARI( Int,NewSeed) = ::Std_obj::_hx_int(_hx_tmp1);
HXDLIN( 635)				HX_VAR_NAME( Float,lowerBound1,"lowerBound");
HXDLIN( 635)				if ((NewSeed < (int)1)) {
HXLINE( 635)					lowerBound1 = (int)1;
            				}
            				else {
HXLINE( 635)					lowerBound1 = NewSeed;
            				}
HXDLIN( 635)				 ::Dynamic _hx_tmp2;
HXDLIN( 635)				if ((lowerBound1 > (int)2147483646)) {
HXLINE( 635)					_hx_tmp2 = (int)2147483646;
            				}
            				else {
HXLINE( 635)					_hx_tmp2 = lowerBound1;
            				}
HXDLIN( 635)				HX_VARI_NAME( Int,NewSeed1,"NewSeed") = ::Std_obj::_hx_int(_hx_tmp2);
HXDLIN( 635)				HX_VAR_NAME( Float,lowerBound2,"lowerBound");
HXDLIN( 635)				if ((NewSeed1 < (int)1)) {
HXLINE( 635)					lowerBound2 = (int)1;
            				}
            				else {
HXLINE( 635)					lowerBound2 = NewSeed1;
            				}
HXDLIN( 635)				 ::Dynamic _hx_tmp3;
HXDLIN( 635)				if ((lowerBound2 > (int)2147483646)) {
HXLINE( 635)					_hx_tmp3 = (int)2147483646;
            				}
            				else {
HXLINE( 635)					_hx_tmp3 = lowerBound2;
            				}
HXDLIN( 635)				Float _hx_tmp4 = (_this->internalSeed = ::Std_obj::_hx_int(_hx_tmp3));
HXDLIN( 635)				Int _hx_tmp5 = ::Std_obj::_hx_int(_hx_tmp4);
HXDLIN( 635)				_this->initialSeed = _hx_tmp5;
            			}
            		}
...
HXLINE( 647)		{
HXLINE( 647)			HX_VARI_NAME(  ::flixel::math::FlxRect,_this1,"_this") = ::flixel::FlxG_obj::worldBounds;
HXDLIN( 647)			Float Width = (::flixel::FlxG_obj::width + (int)20);
HXDLIN( 647)			Float Height = (::flixel::FlxG_obj::height + (int)20);
HXDLIN( 647)			_this1->x = (int)-10;
HXDLIN( 647)			_this1->y = (int)-10;
HXDLIN( 647)			_this1->width = Width;
HXDLIN( 647)			_this1->height = Height;
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(FlxG_obj,reset,(void))
 ...
 ::flixel::_hx_system::scaleModes::BaseScaleMode FlxG_obj::set_scaleMode( ::flixel::_hx_system::scaleModes::BaseScaleMode ScaleMode){
            	HX_STACK_FRAME("flixel.FlxG","set_scaleMode",0xb374d549,"flixel.FlxG.set_scaleMode","flixel/FlxG.hx",652,0x8e176836)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxG_obj,set_scaleMode,return )
 ...
 ::flixel::input::mouse::FlxMouse FlxG_obj::set_mouse( ::flixel::input::mouse::FlxMouse NewMouse){
            	HX_STACK_FRAME("flixel.FlxG","set_mouse",0x1e754261,"flixel.FlxG.set_mouse","flixel/FlxG.hx",660,0x8e176836)
            	HX_STACK_ARG(NewMouse,"NewMouse")
HXLINE( 661)		Bool _hx_tmp = hx::IsNull( ::flixel::FlxG_obj::mouse );
...
HXLINE( 666)		HX_VARI(  ::flixel::input::mouse::FlxMouse,oldMouse) = ::flixel::FlxG_obj::mouse;
HXLINE( 667)		HX_VARI(  ::flixel::input::mouse::FlxMouse,result) = ::flixel::FlxG_obj::inputs->replace_flixel_input_mouse_FlxMouse(oldMouse,NewMouse);
HXLINE( 668)		Bool _hx_tmp1 = hx::IsNotNull( result );
...
Int FlxG_obj::set_updateFramerate(Int Framerate){
            	HX_STACK_FRAME("flixel.FlxG","set_updateFramerate",0x52770580,"flixel.FlxG.set_updateFramerate","flixel/FlxG.hx",679,0x8e176836)
...
HXLINE( 689)		Bool _hx_tmp = (::flixel::FlxG_obj::game->_maxAccumulation < ::flixel::FlxG_obj::game->_stepMS);
...
Int FlxG_obj::set_drawFramerate(Int Framerate){
            	HX_STACK_FRAME("flixel.FlxG","set_drawFramerate",0x3e23c125,"flixel.FlxG.set_drawFramerate","flixel/FlxG.hx",696,0x8e176836)
            	HX_STACK_ARG(Framerate,"Framerate")
HXLINE( 701)		Float _hx_tmp = ::Math_obj::abs(Framerate);
HXDLIN( 701)		::flixel::FlxG_obj::drawFramerate = ::Std_obj::_hx_int(_hx_tmp);
HXLINE( 703)		Bool _hx_tmp1 = hx::IsNotNull( ::flixel::FlxG_obj::game->stage );
HXDLIN( 703)		if (_hx_tmp1) {
HXLINE( 704)			::flixel::FlxG_obj::game->stage->set_frameRate(::flixel::FlxG_obj::drawFramerate);
            		}
HXLINE( 706)		Float _hx_tmp2 = ((Float)(int)2000 / (Float)::flixel::FlxG_obj::drawFramerate);
HXDLIN( 706)		::flixel::FlxG_obj::game->_maxAccumulation = (_hx_tmp2 - (int)1);
HXLINE( 708)		Bool _hx_tmp3 = (::flixel::FlxG_obj::game->_maxAccumulation < ::flixel::FlxG_obj::game->_stepMS);
...
Bool FlxG_obj::get_fullscreen(){
            	HX_STACK_FRAME("flixel.FlxG","get_fullscreen",0xfece4c0b,"flixel.FlxG.get_fullscreen","flixel/FlxG.hx",716,0x8e176836)
HXLINE( 716)		 ::Dynamic _hx_tmp = ::openfl::Lib_obj::current->stage->get_displayState();
HXDLIN( 716)		if (hx::IsNotEq( _hx_tmp,(int)0 )) {
HXLINE( 717)			 ::Dynamic _hx_tmp1 = ::openfl::Lib_obj::current->stage->get_displayState();
HXLINE( 716)			return hx::IsEq( _hx_tmp1,(int)1 );
            		}
            		else {
HXLINE( 716)			return true;
            		}
...
Bool FlxG_obj::set_fullscreen(Bool Value){
            	HX_STACK_FRAME("flixel.FlxG","set_fullscreen",0x1eee347f,"flixel.FlxG.set_fullscreen","flixel/FlxG.hx",721,0x8e176836)
            	HX_STACK_ARG(Value,"Value")
HXLINE( 722)		 ::Dynamic _hx_tmp;
HXDLIN( 722)		if (Value) {
HXLINE( 722)			_hx_tmp = (int)0;
            		}
            		else {
HXLINE( 722)			_hx_tmp = (int)2;
            		}
HXDLIN( 722)		::openfl::Lib_obj::current->stage->set_displayState(_hx_tmp);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxG_obj,set_fullscreen,return )
 ...
 ::openfl::display::Stage FlxG_obj::get_stage(){
            	HX_STACK_FRAME("flixel.FlxG","get_stage",0xb2caaaee,"flixel.FlxG.get_stage","flixel/FlxG.hx",728,0x8e176836)
HXLINE( 728)		return ::openfl::Lib_obj::current->stage;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(FlxG_obj,get_stage,return )
 ...
 ::flixel::FlxState FlxG_obj::get_state(){
            	HX_STACK_FRAME("flixel.FlxG","get_state",0xb2cab641,"flixel.FlxG.get_state","flixel/FlxG.hx",733,0x8e176836)
HXLINE( 733)		return ::flixel::FlxG_obj::game->_state;
            	}
...
Bool FlxG_obj::get_onMobile(){
            	HX_STACK_FRAME("flixel.FlxG","get_onMobile",0x5f27a0b1,"flixel.FlxG.get_onMobile","flixel/FlxG.hx",738,0x8e176836)
...
{
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",71,0x8e176836)
HXLINE(  71)		autoPause = true;
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",76,0x8e176836)
HXLINE(  76)		fixedTimestep = true;
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",80,0x8e176836)
HXLINE(  80)		timeScale = ((Float)1);
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",86,0x8e176836)
HXLINE(  86)		worldDivisions = (int)6;
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",97,0x8e176836)
HXLINE(  97)		VERSION =  ::flixel::_hx_system::FlxVersion_obj::__new((int)4,(int)3,(int)0);
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",143,0x8e176836)
HXLINE( 143)		elapsed = ((Float)0);
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",150,0x8e176836)
HXLINE( 150)		maxElapsed = ((Float)0.1);
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",165,0x8e176836)
HXLINE( 165)		scaleMode = ( ( ::flixel::_hx_system::scaleModes::BaseScaleMode)( ::flixel::_hx_system::scaleModes::RatioScaleMode_obj::__new(null())) );
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",175,0x8e176836)
HXLINE( 175)		Float X = (int)0;
HXDLIN( 175)		Float Y = (int)0;
HXDLIN( 175)		Float Width = (int)0;
HXDLIN( 175)		Float Height = (int)0;
HXDLIN( 175)		HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 175)		_this->x = X;
HXDLIN( 175)		_this->y = Y;
HXDLIN( 175)		_this->width = Width;
HXDLIN( 175)		_this->height = Height;
HXDLIN( 175)		_this->_inPool = false;
HXDLIN( 175)		worldBounds = _this;
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",181,0x8e176836)
HXLINE( 181)		save =  ::flixel::util::FlxSave_obj::__new();
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",187,0x8e176836)
HXLINE( 187)		random =  ::flixel::math::FlxRandom_obj::__new(null());
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",208,0x8e176836)
HXLINE( 208)		swipes = ::Array_obj< ::Dynamic>::__new(0);
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",250,0x8e176836)
HXLINE( 250)		inputs =  ::flixel::_hx_system::frontEnds::InputFrontEnd_obj::__new();
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",254,0x8e176836)
HXLINE( 254)		console =  ::flixel::_hx_system::frontEnds::ConsoleFrontEnd_obj::__new();
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",258,0x8e176836)
HXLINE( 258)		log =  ::flixel::_hx_system::frontEnds::LogFrontEnd_obj::__new();
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",262,0x8e176836)
HXLINE( 262)		bitmapLog =  ::flixel::_hx_system::frontEnds::BitmapLogFrontEnd_obj::__new();
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",266,0x8e176836)
HXLINE( 266)		watch =  ::flixel::_hx_system::frontEnds::WatchFrontEnd_obj::__new();
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",271,0x8e176836)
HXLINE( 271)		debugger =  ::flixel::_hx_system::frontEnds::DebuggerFrontEnd_obj::__new();
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",281,0x8e176836)
HXLINE( 281)		bitmap =  ::flixel::_hx_system::frontEnds::BitmapFrontEnd_obj::__new();
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",285,0x8e176836)
HXLINE( 285)		cameras =  ::flixel::_hx_system::frontEnds::CameraFrontEnd_obj::__new();
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",291,0x8e176836)
HXLINE( 291)		initialWidth = (int)0;
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",292,0x8e176836)
HXLINE( 292)		initialHeight = (int)0;
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",293,0x8e176836)
HXLINE( 293)		initialZoom = ((Float)0);
            	}
{
            	HX_STACK_FRAME("flixel.FlxG","boot",0x0ca22ef9,"flixel.FlxG.boot","flixel/FlxG.hx",305,0x8e176836)
HXLINE( 305)		signals =  ::flixel::_hx_system::frontEnds::SignalFrontEnd_obj::__new();
            	}
}
