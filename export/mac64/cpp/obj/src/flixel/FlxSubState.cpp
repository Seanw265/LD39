...
HXLINE(  53)		Bool _hx_tmp = ::flixel::FlxG_obj::renderTile;
HXDLIN(  53)		if (_hx_tmp) {
HXLINE(  54)			this->_bgSprite =  ::flixel::_hx_system::FlxBGSprite_obj::__new();
            		}
...
void FlxSubState_obj::draw(){
            	HX_STACK_FRAME("flixel.FlxSubState","draw",0xafc56fc1,"flixel.FlxSubState.draw","flixel/FlxSubState.hx",59,0xd8a3e54e)
            	HX_STACK_THIS(this)
HXLINE(  61)		Bool _hx_tmp = ::flixel::FlxG_obj::renderBlit;
HXDLIN(  61)		if (_hx_tmp) {
HXLINE(  63)			HX_VARI( Int,_g) = (int)0;
HXDLIN(  63)			HX_VARI( ::Array< ::Dynamic>,_g1) = this->get_cameras();
HXDLIN(  63)			while((_g < _g1->length)){
HXLINE(  63)				HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN(  63)				++_g;
...
void FlxSubState_obj::destroy(){
            	HX_STACK_FRAME("flixel.FlxSubState","destroy",0xc08a1d5d,"flixel.FlxSubState.destroy","flixel/FlxSubState.hx",78,0xd8a3e54e)
            	HX_STACK_THIS(this)
...
void FlxSubState_obj::close(){
            	HX_STACK_FRAME("flixel.FlxSubState","close",0x85a9195b,"flixel.FlxSubState.close","flixel/FlxSubState.hx",91,0xd8a3e54e)
            	HX_STACK_THIS(this)
HXLINE(  91)		Bool _hx_tmp;
HXDLIN(  91)		Bool _hx_tmp1 = hx::IsNotNull( this->_parentState );
...
Int FlxSubState_obj::get_bgColor(){
            	HX_STACK_FRAME("flixel.FlxSubState","get_bgColor",0x02e53f58,"flixel.FlxSubState.get_bgColor","flixel/FlxSubState.hx",98,0xd8a3e54e)
            	HX_STACK_THIS(this)
...
Int FlxSubState_obj::set_bgColor(Int Value){
            	HX_STACK_FRAME("flixel.FlxSubState","set_bgColor",0x0d524664,"flixel.FlxSubState.set_bgColor","flixel/FlxSubState.hx",103,0xd8a3e54e)
            	HX_STACK_THIS(this)
