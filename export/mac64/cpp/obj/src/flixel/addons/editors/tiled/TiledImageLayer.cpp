...
HXDLIN(  16)		Bool _hx_tmp1 = source->has->resolve(HX_("x",78,00,00,00));
HXDLIN(  16)		if (_hx_tmp1) {
HXLINE(  16)			::String _hx_tmp2 = source->att->resolve(HX_("x",78,00,00,00));
HXDLIN(  16)			_hx_tmp = ::Std_obj::parseInt(_hx_tmp2);
            		}
            		else {
HXLINE(  16)			_hx_tmp = (int)0;
            		}
HXDLIN(  16)		this->x = _hx_tmp;
HXLINE(  17)		Int _hx_tmp3;
HXDLIN(  17)		Bool _hx_tmp4 = source->has->resolve(HX_("y",79,00,00,00));
HXDLIN(  17)		if (_hx_tmp4) {
HXLINE(  17)			::String _hx_tmp5 = source->att->resolve(HX_("y",79,00,00,00));
HXDLIN(  17)			_hx_tmp3 = ::Std_obj::parseInt(_hx_tmp5);
            		}
            		else {
HXLINE(  17)			_hx_tmp3 = (int)0;
            		}
HXDLIN(  17)		this->y = _hx_tmp3;
            	}
