...
void TiledTilePropertySet_obj::__construct(Int tileID){
            	HX_STACK_FRAME("flixel.addons.editors.tiled.TiledTilePropertySet","new",0x96943044,"flixel.addons.editors.tiled.TiledTilePropertySet.new","flixel/addons/editors/tiled/TiledTilePropertySet.hx",16,0xb74dff0a)
            	HX_STACK_THIS(this)
...
void TiledTilePropertySet_obj::addAnimationFrame(Int tileID,Float duration){
            	HX_STACK_FRAME("flixel.addons.editors.tiled.TiledTilePropertySet","addAnimationFrame",0x771c8f6e,"flixel.addons.editors.tiled.TiledTilePropertySet.addAnimationFrame","flixel/addons/editors/tiled/TiledTilePropertySet.hx",24,0xb74dff0a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(tileID,"tileID")
