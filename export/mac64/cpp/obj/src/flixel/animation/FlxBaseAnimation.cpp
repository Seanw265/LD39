...
Int FlxBaseAnimation_obj::set_curIndex(Int Value){
            	HX_STACK_FRAME("flixel.animation.FlxBaseAnimation","set_curIndex",0x05c5f580,"flixel.animation.FlxBaseAnimation.set_curIndex","flixel/animation/FlxBaseAnimation.hx",27,0x062a9a5f)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
HXLINE(  28)		this->curIndex = Value;
HXLINE(  30)		Bool _hx_tmp;
HXDLIN(  30)		Bool _hx_tmp1 = hx::IsNotNull( this->parent );
...
void FlxBaseAnimation_obj::destroy(){
            	HX_STACK_FRAME("flixel.animation.FlxBaseAnimation","destroy",0x93a46e09,"flixel.animation.FlxBaseAnimation.destroy","flixel/animation/FlxBaseAnimation.hx",45,0x062a9a5f)
            	HX_STACK_THIS(this)
...
void FlxBaseAnimation_obj::update(Float elapsed){
            	HX_STACK_FRAME("flixel.animation.FlxBaseAnimation","update",0xf1225bda,"flixel.animation.FlxBaseAnimation.update","flixel/animation/FlxBaseAnimation.hx",50,0x062a9a5f)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(FlxBaseAnimation_obj,update,(void))
 ...
 ::flixel::animation::FlxBaseAnimation FlxBaseAnimation_obj::clone( ::flixel::animation::FlxAnimationController Parent){
            	HX_STACK_FRAME("flixel.animation.FlxBaseAnimation","clone",0xf2c3a2ac,"flixel.animation.FlxBaseAnimation.clone","flixel/animation/FlxBaseAnimation.hx",54,0x062a9a5f)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Parent,"Parent")
