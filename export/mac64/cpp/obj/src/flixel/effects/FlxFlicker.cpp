...
void FlxFlicker_obj::__construct(){
            	HX_STACK_FRAME("flixel.effects.FlxFlicker","new",0x4bc826b6,"flixel.effects.FlxFlicker.new","flixel/effects/FlxFlicker.hx",194,0x4fa53f38)
            	HX_STACK_THIS(this)
            	}
...
void FlxFlicker_obj::destroy(){
            	HX_STACK_FRAME("flixel.effects.FlxFlicker","destroy",0x34536650,"flixel.effects.FlxFlicker.destroy","flixel/effects/FlxFlicker.hx",126,0x4fa53f38)
            	HX_STACK_THIS(this)
...
void FlxFlicker_obj::start( ::flixel::FlxObject Object,Float Duration,Float Interval,Bool EndVisibility, ::Dynamic CompletionCallback, ::Dynamic ProgressCallback){
            	HX_STACK_FRAME("flixel.effects.FlxFlicker","start",0xd6028c38,"flixel.effects.FlxFlicker.start","flixel/effects/FlxFlicker.hx",138,0x4fa53f38)
            	HX_STACK_THIS(this)
...
HXLINE( 145)		 ::flixel::util::FlxTimer _hx_tmp =  ::flixel::util::FlxTimer_obj::__new(null());
HXDLIN( 145)		Float _hx_tmp1 = this->interval;
HXDLIN( 145)		Float _hx_tmp2 = ((Float)this->duration / (Float)this->interval);
HXDLIN( 145)		Int _hx_tmp3 = ::Std_obj::_hx_int(_hx_tmp2);
HXDLIN( 145)		this->timer = _hx_tmp->start(_hx_tmp1,this->flickerProgress_dyn(),_hx_tmp3);
            	}
...
void FlxFlicker_obj::stop(){
            	HX_STACK_FRAME("flixel.effects.FlxFlicker","stop",0x06b324ec,"flixel.effects.FlxFlicker.stop","flixel/effects/FlxFlicker.hx",152,0x4fa53f38)
            	HX_STACK_THIS(this)
...
void FlxFlicker_obj::release(){
            	HX_STACK_FRAME("flixel.effects.FlxFlicker","release",0x68babf1d,"flixel.effects.FlxFlicker.release","flixel/effects/FlxFlicker.hx",162,0x4fa53f38)
            	HX_STACK_THIS(this)
...
void FlxFlicker_obj::flickerProgress( ::flixel::util::FlxTimer Timer){
            	HX_STACK_FRAME("flixel.effects.FlxFlicker","flickerProgress",0x5258c61b,"flixel.effects.FlxFlicker.flickerProgress","flixel/effects/FlxFlicker.hx",171,0x4fa53f38)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Timer,"Timer")
HXLINE( 172)		this->object->set_visible(!(this->object->visible));
HXLINE( 174)		Bool _hx_tmp = hx::IsNotNull( this->progressCallback );
...
HXLINE( 179)			_hx_tmp1 = ((Timer->loops - Timer->_loopsCounter) == (int)0);
            		}
            		else {
...
HXLINE( 182)			Bool _hx_tmp2 = hx::IsNotNull( this->completionCallback );
...
Bool ForceRestart = __o_ForceRestart.Default(true);
            	HX_STACK_FRAME("flixel.effects.FlxFlicker","flicker",0x86ba144e,"flixel.effects.FlxFlicker.flicker","flixel/effects/FlxFlicker.hx",39,0x4fa53f38)
            	HX_STACK_ARG(Object,"Object")
            	HX_STACK_ARG(Duration,"Duration")
            	HX_STACK_ARG(Interval,"Interval")
            	HX_STACK_ARG(EndVisibility,"EndVisibility")
            	...
            	HX_STACK_ARG(CompletionCallback,"CompletionCallback")
            	HX_STACK_ARG(ProgressCallback,"ProgressCallback")
HXLINE(  40)		Bool _hx_tmp = ::flixel::effects::FlxFlicker_obj::isFlickering(Object);
...
HXLINE(  53)		Bool _hx_tmp1 = (Interval <= (int)0);
HXDLIN(  53)		if (_hx_tmp1) {
HXLINE(  55)			Interval = ::flixel::FlxG_obj::elapsed;
            		}
HXLINE(  58)		HX_VARI(  ::flixel::effects::FlxFlicker,flicker) = ::flixel::effects::FlxFlicker_obj::_pool->get();
...
Bool FlxFlicker_obj::isFlickering( ::flixel::FlxObject Object){
            	HX_STACK_FRAME("flixel.effects.FlxFlicker","isFlickering",0x76c8b45e,"flixel.effects.FlxFlicker.isFlickering","flixel/effects/FlxFlicker.hx",70,0x4fa53f38)
            	HX_STACK_ARG(Object,"Object")
...
void FlxFlicker_obj::stopFlickering( ::flixel::FlxObject Object){
            	HX_STACK_FRAME("flixel.effects.FlxFlicker","stopFlickering",0xf09864f6,"flixel.effects.FlxFlicker.stopFlickering","flixel/effects/FlxFlicker.hx",79,0x4fa53f38)
            	HX_STACK_ARG(Object,"Object")
HXLINE(  80)		HX_VARI(  ::flixel::effects::FlxFlicker,boundFlicker) = ::flixel::effects::FlxFlicker_obj::_boundObjects->get(Object).StaticCast<  ::flixel::effects::FlxFlicker >();
HXLINE(  81)		Bool _hx_tmp = hx::IsNotNull( boundFlicker );
