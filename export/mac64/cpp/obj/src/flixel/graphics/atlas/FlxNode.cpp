...
HX_DEFINE_DYNAMIC_FUNC2(FlxNode_obj,canPlace,return )
 ...
 ::flixel::graphics::frames::FlxTileFrames FlxNode_obj::getTileFrames( ::flixel::math::FlxPoint tileSize, ::flixel::math::FlxPoint tileSpacing, ::flixel::math::FlxPoint tileBorder){
            	HX_STACK_FRAME("flixel.graphics.atlas.FlxNode","getTileFrames",0xf6655efc,"flixel.graphics.atlas.FlxNode.getTileFrames","flixel/graphics/atlas/FlxNode.hx",112,0x6d18bb9f)
            	HX_STACK_THIS(this)
...
HXDLIN( 114)		HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) = _this->framesHash->get(this->key).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXLINE( 116)		Bool _hx_tmp = hx::IsNotNull( frame );
HXDLIN( 116)		if (_hx_tmp) {
HXLINE( 118)			HX_VARI(  ::flixel::graphics::frames::FlxTileFrames,tileFrames) = ::flixel::graphics::frames::FlxTileFrames_obj::fromFrame(frame,tileSize,tileSpacing);
HXLINE( 119)			Bool _hx_tmp1 = hx::IsNotNull( tileBorder );
...
HXLINE( 137)		Bool _hx_tmp = hx::IsNotNull( frame );
...
Bool FlxNode_obj::get_isEmpty(){
            	HX_STACK_FRAME("flixel.graphics.atlas.FlxNode","get_isEmpty",0xd9c0632c,"flixel.graphics.atlas.FlxNode.get_isEmpty","flixel/graphics/atlas/FlxNode.hx",145,0x6d18bb9f)
            	HX_STACK_THIS(this)
...
Int FlxNode_obj::get_x(){
            	HX_STACK_FRAME("flixel.graphics.atlas.FlxNode","get_x",0x3d1080a1,"flixel.graphics.atlas.FlxNode.get_x","flixel/graphics/atlas/FlxNode.hx",150,0x6d18bb9f)
            	HX_STACK_THIS(this)
...
Int FlxNode_obj::get_y(){
            	HX_STACK_FRAME("flixel.graphics.atlas.FlxNode","get_y",0x3d1080a2,"flixel.graphics.atlas.FlxNode.get_y","flixel/graphics/atlas/FlxNode.hx",155,0x6d18bb9f)
            	HX_STACK_THIS(this)
...
Int FlxNode_obj::get_width(){
            	HX_STACK_FRAME("flixel.graphics.atlas.FlxNode","get_width",0xb520feaf,"flixel.graphics.atlas.FlxNode.get_width","flixel/graphics/atlas/FlxNode.hx",160,0x6d18bb9f)
            	HX_STACK_THIS(this)
...
Int FlxNode_obj::set_width(Int value){
            	HX_STACK_FRAME("flixel.graphics.atlas.FlxNode","set_width",0x9871eabb,"flixel.graphics.atlas.FlxNode.set_width","flixel/graphics/atlas/FlxNode.hx",164,0x6d18bb9f)
            	HX_STACK_THIS(this)
...
Int FlxNode_obj::get_height(){
            	HX_STACK_FRAME("flixel.graphics.atlas.FlxNode","get_height",0x7e0d531e,"flixel.graphics.atlas.FlxNode.get_height","flixel/graphics/atlas/FlxNode.hx",171,0x6d18bb9f)
            	HX_STACK_THIS(this)
...
Int FlxNode_obj::set_height(Int value){
            	HX_STACK_FRAME("flixel.graphics.atlas.FlxNode","set_height",0x818af192,"flixel.graphics.atlas.FlxNode.set_height","flixel/graphics/atlas/FlxNode.hx",175,0x6d18bb9f)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
