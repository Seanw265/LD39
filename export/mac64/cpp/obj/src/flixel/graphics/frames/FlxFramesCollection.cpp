...
HXDLIN(  95)			HX_VARI( Int,_g) = this->frames->length;
...
HX_DEFINE_DYNAMIC_FUNC0(FlxFramesCollection_obj,destroy,(void))
 ...
 ::flixel::graphics::frames::FlxFrame FlxFramesCollection_obj::addEmptyFrame( ::flixel::math::FlxRect size){
            	HX_STACK_FRAME("flixel.graphics.frames.FlxFramesCollection","addEmptyFrame",0x8f5bf232,"flixel.graphics.frames.FlxFramesCollection.addEmptyFrame","flixel/graphics/frames/FlxFramesCollection.hx",132,0xe09dd200)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(size,"size")
HXLINE( 133)		HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) =  ::flixel::graphics::frames::FlxFrame_obj::__new(this->parent,null(),null(),null());
HXLINE( 134)		frame->type = (int)2;
HXLINE( 135)		Float X = (int)0;
HXDLIN( 135)		Float Y = (int)0;
HXDLIN( 135)		Float Width = (int)0;
HXDLIN( 135)		Float Height = (int)0;
HXDLIN( 135)		HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 135)		_this->x = X;
HXDLIN( 135)		_this->y = Y;
HXDLIN( 135)		_this->width = Width;
HXDLIN( 135)		_this->height = Height;
HXDLIN( 135)		_this->_inPool = false;
HXDLIN( 135)		frame->set_frame(_this);
...
HX_DEFINE_DYNAMIC_FUNC1(FlxFramesCollection_obj,addEmptyFrame,return )
 ...
 ::flixel::graphics::frames::FlxFrame FlxFramesCollection_obj::addSpriteSheetFrame( ::flixel::math::FlxRect region){
            	HX_STACK_FRAME("flixel.graphics.frames.FlxFramesCollection","addSpriteSheetFrame",0x98036ac5,"flixel.graphics.frames.FlxFramesCollection.addSpriteSheetFrame","flixel/graphics/frames/FlxFramesCollection.hx",148,0xe09dd200)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(region,"region")
HXLINE( 149)		HX_VARI(  ::flixel::graphics::frames::FlxFrame,frame) =  ::flixel::graphics::frames::FlxFrame_obj::__new(this->parent,null(),null(),null());
HXLINE( 150)		 ::flixel::math::FlxRect _hx_tmp = this->checkFrame(region,null());
HXDLIN( 150)		frame->set_frame(_hx_tmp);
...
HXLINE( 177)		HX_VARI(  ::flixel::graphics::frames::FlxFrame,texFrame) =  ::flixel::graphics::frames::FlxFrame_obj::__new(this->parent,angle,flipX,flipY);
...
HXLINE( 181)		 ::flixel::math::FlxRect _hx_tmp2 = this->checkFrame(frame,name);
HXDLIN( 181)		texFrame->set_frame(_hx_tmp2);
...
HXLINE( 227)		Bool _hx_tmp2 = hx::IsNotNull( name );
...
HX_DEFINE_DYNAMIC_FUNC1(FlxFramesCollection_obj,pushFrame,return )
 ...
 ::flixel::graphics::frames::FlxFramesCollection FlxFramesCollection_obj::addBorder( ::flixel::math::FlxPoint border){
            	HX_STACK_FRAME("flixel.graphics.frames.FlxFramesCollection","addBorder",0x7da91fbe,"flixel.graphics.frames.FlxFramesCollection.addBorder","flixel/graphics/frames/FlxFramesCollection.hx",241,0xe09dd200)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(border,"border")
...
::String FlxFramesCollection_obj::toString(){
            	HX_STACK_FRAME("flixel.graphics.frames.FlxFramesCollection","toString",0xfe5297fb,"flixel.graphics.frames.FlxFramesCollection.toString","flixel/graphics/frames/FlxFramesCollection.hx",247,0xe09dd200)
            	HX_STACK_THIS(this)
HXLINE( 248)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 248)		_this->label = HX_("frames",a6,af,85,ac);
HXDLIN( 248)		_this->value = this->frames;
HXLINE( 249)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 249)		_this1->label = HX_("type",ba,f2,08,4d);
HXDLIN( 249)		_this1->value = this->type;
...
Int FlxFramesCollection_obj::get_numFrames(){
            	HX_STACK_FRAME("flixel.graphics.frames.FlxFramesCollection","get_numFrames",0xbd2728b4,"flixel.graphics.frames.FlxFramesCollection.get_numFrames","flixel/graphics/frames/FlxFramesCollection.hx",254,0xe09dd200)
            	HX_STACK_THIS(this)
