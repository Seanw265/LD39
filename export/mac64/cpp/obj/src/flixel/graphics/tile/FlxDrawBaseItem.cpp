...
HXLINE(  21)		 ::Dynamic _hx_switch_0 = blend;
            		if (  (_hx_switch_0==(int)0) ){
HXLINE(  21)			return (int)65536;
HXDLIN(  21)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==(int)2) ){
HXLINE(  21)			return (int)1048576;
HXDLIN(  21)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==(int)3) ){
HXLINE(  21)			return (int)16777216;
HXDLIN(  21)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==(int)5) ){
HXLINE(  21)			return (int)8388608;
HXDLIN(  21)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==(int)6) ){
HXLINE(  21)			return (int)33554432;
HXDLIN(  21)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==(int)8) ){
HXLINE(  21)			return (int)2097152;
HXDLIN(  21)			goto _hx_goto_0;
            		}
