...
HXLINE(  66)			_hx_tmp2 = hx::IsNotNull( transform );
            		}
            		else {
...
HXLINE(  68)			{
HXLINE(  68)				Float f14 = transform->redOffset;
HXDLIN(  68)				this->drawData[this->position++] = f14;
            			}
HXLINE(  69)			{
HXLINE(  69)				Float f15 = transform->greenOffset;
HXDLIN(  69)				this->drawData[this->position++] = f15;
            			}
HXLINE(  70)			{
HXLINE(  70)				Float f16 = transform->blueOffset;
HXDLIN(  70)				this->drawData[this->position++] = f16;
            			}
HXLINE(  71)			{
HXLINE(  71)				Float f17 = transform->alphaOffset;
HXDLIN(  71)				this->drawData[this->position++] = f17;
            			}
            		}
            	}
...
HXLINE(  93)			hx::OrEq(flags,(int)128);
            		}
HXLINE(  96)		hx::OrEq(flags,this->blending);
HXLINE(  99)		 ::openfl::display::Graphics _hx_tmp1 = camera->canvas->get_graphics();
...
HXLINE( 115)			hx::AddEq(elementsPerTile,(int)4);
            		}
