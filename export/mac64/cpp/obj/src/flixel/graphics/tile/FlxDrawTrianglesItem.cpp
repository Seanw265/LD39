...
HXLINE(  56)		camera->canvas->get_graphics()->drawTriangles(this->vertices,this->indices,this->uvtData,(int)1);
...
void FlxDrawTrianglesItem_obj::addTriangles(::Array< Float > vertices,::Array< Int > indices,::Array< Float > uvtData,::Array< Int > colors, ::flixel::math::FlxPoint position, ::flixel::math::FlxRect cameraBounds){
            	HX_STACK_FRAME("flixel.graphics.tile.FlxDrawTrianglesItem","addTriangles",0xd3f66861,"flixel.graphics.tile.FlxDrawTrianglesItem.addTriangles","flixel/graphics/tile/FlxDrawTrianglesItem.hx",99,0x6492a666)
            	HX_STACK_THIS(this)
...
HXLINE( 100)		Bool _hx_tmp = hx::IsNull( position );
HXDLIN( 100)		if (_hx_tmp) {
HXLINE( 101)			position = ::flixel::graphics::tile::FlxDrawTrianglesItem_obj::point->set(null(),null());
            		}
HXLINE( 103)		Bool _hx_tmp1 = hx::IsNull( cameraBounds );
HXDLIN( 103)		if (_hx_tmp1) {
HXLINE( 104)			HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::graphics::tile::FlxDrawTrianglesItem_obj::rect;
HXDLIN( 104)			Float Width = ::flixel::FlxG_obj::width;
HXDLIN( 104)			Float Height = ::flixel::FlxG_obj::height;
HXDLIN( 104)			_this->x = (int)0;
HXDLIN( 104)			_this->y = (int)0;
HXDLIN( 104)			_this->width = Width;
HXDLIN( 104)			_this->height = Height;
HXDLIN( 104)			cameraBounds = _this;
            		}
HXLINE( 106)		HX_VARI( Int,verticesLength) = vertices->length;
HXLINE( 107)		HX_VARI( Int,prevVerticesLength) = this->vertices->length;
HXLINE( 108)		HX_VARI( Int,numberOfVertices) = ::Std_obj::_hx_int(((Float)verticesLength / (Float)(int)2));
HXLINE( 109)		HX_VARI( Int,prevIndicesLength) = this->indices->length;
HXLINE( 110)		HX_VARI( Int,prevUVTDataLength) = this->uvtData->length;
HXLINE( 111)		HX_VARI( Int,prevColorsLength) = this->colors->length;
HXLINE( 112)		HX_VARI( Int,prevNumberOfVertices) = this->get_numVertices();
HXLINE( 114)		HX_VAR( Float,tempX);
HXDLIN( 114)		HX_VAR( Float,tempY);
HXLINE( 115)		HX_VARI( Int,i) = (int)0;
HXLINE( 116)		HX_VARI( Int,currentVertexPosition) = prevVerticesLength;
HXLINE( 118)		while((i < verticesLength)){
HXLINE( 120)			tempX = (position->x + vertices->__get(i));
HXLINE( 121)			tempY = (position->y + vertices->__get((i + (int)1)));
HXLINE( 123)			Int _hx_tmp2 = currentVertexPosition++;
HXDLIN( 123)			this->vertices[_hx_tmp2] = tempX;
HXLINE( 124)			Int _hx_tmp3 = currentVertexPosition++;
HXDLIN( 124)			this->vertices[_hx_tmp3] = tempY;
HXLINE( 126)			if ((i == (int)0)) {
HXLINE( 128)				HX_VARI_NAME(  ::flixel::math::FlxRect,_this1,"_this") = this->bounds;
...
HXLINE( 132)				HX_VARI(  ::flixel::math::FlxRect,bounds) = this->bounds;
HXDLIN( 132)				Bool _hx_tmp4 = (tempX < bounds->x);
HXDLIN( 132)				if (_hx_tmp4) {
HXLINE( 132)					hx::AddEq(bounds->width,(bounds->x - tempX));
HXDLIN( 132)					bounds->x = tempX;
            				}
HXDLIN( 132)				Bool _hx_tmp5 = (tempY < bounds->y);
HXDLIN( 132)				if (_hx_tmp5) {
HXLINE( 132)					hx::AddEq(bounds->height,(bounds->y - tempY));
HXDLIN( 132)					bounds->y = tempY;
            				}
HXDLIN( 132)				Bool _hx_tmp6 = (tempX > (bounds->x + bounds->width));
HXDLIN( 132)				if (_hx_tmp6) {
HXLINE( 132)					bounds->width = (tempX - bounds->x);
            				}
HXDLIN( 132)				Bool _hx_tmp7 = (tempY > (bounds->y + bounds->height));
HXDLIN( 132)				if (_hx_tmp7) {
HXLINE( 132)					bounds->height = (tempY - bounds->y);
            				}
            			}
HXLINE( 135)			hx::AddEq(i,(int)2);
            		}
HXLINE( 138)		HX_VARI(  ::flixel::math::FlxRect,Rect) = this->bounds;
HXDLIN( 138)		HX_VAR( Bool,result);
HXDLIN( 138)		Bool _hx_tmp8;
HXDLIN( 138)		Bool _hx_tmp9;
HXDLIN( 138)		if (((Rect->x + Rect->width) > cameraBounds->x)) {
HXLINE( 138)			_hx_tmp9 = (Rect->x < (cameraBounds->x + cameraBounds->width));
            		}
            		else {
HXLINE( 138)			_hx_tmp9 = false;
            		}
HXDLIN( 138)		if (_hx_tmp9) {
HXLINE( 138)			_hx_tmp8 = ((Rect->y + Rect->height) > cameraBounds->y);
            		}
            		else {
HXLINE( 138)			_hx_tmp8 = false;
            		}
HXDLIN( 138)		if (_hx_tmp8) {
HXLINE( 138)			result = (Rect->y < (cameraBounds->y + cameraBounds->height));
            		}
            		else {
HXLINE( 138)			result = false;
            		}
HXDLIN( 138)		Bool _hx_tmp10 = Rect->_weak;
HXDLIN( 138)		if (_hx_tmp10) {
HXLINE( 138)			Bool _hx_tmp11 = !(Rect->_inPool);
...
HXLINE( 140)			Int _hx_tmp12 = (this->vertices->length - verticesLength);
HXDLIN( 140)			this->vertices->removeRange(_hx_tmp12,verticesLength);
            		}
            		else {
HXLINE( 144)			HX_VARI( Int,uvtDataLength) = uvtData->length;
HXLINE( 145)			{
HXLINE( 145)				HX_VARI( Int,_g1) = (int)0;
HXDLIN( 145)				while((_g1 < uvtDataLength)){
HXLINE( 145)					HX_VARI_NAME( Int,i1,"i") = _g1++;
HXLINE( 147)					Int _hx_tmp13 = (prevUVTDataLength + i1);
HXDLIN( 147)					Float _hx_tmp14 = uvtData->__get(i1);
HXDLIN( 147)					this->uvtData[_hx_tmp13] = _hx_tmp14;
            				}
            			}
HXLINE( 150)			HX_VARI( Int,indicesLength) = indices->length;
HXLINE( 151)			{
HXLINE( 151)				HX_VARI_NAME( Int,_g11,"_g1") = (int)0;
HXDLIN( 151)				while((_g11 < indicesLength)){
HXLINE( 151)					HX_VARI_NAME( Int,i2,"i") = _g11++;
HXLINE( 153)					Int _hx_tmp15 = (prevIndicesLength + i2);
HXDLIN( 153)					Int _hx_tmp16 = (indices->__get(i2) + prevNumberOfVertices);
HXDLIN( 153)					this->indices[_hx_tmp15] = _hx_tmp16;
            				}
            			}
HXLINE( 156)			Bool _hx_tmp17 = this->colored;
HXDLIN( 156)			if (_hx_tmp17) {
HXLINE( 158)				{
HXLINE( 158)					HX_VARI_NAME( Int,_g12,"_g1") = (int)0;
HXDLIN( 158)					while((_g12 < numberOfVertices)){
HXLINE( 158)						HX_VARI_NAME( Int,i3,"i") = _g12++;
HXLINE( 160)						Int _hx_tmp18 = (prevColorsLength + i3);
HXDLIN( 160)						Int _hx_tmp19 = colors->__get(i3);
HXDLIN( 160)						this->colors[_hx_tmp18] = _hx_tmp19;
            					}
            				}
HXLINE( 163)				hx::AddEq(this->colorsPosition,numberOfVertices);
            			}
HXLINE( 166)			hx::AddEq(this->verticesPosition,verticesLength);
HXLINE( 167)			hx::AddEq(this->indicesPosition,indicesLength);
            		}
HXLINE( 170)		Bool _hx_tmp20 = position->_weak;
HXDLIN( 170)		if (_hx_tmp20) {
HXLINE( 170)			position->put();
            		}
HXLINE( 171)		Bool _hx_tmp21 = cameraBounds->_weak;
HXDLIN( 171)		if (_hx_tmp21) {
HXLINE( 171)			Bool _hx_tmp22 = !(cameraBounds->_inPool);
...
void FlxDrawTrianglesItem_obj::addQuad( ::flixel::graphics::frames::FlxFrame frame, ::flixel::math::FlxMatrix matrix, ::openfl::geom::ColorTransform transform){
            	HX_STACK_FRAME("flixel.graphics.tile.FlxDrawTrianglesItem","addQuad",0xc08c1cd1,"flixel.graphics.tile.FlxDrawTrianglesItem.addQuad","flixel/graphics/tile/FlxDrawTrianglesItem.hx",202,0x6492a666)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(frame,"frame")
            	HX_STACK_ARG(matrix,"matrix")
            	HX_STACK_ARG(transform,"transform")
HXLINE( 203)		HX_VARI( Int,prevVerticesPos) = this->verticesPosition;
HXLINE( 204)		HX_VARI( Int,prevIndicesPos) = this->indicesPosition;
HXLINE( 205)		HX_VARI( Int,prevColorsPos) = this->colorsPosition;
HXLINE( 206)		HX_VARI( Int,prevNumberOfVertices) = this->get_numVertices();
HXLINE( 208)		HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 208)		point->_inPool = false;
HXLINE( 209)		{
HXLINE( 209)			HX_VARI( Float,x1) = (((point->x * matrix->a) + (point->y * matrix->c)) + matrix->tx);
HXDLIN( 209)			HX_VARI( Float,y1) = (((point->x * matrix->b) + (point->y * matrix->d)) + matrix->ty);
HXDLIN( 209)			point->set(x1,y1);
            		}
HXLINE( 211)		this->vertices[prevVerticesPos] = point->x;
HXLINE( 212)		this->vertices[(prevVerticesPos + (int)1)] = point->y;
HXLINE( 214)		this->uvtData[prevVerticesPos] = frame->uv->x;
HXLINE( 215)		this->uvtData[(prevVerticesPos + (int)1)] = frame->uv->y;
HXLINE( 217)		point->set(frame->frame->width,(int)0);
HXLINE( 218)		{
HXLINE( 218)			HX_VARI_NAME( Float,x11,"x1") = (((point->x * matrix->a) + (point->y * matrix->c)) + matrix->tx);
HXDLIN( 218)			HX_VARI_NAME( Float,y11,"y1") = (((point->x * matrix->b) + (point->y * matrix->d)) + matrix->ty);
HXDLIN( 218)			point->set(x11,y11);
            		}
HXLINE( 220)		this->vertices[(prevVerticesPos + (int)2)] = point->x;
HXLINE( 221)		this->vertices[(prevVerticesPos + (int)3)] = point->y;
HXLINE( 223)		this->uvtData[(prevVerticesPos + (int)2)] = frame->uv->width;
HXLINE( 224)		this->uvtData[(prevVerticesPos + (int)3)] = frame->uv->y;
HXLINE( 226)		point->set(frame->frame->width,frame->frame->height);
HXLINE( 227)		{
HXLINE( 227)			HX_VARI_NAME( Float,x12,"x1") = (((point->x * matrix->a) + (point->y * matrix->c)) + matrix->tx);
HXDLIN( 227)			HX_VARI_NAME( Float,y12,"y1") = (((point->x * matrix->b) + (point->y * matrix->d)) + matrix->ty);
HXDLIN( 227)			point->set(x12,y12);
            		}
HXLINE( 229)		this->vertices[(prevVerticesPos + (int)4)] = point->x;
HXLINE( 230)		this->vertices[(prevVerticesPos + (int)5)] = point->y;
HXLINE( 232)		this->uvtData[(prevVerticesPos + (int)4)] = frame->uv->width;
HXLINE( 233)		this->uvtData[(prevVerticesPos + (int)5)] = frame->uv->height;
HXLINE( 235)		point->set((int)0,frame->frame->height);
HXLINE( 236)		{
HXLINE( 236)			HX_VARI_NAME( Float,x13,"x1") = (((point->x * matrix->a) + (point->y * matrix->c)) + matrix->tx);
HXDLIN( 236)			HX_VARI_NAME( Float,y13,"y1") = (((point->x * matrix->b) + (point->y * matrix->d)) + matrix->ty);
HXDLIN( 236)			point->set(x13,y13);
            		}
HXLINE( 238)		this->vertices[(prevVerticesPos + (int)6)] = point->x;
HXLINE( 239)		this->vertices[(prevVerticesPos + (int)7)] = point->y;
HXLINE( 241)		point->put();
HXLINE( 243)		this->uvtData[(prevVerticesPos + (int)6)] = frame->uv->x;
HXLINE( 244)		this->uvtData[(prevVerticesPos + (int)7)] = frame->uv->height;
HXLINE( 246)		this->indices[prevIndicesPos] = prevNumberOfVertices;
HXLINE( 247)		this->indices[(prevIndicesPos + (int)1)] = (prevNumberOfVertices + (int)1);
HXLINE( 248)		this->indices[(prevIndicesPos + (int)2)] = (prevNumberOfVertices + (int)2);
HXLINE( 249)		this->indices[(prevIndicesPos + (int)3)] = (prevNumberOfVertices + (int)2);
HXLINE( 250)		this->indices[(prevIndicesPos + (int)4)] = (prevNumberOfVertices + (int)3);
HXLINE( 251)		this->indices[(prevIndicesPos + (int)5)] = prevNumberOfVertices;
HXLINE( 253)		Bool _hx_tmp = this->colored;
HXDLIN( 253)		if (_hx_tmp) {
HXLINE( 255)			HX_VARI( Float,red) = ((Float)1.0);
HXLINE( 256)			HX_VARI( Float,green) = ((Float)1.0);
HXLINE( 257)			HX_VARI( Float,blue) = ((Float)1.0);
HXLINE( 258)			HX_VARI( Float,alpha) = ((Float)1.0);
HXLINE( 260)			Bool _hx_tmp1 = hx::IsNotNull( transform );
...
HXLINE( 271)			HX_VARI( Int,color) = ::flixel::util::_FlxColor::FlxColor_Impl__obj::_new(null());
HXDLIN( 271)			{
HXLINE( 271)				HX_VARI( Int,Value) = ::Math_obj::round((red * (int)255));
HXDLIN( 271)				hx::AndEq(color,(int)-16711681);
HXDLIN( 271)				Int _hx_tmp2;
HXDLIN( 271)				if ((Value > (int)255)) {
HXLINE( 271)					_hx_tmp2 = (int)255;
            				}
            				else {
...
HXLINE( 271)						_hx_tmp2 = Value;
            					}
            				}
HXDLIN( 271)				hx::OrEq(color,((int)_hx_tmp2 << (int)(int)16));
            			}
HXDLIN( 271)			{
HXLINE( 271)				HX_VARI_NAME( Int,Value1,"Value") = ::Math_obj::round((green * (int)255));
HXDLIN( 271)				hx::AndEq(color,(int)-65281);
HXDLIN( 271)				Int _hx_tmp3;
HXDLIN( 271)				if ((Value1 > (int)255)) {
HXLINE( 271)					_hx_tmp3 = (int)255;
            				}
            				else {
HXLINE( 271)					if ((Value1 < (int)0)) {
HXLINE( 271)						_hx_tmp3 = (int)0;
            					}
            					else {
HXLINE( 271)						_hx_tmp3 = Value1;
            					}
            				}
HXDLIN( 271)				hx::OrEq(color,((int)_hx_tmp3 << (int)(int)8));
            			}
HXDLIN( 271)			{
HXLINE( 271)				HX_VARI_NAME( Int,Value2,"Value") = ::Math_obj::round((blue * (int)255));
HXDLIN( 271)				hx::AndEq(color,(int)-256);
HXDLIN( 271)				Int _hx_tmp4;
HXDLIN( 271)				if ((Value2 > (int)255)) {
HXLINE( 271)					_hx_tmp4 = (int)255;
            				}
            				else {
HXLINE( 271)					if ((Value2 < (int)0)) {
HXLINE( 271)						_hx_tmp4 = (int)0;
            					}
            					else {
HXLINE( 271)						_hx_tmp4 = Value2;
            					}
            				}
HXDLIN( 271)				hx::OrEq(color,_hx_tmp4);
            			}
HXDLIN( 271)			{
HXLINE( 271)				HX_VARI_NAME( Int,Value3,"Value") = ::Math_obj::round((alpha * (int)255));
HXDLIN( 271)				hx::AndEq(color,(int)16777215);
HXDLIN( 271)				Int _hx_tmp5;
HXDLIN( 271)				if ((Value3 > (int)255)) {
HXLINE( 271)					_hx_tmp5 = (int)255;
            				}
            				else {
HXLINE( 271)					if ((Value3 < (int)0)) {
HXLINE( 271)						_hx_tmp5 = (int)0;
            					}
            					else {
HXLINE( 271)						_hx_tmp5 = Value3;
            					}
            				}
HXDLIN( 271)				hx::OrEq(color,((int)_hx_tmp5 << (int)(int)24));
            			}
HXDLIN( 271)			HX_VARI_NAME( Int,color1,"color") = color;
HXLINE( 273)			this->colors[prevColorsPos] = color1;
HXLINE( 274)			this->colors[(prevColorsPos + (int)1)] = color1;
HXLINE( 275)			this->colors[(prevColorsPos + (int)2)] = color1;
HXLINE( 276)			this->colors[(prevColorsPos + (int)3)] = color1;
HXLINE( 278)			hx::AddEq(this->colorsPosition,(int)4);
            		}
HXLINE( 281)		hx::AddEq(this->verticesPosition,(int)8);
HXLINE( 282)		hx::AddEq(this->indicesPosition,(int)6);
            	}


Int FlxDrawTrianglesItem_obj::get_numVertices(){
            	HX_STACK_FRAME("flixel.graphics.tile.FlxDrawTrianglesItem","get_numVertices",0x2e325a3f,"flixel.graphics.tile.FlxDrawTrianglesItem.get_numVertices","flixel/graphics/tile/FlxDrawTrianglesItem.hx",287,0x6492a666)
            	HX_STACK_THIS(this)
HXLINE( 287)		Float _hx_tmp = ((Float)this->vertices->length / (Float)(int)2);
HXDLIN( 287)		return ::Std_obj::_hx_int(_hx_tmp);
            	}


Int FlxDrawTrianglesItem_obj::get_numTriangles(){
            	HX_STACK_FRAME("flixel.graphics.tile.FlxDrawTrianglesItem","get_numTriangles",0x542b93a5,"flixel.graphics.tile.FlxDrawTrianglesItem.get_numTriangles","flixel/graphics/tile/FlxDrawTrianglesItem.hx",292,0x6492a666)
            	HX_STACK_THIS(this)
HXLINE( 292)		Float _hx_tmp = ((Float)this->indices->length / (Float)(int)3);
HXDLIN( 292)		return ::Std_obj::_hx_int(_hx_tmp);
            	}
 ...
 ::flixel::math::FlxRect FlxDrawTrianglesItem_obj::inflateBounds( ::flixel::math::FlxRect bounds,Float x,Float y){
            	HX_STACK_FRAME("flixel.graphics.tile.FlxDrawTrianglesItem","inflateBounds",0x8ece7465,"flixel.graphics.tile.FlxDrawTrianglesItem.inflateBounds","flixel/graphics/tile/FlxDrawTrianglesItem.hx",175,0x6492a666)
            	HX_STACK_ARG(bounds,"bounds")
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 176)		Bool _hx_tmp = (x < bounds->x);
HXDLIN( 176)		if (_hx_tmp) {
HXLINE( 178)			hx::AddEq(bounds->width,(bounds->x - x));
HXLINE( 179)			bounds->x = x;
            		}
HXLINE( 182)		Bool _hx_tmp1 = (y < bounds->y);
HXDLIN( 182)		if (_hx_tmp1) {
HXLINE( 184)			hx::AddEq(bounds->height,(bounds->y - y));
HXLINE( 185)			bounds->y = y;
            		}
HXLINE( 188)		Bool _hx_tmp2 = (x > (bounds->x + bounds->width));
HXDLIN( 188)		if (_hx_tmp2) {
HXLINE( 190)			bounds->width = (x - bounds->x);
            		}
HXLINE( 193)		Bool _hx_tmp3 = (y > (bounds->y + bounds->height));
