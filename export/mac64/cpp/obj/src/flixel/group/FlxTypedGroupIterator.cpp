...
void FlxTypedGroupIterator_obj::__construct(::cpp::VirtualArray GroupMembers, ::Dynamic filter){
            	HX_STACK_FRAME("flixel.group.FlxTypedGroupIterator","new",0xa7153fe6,"flixel.group.FlxTypedGroupIterator.new","flixel/group/FlxGroup.hx",834,0x1e89d58e)
            	HX_STACK_THIS(this)
...
Dynamic FlxTypedGroupIterator_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::Dynamic FlxTypedGroupIterator_obj::next(){
            	HX_STACK_FRAME("flixel.group.FlxTypedGroupIterator","next",0x8b82aaad,"flixel.group.FlxTypedGroupIterator.next","flixel/group/FlxGroup.hx",843,0x1e89d58e)
            	HX_STACK_THIS(this)
HXLINE( 843)		Bool _hx_tmp = this->hasNext();
HXDLIN( 843)		if (_hx_tmp) {
HXLINE( 843)			return this->_groupMembers->__get(this->_cursor++);
            		}
            		else {
...
Bool FlxTypedGroupIterator_obj::hasNext(){
            	HX_STACK_FRAME("flixel.group.FlxTypedGroupIterator","hasNext",0x559d4ff3,"flixel.group.FlxTypedGroupIterator.hasNext","flixel/group/FlxGroup.hx",847,0x1e89d58e)
            	HX_STACK_THIS(this)
HXLINE( 848)		while(true){
HXLINE( 848)			Bool _hx_tmp;
HXDLIN( 848)			Bool _hx_tmp1 = (this->_cursor < this->_length);
HXDLIN( 848)			if (_hx_tmp1) {
HXLINE( 848)				Bool _hx_tmp2 = hx::IsNotNull( this->_groupMembers->__get(this->_cursor) );
HXDLIN( 848)				if (_hx_tmp2) {
HXLINE( 848)					Bool _hx_tmp3 = hx::IsNotNull( this->_filter );
HXDLIN( 848)					if (_hx_tmp3) {
HXLINE( 848)						 ::Dynamic _hx_tmp4 = this->_groupMembers->__get(this->_cursor);
HXDLIN( 848)						_hx_tmp = !(( (Bool)(this->_filter(_hx_tmp4)) ));
            					}
            					else {
