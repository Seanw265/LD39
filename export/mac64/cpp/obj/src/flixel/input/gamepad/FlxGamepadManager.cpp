...
HXLINE( 319)				 ::openfl::ui::GameInputDevice _hx_tmp = ::openfl::ui::GameInput_obj::getDeviceAt(i);
HXDLIN( 319)				this->addGamepad(_hx_tmp);
            			}
            		}
            	}
...
void FlxGamepadManager_obj::onDeviceAdded( ::openfl::events::GameInputEvent Event){
            	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepadManager","onDeviceAdded",0x0a66e6f8,"flixel.input.gamepad.FlxGamepadManager.onDeviceAdded","flixel/input/gamepad/FlxGamepadManager.hx",326,0xccfee0a6)
            	HX_STACK_THIS(this)
...
void FlxGamepadManager_obj::onDeviceRemoved( ::openfl::events::GameInputEvent Event){
            	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepadManager","onDeviceRemoved",0xfdb62fd8,"flixel.input.gamepad.FlxGamepadManager.onDeviceRemoved","flixel/input/gamepad/FlxGamepadManager.hx",331,0xccfee0a6)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Event,"Event")
...
Int FlxGamepadManager_obj::findGamepadIndex( ::openfl::ui::GameInputDevice Device){
            	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepadManager","findGamepadIndex",0xba70451d,"flixel.input.gamepad.FlxGamepadManager.findGamepadIndex","flixel/input/gamepad/FlxGamepadManager.hx",335,0xccfee0a6)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Device,"Device")
HXLINE( 336)		Bool _hx_tmp = hx::IsNull( Device );
...
void FlxGamepadManager_obj::addGamepad( ::openfl::ui::GameInputDevice Device){
            	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepadManager","addGamepad",0xa73480d3,"flixel.input.gamepad.FlxGamepadManager.addGamepad","flixel/input/gamepad/FlxGamepadManager.hx",347,0xccfee0a6)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Device,"Device")
HXLINE( 348)		Bool _hx_tmp = hx::IsNull( Device );
...
HXLINE( 356)		::hx::EnumBase _hx_tmp1 = this->getModelFromDeviceName(Device->name);
HXDLIN( 356)		HX_VARI(  ::flixel::input::gamepad::FlxGamepad,gamepad) = this->createByID(id,_hx_tmp1);
...
::hx::EnumBase FlxGamepadManager_obj::getModelFromDeviceName(::String name){
            	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepadManager","getModelFromDeviceName",0x16d9cf71,"flixel.input.gamepad.FlxGamepadManager.getModelFromDeviceName","flixel/input/gamepad/FlxGamepadManager.hx",361,0xccfee0a6)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(name,"name")
HXLINE( 376)		::String s = name.toLowerCase();
HXDLIN( 376)		::String s1 = ::StringTools_obj::replace(s,HX_("-",2d,00,00,00),HX_("",00,00,00,00));
HXDLIN( 376)		name = ::StringTools_obj::replace(s1,HX_("_",5f,00,00,00),HX_("",00,00,00,00));
HXLINE( 377)		Int _hx_tmp = name.indexOf(HX_("ouya",6e,e0,b7,49),null());
HXDLIN( 377)		if ((_hx_tmp != (int)-1)) {
HXLINE( 377)			return ::flixel::input::gamepad::FlxGamepadModel_obj::OUYA_dyn();
            		}
            		else {
HXLINE( 378)			Bool _hx_tmp1;
HXDLIN( 378)			Int _hx_tmp2 = name.indexOf(HX_("wireless controller",5e,0b,31,72),null());
HXDLIN( 378)			if ((_hx_tmp2 == (int)-1)) {
HXLINE( 378)				Int _hx_tmp3 = name.indexOf(HX_("ps4",d1,60,55,00),null());
HXDLIN( 378)				_hx_tmp1 = (_hx_tmp3 != (int)-1);
            			}
            			else {
...
HXLINE( 379)				Int _hx_tmp4 = name.indexOf(HX_("logitech",3b,70,e5,19),null());
HXDLIN( 379)				if ((_hx_tmp4 != (int)-1)) {
HXLINE( 377)					return ::flixel::input::gamepad::FlxGamepadModel_obj::LOGITECH_dyn();
            				}
            				else {
HXLINE( 380)					Bool _hx_tmp5;
HXDLIN( 380)					Int _hx_tmp6 = name.indexOf(HX_("xbox",93,58,9c,4f),null());
HXDLIN( 380)					if ((_hx_tmp6 != (int)-1)) {
HXLINE( 380)						Int _hx_tmp7 = name.indexOf(HX_("360",2d,e2,26,00),null());
HXDLIN( 380)						_hx_tmp5 = (_hx_tmp7 != (int)-1);
            					}
            					else {
...
HXLINE( 381)						Int _hx_tmp8 = name.indexOf(HX_("xinput",92,10,f1,b8),null());
HXDLIN( 381)						if ((_hx_tmp8 != (int)-1)) {
HXLINE( 377)							return ::flixel::input::gamepad::FlxGamepadModel_obj::XINPUT_dyn();
            						}
            						else {
HXLINE( 382)							Int _hx_tmp9 = name.indexOf(HX_("nintendo rvlcnt01tr",cb,02,13,80),null());
HXDLIN( 382)							if ((_hx_tmp9 != (int)-1)) {
HXLINE( 377)								return ::flixel::input::gamepad::FlxGamepadModel_obj::WII_REMOTE_dyn();
            							}
            							else {
HXLINE( 383)								Int _hx_tmp10 = name.indexOf(HX_("nintendo rvlcnt01",0d,c0,58,28),null());
HXDLIN( 383)								if ((_hx_tmp10 != (int)-1)) {
HXLINE( 377)									return ::flixel::input::gamepad::FlxGamepadModel_obj::WII_REMOTE_dyn();
            								}
            								else {
HXLINE( 384)									Int _hx_tmp11 = name.indexOf(HX_("mayflash wiimote pc adapter",ed,5a,02,8e),null());
HXDLIN( 384)									if ((_hx_tmp11 != (int)-1)) {
HXLINE( 377)										return ::flixel::input::gamepad::FlxGamepadModel_obj::MAYFLASH_WII_REMOTE_dyn();
            									}
            									else {
HXLINE( 385)										Int _hx_tmp12 = name.indexOf(HX_("mfi",f0,0e,53,00),null());
HXDLIN( 385)										if ((_hx_tmp12 != (int)-1)) {
...
void FlxGamepadManager_obj::removeGamepad( ::openfl::ui::GameInputDevice Device){
            	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepadManager","removeGamepad",0xfe38fe4a,"flixel.input.gamepad.FlxGamepadManager.removeGamepad","flixel/input/gamepad/FlxGamepadManager.hx",390,0xccfee0a6)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Device,"Device")
HXLINE( 391)		Bool _hx_tmp = hx::IsNull( Device );
...
HXDLIN( 397)				Bool _hx_tmp2 = hx::IsNotNull( gamepad );
HXDLIN( 397)				if (_hx_tmp2) {
HXLINE( 397)					_hx_tmp1 = hx::IsEq( gamepad->_device,Device );
            				}
            				else {
...
{
{
            	HX_STACK_FRAME("flixel.input.gamepad.FlxGamepadManager","boot",0x70552845,"flixel.input.gamepad.FlxGamepadManager.boot","flixel/input/gamepad/FlxGamepadManager.hx",53,0xccfee0a6)
HXLINE(  53)		_gameInput =  ::openfl::ui::GameInput_obj::__new();
            	}
}
