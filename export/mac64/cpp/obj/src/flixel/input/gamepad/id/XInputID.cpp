...
{
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",54,0x9958eee3)
HXLINE(  54)		A = (int)6;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",55,0x9958eee3)
HXLINE(  55)		B = (int)7;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",56,0x9958eee3)
HXLINE(  56)		X = (int)8;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",57,0x9958eee3)
HXLINE(  57)		Y = (int)9;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",59,0x9958eee3)
HXLINE(  59)		BACK = (int)10;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",60,0x9958eee3)
HXLINE(  60)		GUIDE = (int)11;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",61,0x9958eee3)
HXLINE(  61)		START = (int)12;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",63,0x9958eee3)
HXLINE(  63)		LEFT_STICK_CLICK = (int)13;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",64,0x9958eee3)
HXLINE(  64)		RIGHT_STICK_CLICK = (int)14;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",66,0x9958eee3)
HXLINE(  66)		LB = (int)15;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",67,0x9958eee3)
HXLINE(  67)		RB = (int)16;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",69,0x9958eee3)
HXLINE(  69)		DPAD_UP = (int)17;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",70,0x9958eee3)
HXLINE(  70)		DPAD_DOWN = (int)18;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",71,0x9958eee3)
HXLINE(  71)		DPAD_LEFT = (int)19;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",72,0x9958eee3)
HXLINE(  72)		DPAD_RIGHT = (int)20;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",74,0x9958eee3)
HXLINE(  74)		LEFT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__new((int)0,(int)1, ::Dynamic(hx::Anon_obj::Create(4)
...
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",75,0x9958eee3)
HXLINE(  75)		RIGHT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__new((int)2,(int)3, ::Dynamic(hx::Anon_obj::Create(4)
...
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",77,0x9958eee3)
HXLINE(  77)		LEFT_TRIGGER = (int)4;
            	}
{
            	HX_STACK_FRAME("flixel.input.gamepad.id.XInputID","boot",0x5dbba0a3,"flixel.input.gamepad.id.XInputID.boot","flixel/input/gamepad/id/XInputID.hx",78,0x9958eee3)
