...
Bool FlxGamepadAnalogStateList_obj::checkRaw(Int RawID,Int Status){
            	HX_STACK_FRAME("flixel.input.gamepad.lists.FlxGamepadAnalogStateList","checkRaw",0x43d8cbba,"flixel.input.gamepad.lists.FlxGamepadAnalogStateList.checkRaw","flixel/input/gamepad/lists/FlxGamepadAnalogStateList.hx",99,0xa4c0584e)
            	HX_STACK_THIS(this)
