...
Bool FlxGamepadButtonList_obj::get_LEFT_TRIGGER(){
            	HX_STACK_FRAME("flixel.input.gamepad.lists.FlxGamepadButtonList","get_LEFT_TRIGGER",0xc549e39c,"flixel.input.gamepad.lists.FlxGamepadButtonList.get_LEFT_TRIGGER","flixel/input/gamepad/lists/FlxGamepadButtonList.hx",28,0x834770bf)
            	HX_STACK_THIS(this)
HXLINE(  28)		HX_VARI(  ::flixel::input::gamepad::FlxGamepad,_this) = this->gamepad;
HXDLIN(  28)		Int Status = this->status;
HXDLIN(  28)		Int _hx_tmp = _this->mapping->getRawID((int)17);
HXDLIN(  28)		return _this->checkStatusRaw(_hx_tmp,Status);
            	}
...
Bool FlxGamepadButtonList_obj::get_RIGHT_TRIGGER(){
            	HX_STACK_FRAME("flixel.input.gamepad.lists.FlxGamepadButtonList","get_RIGHT_TRIGGER",0x7a39ecd9,"flixel.input.gamepad.lists.FlxGamepadButtonList.get_RIGHT_TRIGGER","flixel/input/gamepad/lists/FlxGamepadButtonList.hx",29,0x834770bf)
            	HX_STACK_THIS(this)
HXLINE(  29)		HX_VARI(  ::flixel::input::gamepad::FlxGamepad,_this) = this->gamepad;
HXDLIN(  29)		Int Status = this->status;
HXDLIN(  29)		Int _hx_tmp = _this->mapping->getRawID((int)18);
HXDLIN(  29)		return _this->checkStatusRaw(_hx_tmp,Status);
            	}
