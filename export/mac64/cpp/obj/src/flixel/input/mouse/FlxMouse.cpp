...
HXLINE( 391)		this->cursorContainer->mouseChildren = false;
HXLINE( 392)		this->cursorContainer->mouseEnabled = false;
HXLINE( 394)		this->_leftButton =  ::flixel::input::mouse::FlxMouseButton_obj::__new((int)-1);
HXLINE( 396)		this->_stage = ::openfl::Lib_obj::current->stage;
HXLINE( 397)		this->_stage->addEventListener(HX_("mouseDown",27,b1,c2,ee),this->_leftButton->onDown_dyn(),null(),null(),null());
HXLINE( 398)		this->_stage->addEventListener(HX_("mouseUp",e0,f3,72,c0),this->_leftButton->onUp_dyn(),null(),null(),null());
HXLINE( 401)		this->_middleButton =  ::flixel::input::mouse::FlxMouseButton_obj::__new((int)-2);
HXLINE( 402)		this->_rightButton =  ::flixel::input::mouse::FlxMouseButton_obj::__new((int)-3);
HXLINE( 404)		this->_stage->addEventListener(HX_("middleMouseDown",12,2b,fe,01),this->_middleButton->onDown_dyn(),null(),null(),null());
HXLINE( 405)		this->_stage->addEventListener(HX_("middleMouseUp",0b,8d,f5,3a),this->_middleButton->onUp_dyn(),null(),null(),null());
HXLINE( 406)		this->_stage->addEventListener(HX_("rightMouseDown",ab,29,d7,cd),this->_rightButton->onDown_dyn(),null(),null(),null());
HXLINE( 407)		this->_stage->addEventListener(HX_("rightMouseUp",64,83,21,ab),this->_rightButton->onUp_dyn(),null(),null(),null());
HXLINE( 409)		this->_stage->addEventListener(HX_("mouseLeave",92,28,20,90),this->onMouseLeave_dyn(),null(),null(),null());
HXLINE( 412)		this->_stage->addEventListener(HX_("mouseWheel",36,28,87,e7),this->onMouseWheel_dyn(),null(),null(),null());
HXLINE( 414)		::flixel::FlxG_obj::signals->gameStarted->add(this->onGameStart_dyn());
HXLINE( 415)		::openfl::ui::Mouse_obj::hide();
            	}
...
Int YOffset = __o_YOffset.Default(0);
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","load",0xf3e8bd02,"flixel.input.mouse.FlxMouse.load","flixel/input/mouse/FlxMouse.hx",176,0xe4e80b89)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Graphic,"Graphic")
            	HX_STACK_ARG(Scale,"Scale")
            	HX_STACK_ARG(XOffset,"XOffset")
            	HX_STACK_ARG(YOffset,"YOffset")
HXLINE( 178)		Bool _hx_tmp = hx::IsNotNull( this->_cursor );
HXDLIN( 178)		if (_hx_tmp) {
HXLINE( 180)			::flixel::util::FlxDestroyUtil_obj::removeChild(this->cursorContainer,this->_cursor);
            		}
HXLINE( 184)		Bool _hx_tmp1 = hx::IsNull( Graphic );
HXDLIN( 184)		if (_hx_tmp1) {
HXLINE( 186)			Graphic =  ::flixel::input::mouse::_FlxMouse::GraphicCursor_obj::__new((int)0,(int)0,null(),null());
            		}
HXLINE( 189)		Bool _hx_tmp2 = ::Std_obj::is(Graphic,hx::ClassOf< ::hx::Class >());
HXDLIN( 189)		if (_hx_tmp2) {
HXLINE( 191)			this->_cursor = ( ( ::openfl::display::Bitmap)(::Type_obj::createInstance(Graphic,::cpp::VirtualArray_obj::__new(0))) );
            		}
            		else {
HXLINE( 193)			Bool _hx_tmp3 = ::Std_obj::is(Graphic,hx::ClassOf< ::openfl::display::BitmapData >());
HXDLIN( 193)			if (_hx_tmp3) {
HXLINE( 195)				this->_cursor =  ::openfl::display::Bitmap_obj::__new(( ( ::openfl::display::BitmapData)(Graphic) ),null(),null());
            			}
            			else {
HXLINE( 197)				Bool _hx_tmp4 = ::Std_obj::is(Graphic,hx::ClassOf< ::String >());
HXDLIN( 197)				if (_hx_tmp4) {
HXLINE( 199)					HX_VARI( ::String,id) = ( (::String)(Graphic) );
HXDLIN( 199)					 ::openfl::display::BitmapData _hx_tmp5;
HXDLIN( 199)					Bool _hx_tmp6 = ::openfl::Assets_obj::exists(id,null());
HXDLIN( 199)					if (_hx_tmp6) {
HXLINE( 199)						_hx_tmp5 = ::openfl::Assets_obj::getBitmapData(id,false);
            					}
            					else {
HXLINE( 199)						_hx_tmp5 = null();
            					}
HXDLIN( 199)					this->_cursor =  ::openfl::display::Bitmap_obj::__new(_hx_tmp5,null(),null());
            				}
            				else {
HXLINE( 203)					this->_cursor =  ::openfl::display::Bitmap_obj::__new( ::flixel::input::mouse::_FlxMouse::GraphicCursor_obj::__new((int)0,(int)0,null(),null()),null(),null());
            				}
            			}
            		}
...
void FlxMouse_obj::unload(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","unload",0x5a7132db,"flixel.input.mouse.FlxMouse.unload","flixel/input/mouse/FlxMouse.hx",248,0xe4e80b89)
            	HX_STACK_THIS(this)
HXLINE( 248)		Bool _hx_tmp = hx::IsNotNull( this->_cursor );
HXDLIN( 248)		if (_hx_tmp) {
HXLINE( 250)			Bool _hx_tmp1 = this->cursorContainer->get_visible();
HXDLIN( 250)			if (_hx_tmp1) {
HXLINE( 252)				this->load(null(),null(),null(),null());
            			}
            			else {
HXLINE( 256)				this->_cursor = ( ( ::openfl::display::Bitmap)(::flixel::util::FlxDestroyUtil_obj::removeChild(this->cursorContainer,this->_cursor)) );
            			}
            		}
            	}
...
void FlxMouse_obj::destroy(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","destroy",0x77a13b9e,"flixel.input.mouse.FlxMouse.destroy","flixel/input/mouse/FlxMouse.hx",335,0xe4e80b89)
            	HX_STACK_THIS(this)
HXLINE( 336)		Bool _hx_tmp = hx::IsNotNull( this->_stage );
HXDLIN( 336)		if (_hx_tmp) {
HXLINE( 338)			this->_stage->removeEventListener(HX_("mouseDown",27,b1,c2,ee),this->_leftButton->onDown_dyn(),null());
HXLINE( 339)			this->_stage->removeEventListener(HX_("mouseUp",e0,f3,72,c0),this->_leftButton->onUp_dyn(),null());
HXLINE( 342)			this->_stage->removeEventListener(HX_("middleMouseDown",12,2b,fe,01),this->_middleButton->onDown_dyn(),null());
HXLINE( 343)			this->_stage->removeEventListener(HX_("middleMouseUp",0b,8d,f5,3a),this->_middleButton->onUp_dyn(),null());
HXLINE( 344)			this->_stage->removeEventListener(HX_("rightMouseDown",ab,29,d7,cd),this->_rightButton->onDown_dyn(),null());
HXLINE( 345)			this->_stage->removeEventListener(HX_("rightMouseUp",64,83,21,ab),this->_rightButton->onUp_dyn(),null());
HXLINE( 347)			this->_stage->removeEventListener(HX_("mouseLeave",92,28,20,90),this->onMouseLeave_dyn(),null());
HXLINE( 350)			this->_stage->removeEventListener(HX_("mouseWheel",36,28,87,e7),this->onMouseWheel_dyn(),null());
            		}
...
void FlxMouse_obj::reset(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","reset",0xe595a773,"flixel.input.mouse.FlxMouse.reset","flixel/input/mouse/FlxMouse.hx",374,0xe4e80b89)
            	HX_STACK_THIS(this)
...
void FlxMouse_obj::update(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","update",0x7bea17e5,"flixel.input.mouse.FlxMouse.update","flixel/input/mouse/FlxMouse.hx",423,0xe4e80b89)
            	HX_STACK_THIS(this)
HXLINE( 425)		{
HXLINE( 425)			Float newX = ::flixel::FlxG_obj::game->get_mouseX();
HXDLIN( 425)			Float newY = ::flixel::FlxG_obj::game->get_mouseY();
HXDLIN( 425)			Float _hx_tmp = ((Float)newX / (Float)::flixel::FlxG_obj::scaleMode->scale->x);
HXDLIN( 425)			this->_globalScreenX = ::Std_obj::_hx_int(_hx_tmp);
HXDLIN( 425)			Float _hx_tmp1 = ((Float)newY / (Float)::flixel::FlxG_obj::scaleMode->scale->y);
HXDLIN( 425)			this->_globalScreenY = ::Std_obj::_hx_int(_hx_tmp1);
HXDLIN( 425)			this->updatePositions();
            		}
HXLINE( 428)		Bool _hx_tmp2 = this->visible;
HXDLIN( 428)		if (_hx_tmp2) {
HXLINE( 430)			Float _hx_tmp3 = ::flixel::FlxG_obj::game->get_mouseX();
HXDLIN( 430)			this->cursorContainer->set_x(_hx_tmp3);
HXLINE( 431)			Float _hx_tmp4 = ::flixel::FlxG_obj::game->get_mouseY();
HXDLIN( 431)			this->cursorContainer->set_y(_hx_tmp4);
            		}
HXLINE( 436)		this->_leftButton->update();
HXLINE( 438)		this->_middleButton->update();
HXLINE( 439)		this->_rightButton->update();
HXLINE( 443)		Bool _hx_tmp5 = !(this->_wheelUsed);
...
void FlxMouse_obj::onFocus(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","onFocus",0xede20cdd,"flixel.input.mouse.FlxMouse.onFocus","flixel/input/mouse/FlxMouse.hx",454,0xe4e80b89)
            	HX_STACK_THIS(this)
...
void FlxMouse_obj::onFocusLost(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","onFocusLost",0xc7f71561,"flixel.input.mouse.FlxMouse.onFocusLost","flixel/input/mouse/FlxMouse.hx",468,0xe4e80b89)
            	HX_STACK_THIS(this)
HXLINE( 470)		this->_visibleWhenFocusLost = this->visible;
HXLINE( 472)		Bool _hx_tmp = this->visible;
HXDLIN( 472)		if (_hx_tmp) {
HXLINE( 474)			this->set_visible(false);
            		}
HXLINE( 477)		::openfl::ui::Mouse_obj::show();
            	}
...
void FlxMouse_obj::onGameStart(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","onGameStart",0x61da7695,"flixel.input.mouse.FlxMouse.onGameStart","flixel/input/mouse/FlxMouse.hx",485,0xe4e80b89)
            	HX_STACK_THIS(this)
HXLINE( 485)		this->set_visible(this->visible);
            	}
...
void FlxMouse_obj::onMouseWheel( ::openfl::events::MouseEvent FlashEvent){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","onMouseWheel",0xdc642911,"flixel.input.mouse.FlxMouse.onMouseWheel","flixel/input/mouse/FlxMouse.hx",493,0xe4e80b89)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(FlashEvent,"FlashEvent")
HXLINE( 493)		Bool _hx_tmp = this->enabled;
...
void FlxMouse_obj::onMouseLeave( ::Dynamic _){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","onMouseLeave",0x84fd296d,"flixel.input.mouse.FlxMouse.onMouseLeave","flixel/input/mouse/FlxMouse.hx",506,0xe4e80b89)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(_,"_")
...
Bool FlxMouse_obj::get_pressed(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","get_pressed",0x4652635d,"flixel.input.mouse.FlxMouse.get_pressed","flixel/input/mouse/FlxMouse.hx",512,0xe4e80b89)
            	HX_STACK_THIS(this)
HXLINE( 512)		HX_VARI(  ::flixel::input::mouse::FlxMouseButton,_this) = this->_leftButton;
HXDLIN( 512)		if ((_this->current != (int)1)) {
HXLINE( 512)			return (_this->current == (int)2);
            		}
            		else {
...
Bool FlxMouse_obj::get_justPressed(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","get_justPressed",0x70091811,"flixel.input.mouse.FlxMouse.get_justPressed","flixel/input/mouse/FlxMouse.hx",513,0xe4e80b89)
            	HX_STACK_THIS(this)
HXLINE( 513)		return (this->_leftButton->current == (int)2);
            	}
...
Bool FlxMouse_obj::get_justReleased(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","get_justReleased",0x9ec2046e,"flixel.input.mouse.FlxMouse.get_justReleased","flixel/input/mouse/FlxMouse.hx",514,0xe4e80b89)
            	HX_STACK_THIS(this)
HXLINE( 514)		return (this->_leftButton->current == (int)-1);
            	}
...
Int FlxMouse_obj::get_justPressedTimeInTicks(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","get_justPressedTimeInTicks",0xbe077333,"flixel.input.mouse.FlxMouse.get_justPressedTimeInTicks","flixel/input/mouse/FlxMouse.hx",515,0xe4e80b89)
            	HX_STACK_THIS(this)
HXLINE( 515)		return this->_leftButton->justPressedTimeInTicks;
            	}
...
Bool FlxMouse_obj::get_pressedRight(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","get_pressedRight",0x90e8c73f,"flixel.input.mouse.FlxMouse.get_pressedRight","flixel/input/mouse/FlxMouse.hx",518,0xe4e80b89)
            	HX_STACK_THIS(this)
HXLINE( 518)		HX_VARI(  ::flixel::input::mouse::FlxMouseButton,_this) = this->_rightButton;
HXDLIN( 518)		if ((_this->current != (int)1)) {
HXLINE( 518)			return (_this->current == (int)2);
            		}
            		else {
...
Bool FlxMouse_obj::get_justPressedRight(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","get_justPressedRight",0xa8a2860b,"flixel.input.mouse.FlxMouse.get_justPressedRight","flixel/input/mouse/FlxMouse.hx",519,0xe4e80b89)
            	HX_STACK_THIS(this)
HXLINE( 519)		return (this->_rightButton->current == (int)2);
            	}
...
Bool FlxMouse_obj::get_justReleasedRight(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","get_justReleasedRight",0x8742a88e,"flixel.input.mouse.FlxMouse.get_justReleasedRight","flixel/input/mouse/FlxMouse.hx",520,0xe4e80b89)
            	HX_STACK_THIS(this)
HXLINE( 520)		return (this->_rightButton->current == (int)-1);
            	}
...
Int FlxMouse_obj::get_justPressedTimeInTicksRight(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","get_justPressedTimeInTicksRight",0xf3dc8fa9,"flixel.input.mouse.FlxMouse.get_justPressedTimeInTicksRight","flixel/input/mouse/FlxMouse.hx",521,0xe4e80b89)
            	HX_STACK_THIS(this)
HXLINE( 521)		return this->_rightButton->justPressedTimeInTicks;
            	}
...
Bool FlxMouse_obj::get_pressedMiddle(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","get_pressedMiddle",0x38fe0e92,"flixel.input.mouse.FlxMouse.get_pressedMiddle","flixel/input/mouse/FlxMouse.hx",523,0xe4e80b89)
            	HX_STACK_THIS(this)
HXLINE( 523)		HX_VARI(  ::flixel::input::mouse::FlxMouseButton,_this) = this->_middleButton;
HXDLIN( 523)		if ((_this->current != (int)1)) {
HXLINE( 523)			return (_this->current == (int)2);
            		}
            		else {
...
Bool FlxMouse_obj::get_justPressedMiddle(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","get_justPressedMiddle",0xe3cb4246,"flixel.input.mouse.FlxMouse.get_justPressedMiddle","flixel/input/mouse/FlxMouse.hx",524,0xe4e80b89)
            	HX_STACK_THIS(this)
HXLINE( 524)		return (this->_middleButton->current == (int)2);
            	}
...
Bool FlxMouse_obj::get_justReleasedMiddle(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","get_justReleasedMiddle",0xd1495263,"flixel.input.mouse.FlxMouse.get_justReleasedMiddle","flixel/input/mouse/FlxMouse.hx",525,0xe4e80b89)
            	HX_STACK_THIS(this)
HXLINE( 525)		return (this->_middleButton->current == (int)-1);
            	}
...
Int FlxMouse_obj::get_justPressedTimeInTicksMiddle(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","get_justPressedTimeInTicksMiddle",0x6b59a2e8,"flixel.input.mouse.FlxMouse.get_justPressedTimeInTicksMiddle","flixel/input/mouse/FlxMouse.hx",526,0xe4e80b89)
            	HX_STACK_THIS(this)
HXLINE( 526)		return this->_middleButton->justPressedTimeInTicks;
            	}
...
void FlxMouse_obj::showSystemCursor(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","showSystemCursor",0xf4551c9e,"flixel.input.mouse.FlxMouse.showSystemCursor","flixel/input/mouse/FlxMouse.hx",530,0xe4e80b89)
            	HX_STACK_THIS(this)
HXLINE( 534)		this->cursorContainer->set_visible(false);
HXLINE( 537)		::openfl::ui::Mouse_obj::show();
            	}
...
void FlxMouse_obj::hideSystemCursor(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","hideSystemCursor",0xb5438fe3,"flixel.input.mouse.FlxMouse.hideSystemCursor","flixel/input/mouse/FlxMouse.hx",541,0xe4e80b89)
            	HX_STACK_THIS(this)
HXLINE( 548)		::openfl::ui::Mouse_obj::hide();
HXLINE( 550)		Bool _hx_tmp = this->visible;
...
Bool FlxMouse_obj::set_useSystemCursor(Bool Value){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","set_useSystemCursor",0x074e74d3,"flixel.input.mouse.FlxMouse.set_useSystemCursor","flixel/input/mouse/FlxMouse.hx",558,0xe4e80b89)
            	HX_STACK_THIS(this)
...
void FlxMouse_obj::showCursor(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","showCursor",0xa585e38f,"flixel.input.mouse.FlxMouse.showCursor","flixel/input/mouse/FlxMouse.hx",572,0xe4e80b89)
            	HX_STACK_THIS(this)
HXLINE( 572)		Bool _hx_tmp = this->useSystemCursor;
HXDLIN( 572)		if (_hx_tmp) {
HXLINE( 574)			::openfl::ui::Mouse_obj::show();
            		}
            		else {
HXLINE( 578)			Bool _hx_tmp1 = hx::IsNull( this->_cursor );
HXDLIN( 578)			if (_hx_tmp1) {
HXLINE( 579)				this->load(null(),null(),null(),null());
            			}
HXLINE( 584)			this->cursorContainer->set_visible(true);
HXLINE( 585)			::openfl::ui::Mouse_obj::hide();
            		}
            	}
...
void FlxMouse_obj::hideCursor(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","hideCursor",0xd396e514,"flixel.input.mouse.FlxMouse.hideCursor","flixel/input/mouse/FlxMouse.hx",591,0xe4e80b89)
            	HX_STACK_THIS(this)
HXLINE( 592)		this->cursorContainer->set_visible(false);
HXLINE( 593)		::openfl::ui::Mouse_obj::hide();
            	}
...
Bool FlxMouse_obj::set_visible(Bool Value){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","set_visible",0xb9fd1039,"flixel.input.mouse.FlxMouse.set_visible","flixel/input/mouse/FlxMouse.hx",597,0xe4e80b89)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
HXLINE( 598)		if (Value) {
...
HX_DEFINE_DYNAMIC_FUNC1(FlxMouse_obj,set_visible,return )
 ...
 ::flixel::_hx_system::replay::MouseRecord FlxMouse_obj::record(){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","record",0xf2d1086d,"flixel.input.mouse.FlxMouse.record","flixel/input/mouse/FlxMouse.hx",608,0xe4e80b89)
            	HX_STACK_THIS(this)
...
HXLINE( 619)		return  ::flixel::_hx_system::replay::MouseRecord_obj::__new(this->_lastX,this->_lastY,this->_leftButton->current,this->_lastWheel);
            	}
...
void FlxMouse_obj::playback( ::flixel::_hx_system::replay::MouseRecord Record){
            	HX_STACK_FRAME("flixel.input.mouse.FlxMouse","playback",0xaadcd2f7,"flixel.input.mouse.FlxMouse.playback","flixel/input/mouse/FlxMouse.hx",624,0xe4e80b89)
            	HX_STACK_THIS(this)
...
HXLINE( 631)			this->_stage->dispatchEvent( ::openfl::events::MouseEvent_obj::__new(HX_("mouseUp",e0,f3,72,c0),true,false,Record->x,Record->y,null(),null(),null(),null(),null(),null(),null(),null()));
            		}
