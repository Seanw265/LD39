...
void FlxCallbackPoint_obj::__construct( ::Dynamic setXCallback, ::Dynamic setYCallback, ::Dynamic setXYCallback){
            	HX_STACK_FRAME("flixel.math.FlxCallbackPoint","new",0x2af621df,"flixel.math.FlxCallbackPoint.new","flixel/math/FlxPoint.hx",481,0xb3e1cd2c)
            	HX_STACK_THIS(this)
...
HXLINE( 488)		Bool _hx_tmp = hx::IsNotNull( this->_setXCallback );
HXDLIN( 488)		if (_hx_tmp) {
HXLINE( 490)			Bool _hx_tmp1 = hx::IsNull( this->_setYCallback );
HXDLIN( 490)			if (_hx_tmp1) {
HXLINE( 491)				this->_setYCallback = setXCallback;
            			}
HXLINE( 492)			Bool _hx_tmp2 = hx::IsNull( this->_setXYCallback );
...
Float Y = __o_Y.Default(0);
            	HX_STACK_FRAME("flixel.math.FlxCallbackPoint","set",0x2af9ed21,"flixel.math.FlxCallbackPoint.set","flixel/math/FlxPoint.hx",498,0xb3e1cd2c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(X,"X")
            	HX_STACK_ARG(Y,"Y")
HXLINE( 499)		this->super::set(X,Y);
HXLINE( 500)		Bool _hx_tmp = hx::IsNotNull( this->_setXYCallback );
...
Float FlxCallbackPoint_obj::set_x(Float Value){
            	HX_STACK_FRAME("flixel.math.FlxCallbackPoint","set_x",0x4f288a9a,"flixel.math.FlxCallbackPoint.set_x","flixel/math/FlxPoint.hx",506,0xb3e1cd2c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
HXLINE( 507)		this->super::set_x(Value);
HXLINE( 508)		Bool _hx_tmp = hx::IsNotNull( this->_setXCallback );
...
Float FlxCallbackPoint_obj::set_y(Float Value){
            	HX_STACK_FRAME("flixel.math.FlxCallbackPoint","set_y",0x4f288a9b,"flixel.math.FlxCallbackPoint.set_y","flixel/math/FlxPoint.hx",514,0xb3e1cd2c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
HXLINE( 515)		this->super::set_y(Value);
HXLINE( 516)		Bool _hx_tmp = hx::IsNotNull( this->_setYCallback );
...
void FlxCallbackPoint_obj::destroy(){
            	HX_STACK_FRAME("flixel.math.FlxCallbackPoint","destroy",0xdd08a9f9,"flixel.math.FlxCallbackPoint.destroy","flixel/math/FlxPoint.hx",522,0xb3e1cd2c)
            	HX_STACK_THIS(this)
...
void FlxCallbackPoint_obj::put(){
            	HX_STACK_FRAME("flixel.math.FlxCallbackPoint","put",0x2af7b44e,"flixel.math.FlxCallbackPoint.put","flixel/math/FlxPoint.hx",529,0xb3e1cd2c)
            	HX_STACK_THIS(this)
            	}
