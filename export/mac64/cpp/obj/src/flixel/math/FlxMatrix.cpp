...
Float FlxMatrix_obj::transformX(Float px,Float py){
            	HX_STACK_FRAME("flixel.math.FlxMatrix","transformX",0x33d1359b,"flixel.math.FlxMatrix.transformX","flixel/math/FlxMatrix.hx",78,0x564a249f)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(px,"px")
            	HX_STACK_ARG(py,"py")
HXLINE(  78)		return (((px * this->a) + (py * this->c)) + this->tx);
            	}
...
Float FlxMatrix_obj::transformY(Float px,Float py){
            	HX_STACK_FRAME("flixel.math.FlxMatrix","transformY",0x33d1359c,"flixel.math.FlxMatrix.transformY","flixel/math/FlxMatrix.hx",93,0x564a249f)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(px,"px")
            	HX_STACK_ARG(py,"py")
HXLINE(  93)		return (((px * this->b) + (py * this->d)) + this->ty);
            	}
