...
HXLINE( 222)			FlashPoint =  ::openfl::geom::Point_obj::__new(null(),null());
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxPoint_obj,angleBetween,return )
 ...
 ::flixel::math::FlxVector FlxPoint_obj::toVector(){
            	HX_STACK_FRAME("flixel.math.FlxPoint","toVector",0x99e1901a,"flixel.math.FlxPoint.toVector","flixel/math/FlxPoint.hx",397,0xb3e1cd2c)
            	HX_STACK_THIS(this)
HXLINE( 397)		Float X = this->x;
HXDLIN( 397)		Float Y = this->y;
HXDLIN( 397)		HX_VARI(  ::flixel::math::FlxVector,vector) = Dynamic( ::flixel::math::FlxVector_obj::_pool->get()->set(X,Y)).StaticCast<  ::flixel::math::FlxVector >();
...
Bool FlxPoint_obj::equals( ::flixel::math::FlxPoint point){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(point,"point")
HXLINE( 408)		HX_VAR( Bool,result);
HXDLIN( 408)		Float aValueA = this->x;
HXDLIN( 408)		Float aValueB = point->x;
HXDLIN( 408)		Float _hx_tmp = ::Math_obj::abs((aValueA - aValueB));
HXDLIN( 408)		if ((_hx_tmp <= ((Float)0.0000001))) {
HXLINE( 408)			Float aValueA1 = this->y;
HXDLIN( 408)			Float aValueB1 = point->y;
HXDLIN( 408)			Float _hx_tmp1 = ::Math_obj::abs((aValueA1 - aValueB1));
HXDLIN( 408)			result = (_hx_tmp1 <= ((Float)0.0000001));
            		}
            		else {
HXLINE( 408)			result = false;
            		}
HXLINE( 409)		Bool _hx_tmp2 = point->_weak;
...
void FlxPoint_obj::destroy(){
            	HX_STACK_FRAME("flixel.math.FlxPoint","destroy",0xdae378fe,"flixel.math.FlxPoint.destroy","flixel/math/FlxPoint.hx",416,0xb3e1cd2c)
            	HX_STACK_THIS(this)
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxPoint_obj,destroy,(void))
 ...
 ::flixel::math::FlxPoint FlxPoint_obj::transform( ::openfl::geom::Matrix matrix){
            	HX_STACK_FRAME("flixel.math.FlxPoint","transform",0x46de8270,"flixel.math.FlxPoint.transform","flixel/math/FlxPoint.hx",424,0xb3e1cd2c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(matrix,"matrix")
HXLINE( 425)		HX_VARI( Float,x1) = (((this->x * matrix->a) + (this->y * matrix->c)) + matrix->tx);
HXLINE( 426)		HX_VARI( Float,y1) = (((this->x * matrix->b) + (this->y * matrix->d)) + matrix->ty);
HXLINE( 428)		return this->set(x1,y1);
            	}
...
::String FlxPoint_obj::toString(){
            	HX_STACK_FRAME("flixel.math.FlxPoint","toString",0x13b40828,"flixel.math.FlxPoint.toString","flixel/math/FlxPoint.hx",436,0xb3e1cd2c)
            	HX_STACK_THIS(this)
HXLINE( 437)		 ::Dynamic value = this->x;
HXDLIN( 437)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 437)		_this->label = HX_("x",78,00,00,00);
HXDLIN( 437)		_this->value = value;
HXLINE( 438)		 ::Dynamic value1 = this->y;
HXDLIN( 438)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 438)		_this1->label = HX_("y",79,00,00,00);
HXDLIN( 438)		_this1->value = value1;
HXLINE( 436)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(2)->init(0,_this)->init(1,_this1));
            	}
...
Float FlxPoint_obj::set_x(Float Value){
            	HX_STACK_FRAME("flixel.math.FlxPoint","set_x",0x1a631e5f,"flixel.math.FlxPoint.set_x","flixel/math/FlxPoint.hx",446,0xb3e1cd2c)
            	HX_STACK_THIS(this)
...
Float FlxPoint_obj::set_y(Float Value){
            	HX_STACK_FRAME("flixel.math.FlxPoint","set_y",0x1a631e60,"flixel.math.FlxPoint.set_y","flixel/math/FlxPoint.hx",454,0xb3e1cd2c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
...
::Dynamic FlxPoint_obj::get_pool(){
            	HX_STACK_FRAME("flixel.math.FlxPoint","get_pool",0xa55c73e1,"flixel.math.FlxPoint.get_pool","flixel/math/FlxPoint.hx",459,0xb3e1cd2c)
