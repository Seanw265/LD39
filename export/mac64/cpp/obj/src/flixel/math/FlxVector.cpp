...
HXDLIN( 240)		return (_hx_tmp1 < ((Float)9.99999999999999841e-15));
            	}
...
HXDLIN( 386)		if ((_hx_tmp1 < ((Float)9.99999999999999841e-15))) {
...
HXLINE( 387)			_hx_tmp2 = (((v->x * v->x) + (v->y * v->y)) < ((Float)9.99999999999999841e-15));
            		}
            		else {
