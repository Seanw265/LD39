...
void FlxBGSprite_obj::draw(){
            	HX_STACK_FRAME("flixel.system.FlxBGSprite","draw",0x1cf08403,"flixel.system.FlxBGSprite.draw","flixel/system/FlxBGSprite.hx",23,0xa9844f6f)
            	HX_STACK_THIS(this)
HXLINE(  23)		HX_VARI( Int,_g) = (int)0;
HXDLIN(  23)		HX_VARI( ::Array< ::Dynamic>,_g1) = this->get_cameras();
HXDLIN(  23)		while((_g < _g1->length)){
HXLINE(  23)			HX_VARI(  ::flixel::FlxCamera,camera) = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN(  23)			++_g;
