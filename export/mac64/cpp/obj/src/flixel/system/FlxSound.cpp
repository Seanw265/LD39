...
HXLINE( 227)			this->_channel->removeEventListener(HX_("soundComplete",a8,30,e6,1c),this->stopped_dyn(),null());
...
HXLINE( 234)			this->_sound->removeEventListener(HX_("id3",f8,03,50,00),this->gotID3_dyn(),null());
...
HXLINE( 275)			this->amplitudeLeft = ((Float)this->_channel->leftPeak / (Float)this->_transform->volume);
HXLINE( 276)			this->amplitudeRight = ((Float)this->_channel->rightPeak / (Float)this->_transform->volume);
HXLINE( 277)			Float _hx_tmp7 = (this->amplitudeLeft + this->amplitudeRight);
HXDLIN( 277)			this->amplitude = (_hx_tmp7 * ((Float)0.5));
            		}
            		else {
...
HXDLIN( 286)		Bool _hx_tmp9 = hx::IsNotNull( this->endTime );
HXDLIN( 286)		if (_hx_tmp9) {
HXLINE( 286)			_hx_tmp8 = hx::IsGreaterEq( this->_time,this->endTime );
            		}
            		else {
...
HXLINE( 312)		Bool _hx_tmp1 = ::Std_obj::is(EmbeddedSound,hx::ClassOf< ::openfl::media::Sound >());
...
HXLINE( 318)				this->_sound = ( ( ::openfl::media::Sound)(::Type_obj::createInstance(EmbeddedSound,::cpp::VirtualArray_obj::__new(0))) );
            			}
            			else {
HXLINE( 320)				Bool _hx_tmp3 = ::Std_obj::is(EmbeddedSound,hx::ClassOf< ::String >());
HXDLIN( 320)				if (_hx_tmp3) {
HXLINE( 322)					Bool _hx_tmp4;
HXDLIN( 322)					Bool _hx_tmp5 = !(::openfl::Assets_obj::exists(EmbeddedSound,HX_("SOUND",af,c4,ba,fe)));
HXDLIN( 322)					if (_hx_tmp5) {
HXLINE( 322)						_hx_tmp4 = ::openfl::Assets_obj::exists(EmbeddedSound,HX_("MUSIC",85,08,49,8e));
            					}
            					else {
HXLINE( 322)						_hx_tmp4 = true;
            					}
HXDLIN( 322)					if (_hx_tmp4) {
HXLINE( 324)						this->_sound = ::openfl::Assets_obj::getSound(EmbeddedSound,null());
            					}
            				}
            			}
            		}
...
HXLINE( 346)		this->_sound =  ::openfl::media::Sound_obj::__new(null(),null());
HXLINE( 347)		this->_sound->addEventListener(HX_("id3",f8,03,50,00),this->gotID3_dyn(),null(),null(),null());
HXLINE( 348)		this->_sound->load( ::openfl::net::URLRequest_obj::__new(SoundURL),null());
...
HXLINE( 566)			this->_channel->addEventListener(HX_("soundComplete",a8,30,e6,1c),this->stopped_dyn(),null(),null(),null());
...
HXLINE( 613)			this->_channel->removeEventListener(HX_("soundComplete",a8,30,e6,1c),this->stopped_dyn(),null());
...
HXLINE( 634)		this->_sound->removeEventListener(HX_("id3",f8,03,50,00),this->gotID3_dyn(),null());
            	}
