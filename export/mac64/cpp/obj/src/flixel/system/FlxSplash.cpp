...
HXLINE(  60)		this->_sprite =  ::openfl::display::Sprite_obj::__new();
HXLINE(  61)		::openfl::Lib_obj::current->stage->addChild(this->_sprite);
HXLINE(  62)		this->_gfx = this->_sprite->get_graphics();
HXLINE(  64)		this->_text =  ::openfl::text::TextField_obj::__new();
HXLINE(  65)		this->_text->set_selectable(false);
HXLINE(  66)		this->_text->set_embedFonts(true);
HXLINE(  67)		HX_VARI(  ::openfl::text::TextFormat,dtf) =  ::openfl::text::TextFormat_obj::__new(::flixel::_hx_system::FlxAssets_obj::FONT_DEFAULT,(int)16,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
...
HXLINE(  76)		 ::openfl::media::Sound _hx_tmp = ::openfl::Assets_obj::getSound((HX_("flixel/sounds/flixel",54,41,d6,5d) + HX_(".ogg",e1,64,bc,1e)),null());
