...
void VirtualInputData_obj::__construct( ::Dynamic __o_length){
 ::Dynamic length = __o_length.Default(0);
            	HX_STACK_FRAME("flixel.system.VirtualInputData","new",0x4566b028,"flixel.system.VirtualInputData.new","lime/Assets.hx",1201,0x48c77341)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(length,"length")
HXLINE(1203)		super::__construct(null());
HXLINE(1205)		HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::Resource_obj::getBytes(::flixel::_hx_system::VirtualInputData_obj::resourceName);
HXLINE(1206)		this->_hx___fromBytes(bytes);
            	}
...
{
{
            	HX_STACK_FRAME("flixel.system.VirtualInputData","boot",0x6c8c736a,"flixel.system.VirtualInputData.boot","openfl/utils/ByteArray.hx",226,0xaa5cee4a)
HXLINE( 226)		resourceName = HX_("__ASSET__:file_flixel_system_VirtualInputData",cf,a9,c1,46);
            	}
}
