...
void GraphicLogoLight_obj::__construct(Int width,Int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACK_FRAME("flixel.system._FlxPreloader.GraphicLogoLight","new",0xeb15e96d,"flixel.system._FlxPreloader.GraphicLogoLight.new","openfl/Assets.hx",1176,0x989d477c)
            	HX_STACK_THIS(this)
...
HXLINE(1213)		 ::haxe::io::Bytes _hx_tmp = ::haxe::Resource_obj::getBytes(::flixel::_hx_system::_FlxPreloader::GraphicLogoLight_obj::resourceName);
...
HXLINE(1214)		{
            			...
            			void _hx_run( ::lime::graphics::Image image){
            				HX_STACK_FRAME("flixel.system._FlxPreloader.GraphicLogoLight","new",0xeb15e96d,"flixel.system._FlxPreloader.GraphicLogoLight.new","openfl/Assets.hx",1214,0x989d477c)
...
{
{
            	HX_STACK_FRAME("flixel.system._FlxPreloader.GraphicLogoLight","boot",0xc02f5685,"flixel.system._FlxPreloader.GraphicLogoLight.boot","openfl/display/BitmapData.hx",59,0xdd12d5b9)
HXLINE(  59)		resourceName = HX_("__ASSET__:bitmap_flixel_system__FlxPreloader_GraphicLogoLight",b2,b0,e9,d2);
            	}
}
