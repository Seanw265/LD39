...
HXLINE(  19)		return ( ( ::openfl::text::TextField)(::flixel::_hx_system::debug::DebuggerUtil_obj::initTextField( ::openfl::text::TextField_obj::__new(),X,Y,Color,Size)) );
            	}
...
Int Size = __o_Size.Default(12);
            	...
            	HX_STACK_ARG(Color,"Color")
            	HX_STACK_ARG(Size,"Size")
HXLINE(  24)		( ( ::openfl::display::DisplayObject)(tf) )->set_x(X);
HXLINE(  25)		( ( ::openfl::display::DisplayObject)(tf) )->set_y(Y);
...
HXLINE(  34)		( ( ::openfl::text::TextField)(tf) )->set_defaultTextFormat( ::openfl::text::TextFormat_obj::__new(::flixel::_hx_system::FlxAssets_obj::FONT_DEBUGGER,Size,((int)Color & (int)(int)16777215),null(),null(),null(),null(),null(),null(),null(),null(),null(),null()));
