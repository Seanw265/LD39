...
HXLINE(  63)		this->restartBtn = Debugger->addButton(::flixel::util::FlxHorizontalAlign_obj::CENTER_dyn(), ::flixel::_hx_system::debug::_VCR::GraphicRestart_obj::__new((int)0,(int)0,null(),null()),::flixel::FlxG_obj::resetState_dyn(),null(),null());
HXLINE(  72)		this->playbackToggleBtn = Debugger->addButton(::flixel::util::FlxHorizontalAlign_obj::CENTER_dyn(), ::flixel::_hx_system::debug::_VCR::GraphicPause_obj::__new((int)0,(int)0,null(),null()),this->onManualPause_dyn(),null(),null());
HXLINE(  73)		this->stepBtn = Debugger->addButton(::flixel::util::FlxHorizontalAlign_obj::CENTER_dyn(), ::flixel::_hx_system::debug::_VCR::GraphicStep_obj::__new((int)0,(int)0,null(),null()),this->onStep_dyn(),null(),null());
            	}
...
void VCR_obj::onManualPause(){
            	HX_STACK_FRAME("flixel.system.debug.VCR","onManualPause",0x2a392cc0,"flixel.system.debug.VCR.onManualPause","flixel/system/debug/VCR.hx",140,0x4ecb3ec2)
            	HX_STACK_THIS(this)
...
void VCR_obj::onPause(){
            	HX_STACK_FRAME("flixel.system.debug.VCR","onPause",0xf9cf54e6,"flixel.system.debug.VCR.onPause","flixel/system/debug/VCR.hx",151,0x4ecb3ec2)
            	HX_STACK_THIS(this)
HXLINE( 152)		this->playbackToggleBtn->upHandler = ::flixel::FlxG_obj::vcr->resume_dyn();
HXLINE( 153)		this->playbackToggleBtn->changeIcon( ::flixel::_hx_system::debug::GraphicArrowRight_obj::__new((int)0,(int)0,null(),null()));
            	}
...
void VCR_obj::onResume(){
            	HX_STACK_FRAME("flixel.system.debug.VCR","onResume",0xb49b1dbd,"flixel.system.debug.VCR.onResume","flixel/system/debug/VCR.hx",161,0x4ecb3ec2)
            	HX_STACK_THIS(this)
HXLINE( 162)		this->manualPause = false;
HXLINE( 163)		this->playbackToggleBtn->upHandler = this->onManualPause_dyn();
HXLINE( 164)		this->playbackToggleBtn->changeIcon( ::flixel::_hx_system::debug::_VCR::GraphicPause_obj::__new((int)0,(int)0,null(),null()));
            	}
...
void VCR_obj::onStep(){
            	HX_STACK_FRAME("flixel.system.debug.VCR","onStep",0x2da2775c,"flixel.system.debug.VCR.onStep","flixel/system/debug/VCR.hx",172,0x4ecb3ec2)
            	HX_STACK_THIS(this)
