...
HXLINE( 100)		this->minSize =  ::openfl::geom::Point_obj::__new((int)50,(int)30);
...
HXLINE( 105)		this->_drag =  ::openfl::geom::Point_obj::__new(null(),null());
HXLINE( 106)		this->_resizable = Resizable;
HXLINE( 107)		this->_closable = Closable;
HXLINE( 109)		this->_shadow =  ::openfl::display::Bitmap_obj::__new( ::openfl::display::BitmapData_obj::__new((int)1,(int)2,true,(int)-16777216),null(),null());
HXLINE( 110)		this->_background =  ::openfl::display::Bitmap_obj::__new( ::openfl::display::BitmapData_obj::__new((int)1,(int)1,true,(int)-580952225),null(),null());
HXLINE( 111)		this->_header =  ::openfl::display::Bitmap_obj::__new( ::openfl::display::BitmapData_obj::__new((int)1,(int)15,true,(int)-1157627904),null(),null());
...
HXLINE( 126)			HX_VARI(  ::openfl::display::Bitmap,icon) =  ::openfl::display::Bitmap_obj::__new(Icon,null(),null());
...
HXLINE( 136)			 ::openfl::display::BitmapData _hx_tmp7 = ::flixel::_hx_system::debug::DebuggerUtil_obj::fixSize( ::flixel::_hx_system::debug::_Window::GraphicWindowHandle_obj::__new((int)0,(int)0,null(),null()));
HXDLIN( 136)			this->_handle =  ::openfl::display::Bitmap_obj::__new(_hx_tmp7,null(),null());
...
HXLINE( 244)			this->maxSize =  ::openfl::geom::Point_obj::__new(this->_bounds->width,this->_bounds->height);
            		}
            		else {
HXLINE( 248)			this->maxSize =  ::openfl::geom::Point_obj::__new(((Float)1.79e+308),((Float)1.79e+308));
            		}
            	}
...
void Window_obj::init( ::openfl::events::Event E){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(E,"E")
HXLINE( 315)		Bool _hx_tmp = hx::IsNull( this->stage );
...
HXLINE( 338)		Bool _hx_tmp2 = !(this->parent->get_visible());
...
HXLINE( 347)			Float _hx_tmp4 = this->parent->get_mouseX();
HXDLIN( 347)			Float _hx_tmp5 = (_hx_tmp4 - this->_drag->x);
HXDLIN( 347)			Float _hx_tmp6 = this->parent->get_mouseY();
...
void Window_obj::bound(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 403)		Bool _hx_tmp = hx::IsNotNull( this->_bounds );
HXDLIN( 403)		if (_hx_tmp) {
HXLINE( 405)			HX_VARI( Float,Value) = this->get_x();
HXDLIN( 405)			HX_VARI(  ::Dynamic,Min) = this->_bounds->get_left();
HXDLIN( 405)			Float _hx_tmp1 = this->_bounds->get_right();
HXDLIN( 405)			HX_VARI(  ::Dynamic,Max) = (_hx_tmp1 - this->_width);
HXDLIN( 405)			HX_VAR( Float,lowerBound);
HXDLIN( 405)			Bool _hx_tmp2;
HXDLIN( 405)			Bool _hx_tmp3 = hx::IsNotNull( Min );
HXDLIN( 405)			if (_hx_tmp3) {
HXLINE( 405)				_hx_tmp2 = hx::IsLess( Value,Min );
            			}
            			else {
...
HXDLIN( 405)			Float _hx_tmp4;
HXDLIN( 405)			Bool _hx_tmp5;
HXDLIN( 405)			Bool _hx_tmp6 = hx::IsNotNull( Max );
HXDLIN( 405)			if (_hx_tmp6) {
HXLINE( 405)				_hx_tmp5 = hx::IsGreater( lowerBound,Max );
            			}
            			else {
HXLINE( 405)				_hx_tmp5 = false;
            			}
HXDLIN( 405)			if (_hx_tmp5) {
HXLINE( 405)				_hx_tmp4 = Max;
            			}
            			else {
HXLINE( 405)				_hx_tmp4 = lowerBound;
            			}
HXDLIN( 405)			this->set_x(_hx_tmp4);
HXLINE( 406)			HX_VARI_NAME( Float,Value1,"Value") = this->get_y();
HXDLIN( 406)			HX_VARI_NAME(  ::Dynamic,Min1,"Min") = this->_bounds->get_top();
HXDLIN( 406)			Float _hx_tmp7 = this->_bounds->get_bottom();
HXDLIN( 406)			HX_VARI_NAME(  ::Dynamic,Max1,"Max") = (_hx_tmp7 - this->_height);
HXDLIN( 406)			HX_VAR_NAME( Float,lowerBound1,"lowerBound");
HXDLIN( 406)			Bool _hx_tmp8;
HXDLIN( 406)			Bool _hx_tmp9 = hx::IsNotNull( Min1 );
HXDLIN( 406)			if (_hx_tmp9) {
HXLINE( 406)				_hx_tmp8 = hx::IsLess( Value1,Min1 );
            			}
            			else {
HXLINE( 406)				_hx_tmp8 = false;
            			}
HXDLIN( 406)			if (_hx_tmp8) {
HXLINE( 406)				lowerBound1 = Min1;
            			}
            			else {
HXLINE( 406)				lowerBound1 = Value1;
            			}
HXDLIN( 406)			Float _hx_tmp10;
HXDLIN( 406)			Bool _hx_tmp11;
HXDLIN( 406)			Bool _hx_tmp12 = hx::IsNotNull( Max1 );
HXDLIN( 406)			if (_hx_tmp12) {
HXLINE( 406)				_hx_tmp11 = hx::IsGreater( lowerBound1,Max1 );
            			}
            			else {
HXLINE( 406)				_hx_tmp11 = false;
            			}
HXDLIN( 406)			if (_hx_tmp11) {
HXLINE( 406)				_hx_tmp10 = Max1;
            			}
            			else {
HXLINE( 406)				_hx_tmp10 = lowerBound1;
            			}
HXDLIN( 406)			this->set_y(_hx_tmp10);
            		}
            	}
...
void Window_obj::updateSize(){
            	HX_STACK_FRAME("flixel.system.debug.Window","updateSize",0x6f89a180,"flixel.system.debug.Window.updateSize","flixel/system/debug/Window.hx",414,0xb8dfd4e5)
            	HX_STACK_THIS(this)
HXLINE( 415)		HX_VARI( Float,Value) = this->_width;
HXDLIN( 415)		HX_VARI(  ::Dynamic,Min) = this->minSize->x;
HXDLIN( 415)		HX_VARI(  ::Dynamic,Max) = this->maxSize->x;
HXDLIN( 415)		HX_VAR( Float,lowerBound);
HXDLIN( 415)		Bool _hx_tmp;
HXDLIN( 415)		Bool _hx_tmp1 = hx::IsNotNull( Min );
HXDLIN( 415)		if (_hx_tmp1) {
HXLINE( 415)			_hx_tmp = hx::IsLess( Value,Min );
            		}
            		else {
...
HXDLIN( 415)		Bool _hx_tmp4 = hx::IsNotNull( Max );
HXDLIN( 415)		if (_hx_tmp4) {
HXLINE( 415)			_hx_tmp3 = hx::IsGreater( lowerBound,Max );
            		}
            		else {
HXLINE( 415)			_hx_tmp3 = false;
            		}
HXDLIN( 415)		if (_hx_tmp3) {
HXLINE( 415)			_hx_tmp2 = Max;
            		}
            		else {
HXLINE( 415)			_hx_tmp2 = lowerBound;
            		}
HXDLIN( 415)		this->_width = ::Std_obj::_hx_int(_hx_tmp2);
HXLINE( 416)		HX_VARI_NAME( Float,Value1,"Value") = this->_height;
HXDLIN( 416)		HX_VARI_NAME(  ::Dynamic,Min1,"Min") = this->minSize->y;
HXDLIN( 416)		HX_VARI_NAME(  ::Dynamic,Max1,"Max") = this->maxSize->y;
HXDLIN( 416)		HX_VAR_NAME( Float,lowerBound1,"lowerBound");
HXDLIN( 416)		Bool _hx_tmp5;
HXDLIN( 416)		Bool _hx_tmp6 = hx::IsNotNull( Min1 );
HXDLIN( 416)		if (_hx_tmp6) {
HXLINE( 416)			_hx_tmp5 = hx::IsLess( Value1,Min1 );
            		}
            		else {
HXLINE( 416)			_hx_tmp5 = false;
            		}
HXDLIN( 416)		if (_hx_tmp5) {
HXLINE( 416)			lowerBound1 = Min1;
            		}
            		else {
HXLINE( 416)			lowerBound1 = Value1;
            		}
HXDLIN( 416)		Float _hx_tmp7;
HXDLIN( 416)		Bool _hx_tmp8;
HXDLIN( 416)		Bool _hx_tmp9 = hx::IsNotNull( Max1 );
HXDLIN( 416)		if (_hx_tmp9) {
HXLINE( 416)			_hx_tmp8 = hx::IsGreater( lowerBound1,Max1 );
            		}
            		else {
HXLINE( 416)			_hx_tmp8 = false;
            		}
HXDLIN( 416)		if (_hx_tmp8) {
HXLINE( 416)			_hx_tmp7 = Max1;
            		}
            		else {
HXLINE( 416)			_hx_tmp7 = lowerBound1;
            		}
HXDLIN( 416)		this->_height = ::Std_obj::_hx_int(_hx_tmp7);
HXLINE( 418)		this->_header->set_scaleX(this->_width);
HXLINE( 419)		this->_background->set_scaleX(this->_width);
HXLINE( 420)		Int _hx_tmp10 = this->_height;
HXDLIN( 420)		Float _hx_tmp11 = this->_header->get_height();
HXDLIN( 420)		this->_background->set_scaleY((_hx_tmp10 - _hx_tmp11));
HXLINE( 421)		this->_shadow->set_scaleX(this->_width);
HXLINE( 422)		this->_shadow->set_y(this->_height);
HXLINE( 423)		Int _hx_tmp12 = (this->_width - (int)4);
HXDLIN( 423)		this->_title->set_width(_hx_tmp12);
HXLINE( 424)		Bool _hx_tmp13 = this->_resizable;
HXDLIN( 424)		if (_hx_tmp13) {
HXLINE( 426)			Int _hx_tmp14 = this->_width;
HXDLIN( 426)			Float _hx_tmp15 = this->_handle->get_width();
HXDLIN( 426)			this->_handle->set_x((_hx_tmp14 - _hx_tmp15));
HXLINE( 427)			Int _hx_tmp16 = this->_height;
HXDLIN( 427)			Float _hx_tmp17 = this->_handle->get_height();
HXDLIN( 427)			this->_handle->set_y((_hx_tmp16 - _hx_tmp17));
            		}
HXLINE( 429)		Bool _hx_tmp18 = hx::IsNotNull( this->_closeButton );
HXDLIN( 429)		if (_hx_tmp18) {
HXLINE( 431)			Int _hx_tmp19 = this->_width;
HXDLIN( 431)			Float _hx_tmp20 = this->_closeButton->get_width();
HXDLIN( 431)			this->_closeButton->set_x(((_hx_tmp19 - _hx_tmp20) - (int)3));
