...
void GraphicRecordOn_obj::__construct(Int width,Int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACK_FRAME("flixel.system.debug._VCR.GraphicRecordOn","new",0x07d5634a,"flixel.system.debug._VCR.GraphicRecordOn.new","openfl/Assets.hx",1176,0x989d477c)
            	HX_STACK_THIS(this)
...
HXLINE(1213)		 ::haxe::io::Bytes _hx_tmp = ::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::_VCR::GraphicRecordOn_obj::resourceName);
...
HXLINE(1214)		{
            			...
            			void _hx_run( ::lime::graphics::Image image){
            				HX_STACK_FRAME("flixel.system.debug._VCR.GraphicRecordOn","new",0x07d5634a,"flixel.system.debug._VCR.GraphicRecordOn.new","openfl/Assets.hx",1214,0x989d477c)
...
{
{
            	HX_STACK_FRAME("flixel.system.debug._VCR.GraphicRecordOn","boot",0xcafa7e08,"flixel.system.debug._VCR.GraphicRecordOn.boot","openfl/display/BitmapData.hx",59,0xdd12d5b9)
HXLINE(  59)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug__VCR_GraphicRecordOn",7e,48,e5,2b);
            	}
}
