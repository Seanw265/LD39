...
HXLINE(  32)		 ::openfl::display::Bitmap _hx_tmp = (this->background =  ::openfl::display::Bitmap_obj::__new(null(),null(),null()));
HXDLIN(  32)		this->addChild(_hx_tmp);
HXLINE(  33)		this->background->bitmapData = ::flixel::_hx_system::debug::completion::CompletionListEntry_obj::normalBitmapData;
...
HXLINE(  43)			::flixel::_hx_system::debug::completion::CompletionListEntry_obj::normalBitmapData =  ::openfl::display::BitmapData_obj::__new((int)150,(int)20,true,(int)-10526881);
            		}
...
HXLINE(  45)			::flixel::_hx_system::debug::completion::CompletionListEntry_obj::highlightBitmapData =  ::openfl::display::BitmapData_obj::__new((int)150,(int)20,true,(int)-9605779);
            		}
            	}
...
HXDLIN(  63)		this->background->bitmapData = _hx_tmp;
