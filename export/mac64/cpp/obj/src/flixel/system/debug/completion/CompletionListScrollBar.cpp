...
HXLINE(  22)		this->addChild( ::openfl::display::Bitmap_obj::__new( ::openfl::display::BitmapData_obj::__new(width,height,true,(int)-12303292),null(),null()));
HXLINE(  23)		this->handle =  ::openfl::display::Bitmap_obj::__new( ::openfl::display::BitmapData_obj::__new(width,(int)1,true,(int)-14540254),null(),null());
