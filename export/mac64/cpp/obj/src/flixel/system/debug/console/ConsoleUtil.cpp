...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ConsoleUtil_obj,runCommand,return )
 ...
 ::Dynamic ConsoleUtil_obj::runExpr(::hx::EnumBase expr){
            	HX_STACK_FRAME("flixel.system.debug.console.ConsoleUtil","runExpr",0x4a0f2d6c,"flixel.system.debug.console.ConsoleUtil.runExpr","flixel/system/debug/console/ConsoleUtil.hx",72,0x2e8bcde6)
...
void ConsoleUtil_obj::registerObject(::String ObjectAlias, ::Dynamic AnyObject){
            	HX_STACK_FRAME("flixel.system.debug.console.ConsoleUtil","registerObject",0x0d502bb6,"flixel.system.debug.console.ConsoleUtil.registerObject","flixel/system/debug/console/ConsoleUtil.hx",83,0x2e8bcde6)
            	HX_STACK_ARG(ObjectAlias,"ObjectAlias")
            	HX_STACK_ARG(AnyObject,"AnyObject")
HXLINE(  83)		Bool _hx_tmp;
HXDLIN(  83)		Bool _hx_tmp1 = hx::IsNotNull( AnyObject );
...
void ConsoleUtil_obj::registerFunction(::String FunctionAlias, ::Dynamic Function){
            	HX_STACK_FRAME("flixel.system.debug.console.ConsoleUtil","registerFunction",0xb3a1c3cf,"flixel.system.debug.console.ConsoleUtil.registerFunction","flixel/system/debug/console/ConsoleUtil.hx",95,0x2e8bcde6)
            	HX_STACK_ARG(FunctionAlias,"FunctionAlias")
            	HX_STACK_ARG(Function,"Function")
HXLINE(  95)		Bool _hx_tmp = ::Reflect_obj::isFunction(Function);
...
::Array< ::String > ConsoleUtil_obj::getFields( ::Dynamic Object){
            	HX_STACK_FRAME("flixel.system.debug.console.ConsoleUtil","getFields",0x604f9dfb,"flixel.system.debug.console.ConsoleUtil.getFields","flixel/system/debug/console/ConsoleUtil.hx",101,0x2e8bcde6)
            	HX_STACK_ARG(Object,"Object")
HXLINE( 102)		HX_VARI( ::Array< ::String >,fields) = ::Array_obj< ::String >::__new(0);
HXLINE( 103)		Bool _hx_tmp = ::Std_obj::is(Object,hx::ClassOf< ::hx::Class >());
HXDLIN( 103)		if (_hx_tmp) {
HXLINE( 104)			fields = ::Type_obj::getClassFields(Object);
            		}
            		else {
HXLINE( 105)			Bool _hx_tmp1 = ::Reflect_obj::isObject(Object);
HXDLIN( 105)			if (_hx_tmp1) {
HXLINE( 106)				hx::Class _hx_tmp2 = ::Type_obj::getClass(Object);
HXDLIN( 106)				fields = ::Type_obj::getInstanceFields(_hx_tmp2);
            			}
            		}
HXLINE( 108)		HX_VARI( ::Array< ::String >,filteredFields) = ::Array_obj< ::String >::__new(0);
HXLINE( 109)		{
HXLINE( 109)			HX_VARI( Int,_g) = (int)0;
HXDLIN( 109)			while((_g < fields->length)){
HXLINE( 109)				HX_VARI( ::String,field) = fields->__get(_g);
HXDLIN( 109)				++_g;
HXLINE( 112)				Bool _hx_tmp3;
HXDLIN( 112)				Bool _hx_tmp4 = !(::StringTools_obj::startsWith(field,HX_("get_",09,03,62,44)));
HXDLIN( 112)				if (_hx_tmp4) {
HXLINE( 112)					_hx_tmp3 = ::StringTools_obj::startsWith(field,HX_("set_",7d,92,50,4c));
            				}
            				else {
HXLINE( 112)					_hx_tmp3 = true;
            				}
HXDLIN( 112)				if (_hx_tmp3) {
HXLINE( 114)					HX_VARI( ::String,name) = field.substr((int)4,null());
HXLINE( 116)					Bool _hx_tmp5;
HXDLIN( 116)					Int _hx_tmp6 = fields->indexOf(name,null());
HXDLIN( 116)					if ((_hx_tmp6 == (int)-1)) {
HXLINE( 116)						Int _hx_tmp7 = filteredFields->indexOf(name,null());
HXDLIN( 116)						_hx_tmp5 = (_hx_tmp7 == (int)-1);
            					}
            					else {
...
::Array< ::String > ConsoleUtil_obj::sortFields(::Array< ::String > fields){
            		...
            		Bool _hx_run(::String field){
            			HX_STACK_FRAME("flixel.system.debug.console.ConsoleUtil","sortFields",0x773f00ab,"flixel.system.debug.console.ConsoleUtil.sortFields","flixel/system/debug/console/ConsoleUtil.hx",131,0x2e8bcde6)
            			HX_STACK_ARG(field,"field")
HXLINE( 132)			Bool _hx_tmp = ::StringTools_obj::startsWith(field,HX_("_",5f,00,00,00));
...
HXLINE( 137)			return true;
            	...
            	HX_STACK_FRAME("flixel.system.debug.console.ConsoleUtil","sortFields",0x773f00ab,"flixel.system.debug.console.ConsoleUtil.sortFields","flixel/system/debug/console/ConsoleUtil.hx",127,0x2e8bcde6)
            	HX_STACK_ARG(fields,"fields")
HXLINE( 128)		HX_VARI( ::Array< ::String >,underscoreList) = ::Array_obj< ::String >::__new(0);
...
void ConsoleUtil_obj::log( ::Dynamic Text){
            	HX_STACK_FRAME("flixel.system.debug.console.ConsoleUtil","log",0x2bebd9d0,"flixel.system.debug.console.ConsoleUtil.log","flixel/system/debug/console/ConsoleUtil.hx",153,0x2e8bcde6)
            	HX_STACK_ARG(Text,"Text")
HXLINE( 153)		::flixel::FlxG_obj::log->advanced(::cpp::VirtualArray_obj::__new(1)->init(0,Text),::flixel::_hx_system::debug::log::LogStyle_obj::CONSOLE,null());
            	}
