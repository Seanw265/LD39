...
void GraphicMoverTool_obj::__construct(Int width,Int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACK_FRAME("flixel.system.debug.interaction.tools.GraphicMoverTool","new",0x5d2174da,"flixel.system.debug.interaction.tools.GraphicMoverTool.new","openfl/Assets.hx",1176,0x989d477c)
            	HX_STACK_THIS(this)
...
HXLINE(1213)		 ::haxe::io::Bytes _hx_tmp = ::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::interaction::tools::GraphicMoverTool_obj::resourceName);
...
HXLINE(1214)		{
            			...
            			void _hx_run( ::lime::graphics::Image image){
            				HX_STACK_FRAME("flixel.system.debug.interaction.tools.GraphicMoverTool","new",0x5d2174da,"flixel.system.debug.interaction.tools.GraphicMoverTool.new","openfl/Assets.hx",1214,0x989d477c)
...
{
{
            	HX_STACK_FRAME("flixel.system.debug.interaction.tools.GraphicMoverTool","boot",0x183dca78,"flixel.system.debug.interaction.tools.GraphicMoverTool.boot","openfl/display/BitmapData.hx",59,0xdd12d5b9)
HXLINE(  59)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_interaction_tools_GraphicMoverTool",81,a4,f3,1e);
            	}
}
