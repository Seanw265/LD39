...
void Pointer_obj::__construct(){
            	HX_STACK_FRAME("flixel.system.debug.interaction.tools.Pointer","new",0x18297018,"flixel.system.debug.interaction.tools.Pointer.new","flixel/system/debug/interaction/tools/Pointer.hx",21,0x6c93613b)
            	HX_STACK_THIS(this)
HXLINE(  28)		this->_itemsInSelectionArea = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  27)		this->_selectionArea =  ::flixel::math::FlxRect_obj::__new(null(),null(),null(),null());
HXLINE(  26)		this->_selectionCancelled = false;
HXLINE(  25)		this->_selectionHappening = false;
HXLINE(  24)		this->_selectionEndPoint =  ::flixel::math::FlxPoint_obj::__new(null(),null());
HXLINE(  23)		this->_selectionStartPoint =  ::flixel::math::FlxPoint_obj::__new(null(),null());
...
Dynamic Pointer_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::flixel::_hx_system::debug::interaction::tools::Tool Pointer_obj::init( ::flixel::_hx_system::debug::interaction::Interaction brain){
            	HX_STACK_FRAME("flixel.system.debug.interaction.tools.Pointer","init",0x08d15c58,"flixel.system.debug.interaction.tools.Pointer.init","flixel/system/debug/interaction/tools/Pointer.hx",31,0x6c93613b)
            	HX_STACK_THIS(this)
...
HXLINE(  36)		this->setCursor( ::flixel::_hx_system::debug::interaction::tools::GraphicCursorCross_obj::__new((int)0,(int)0,null(),null()));
HXLINE(  38)		return hx::ObjectPtr<OBJ_>(this);
            	}


void Pointer_obj::update(){
            	HX_STACK_FRAME("flixel.system.debug.interaction.tools.Pointer","update",0xd4dc8951,"flixel.system.debug.interaction.tools.Pointer.update","flixel/system/debug/interaction/tools/Pointer.hx",42,0x6c93613b)
            	HX_STACK_THIS(this)
HXLINE(  44)		Bool _hx_tmp = !(this->isActive());
HXDLIN(  44)		if (_hx_tmp) {
HXLINE(  45)			return;
            		}
HXLINE(  47)		Bool _hx_tmp1;
HXDLIN(  47)		if (this->_brain->pointerJustPressed) {
HXLINE(  47)			_hx_tmp1 = !(this->_selectionHappening);
            		}
            		else {
...
HXLINE(  50)		Bool _hx_tmp2 = this->_selectionHappening;
...
HXLINE(  62)		Bool _hx_tmp3 = this->_selectionHappening;
HXDLIN(  62)		if (_hx_tmp3) {
HXLINE(  63)			this->stopSelection(null());
            		}
HXLINE(  66)		Bool _hx_tmp4 = (this->_itemsInSelectionArea->length > (int)0);
HXDLIN(  66)		if (_hx_tmp4) {
HXLINE(  68)			this->handleItemAddition(this->_itemsInSelectionArea);
            		}
            		else {
HXLINE(  70)			Bool _hx_tmp5;
HXDLIN(  70)			Bool _hx_tmp6 = !(this->_brain->keyPressed((int)17));
HXDLIN(  70)			if (_hx_tmp6) {
HXLINE(  70)				_hx_tmp5 = !(this->_selectionCancelled);
            			}
            			else {
...
void Pointer_obj::calculateSelectionArea(){
            	HX_STACK_FRAME("flixel.system.debug.interaction.tools.Pointer","calculateSelectionArea",0x6774abfb,"flixel.system.debug.interaction.tools.Pointer.calculateSelectionArea","flixel/system/debug/interaction/tools/Pointer.hx",78,0x6c93613b)
            	HX_STACK_THIS(this)
...
HXLINE(  84)		Bool _hx_tmp = (this->_selectionArea->width < (int)0);
HXDLIN(  84)		if (_hx_tmp) {
HXLINE(  86)			hx::MultEq(this->_selectionArea->width,(int)-1);
HXLINE(  87)			this->_selectionArea->x = (this->_selectionArea->x - this->_selectionArea->width);
            		}
HXLINE(  90)		Bool _hx_tmp1 = (this->_selectionArea->height < (int)0);
HXDLIN(  90)		if (_hx_tmp1) {
HXLINE(  92)			hx::MultEq(this->_selectionArea->height,(int)-1);
...
void Pointer_obj::startSelection(){
            	HX_STACK_FRAME("flixel.system.debug.interaction.tools.Pointer","startSelection",0x524d52d2,"flixel.system.debug.interaction.tools.Pointer.startSelection","flixel/system/debug/interaction/tools/Pointer.hx",102,0x6c93613b)
            	HX_STACK_THIS(this)
...
void Pointer_obj::cancelSelection(){
            	HX_STACK_FRAME("flixel.system.debug.interaction.tools.Pointer","cancelSelection",0xa173bf2a,"flixel.system.debug.interaction.tools.Pointer.cancelSelection","flixel/system/debug/interaction/tools/Pointer.hx",116,0x6c93613b)
            	HX_STACK_THIS(this)
...
Bool findItems = __o_findItems.Default(true);
            	HX_STACK_FRAME("flixel.system.debug.interaction.tools.Pointer","stopSelection",0x29b84da2,"flixel.system.debug.interaction.tools.Pointer.stopSelection","flixel/system/debug/interaction/tools/Pointer.hx",130,0x6c93613b)
            	HX_STACK_THIS(this)
...
HXLINE( 145)		{
HXLINE( 145)			HX_VARI(  ::flixel::math::FlxRect,_this) = this->_selectionArea;
...
void Pointer_obj::updateConsoleSelection(){
            	HX_STACK_FRAME("flixel.system.debug.interaction.tools.Pointer","updateConsoleSelection",0xdb302166,"flixel.system.debug.interaction.tools.Pointer.updateConsoleSelection","flixel/system/debug/interaction/tools/Pointer.hx",153,0x6c93613b)
            	HX_STACK_THIS(this)
HXLINE( 153)		switch((int)(this->_itemsInSelectionArea->length)){
            			case (int)0: {
            			}
            			break;
            			case (int)1: {
...
void Pointer_obj::handleItemAddition(::Array< ::Dynamic> itemsInSelectionArea){
            	HX_STACK_FRAME("flixel.system.debug.interaction.tools.Pointer","handleItemAddition",0xee76343f,"flixel.system.debug.interaction.tools.Pointer.handleItemAddition","flixel/system/debug/interaction/tools/Pointer.hx",162,0x6c93613b)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(itemsInSelectionArea,"itemsInSelectionArea")
HXLINE( 164)		HX_VARI( Bool,adding) = this->_brain->keyPressed((int)17);
...
HXDLIN( 177)				Int _hx_tmp1 = selectedItems->members->indexOf(( ( ::flixel::FlxObject)(item) ),null());
HXDLIN( 177)				if ((_hx_tmp1 != (int)-1)) {
...
void Pointer_obj::draw(){
            	HX_STACK_FRAME("flixel.system.debug.interaction.tools.Pointer","draw",0x05864d4c,"flixel.system.debug.interaction.tools.Pointer.draw","flixel/system/debug/interaction/tools/Pointer.hx",185,0x6c93613b)
            	HX_STACK_THIS(this)
HXLINE( 186)		HX_VARI(  ::openfl::display::Graphics,gfx) = this->_brain->getDebugGraphics();
HXLINE( 187)		Bool _hx_tmp = hx::IsNull( gfx );
HXDLIN( 187)		if (_hx_tmp) {
HXLINE( 188)			return;
            		}
HXLINE( 190)		Bool _hx_tmp1 = this->_selectionHappening;
HXDLIN( 190)		if (_hx_tmp1) {
HXLINE( 193)			gfx->lineStyle(((Float)0.9),(int)12255232,null(),null(),null(),null(),null(),null());
HXLINE( 194)			Float _hx_tmp2 = (this->_selectionArea->x - ::flixel::FlxG_obj::camera->scroll->x);
HXDLIN( 194)			Float _hx_tmp3 = (this->_selectionArea->y - ::flixel::FlxG_obj::camera->scroll->y);
HXDLIN( 194)			gfx->drawRect(_hx_tmp2,_hx_tmp3,this->_selectionArea->width,this->_selectionArea->height);
            		}
HXLINE( 198)		Bool _hx_tmp4 = ::flixel::FlxG_obj::renderBlit;
