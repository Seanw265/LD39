...
HXLINE( 153)		 ::openfl::text::TextField _hx_tmp11 = (this->_leftTextField = ::flixel::_hx_system::debug::DebuggerUtil_obj::createTextField((int)5,(int)125,(int)-1426063361,(int)11));
HXDLIN( 153)		this->addChild(_hx_tmp11);
HXLINE( 154)		 ::openfl::text::TextField _hx_tmp12 = (this->_rightTextField = ::flixel::_hx_system::debug::DebuggerUtil_obj::createTextField((int)75,(int)125,(int)-1,(int)11));
...
HXLINE( 255)			Int _hx_tmp4 = ::openfl::_hx_system::System_obj::get_totalMemory();
...
Float Stats_obj::currentMem(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 351)		Int _hx_tmp = ::openfl::_hx_system::System_obj::get_totalMemory();
