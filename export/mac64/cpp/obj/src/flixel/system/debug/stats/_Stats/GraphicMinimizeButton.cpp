...
void GraphicMinimizeButton_obj::__construct(Int width,Int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACK_FRAME("flixel.system.debug.stats._Stats.GraphicMinimizeButton","new",0x3ce68c53,"flixel.system.debug.stats._Stats.GraphicMinimizeButton.new","openfl/Assets.hx",1176,0x989d477c)
            	HX_STACK_THIS(this)
...
HXLINE(1213)		 ::haxe::io::Bytes _hx_tmp = ::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::stats::_Stats::GraphicMinimizeButton_obj::resourceName);
...
HXLINE(1214)		{
            			...
            			void _hx_run( ::lime::graphics::Image image){
            				HX_STACK_FRAME("flixel.system.debug.stats._Stats.GraphicMinimizeButton","new",0x3ce68c53,"flixel.system.debug.stats._Stats.GraphicMinimizeButton.new","openfl/Assets.hx",1214,0x989d477c)
...
{
{
            	HX_STACK_FRAME("flixel.system.debug.stats._Stats.GraphicMinimizeButton","boot",0x04ed3cdf,"flixel.system.debug.stats._Stats.GraphicMinimizeButton.boot","openfl/display/BitmapData.hx",59,0xdd12d5b9)
HXLINE(  59)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_stats__Stats_GraphicMinimizeButton",38,20,46,56);
            	}
}
