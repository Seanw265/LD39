...
void DebuggerFrontEnd_obj::setLayout(::hx::EnumBase Layout){
            	HX_STACK_FRAME("flixel.system.frontEnds.DebuggerFrontEnd","setLayout",0x96c2386b,"flixel.system.frontEnds.DebuggerFrontEnd.setLayout","flixel/system/frontEnds/DebuggerFrontEnd.hx",52,0x2ebb4b30)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(DebuggerFrontEnd_obj,resetLayout,(void))
 ...
 ::flixel::_hx_system::ui::FlxSystemButton DebuggerFrontEnd_obj::addButton(::hx::EnumBase Alignment, ::openfl::display::BitmapData Icon, ::Dynamic UpHandler,hx::Null< Bool >  __o_ToggleMode,hx::Null< Bool >  __o_UpdateLayout){
Bool ToggleMode = __o_ToggleMode.Default(false);
Bool UpdateLayout = __o_UpdateLayout.Default(true);
            	HX_STACK_FRAME("flixel.system.frontEnds.DebuggerFrontEnd","addButton",0x7066ab72,"flixel.system.frontEnds.DebuggerFrontEnd.addButton","flixel/system/frontEnds/DebuggerFrontEnd.hx",83,0x2ebb4b30)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC5(DebuggerFrontEnd_obj,addButton,return )
 ...
 ::flixel::_hx_system::debug::Window DebuggerFrontEnd_obj::track( ::Dynamic ObjectOrClass,::String WindowTitle){
            	HX_STACK_FRAME("flixel.system.frontEnds.DebuggerFrontEnd","track",0x1a1fb78a,"flixel.system.frontEnds.DebuggerFrontEnd.track","flixel/system/frontEnds/DebuggerFrontEnd.hx",110,0x2ebb4b30)
            	HX_STACK_THIS(this)
...
void DebuggerFrontEnd_obj::addTrackerProfile( ::flixel::_hx_system::debug::watch::TrackerProfile Profile){
            	HX_STACK_FRAME("flixel.system.frontEnds.DebuggerFrontEnd","addTrackerProfile",0xb36941d1,"flixel.system.frontEnds.DebuggerFrontEnd.addTrackerProfile","flixel/system/frontEnds/DebuggerFrontEnd.hx",119,0x2ebb4b30)
            	HX_STACK_THIS(this)
...
Bool DebuggerFrontEnd_obj::set_visible(Bool Value){
            	HX_STACK_FRAME("flixel.system.frontEnds.DebuggerFrontEnd","set_visible",0xfdfb51d4,"flixel.system.frontEnds.DebuggerFrontEnd.set_visible","flixel/system/frontEnds/DebuggerFrontEnd.hx",155,0x2ebb4b30)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
