...
HXDLIN( 152)		Bool _hx_tmp1 = !(::openfl::Assets_obj::exists(EmbeddedSound,HX_("SOUND",af,c4,ba,fe)));
HXDLIN( 152)		if (_hx_tmp1) {
HXLINE( 152)			_hx_tmp = ::openfl::Assets_obj::exists(EmbeddedSound,HX_("MUSIC",85,08,49,8e));
            		}
            		else {
HXLINE( 152)			_hx_tmp = true;
            		}
HXDLIN( 152)		if (_hx_tmp) {
HXLINE( 154)			return ::openfl::Assets_obj::getSound(EmbeddedSound,true);
            		}
...
HXDLIN( 166)		HX_VARI( ::Array< ::String >,_g1) = ::openfl::Assets_obj::list(HX_("SOUND",af,c4,ba,fe));
HXDLIN( 166)		while((_g < _g1->length)){
HXLINE( 166)			HX_VARI( ::String,id) = _g1->__get(_g);
HXDLIN( 166)			++_g;
HXLINE( 168)			Bool _hx_tmp;
HXDLIN( 168)			Bool _hx_tmp1 = !(::openfl::Assets_obj::exists(id,HX_("SOUND",af,c4,ba,fe)));
HXDLIN( 168)			if (_hx_tmp1) {
HXLINE( 168)				_hx_tmp = ::openfl::Assets_obj::exists(id,HX_("MUSIC",85,08,49,8e));
            			}
            			else {
HXLINE( 168)				_hx_tmp = true;
            			}
HXDLIN( 168)			if (_hx_tmp) {
HXLINE( 168)				::openfl::Assets_obj::getSound(id,true);
            			}
            		}
            	}
...
HXLINE( 187)			 ::openfl::media::Sound _hx_tmp1;
HXDLIN( 187)			Bool _hx_tmp2;
HXDLIN( 187)			Bool _hx_tmp3 = !(::openfl::Assets_obj::exists(EmbeddedSound,HX_("SOUND",af,c4,ba,fe)));
HXDLIN( 187)			if (_hx_tmp3) {
HXLINE( 187)				_hx_tmp2 = ::openfl::Assets_obj::exists(EmbeddedSound,HX_("MUSIC",85,08,49,8e));
            			}
            			else {
HXLINE( 187)				_hx_tmp2 = true;
            			}
HXDLIN( 187)			if (_hx_tmp2) {
HXLINE( 187)				_hx_tmp1 = ::openfl::Assets_obj::getSound(EmbeddedSound,true);
            			}
            			else {
