...
void WatchFrontEnd_obj::__construct(){
            	HX_STACK_FRAME("flixel.system.frontEnds.WatchFrontEnd","new",0xbd21d019,"flixel.system.frontEnds.WatchFrontEnd.new","flixel/system/frontEnds/WatchFrontEnd.hx",11,0xd7ade198)
            	HX_STACK_THIS(this)
            	}
...
void WatchFrontEnd_obj::add( ::Dynamic object,::String field,::String displayName){
            	HX_STACK_FRAME("flixel.system.frontEnds.WatchFrontEnd","add",0xbd17f1da,"flixel.system.frontEnds.WatchFrontEnd.add","flixel/system/frontEnds/WatchFrontEnd.hx",22,0xd7ade198)
            	HX_STACK_THIS(this)
...
void WatchFrontEnd_obj::remove( ::Dynamic object,::String field){
            	HX_STACK_FRAME("flixel.system.frontEnds.WatchFrontEnd","remove",0x8d8c762b,"flixel.system.frontEnds.WatchFrontEnd.remove","flixel/system/frontEnds/WatchFrontEnd.hx",35,0xd7ade198)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(object,"object")
            	HX_STACK_ARG(field,"field")
            	}
...
void WatchFrontEnd_obj::addQuick(::String displayName, ::Dynamic value){
            	HX_STACK_FRAME("flixel.system.frontEnds.WatchFrontEnd","addQuick",0x8c660eb3,"flixel.system.frontEnds.WatchFrontEnd.addQuick","flixel/system/frontEnds/WatchFrontEnd.hx",50,0xd7ade198)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(displayName,"displayName")
...
void WatchFrontEnd_obj::removeQuick(::String displayName){
            	HX_STACK_FRAME("flixel.system.frontEnds.WatchFrontEnd","removeQuick",0x15fb44c2,"flixel.system.frontEnds.WatchFrontEnd.removeQuick","flixel/system/frontEnds/WatchFrontEnd.hx",62,0xd7ade198)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(displayName,"displayName")
            	}
...
void WatchFrontEnd_obj::addExpression(::String expression,::String displayName){
            	HX_STACK_FRAME("flixel.system.frontEnds.WatchFrontEnd","addExpression",0xe5869c12,"flixel.system.frontEnds.WatchFrontEnd.addExpression","flixel/system/frontEnds/WatchFrontEnd.hx",77,0xd7ade198)
            	HX_STACK_THIS(this)
...
void WatchFrontEnd_obj::removeExpression(::String displayName){
            	HX_STACK_FRAME("flixel.system.frontEnds.WatchFrontEnd","removeExpression",0xc4a80fa3,"flixel.system.frontEnds.WatchFrontEnd.removeExpression","flixel/system/frontEnds/WatchFrontEnd.hx",94,0xd7ade198)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(displayName,"displayName")
            	}
...
void WatchFrontEnd_obj::addMouse(){
            	HX_STACK_FRAME("flixel.system.frontEnds.WatchFrontEnd","addMouse",0x3add9deb,"flixel.system.frontEnds.WatchFrontEnd.addMouse","flixel/system/frontEnds/WatchFrontEnd.hx",105,0xd7ade198)
            	HX_STACK_THIS(this)
            	}
...
void WatchFrontEnd_obj::removeMouse(){
            	HX_STACK_FRAME("flixel.system.frontEnds.WatchFrontEnd","removeMouse",0xc472d3fa,"flixel.system.frontEnds.WatchFrontEnd.removeMouse","flixel/system/frontEnds/WatchFrontEnd.hx",115,0xd7ade198)
            	HX_STACK_THIS(this)
            	}
