...
HXLINE(  14)		this->draw();
HXLINE(  16)		HX_VARI(  ::openfl::display::Sprite,logo) =  ::openfl::display::Sprite_obj::__new();
HXLINE(  17)		 ::openfl::display::Graphics _hx_tmp = logo->get_graphics();
...
HXLINE(  46)		Float _hx_tmp = ::Math_obj::min(halfWidth,halfHeight);
HXDLIN(  46)		HX_VARI( Int,helper) = ::Std_obj::_hx_int(((Float)_hx_tmp / (Float)(int)3));
