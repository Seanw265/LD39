...
HXLINE(  56)		HX_VARI(  ::openfl::display::Bitmap,tmp) =  ::openfl::display::Bitmap_obj::__new( ::openfl::display::BitmapData_obj::__new(this->_width,(int)30,true,(int)2130706432),null(),null());
HXLINE(  57)		this->screenCenter();
HXLINE(  58)		this->addChild(tmp);
HXLINE(  60)		HX_VARI(  ::openfl::text::TextField,text) =  ::openfl::text::TextField_obj::__new();
...
HXLINE(  74)		HX_VARI(  ::openfl::text::TextFormat,dtf) =  ::openfl::text::TextFormat_obj::__new(::flixel::_hx_system::FlxAssets_obj::FONT_DEFAULT,(int)10,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
...
HXLINE(  87)				tmp =  ::openfl::display::Bitmap_obj::__new( ::openfl::display::BitmapData_obj::__new((int)4,(i + (int)1),false,(int)-1),null(),null());
...
HXLINE( 170)		Float _hx_tmp = (((Float)0.5) * (::openfl::Lib_obj::current->stage->stageWidth - (this->_width * this->_defaultScale)));
HXDLIN( 170)		Float _hx_tmp1 = ::flixel::FlxG_obj::game->get_x();
HXDLIN( 170)		this->set_x((_hx_tmp - _hx_tmp1));
            	}
