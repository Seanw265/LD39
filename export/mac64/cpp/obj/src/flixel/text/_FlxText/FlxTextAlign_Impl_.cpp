...
::String FlxTextAlign_Impl__obj::fromOpenFL( ::Dynamic align){
            	HX_STACK_FRAME("flixel.text._FlxText.FlxTextAlign_Impl_","fromOpenFL",0xc584ea03,"flixel.text._FlxText.FlxTextAlign_Impl_.fromOpenFL","flixel/text/FlxText.hx",1125,0xdf165a6e)
            	HX_STACK_ARG(align,"align")
HXLINE(1125)		 ::Dynamic _hx_switch_0 = align;
            		if (  (_hx_switch_0==(int)0) ){
HXLINE(1125)			return HX_("center",d5,25,db,05);
HXDLIN(1125)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==(int)2) ){
HXLINE(1125)			return HX_("justify",50,df,b5,83);
HXDLIN(1125)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==(int)3) ){
HXLINE(1125)			return HX_("left",07,08,b0,47);
HXDLIN(1125)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==(int)4) ){
HXLINE(1125)			return HX_("right",dc,0b,64,e9);
HXDLIN(1125)			goto _hx_goto_0;
            		}
            		/* default */{
HXLINE(1125)			return HX_("left",07,08,b0,47);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxTextAlign_Impl__obj,fromOpenFL,return )
 ...
 ::Dynamic FlxTextAlign_Impl__obj::toOpenFL(::String align){
            	HX_STACK_FRAME("flixel.text._FlxText.FlxTextAlign_Impl_","toOpenFL",0xa34e3094,"flixel.text._FlxText.FlxTextAlign_Impl_.toOpenFL","flixel/text/FlxText.hx",1137,0xdf165a6e)
            	HX_STACK_ARG(align,"align")
HXLINE(1137)		::String _hx_switch_0 = align;
            		if (  (_hx_switch_0==HX_("center",d5,25,db,05)) ){
HXLINE(1137)			return (int)0;
HXDLIN(1137)			goto _hx_goto_1;
            		}
            		if (  (_hx_switch_0==HX_("justify",50,df,b5,83)) ){
HXLINE(1137)			return (int)2;
HXDLIN(1137)			goto _hx_goto_1;
            		}
            		if (  (_hx_switch_0==HX_("left",07,08,b0,47)) ){
HXLINE(1137)			return (int)3;
HXDLIN(1137)			goto _hx_goto_1;
            		}
            		if (  (_hx_switch_0==HX_("right",dc,0b,64,e9)) ){
HXLINE(1137)			return (int)4;
HXDLIN(1137)			goto _hx_goto_1;
            		}
            		/* default */{
HXLINE(1137)			return (int)3;
...
{
{
            	HX_STACK_FRAME("flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1110,0xdf165a6e)
HXLINE(1110)		LEFT = HX_("left",07,08,b0,47);
            	}
{
            	HX_STACK_FRAME("flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1117,0xdf165a6e)
HXLINE(1117)		CENTER = HX_("center",d5,25,db,05);
            	}
{
            	HX_STACK_FRAME("flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1119,0xdf165a6e)
HXLINE(1119)		RIGHT = HX_("right",dc,0b,64,e9);
            	}
{
...
HXLINE(1121)		JUSTIFY = HX_("justify",50,df,b5,83);
            	}
}
