...
HXLINE( 177)		Bool _hx_tmp = ::openfl::Assets_obj::exists(MapData,null());
...
Int CollideIndex = __o_CollideIndex.Default(1);
            	...
            	HX_STACK_ARG(DrawIndex,"DrawIndex")
            	HX_STACK_ARG(CollideIndex,"CollideIndex")
HXLINE( 322)		HX_VARI(  ::openfl::display::BitmapData,mapBitmap) = ::flixel::_hx_system::FlxAssets_obj::resolveBitmapData(MapGraphic);
...
HXDLIN( 733)		if ((( ( ::flixel::FlxObject)(this->_tileObjects->__get(this->_data->__get(startIndex))) )->allowCollisions <= (int)0)) {
HXLINE( 733)			_hx_tmp1 = (( ( ::flixel::FlxObject)(this->_tileObjects->__get(this->_data->__get(endIndex))) )->allowCollisions > (int)0);
            		}
            		else {
...
HXLINE( 739)		HX_VARI( ::Array< Int >,distances) = this->computePathDistance(startIndex,endIndex,DiagonalPolicy,null());
HXLINE( 741)		Bool _hx_tmp2 = hx::IsNull( distances );
HXDLIN( 741)		if (_hx_tmp2) {
HXLINE( 743)			return null();
            		}
HXLINE( 747)		HX_VARI( ::Array< ::Dynamic>,points) = ::Array_obj< ::Dynamic>::__new();
HXLINE( 748)		this->walkPath(distances,endIndex,points);
HXLINE( 751)		HX_VARI(  ::flixel::math::FlxPoint,node) = points->__get((points->length - (int)1)).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE( 753)		{
HXLINE( 753)			node->set_x(Start->x);
HXDLIN( 753)			node->set_y(Start->y);
HXDLIN( 753)			Bool _hx_tmp3 = Start->_weak;
...
HXDLIN( 755)			Bool _hx_tmp4 = End->_weak;
...
HXLINE( 768)		HX_VARI( ::Array< ::Dynamic>,path) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 769)		HX_VARI( Int,i) = (points->length - (int)1);
HXLINE( 771)		while((i >= (int)0)){
HXLINE( 773)			Int _hx_tmp5 = i--;
HXDLIN( 773)			node = points->__get(_hx_tmp5).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE( 775)			Bool _hx_tmp6 = hx::IsNotNull( node );
HXDLIN( 775)			if (_hx_tmp6) {
...
Bool StopOnEnd = __o_StopOnEnd.Default(true);
            	HX_STACK_FRAME("flixel.tile.FlxBaseTilemap","computePathDistance",0x34e53a3c,"flixel.tile.FlxBaseTilemap.computePathDistance","flixel/tile/FlxBaseTilemap.hx",795,0x0139d8e5)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(StartIndex,"StartIndex")
            	HX_STACK_ARG(EndIndex,"EndIndex")
            	HX_STACK_ARG(DiagonalPolicy,"DiagonalPolicy")
            	HX_STACK_ARG(StopOnEnd,"StopOnEnd")
HXLINE( 798)		HX_VARI( Int,mapSize) = (this->widthInTiles * this->heightInTiles);
HXLINE( 799)		HX_VARI( ::Array< Int >,distances) = ::Array_obj< Int >::__new();
HXLINE( 800)		::flixel::util::FlxArrayUtil_obj::setLength_Int(distances,mapSize);
HXLINE( 801)		HX_VARI( Int,i) = (int)0;
HXLINE( 803)		while((i < mapSize)){
HXLINE( 805)			Bool _hx_tmp = (( ( ::flixel::FlxObject)(this->_tileObjects->__get(this->_data->__get(i))) )->allowCollisions != (int)0);
...
HXLINE( 817)		HX_VARI( Int,distance) = (int)1;
HXLINE( 818)		HX_VARI( ::Array< Int >,neighbors) = ::Array_obj< Int >::__new(1)->init(0,StartIndex);
HXLINE( 819)		HX_VAR( ::Array< Int >,current);
HXLINE( 820)		HX_VAR( Int,currentIndex);
HXLINE( 821)		HX_VAR( Bool,left);
HXLINE( 822)		HX_VAR( Bool,right);
HXLINE( 823)		HX_VAR( Bool,up);
HXLINE( 824)		HX_VAR( Bool,down);
HXLINE( 825)		HX_VAR( Int,currentLength);
HXLINE( 826)		HX_VARI( Bool,foundEnd) = false;
...
HXLINE( 837)				Int _hx_tmp1 = i++;
HXDLIN( 837)				currentIndex = current->__get(_hx_tmp1);
HXLINE( 839)				Int _hx_tmp2 = ::Std_obj::_hx_int(EndIndex);
HXDLIN( 839)				if ((currentIndex == _hx_tmp2)) {
HXLINE( 841)					foundEnd = true;
HXLINE( 842)					if (StopOnEnd) {
HXLINE( 844)						neighbors = ::Array_obj< Int >::__new(0);
HXLINE( 845)						goto _hx_goto_14;
            					}
            				}
HXLINE( 850)				left = (hx::Mod(currentIndex,this->widthInTiles) > (int)0);
HXLINE( 851)				right = (hx::Mod(currentIndex,this->widthInTiles) < (this->widthInTiles - (int)1));
HXLINE( 852)				up = (((Float)currentIndex / (Float)this->widthInTiles) > (int)0);
HXLINE( 853)				down = (((Float)currentIndex / (Float)this->widthInTiles) < (this->heightInTiles - (int)1));
HXLINE( 855)				HX_VAR( Int,index);
HXLINE( 857)				if (up) {
HXLINE( 859)					index = (currentIndex - this->widthInTiles);
HXLINE( 861)					Bool _hx_tmp3 = (distances->__get(index) == (int)-1);
...
HXLINE( 871)					Bool _hx_tmp4 = (distances->__get(index) == (int)-1);
...
HXLINE( 881)					Bool _hx_tmp5 = (distances->__get(index) == (int)-1);
...
HXLINE( 891)					Bool _hx_tmp6 = (distances->__get(index) == (int)-1);
HXDLIN( 891)					if (_hx_tmp6) {
HXLINE( 893)						distances[index] = distance;
HXLINE( 894)						neighbors->push(index);
            					}
            				}
HXLINE( 898)				if ((DiagonalPolicy != (int)0)) {
HXLINE( 900)					HX_VARI( Bool,wideDiagonal) = (DiagonalPolicy == (int)2);
HXLINE( 901)					Bool _hx_tmp7;
HXDLIN( 901)					if (up) {
HXLINE( 901)						_hx_tmp7 = right;
            					}
            					else {
HXLINE( 901)						_hx_tmp7 = false;
            					}
HXDLIN( 901)					if (_hx_tmp7) {
HXLINE( 903)						index = ((currentIndex - this->widthInTiles) + (int)1);
HXLINE( 905)						Bool _hx_tmp8;
HXDLIN( 905)						Bool _hx_tmp9;
HXDLIN( 905)						Bool _hx_tmp10;
HXDLIN( 905)						if (wideDiagonal) {
HXLINE( 905)							_hx_tmp10 = (distances->__get(index) == (int)-1);
            						}
            						else {
HXLINE( 905)							_hx_tmp10 = false;
            						}
HXDLIN( 905)						if (_hx_tmp10) {
HXLINE( 905)							_hx_tmp9 = (distances->__get((currentIndex - this->widthInTiles)) >= (int)-1);
            						}
            						else {
HXLINE( 905)							_hx_tmp9 = false;
            						}
HXDLIN( 905)						if (_hx_tmp9) {
HXLINE( 905)							_hx_tmp8 = (distances->__get((currentIndex + (int)1)) >= (int)-1);
            						}
            						else {
HXLINE( 905)							_hx_tmp8 = false;
            						}
HXDLIN( 905)						if (_hx_tmp8) {
HXLINE( 909)							distances[index] = distance;
HXLINE( 910)							neighbors->push(index);
            						}
            						else {
HXLINE( 912)							Bool _hx_tmp11;
HXDLIN( 912)							if (!(wideDiagonal)) {
HXLINE( 912)								_hx_tmp11 = (distances->__get(index) == (int)-1);
            							}
            							else {
HXLINE( 912)								_hx_tmp11 = false;
            							}
HXDLIN( 912)							if (_hx_tmp11) {
HXLINE( 914)								distances[index] = distance;
HXLINE( 915)								neighbors->push(index);
            							}
            						}
            					}
HXLINE( 918)					Bool _hx_tmp12;
HXDLIN( 918)					if (right) {
HXLINE( 918)						_hx_tmp12 = down;
            					}
            					else {
HXLINE( 918)						_hx_tmp12 = false;
            					}
HXDLIN( 918)					if (_hx_tmp12) {
HXLINE( 920)						index = ((currentIndex + this->widthInTiles) + (int)1);
HXLINE( 922)						Bool _hx_tmp13;
HXDLIN( 922)						Bool _hx_tmp14;
HXDLIN( 922)						Bool _hx_tmp15;
HXDLIN( 922)						if (wideDiagonal) {
HXLINE( 922)							_hx_tmp15 = (distances->__get(index) == (int)-1);
            						}
            						else {
HXLINE( 922)							_hx_tmp15 = false;
            						}
HXDLIN( 922)						if (_hx_tmp15) {
HXLINE( 922)							_hx_tmp14 = (distances->__get((currentIndex + this->widthInTiles)) >= (int)-1);
            						}
            						else {
HXLINE( 922)							_hx_tmp14 = false;
            						}
HXDLIN( 922)						if (_hx_tmp14) {
HXLINE( 922)							_hx_tmp13 = (distances->__get((currentIndex + (int)1)) >= (int)-1);
            						}
            						else {
HXLINE( 922)							_hx_tmp13 = false;
            						}
HXDLIN( 922)						if (_hx_tmp13) {
HXLINE( 926)							distances[index] = distance;
HXLINE( 927)							neighbors->push(index);
            						}
            						else {
HXLINE( 929)							Bool _hx_tmp16;
HXDLIN( 929)							if (!(wideDiagonal)) {
HXLINE( 929)								_hx_tmp16 = (distances->__get(index) == (int)-1);
            							}
            							else {
HXLINE( 929)								_hx_tmp16 = false;
            							}
HXDLIN( 929)							if (_hx_tmp16) {
...
HXLINE( 939)						Bool _hx_tmp18;
HXDLIN( 939)						Bool _hx_tmp19;
HXDLIN( 939)						Bool _hx_tmp20;
HXDLIN( 939)						if (wideDiagonal) {
HXLINE( 939)							_hx_tmp20 = (distances->__get(index) == (int)-1);
            						}
            						else {
HXLINE( 939)							_hx_tmp20 = false;
            						}
HXDLIN( 939)						if (_hx_tmp20) {
HXLINE( 939)							_hx_tmp19 = (distances->__get((currentIndex + this->widthInTiles)) >= (int)-1);
            						}
            						else {
HXLINE( 939)							_hx_tmp19 = false;
            						}
HXDLIN( 939)						if (_hx_tmp19) {
HXLINE( 939)							_hx_tmp18 = (distances->__get((currentIndex - (int)1)) >= (int)-1);
            						}
            						else {
HXLINE( 939)							_hx_tmp18 = false;
            						}
HXDLIN( 939)						if (_hx_tmp18) {
...
HXLINE( 946)								_hx_tmp21 = (distances->__get(index) == (int)-1);
            							}
            							else {
...
HXLINE( 952)					Bool _hx_tmp22;
HXDLIN( 952)					if (up) {
HXLINE( 952)						_hx_tmp22 = left;
            					}
            					else {
HXLINE( 952)						_hx_tmp22 = false;
            					}
HXDLIN( 952)					if (_hx_tmp22) {
HXLINE( 954)						index = ((currentIndex - this->widthInTiles) - (int)1);
HXLINE( 956)						Bool _hx_tmp23;
HXDLIN( 956)						Bool _hx_tmp24;
HXDLIN( 956)						Bool _hx_tmp25;
HXDLIN( 956)						if (wideDiagonal) {
HXLINE( 956)							_hx_tmp25 = (distances->__get(index) == (int)-1);
            						}
            						else {
HXLINE( 956)							_hx_tmp25 = false;
            						}
HXDLIN( 956)						if (_hx_tmp25) {
HXLINE( 956)							_hx_tmp24 = (distances->__get((currentIndex - this->widthInTiles)) >= (int)-1);
            						}
            						else {
HXLINE( 956)							_hx_tmp24 = false;
            						}
HXDLIN( 956)						if (_hx_tmp24) {
HXLINE( 956)							_hx_tmp23 = (distances->__get((currentIndex - (int)1)) >= (int)-1);
            						}
            						else {
HXLINE( 956)							_hx_tmp23 = false;
            						}
HXDLIN( 956)						if (_hx_tmp23) {
HXLINE( 960)							distances[index] = distance;
HXLINE( 961)							neighbors->push(index);
            						}
            						else {
HXLINE( 963)							Bool _hx_tmp26;
HXDLIN( 963)							if (!(wideDiagonal)) {
HXLINE( 963)								_hx_tmp26 = (distances->__get(index) == (int)-1);
            							}
            							else {
HXLINE( 963)								_hx_tmp26 = false;
            							}
HXDLIN( 963)							if (_hx_tmp26) {
...
void FlxBaseTilemap_obj::walkPath(::Array< Int > Data,Int Start,::Array< ::Dynamic> Points){
            	HX_STACK_FRAME("flixel.tile.FlxBaseTilemap","walkPath",0xa1980343,"flixel.tile.FlxBaseTilemap.walkPath","flixel/tile/FlxBaseTilemap.hx",990,0x0139d8e5)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Data,"Data")
            	HX_STACK_ARG(Start,"Start")
            	HX_STACK_ARG(Points,"Points")
HXLINE( 991)		 ::flixel::math::FlxPoint _hx_tmp = this->getTileCoordsByIndex(Start,null());
HXDLIN( 991)		Points->push(_hx_tmp);
HXLINE( 993)		if ((Data->__get(Start) == (int)0)) {
HXLINE( 995)			return;
            		}
HXLINE( 999)		HX_VARI( Bool,left) = (hx::Mod(Start,this->widthInTiles) > (int)0);
HXLINE(1000)		HX_VARI( Bool,right) = (hx::Mod(Start,this->widthInTiles) < (this->widthInTiles - (int)1));
HXLINE(1001)		HX_VARI( Bool,up) = (((Float)Start / (Float)this->widthInTiles) > (int)0);
HXLINE(1002)		HX_VARI( Bool,down) = (((Float)Start / (Float)this->widthInTiles) < (this->heightInTiles - (int)1));
HXLINE(1004)		HX_VARI( Int,current) = Data->__get(Start);
HXLINE(1005)		HX_VAR( Int,i);
HXLINE(1007)		if (up) {
HXLINE(1009)			i = (Start - this->widthInTiles);
HXLINE(1011)			Bool _hx_tmp1;
HXDLIN(1011)			Bool _hx_tmp2;
HXDLIN(1011)			if ((i >= (int)0)) {
HXLINE(1011)				_hx_tmp2 = (Data->__get(i) >= (int)0);
            			}
            			else {
HXLINE(1011)				_hx_tmp2 = false;
            			}
HXDLIN(1011)			if (_hx_tmp2) {
HXLINE(1011)				_hx_tmp1 = (Data->__get(i) < current);
            			}
            			else {
...
HXLINE(1016)		if (right) {
HXLINE(1018)			i = (Start + (int)1);
HXLINE(1020)			Bool _hx_tmp3;
HXDLIN(1020)			Bool _hx_tmp4;
HXDLIN(1020)			if ((i >= (int)0)) {
HXLINE(1020)				_hx_tmp4 = (Data->__get(i) >= (int)0);
            			}
            			else {
HXLINE(1020)				_hx_tmp4 = false;
            			}
HXDLIN(1020)			if (_hx_tmp4) {
HXLINE(1020)				_hx_tmp3 = (Data->__get(i) < current);
            			}
            			else {
...
HXLINE(1029)				_hx_tmp6 = (Data->__get(i) >= (int)0);
            			}
            			else {
HXLINE(1029)				_hx_tmp6 = false;
            			}
HXDLIN(1029)			if (_hx_tmp6) {
HXLINE(1029)				_hx_tmp5 = (Data->__get(i) < current);
            			}
            			else {
...
HXLINE(1038)			Bool _hx_tmp7;
HXDLIN(1038)			Bool _hx_tmp8;
HXDLIN(1038)			if ((i >= (int)0)) {
HXLINE(1038)				_hx_tmp8 = (Data->__get(i) >= (int)0);
            			}
            			else {
HXLINE(1038)				_hx_tmp8 = false;
            			}
HXDLIN(1038)			if (_hx_tmp8) {
HXLINE(1038)				_hx_tmp7 = (Data->__get(i) < current);
            			}
            			else {
...
HXLINE(1047)			Bool _hx_tmp10;
HXDLIN(1047)			Bool _hx_tmp11;
HXDLIN(1047)			if ((i >= (int)0)) {
HXLINE(1047)				_hx_tmp11 = (Data->__get(i) >= (int)0);
            			}
            			else {
HXLINE(1047)				_hx_tmp11 = false;
            			}
HXDLIN(1047)			if (_hx_tmp11) {
HXLINE(1047)				_hx_tmp10 = (Data->__get(i) < current);
            			}
            			else {
...
HXDLIN(1052)		if (right) {
HXLINE(1052)			_hx_tmp12 = down;
            		}
            		else {
...
HXLINE(1056)			Bool _hx_tmp13;
HXDLIN(1056)			Bool _hx_tmp14;
HXDLIN(1056)			if ((i >= (int)0)) {
HXLINE(1056)				_hx_tmp14 = (Data->__get(i) >= (int)0);
            			}
            			else {
HXLINE(1056)				_hx_tmp14 = false;
            			}
HXDLIN(1056)			if (_hx_tmp14) {
HXLINE(1056)				_hx_tmp13 = (Data->__get(i) < current);
            			}
            			else {
...
HXLINE(1065)			Bool _hx_tmp16;
HXDLIN(1065)			Bool _hx_tmp17;
HXDLIN(1065)			if ((i >= (int)0)) {
HXLINE(1065)				_hx_tmp17 = (Data->__get(i) >= (int)0);
            			}
            			else {
HXLINE(1065)				_hx_tmp17 = false;
            			}
HXDLIN(1065)			if (_hx_tmp17) {
HXLINE(1065)				_hx_tmp16 = (Data->__get(i) < current);
            			}
            			else {
...
HXLINE(1074)			Bool _hx_tmp19;
HXDLIN(1074)			Bool _hx_tmp20;
HXDLIN(1074)			if ((i >= (int)0)) {
HXLINE(1074)				_hx_tmp20 = (Data->__get(i) >= (int)0);
            			}
            			else {
HXLINE(1074)				_hx_tmp20 = false;
            			}
HXDLIN(1074)			if (_hx_tmp20) {
HXLINE(1074)				_hx_tmp19 = (Data->__get(i) < current);
            			}
            			else {
...
void FlxBaseTilemap_obj::simplifyPath(::Array< ::Dynamic> Points){
            	HX_STACK_FRAME("flixel.tile.FlxBaseTilemap","simplifyPath",0xe8519bc3,"flixel.tile.FlxBaseTilemap.simplifyPath","flixel/tile/FlxBaseTilemap.hx",1089,0x0139d8e5)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Points,"Points")
HXLINE(1090)		HX_VAR( Float,deltaPrevious);
HXLINE(1091)		HX_VAR( Float,deltaNext);
HXLINE(1092)		HX_VARI(  ::flixel::math::FlxPoint,last) = Points->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE(1093)		HX_VAR(  ::flixel::math::FlxPoint,node);
HXLINE(1094)		HX_VARI( Int,i) = (int)1;
HXLINE(1095)		HX_VARI( Int,l) = (Points->length - (int)1);
HXLINE(1097)		while((i < l)){
HXLINE(1099)			node = Points->__get(i).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE(1100)			deltaPrevious = ((Float)(node->x - last->x) / (Float)(node->y - last->y));
HXLINE(1101)			deltaNext = ((Float)(node->x - Points->__get((i + (int)1)).StaticCast<  ::flixel::math::FlxPoint >()->x) / (Float)(node->y - Points->__get((i + (int)1)).StaticCast<  ::flixel::math::FlxPoint >()->y));
...
void FlxBaseTilemap_obj::raySimplifyPath(::Array< ::Dynamic> Points){
            	HX_STACK_FRAME("flixel.tile.FlxBaseTilemap","raySimplifyPath",0x32723703,"flixel.tile.FlxBaseTilemap.raySimplifyPath","flixel/tile/FlxBaseTilemap.hx",1122,0x0139d8e5)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Points,"Points")
HXLINE(1123)		HX_VARI(  ::flixel::math::FlxPoint,source) = Points->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE(1124)		HX_VARI( Int,lastIndex) = (int)-1;
HXLINE(1125)		HX_VAR(  ::flixel::math::FlxPoint,node);
HXLINE(1126)		HX_VARI( Int,i) = (int)1;
HXLINE(1127)		HX_VARI( Int,l) = Points->length;
HXLINE(1129)		while((i < l)){
HXLINE(1131)			Int _hx_tmp = i++;
HXDLIN(1131)			node = Points->__get(_hx_tmp).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE(1133)			Bool _hx_tmp1 = hx::IsNull( node );
HXDLIN(1133)			if (_hx_tmp1) {
HXLINE(1135)				continue;
            			}
HXLINE(1138)			Bool _hx_tmp2 = this->ray(source,node,this->_point,null());
...
Bool InScreenSpace = __o_InScreenSpace.Default(false);
            	HX_STACK_FRAME("flixel.tile.FlxBaseTilemap","overlaps",0x8f17af01,"flixel.tile.FlxBaseTilemap.overlaps","flixel/tile/FlxBaseTilemap.hx",1166,0x0139d8e5)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(ObjectOrGroup,"ObjectOrGroup")
            	HX_STACK_ARG(InScreenSpace,"InScreenSpace")
            	HX_STACK_ARG(Camera,"Camera")
HXLINE(1167)		HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(ObjectOrGroup);
HXLINE(1168)		Bool _hx_tmp = hx::IsNotNull( group );
...
HXLINE(1172)				_hx_tmp2 = (ObjectOrGroup->flixelType == (int)3);
            			}
            			else {
HXLINE(1172)				_hx_tmp2 = true;
            			}
HXDLIN(1172)			if (_hx_tmp2) {
HXLINE(1172)				_hx_tmp1 = this->overlapsWithCallback(( ( ::flixel::FlxObject)(ObjectOrGroup) ),null(),null(),null());
            			}
            			else {
HXLINE(1172)				_hx_tmp1 = this->overlaps(ObjectOrGroup,false,null());
            			}
...
Bool InScreenSpace = __o_InScreenSpace.Default(false);
            	HX_STACK_FRAME("flixel.tile.FlxBaseTilemap","tilemapOverlapsCallback",0x40d17cea,"flixel.tile.FlxBaseTilemap.tilemapOverlapsCallback","flixel/tile/FlxBaseTilemap.hx",1181,0x0139d8e5)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(ObjectOrGroup,"ObjectOrGroup")
            	HX_STACK_ARG(X,"X")
            	HX_STACK_ARG(Y,"Y")
...
Bool InScreenSpace = __o_InScreenSpace.Default(false);
            	HX_STACK_FRAME("flixel.tile.FlxBaseTilemap","overlapsAt",0x47a26a54,"flixel.tile.FlxBaseTilemap.overlapsAt","flixel/tile/FlxBaseTilemap.hx",1205,0x0139d8e5)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(X,"X")
            	HX_STACK_ARG(Y,"Y")
            	HX_STACK_ARG(ObjectOrGroup,"ObjectOrGroup")
            	HX_STACK_ARG(InScreenSpace,"InScreenSpace")
            	HX_STACK_ARG(Camera,"Camera")
HXLINE(1206)		HX_VARI(  ::flixel::group::FlxTypedGroup,group) = ::flixel::group::FlxTypedGroup_obj::resolveGroup(ObjectOrGroup);
HXLINE(1207)		Bool _hx_tmp = hx::IsNotNull( group );
...
HXLINE(1211)				_hx_tmp2 = (ObjectOrGroup->flixelType == (int)3);
            			}
            			else {
HXLINE(1211)				_hx_tmp2 = true;
            			}
HXDLIN(1211)			if (_hx_tmp2) {
HXLINE(1211)				 ::flixel::math::FlxPoint _hx_tmp3 = this->_point->set(X,Y);
HXDLIN(1211)				_hx_tmp1 = this->overlapsWithCallback(( ( ::flixel::FlxObject)(ObjectOrGroup) ),null(),false,_hx_tmp3);
            			}
            			else {
HXLINE(1211)				_hx_tmp1 = this->overlapsAt(X,Y,ObjectOrGroup,InScreenSpace,Camera);
            			}
...
Bool FlxBaseTilemap_obj::tilemapOverlapsAtCallback( ::flixel::FlxBasic ObjectOrGroup,Float X,Float Y,Bool InScreenSpace, ::flixel::FlxCamera Camera){
            	HX_STACK_FRAME("flixel.tile.FlxBaseTilemap","tilemapOverlapsAtCallback",0xbef90c3d,"flixel.tile.FlxBaseTilemap.tilemapOverlapsAtCallback","flixel/tile/FlxBaseTilemap.hx",1221,0x0139d8e5)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(ObjectOrGroup,"ObjectOrGroup")
            	HX_STACK_ARG(X,"X")
            	HX_STACK_ARG(Y,"Y")
...
HXLINE(1223)			 ::flixel::math::FlxPoint _hx_tmp1 = this->_point->set(X,Y);
HXDLIN(1223)			return this->overlapsWithCallback(( ( ::flixel::FlxObject)(ObjectOrGroup) ),null(),false,_hx_tmp1);
            		}
            		else {
...
Bool InScreenSpace = __o_InScreenSpace.Default(false);
            	HX_STACK_FRAME("flixel.tile.FlxBaseTilemap","overlapsPoint",0x91c6718f,"flixel.tile.FlxBaseTilemap.overlapsPoint","flixel/tile/FlxBaseTilemap.hx",1240,0x0139d8e5)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(WorldPoint,"WorldPoint")
            	HX_STACK_ARG(InScreenSpace,"InScreenSpace")
            	HX_STACK_ARG(Camera,"Camera")
HXLINE(1241)		if (InScreenSpace) {
HXLINE(1243)			Bool _hx_tmp = hx::IsNull( Camera );
HXDLIN(1243)			if (_hx_tmp) {
HXLINE(1244)				Camera = ::flixel::FlxG_obj::camera;
            			}
HXLINE(1246)			WorldPoint->subtractPoint(Camera->scroll);
HXLINE(1247)			Bool _hx_tmp1 = WorldPoint->_weak;
...
Bool FlxBaseTilemap_obj::tileAtPointAllowsCollisions( ::flixel::math::FlxPoint point){
            	HX_STACK_FRAME("flixel.tile.FlxBaseTilemap","tileAtPointAllowsCollisions",0x26e8ec45,"flixel.tile.FlxBaseTilemap.tileAtPointAllowsCollisions","flixel/tile/FlxBaseTilemap.hx",1254,0x0139d8e5)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(point,"point")
HXLINE(1255)		HX_VARI( Int,tileIndex) = this->getTileIndexByCoords(point);
...
HXLINE(1258)		return (( ( ::flixel::FlxObject)(this->_tileObjects->__get(this->_data->__get(tileIndex))) )->allowCollisions > (int)0);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxBaseTilemap_obj,tileAtPointAllowsCollisions,return )
 ...
 ::flixel::math::FlxRect FlxBaseTilemap_obj::getBounds( ::flixel::math::FlxRect Bounds){
            	HX_STACK_FRAME("flixel.tile.FlxBaseTilemap","getBounds",0x47c7aa16,"flixel.tile.FlxBaseTilemap.getBounds","flixel/tile/FlxBaseTilemap.hx",1268,0x0139d8e5)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Bounds,"Bounds")
HXLINE(1269)		Bool _hx_tmp = hx::IsNull( Bounds );
HXDLIN(1269)		if (_hx_tmp) {
HXLINE(1270)			Float X = (int)0;
HXDLIN(1270)			Float Y = (int)0;
HXDLIN(1270)			Float Width = (int)0;
HXDLIN(1270)			Float Height = (int)0;
HXDLIN(1270)			HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN(1270)			_this->x = X;
HXDLIN(1270)			_this->y = Y;
HXDLIN(1270)			_this->width = Width;
HXDLIN(1270)			_this->height = Height;
HXDLIN(1270)			_this->_inPool = false;
HXDLIN(1270)			Bounds = _this;
            		}
HXLINE(1272)		Float X1 = this->x;
HXDLIN(1272)		Float Y1 = this->y;
HXDLIN(1272)		Float Width1 = this->get_width();
HXDLIN(1272)		Float Height1 = this->get_height();
HXDLIN(1272)		Bounds->x = X1;
HXDLIN(1272)		Bounds->y = Y1;
HXDLIN(1272)		Bounds->width = Width1;
HXDLIN(1272)		Bounds->height = Height1;
