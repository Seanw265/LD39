...
void GraphicAutoAlt_obj::__construct(Int width,Int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACK_FRAME("flixel.tile.GraphicAutoAlt","new",0x4e2c2272,"flixel.tile.GraphicAutoAlt.new","openfl/Assets.hx",1176,0x989d477c)
            	HX_STACK_THIS(this)
...
HXLINE(1213)		 ::haxe::io::Bytes _hx_tmp = ::haxe::Resource_obj::getBytes(::flixel::tile::GraphicAutoAlt_obj::resourceName);
...
HXLINE(1214)		{
            			...
            			void _hx_run( ::lime::graphics::Image image){
            				HX_STACK_FRAME("flixel.tile.GraphicAutoAlt","new",0x4e2c2272,"flixel.tile.GraphicAutoAlt.new","openfl/Assets.hx",1214,0x989d477c)
...
{
{
            	HX_STACK_FRAME("flixel.tile.GraphicAutoAlt","boot",0x108b01e0,"flixel.tile.GraphicAutoAlt.boot","openfl/display/BitmapData.hx",59,0xdd12d5b9)
HXLINE(  59)		resourceName = HX_("__ASSET__:bitmap_flixel_tile_GraphicAutoAlt",c6,25,2e,70);
            	}
}
