...
HXLINE( 318)		this->set_type( ::Dynamic(Options->__Field(HX_("type",ba,f2,08,4d),hx::paccDynamic)));
...
HXLINE( 323)		this->setDelays( ::Dynamic(Options->__Field(HX_("startDelay",c1,af,3d,f3),hx::paccDynamic)), ::Dynamic(Options->__Field(HX_("loopDelay",7f,f6,d2,04),hx::paccDynamic)));
HXLINE( 324)		 ::flixel::tweens::FlxTweenManager _hx_tmp;
HXDLIN( 324)		Bool _hx_tmp1 = hx::IsNotNull( manager );
...
void *FlxTween_obj::_hx_getInterface(int inHash) {
 ...
 ::Dynamic FlxTween_obj::resolveTweenOptions( ::Dynamic Options){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","resolveTweenOptions",0x40bbd67e,"flixel.tweens.FlxTween.resolveTweenOptions","flixel/tweens/FlxTween.hx",328,0x5d58d691)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Options,"Options")
HXLINE( 329)		Bool _hx_tmp = hx::IsNull( Options );
HXDLIN( 329)		if (_hx_tmp) {
HXLINE( 330)			Options =  ::Dynamic(hx::Anon_obj::Create(1)
            				->setFixed(0,HX_("type",ba,f2,08,4d),(int)8));
            		}
HXLINE( 332)		Bool _hx_tmp1 = hx::IsNull( Options->__Field(HX_("type",ba,f2,08,4d),hx::paccDynamic) );
...
void FlxTween_obj::destroy(){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","destroy",0xb268abb9,"flixel.tweens.FlxTween.destroy","flixel/tweens/FlxTween.hx",339,0x5d58d691)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(FlxTween_obj,destroy,(void))
 ...
 ::flixel::tweens::FlxTween FlxTween_obj::then( ::flixel::tweens::FlxTween tween){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","then",0x19b266be,"flixel.tweens.FlxTween.then","flixel/tweens/FlxTween.hx",355,0x5d58d691)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(tween,"tween")
HXLINE( 355)		return this->addChainedTween(tween);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxTween_obj,then,return )
 ...
 ::flixel::tweens::FlxTween FlxTween_obj::wait(Float delay){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","wait",0x1ba8be56,"flixel.tweens.FlxTween.wait","flixel/tweens/FlxTween.hx",363,0x5d58d691)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(delay,"delay")
HXLINE( 363)		 ::flixel::tweens::misc::NumTween _hx_tmp = ::flixel::tweens::FlxTween_obj::num((int)0,(int)0,delay,null(),null());
HXDLIN( 363)		return this->addChainedTween(_hx_tmp);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxTween_obj,wait,return )
 ...
 ::flixel::tweens::FlxTween FlxTween_obj::addChainedTween( ::flixel::tweens::FlxTween tween){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","addChainedTween",0xc68ec82b,"flixel.tweens.FlxTween.addChainedTween","flixel/tweens/FlxTween.hx",367,0x5d58d691)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(tween,"tween")
HXLINE( 368)		tween->setVarsOnEnd();
HXLINE( 369)		tween->manager->remove(tween,false);
HXLINE( 371)		Bool _hx_tmp = hx::IsNull( this->_chainedTweens );
...
void FlxTween_obj::update(Float elapsed){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","update",0xb905642a,"flixel.tweens.FlxTween.update","flixel/tweens/FlxTween.hx",379,0x5d58d691)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(elapsed,"elapsed")
HXLINE( 380)		hx::AddEq(this->_secondsSinceStart,elapsed);
HXLINE( 381)		HX_VAR( Float,delay);
...
HXLINE( 386)		Float _hx_tmp = (this->_secondsSinceStart - delay);
HXDLIN( 386)		Float _hx_tmp1 = ::Math_obj::max(_hx_tmp,(int)0);
HXDLIN( 386)		this->scale = ((Float)_hx_tmp1 / (Float)this->duration);
HXLINE( 387)		Bool _hx_tmp2 = hx::IsNotNull( this->ease );
HXDLIN( 387)		if (_hx_tmp2) {
HXLINE( 389)			this->scale = ( (Float)(this->ease(this->scale)) );
            		}
HXLINE( 391)		Bool _hx_tmp3 = this->backward;
...
HXLINE( 395)			_hx_tmp4 = !(this->_running);
            		}
            		else {
...
HXLINE( 398)			Bool _hx_tmp5 = hx::IsNotNull( this->onStart );
HXDLIN( 398)			if (_hx_tmp5) {
HXLINE( 399)				this->onStart(hx::ObjectPtr<OBJ_>(this));
            			}
            		}
HXLINE( 401)		Bool _hx_tmp6 = (this->_secondsSinceStart >= (this->duration + delay));
HXDLIN( 401)		if (_hx_tmp6) {
HXLINE( 403)			Float _hx_tmp7;
HXDLIN( 403)			if (this->backward) {
HXLINE( 403)				_hx_tmp7 = (int)0;
            			}
            			else {
HXLINE( 403)				_hx_tmp7 = (int)1;
            			}
HXDLIN( 403)			this->scale = _hx_tmp7;
HXLINE( 404)			this->finished = true;
            		}
            		else {
HXLINE( 408)			Bool _hx_tmp8 = hx::IsNotNull( this->onUpdate );
...
HX_DEFINE_DYNAMIC_FUNC1(FlxTween_obj,update,(void))
 ...
 ::flixel::tweens::FlxTween FlxTween_obj::start(){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","start",0xd6ec7561,"flixel.tweens.FlxTween.start","flixel/tweens/FlxTween.hx",417,0x5d58d691)
            	HX_STACK_THIS(this)
...
HXLINE( 421)		Bool _hx_tmp1 = (this->duration == (int)0);
...
void FlxTween_obj::cancel(){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","cancel",0xea33cb9b,"flixel.tweens.FlxTween.cancel","flixel/tweens/FlxTween.hx",439,0x5d58d691)
            	HX_STACK_THIS(this)
HXLINE( 440)		this->onEnd();
HXLINE( 442)		Bool _hx_tmp = hx::IsNotNull( this->manager );
...
void FlxTween_obj::cancelChain(){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","cancelChain",0x815e4766,"flixel.tweens.FlxTween.cancelChain","flixel/tweens/FlxTween.hx",457,0x5d58d691)
            	HX_STACK_THIS(this)
HXLINE( 459)		Bool _hx_tmp = hx::IsNotNull( this->_nextTweenInChain );
HXDLIN( 459)		if (_hx_tmp) {
HXLINE( 460)			this->_nextTweenInChain->cancelChain();
            		}
HXLINE( 463)		Bool _hx_tmp1 = hx::IsNotNull( this->_chainedTweens );
...
void FlxTween_obj::finish(){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","finish",0xb87f1e74,"flixel.tweens.FlxTween.finish","flixel/tweens/FlxTween.hx",470,0x5d58d691)
            	HX_STACK_THIS(this)
HXLINE( 471)		this->executions++;
HXLINE( 473)		Bool _hx_tmp = hx::IsNotNull( this->onComplete );
HXDLIN( 473)		if (_hx_tmp) {
HXLINE( 474)			this->onComplete(hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE( 476)		HX_VARI( Int,type) = ((int)this->type & (int)(int)-17);
HXLINE( 478)		Bool _hx_tmp1;
HXDLIN( 478)		if ((type != (int)1)) {
HXLINE( 478)			_hx_tmp1 = (type == (int)8);
            		}
            		else {
...
HXLINE( 483)				_hx_tmp2 = hx::IsNotNull( this->manager );
            			}
            			else {
...
HXLINE( 489)			_hx_tmp3 = (type == (int)4);
            		}
            		else {
HXLINE( 489)			_hx_tmp3 = true;
            		}
HXDLIN( 489)		if (_hx_tmp3) {
HXLINE( 491)			Float _hx_tmp4 = hx::Mod((this->_secondsSinceStart - this->_delayToUse),this->duration);
HXDLIN( 491)			this->_secondsSinceStart = (_hx_tmp4 + this->_delayToUse);
HXLINE( 492)			Float _hx_tmp5 = (this->_secondsSinceStart - this->_delayToUse);
HXDLIN( 492)			Float _hx_tmp6 = ::Math_obj::max(_hx_tmp5,(int)0);
HXDLIN( 492)			this->scale = ((Float)_hx_tmp6 / (Float)this->duration);
HXLINE( 494)			Bool _hx_tmp7;
HXDLIN( 494)			Bool _hx_tmp8;
HXDLIN( 494)			Bool _hx_tmp9 = hx::IsNotNull( this->ease );
HXDLIN( 494)			if (_hx_tmp9) {
HXLINE( 494)				_hx_tmp8 = (this->scale > (int)0);
            			}
            			else {
HXLINE( 494)				_hx_tmp8 = false;
            			}
HXDLIN( 494)			if (_hx_tmp8) {
HXLINE( 494)				_hx_tmp7 = (this->scale < (int)1);
            			}
            			else {
...
HXLINE( 502)				Bool _hx_tmp10 = this->backward;
...
void FlxTween_obj::onEnd(){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","onEnd",0x854598fb,"flixel.tweens.FlxTween.onEnd","flixel/tweens/FlxTween.hx",516,0x5d58d691)
            	HX_STACK_THIS(this)
...
void FlxTween_obj::setVarsOnEnd(){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","setVarsOnEnd",0x855d798f,"flixel.tweens.FlxTween.setVarsOnEnd","flixel/tweens/FlxTween.hx",522,0x5d58d691)
            	HX_STACK_THIS(this)
...
void FlxTween_obj::processTweenChain(){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","processTweenChain",0xe0e06164,"flixel.tweens.FlxTween.processTweenChain","flixel/tweens/FlxTween.hx",529,0x5d58d691)
            	HX_STACK_THIS(this)
HXLINE( 530)		Bool _hx_tmp;
HXDLIN( 530)		Bool _hx_tmp1 = hx::IsNotNull( this->_chainedTweens );
...
void FlxTween_obj::doNextTween( ::flixel::tweens::FlxTween tween){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","doNextTween",0xb736cdac,"flixel.tweens.FlxTween.doNextTween","flixel/tweens/FlxTween.hx",541,0x5d58d691)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(tween,"tween")
HXLINE( 542)		Bool _hx_tmp = !(tween->active);
...
void FlxTween_obj::setChain(::Array< ::Dynamic> previousChain){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","setChain",0xec346660,"flixel.tweens.FlxTween.setChain","flixel/tweens/FlxTween.hx",552,0x5d58d691)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(previousChain,"previousChain")
HXLINE( 553)		Bool _hx_tmp = hx::IsNull( previousChain );
HXDLIN( 553)		if (_hx_tmp) {
HXLINE( 554)			return;
            		}
HXLINE( 556)		Bool _hx_tmp1 = hx::IsNull( this->_chainedTweens );
...
void FlxTween_obj::restart(){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","restart",0xf888468e,"flixel.tweens.FlxTween.restart","flixel/tweens/FlxTween.hx",568,0x5d58d691)
            	HX_STACK_THIS(this)
HXLINE( 568)		Bool _hx_tmp = this->active;
...
HX_DEFINE_DYNAMIC_FUNC0(FlxTween_obj,restart,(void))
 ...
 ::flixel::tweens::FlxTween FlxTween_obj::setDelays( ::Dynamic StartDelay, ::Dynamic LoopDelay){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","setDelays",0x750c1d51,"flixel.tweens.FlxTween.setDelays","flixel/tweens/FlxTween.hx",585,0x5d58d691)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(StartDelay,"StartDelay")
            	HX_STACK_ARG(LoopDelay,"LoopDelay")
HXLINE( 586)		Float _hx_tmp;
HXDLIN( 586)		Bool _hx_tmp1 = hx::IsNotNull( StartDelay );
...
HXLINE( 587)		Float _hx_tmp2;
HXDLIN( 587)		Bool _hx_tmp3 = hx::IsNotNull( LoopDelay );
HXDLIN( 587)		if (_hx_tmp3) {
HXLINE( 587)			_hx_tmp2 = LoopDelay;
            		}
            		else {
HXLINE( 587)			_hx_tmp2 = (int)0;
            		}
HXDLIN( 587)		this->set_loopDelay(_hx_tmp2);
...
Float FlxTween_obj::set_startDelay(Float value){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","set_startDelay",0xdc7f879f,"flixel.tweens.FlxTween.set_startDelay","flixel/tweens/FlxTween.hx",592,0x5d58d691)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 593)		HX_VARI( Float,dly) = ::Math_obj::abs(value);
HXLINE( 594)		Bool _hx_tmp = (this->executions == (int)0);
HXDLIN( 594)		if (_hx_tmp) {
HXLINE( 596)			Float _hx_tmp1 = this->duration;
HXDLIN( 596)			Float _hx_tmp2 = (this->_secondsSinceStart - this->_delayToUse);
HXDLIN( 596)			Float _hx_tmp3 = ::Math_obj::max(_hx_tmp2,(int)0);
HXDLIN( 596)			Float _hx_tmp4 = (_hx_tmp1 * ((Float)_hx_tmp3 / (Float)this->duration));
HXDLIN( 596)			Float _hx_tmp5 = (dly - this->startDelay);
HXDLIN( 596)			Float _hx_tmp6 = ::Math_obj::max(_hx_tmp5,(int)0);
HXDLIN( 596)			this->_secondsSinceStart = (_hx_tmp4 + _hx_tmp6);
...
Float FlxTween_obj::set_loopDelay( ::Dynamic value){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","set_loopDelay",0xc5954461,"flixel.tweens.FlxTween.set_loopDelay","flixel/tweens/FlxTween.hx",603,0x5d58d691)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 604)		HX_VARI( Float,dly) = ::Math_obj::abs(value);
HXLINE( 605)		Bool _hx_tmp = (this->executions > (int)0);
HXDLIN( 605)		if (_hx_tmp) {
HXLINE( 607)			Float _hx_tmp1 = this->duration;
HXDLIN( 607)			Float _hx_tmp2 = (this->_secondsSinceStart - this->_delayToUse);
HXDLIN( 607)			Float _hx_tmp3 = ::Math_obj::max(_hx_tmp2,(int)0);
HXDLIN( 607)			Float _hx_tmp4 = (_hx_tmp1 * ((Float)_hx_tmp3 / (Float)this->duration));
HXDLIN( 607)			Float _hx_tmp5 = (dly - this->loopDelay);
HXDLIN( 607)			Float _hx_tmp6 = ::Math_obj::max(_hx_tmp5,(int)0);
HXDLIN( 607)			this->_secondsSinceStart = (_hx_tmp4 + _hx_tmp6);
...
Float FlxTween_obj::get_percent(){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","get_percent",0x9c57551b,"flixel.tweens.FlxTween.get_percent","flixel/tweens/FlxTween.hx",615,0x5d58d691)
            	HX_STACK_THIS(this)
HXLINE( 615)		Float _hx_tmp = (this->_secondsSinceStart - this->_delayToUse);
HXDLIN( 615)		Float _hx_tmp1 = ::Math_obj::max(_hx_tmp,(int)0);
HXDLIN( 615)		return ((Float)_hx_tmp1 / (Float)this->duration);
            	}
...
Float FlxTween_obj::set_percent(Float value){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","set_percent",0xa6c45c27,"flixel.tweens.FlxTween.set_percent","flixel/tweens/FlxTween.hx",620,0x5d58d691)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 620)		Float _hx_tmp = (this->duration * value);
HXDLIN( 620)		return (this->_secondsSinceStart = (_hx_tmp + this->_delayToUse));
            	}
...
Int FlxTween_obj::set_type(Int value){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","set_type",0x136d7018,"flixel.tweens.FlxTween.set_type","flixel/tweens/FlxTween.hx",624,0x5d58d691)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 625)		Bool _hx_tmp = (value == (int)0);
HXDLIN( 625)		if (_hx_tmp) {
HXLINE( 627)			value = (int)8;
            		}
            		else {
HXLINE( 629)			Bool _hx_tmp1 = (value == (int)16);
...
Bool FlxTween_obj::set_active(Bool active){
            	HX_STACK_FRAME("flixel.tweens.FlxTween","set_active",0x9ccb52a4,"flixel.tweens.FlxTween.set_active","flixel/tweens/FlxTween.hx",639,0x5d58d691)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(active,"active")
HXLINE( 640)		this->active = active;
HXLINE( 642)		Bool _hx_tmp = this->_waitingForRestart;
...
Float Duration = __o_Duration.Default(1);
            	HX_STACK_FRAME("flixel.tweens.FlxTween","tween",0x6c51ab6a,"flixel.tweens.FlxTween.tween","flixel/tweens/FlxTween.hx",66,0x5d58d691)
            	HX_STACK_ARG(Object,"Object")
            	HX_STACK_ARG(Values,"Values")
            	HX_STACK_ARG(Duration,"Duration")
            	HX_STACK_ARG(Options,"Options")
HXLINE(  66)		return ::flixel::tweens::FlxTween_obj::globalManager->tween(Object,Values,Duration,Options);
            	}
...
Float Duration = __o_Duration.Default(1);
            	HX_STACK_FRAME("flixel.tweens.FlxTween","num",0xa4425185,"flixel.tweens.FlxTween.num","flixel/tweens/FlxTween.hx",91,0x5d58d691)
            	HX_STACK_ARG(FromValue,"FromValue")
            	HX_STACK_ARG(ToValue,"ToValue")
            	HX_STACK_ARG(Duration,"Duration")
            	HX_STACK_ARG(Options,"Options")
            	HX_STACK_ARG(TweenFunction,"TweenFunction")
HXLINE(  91)		return ::flixel::tweens::FlxTween_obj::globalManager->num(FromValue,ToValue,Duration,Options,TweenFunction);
            	}
...
Float Duration = __o_Duration.Default(1);
            	HX_STACK_FRAME("flixel.tweens.FlxTween","angle",0x75c344d2,"flixel.tweens.FlxTween.angle","flixel/tweens/FlxTween.hx",110,0x5d58d691)
            	HX_STACK_ARG(Sprite,"Sprite")
            	HX_STACK_ARG(FromAngle,"FromAngle")
            	HX_STACK_ARG(ToAngle,"ToAngle")
            	HX_STACK_ARG(Duration,"Duration")
            	HX_STACK_ARG(Options,"Options")
HXLINE( 110)		return ::flixel::tweens::FlxTween_obj::globalManager->angle(Sprite,FromAngle,ToAngle,Duration,Options);
            	}
...
Float Duration = __o_Duration.Default(1);
            	HX_STACK_FRAME("flixel.tweens.FlxTween","color",0x9d3d7262,"flixel.tweens.FlxTween.color","flixel/tweens/FlxTween.hx",129,0x5d58d691)
            	HX_STACK_ARG(Sprite,"Sprite")
            	HX_STACK_ARG(Duration,"Duration")
            	HX_STACK_ARG(FromColor,"FromColor")
            	HX_STACK_ARG(ToColor,"ToColor")
            	HX_STACK_ARG(Options,"Options")
HXLINE( 129)		return ::flixel::tweens::FlxTween_obj::globalManager->color(Sprite,Duration,FromColor,ToColor,Options);
            	}
...
Bool UseDuration = __o_UseDuration.Default(true);
            	HX_STACK_FRAME("flixel.tweens.FlxTween","linearMotion",0xd656f2dc,"flixel.tweens.FlxTween.linearMotion","flixel/tweens/FlxTween.hx",151,0x5d58d691)
            	HX_STACK_ARG(Object,"Object")
            	...
            	HX_STACK_ARG(Options,"Options")
HXLINE( 151)		return ::flixel::tweens::FlxTween_obj::globalManager->linearMotion(Object,FromX,FromY,ToX,ToY,DurationOrSpeed,UseDuration,Options);
            	}
...
Float DurationOrSpeed = __o_DurationOrSpeed.Default(1);
Bool UseDuration = __o_UseDuration.Default(true);
            	HX_STACK_FRAME("flixel.tweens.FlxTween","quadMotion",0xc62584fe,"flixel.tweens.FlxTween.quadMotion","flixel/tweens/FlxTween.hx",175,0x5d58d691)
            	HX_STACK_ARG(Object,"Object")
            	HX_STACK_ARG(FromX,"FromX")
            	HX_STACK_ARG(FromY,"FromY")
            	...
            	HX_STACK_ARG(UseDuration,"UseDuration")
            	HX_STACK_ARG(Options,"Options")
HXLINE( 175)		return ::flixel::tweens::FlxTween_obj::globalManager->quadMotion(Object,FromX,FromY,ControlX,ControlY,ToX,ToY,DurationOrSpeed,UseDuration,Options);
            	}
...
Float Duration = __o_Duration.Default(1);
            	HX_STACK_FRAME("flixel.tweens.FlxTween","cubicMotion",0xa068755f,"flixel.tweens.FlxTween.cubicMotion","flixel/tweens/FlxTween.hx",200,0x5d58d691)
            	HX_STACK_ARG(Object,"Object")
            	HX_STACK_ARG(FromX,"FromX")
            	HX_STACK_ARG(FromY,"FromY")
            	HX_STACK_ARG(aX,"aX")
            	...
            	HX_STACK_ARG(Duration,"Duration")
            	HX_STACK_ARG(Options,"Options")
HXLINE( 200)		return ::flixel::tweens::FlxTween_obj::globalManager->cubicMotion(Object,FromX,FromY,aX,aY,bX,bY,ToX,ToY,Duration,Options);
            	}
...
Float DurationOrSpeed = __o_DurationOrSpeed.Default(1);
Bool UseDuration = __o_UseDuration.Default(true);
            	HX_STACK_FRAME("flixel.tweens.FlxTween","circularMotion",0x65e89916,"flixel.tweens.FlxTween.circularMotion","flixel/tweens/FlxTween.hx",224,0x5d58d691)
            	HX_STACK_ARG(Object,"Object")
            	...
            	HX_STACK_ARG(UseDuration,"UseDuration")
            	HX_STACK_ARG(Options,"Options")
HXLINE( 224)		return ::flixel::tweens::FlxTween_obj::globalManager->circularMotion(Object,CenterX,CenterY,Radius,Angle,Clockwise,DurationOrSpeed,UseDuration,Options);
            	}
...
Float DurationOrSpeed = __o_DurationOrSpeed.Default(1);
Bool UseDuration = __o_UseDuration.Default(true);
            	HX_STACK_FRAME("flixel.tweens.FlxTween","linearPath",0xd40abccb,"flixel.tweens.FlxTween.linearPath","flixel/tweens/FlxTween.hx",243,0x5d58d691)
            	HX_STACK_ARG(Object,"Object")
            	HX_STACK_ARG(Points,"Points")
            	HX_STACK_ARG(DurationOrSpeed,"DurationOrSpeed")
            	HX_STACK_ARG(UseDuration,"UseDuration")
            	HX_STACK_ARG(Options,"Options")
HXLINE( 243)		return ::flixel::tweens::FlxTween_obj::globalManager->linearPath(Object,Points,DurationOrSpeed,UseDuration,Options);
            	}
...
Float DurationOrSpeed = __o_DurationOrSpeed.Default(1);
Bool UseDuration = __o_UseDuration.Default(true);
            	HX_STACK_FRAME("flixel.tweens.FlxTween","quadPath",0x6abb226d,"flixel.tweens.FlxTween.quadPath","flixel/tweens/FlxTween.hx",262,0x5d58d691)
            	HX_STACK_ARG(Object,"Object")
            	HX_STACK_ARG(Points,"Points")
            	HX_STACK_ARG(DurationOrSpeed,"DurationOrSpeed")
            	HX_STACK_ARG(UseDuration,"UseDuration")
            	HX_STACK_ARG(Options,"Options")
HXLINE( 262)		return ::flixel::tweens::FlxTween_obj::globalManager->quadPath(Object,Points,DurationOrSpeed,UseDuration,Options);
            	}
