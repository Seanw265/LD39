...
HXDLIN(  59)				Float _hx_tmp1 = (point->y + (int)3);
HXDLIN(  59)				point->set(_hx_tmp,_hx_tmp1);
            			}
            		}
HXLINE(  61)		Bool _hx_tmp2 = hx::IsNotNull( Text );
HXDLIN(  61)		if (_hx_tmp2) {
HXLINE(  61)			Float _hx_tmp3 = (this->x + this->labelOffsets->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >()->x);
HXDLIN(  61)			Float _hx_tmp4 = (this->y + this->labelOffsets->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >()->y);
HXDLIN(  61)			this->set_label( ::flixel::text::FlxText_obj::__new(_hx_tmp3,_hx_tmp4,(int)80,Text,null(),null()));
HXDLIN(  61)			this->label->setFormat(null(),(int)8,(int)3355443,HX_("center",d5,25,db,05),null(),null(),null());
HXDLIN(  61)			Float _hx_tmp5 = this->labelAlphas->__get(this->status);
HXDLIN(  61)			this->label->set_alpha(_hx_tmp5);
...
void FlxButton_obj::resetHelpers(){
            	HX_STACK_FRAME("flixel.ui.FlxButton","resetHelpers",0x0b952648,"flixel.ui.FlxButton.resetHelpers","flixel/ui/FlxButton.hx",68,0xc64cf442)
            	HX_STACK_THIS(this)
HXLINE(  69)		this->super::resetHelpers();
HXLINE(  71)		Bool _hx_tmp = hx::IsNotNull( this->label );
HXDLIN(  71)		if (_hx_tmp) {
HXLINE(  73)			Float _hx_tmp1 = this->get_width();
HXDLIN(  73)			Int _hx_tmp2 = (this->label->frameWidth = ::Std_obj::_hx_int(_hx_tmp1));
HXDLIN(  73)			this->label->set_fieldWidth(_hx_tmp2);
HXLINE(  74)			Int _hx_tmp3 = ::Std_obj::_hx_int(this->label->_defaultFormat->size);
HXDLIN(  74)			this->label->set_size(_hx_tmp3);
            		}
            	}


void FlxButton_obj::initLabel(::String Text){
            	HX_STACK_FRAME("flixel.ui.FlxButton","initLabel",0xd1ec8c72,"flixel.ui.FlxButton.initLabel","flixel/ui/FlxButton.hx",80,0xc64cf442)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Text,"Text")
HXLINE(  80)		Bool _hx_tmp = hx::IsNotNull( Text );
HXDLIN(  80)		if (_hx_tmp) {
HXLINE(  82)			Float _hx_tmp1 = (this->x + this->labelOffsets->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >()->x);
HXDLIN(  82)			Float _hx_tmp2 = (this->y + this->labelOffsets->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >()->y);
HXDLIN(  82)			this->set_label( ::flixel::text::FlxText_obj::__new(_hx_tmp1,_hx_tmp2,(int)80,Text,null(),null()));
HXLINE(  83)			this->label->setFormat(null(),(int)8,(int)3355443,HX_("center",d5,25,db,05),null(),null(),null());
HXLINE(  84)			Float _hx_tmp3 = this->labelAlphas->__get(this->status);
HXDLIN(  84)			this->label->set_alpha(_hx_tmp3);
...
::String FlxButton_obj::get_text(){
            	HX_STACK_FRAME("flixel.ui.FlxButton","get_text",0x7dcfb448,"flixel.ui.FlxButton.get_text","flixel/ui/FlxButton.hx",91,0xc64cf442)
            	HX_STACK_THIS(this)
HXLINE(  91)		Bool _hx_tmp = hx::IsNotNull( this->label );
...
::String FlxButton_obj::set_text(::String Text){
            	HX_STACK_FRAME("flixel.ui.FlxButton","set_text",0x2c2d0dbc,"flixel.ui.FlxButton.set_text","flixel/ui/FlxButton.hx",95,0xc64cf442)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Text,"Text")
HXLINE(  96)		Bool _hx_tmp = hx::IsNull( this->label );
HXDLIN(  96)		if (_hx_tmp) {
HXLINE(  98)			Bool _hx_tmp1 = hx::IsNotNull( Text );
HXDLIN(  98)			if (_hx_tmp1) {
HXLINE(  98)				Float _hx_tmp2 = (this->x + this->labelOffsets->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >()->x);
HXDLIN(  98)				Float _hx_tmp3 = (this->y + this->labelOffsets->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >()->y);
HXDLIN(  98)				this->set_label( ::flixel::text::FlxText_obj::__new(_hx_tmp2,_hx_tmp3,(int)80,Text,null(),null()));
HXDLIN(  98)				this->label->setFormat(null(),(int)8,(int)3355443,HX_("center",d5,25,db,05),null(),null(),null());
HXDLIN(  98)				Float _hx_tmp4 = this->labelAlphas->__get(this->status);
HXDLIN(  98)				this->label->set_alpha(_hx_tmp4);
