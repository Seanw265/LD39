...
void FlxButtonEvent_obj::__construct( ::Dynamic Callback, ::flixel::_hx_system::FlxSound sound){
            	HX_STACK_FRAME("flixel.ui._FlxButton.FlxButtonEvent","new",0xea40fb69,"flixel.ui._FlxButton.FlxButtonEvent.new","flixel/ui/FlxButton.hx",635,0xc64cf442)
            	HX_STACK_THIS(this)
...
void FlxButtonEvent_obj::destroy(){
            	HX_STACK_FRAME("flixel.ui._FlxButton.FlxButtonEvent","destroy",0x72801083,"flixel.ui._FlxButton.FlxButtonEvent.destroy","flixel/ui/FlxButton.hx",647,0xc64cf442)
            	HX_STACK_THIS(this)
...
void FlxButtonEvent_obj::fire(){
            	HX_STACK_FRAME("flixel.ui._FlxButton.FlxButtonEvent","fire",0x0954508d,"flixel.ui._FlxButton.FlxButtonEvent.fire","flixel/ui/FlxButton.hx",659,0xc64cf442)
            	HX_STACK_THIS(this)
HXLINE( 660)		Bool _hx_tmp = hx::IsNotNull( this->callback );
HXDLIN( 660)		if (_hx_tmp) {
HXLINE( 661)			this->callback();
            		}
HXLINE( 664)		Bool _hx_tmp1 = hx::IsNotNull( this->sound );
