...
HXLINE(  49)				_hx_tmp3 = (bmd->width >= w);
            			}
            			else {
HXLINE(  49)				_hx_tmp3 = false;
            			}
HXDLIN(  49)			if (_hx_tmp3) {
HXLINE(  49)				_hx_tmp2 = (bmd->height >= h);
            			}
            			else {
...
HXLINE(  50)						_hx_tmp4 = (bmd->width == w);
            					}
            					else {
...
HXLINE(  52)				res = bmd;
HXLINE(  55)				Bool _hx_tmp5 = hx::IsNotNull( node->prev );
HXDLIN(  55)				if (_hx_tmp5) {
HXLINE(  55)					node->prev->next = node->next;
            				}
HXLINE(  56)				Bool _hx_tmp6 = hx::IsNotNull( node->next );
...
HXLINE(  63)			node = node->next;
            		...
            		_hx_goto_0:;
HXLINE(  66)		Bool _hx_tmp7 = hx::IsNotNull( res );
HXDLIN(  66)		if (_hx_tmp7) {
HXLINE(  68)			Bool _hx_tmp8 = hx::IsNotNull( fillColor );
...
HXLINE(  79)			Int _hx_tmp9;
HXDLIN(  79)			Bool _hx_tmp10 = hx::IsNotNull( fillColor );
HXDLIN(  79)			if (_hx_tmp10) {
HXLINE(  79)				_hx_tmp9 = fillColor;
            			}
            			else {
HXLINE(  79)				_hx_tmp9 = (int)-1;
            			}
HXDLIN(  79)			res =  ::openfl::display::BitmapData_obj::__new(w,h,transparent,_hx_tmp9);
            		}
...
HXLINE( 125)			HX_VARI(  ::openfl::display::BitmapData,bmd) = node->bmd;
...
HXLINE( 141)				HX_VARI(  ::openfl::display::BitmapData,bmd) = node->bmd;
...
HXLINE(  31)		_rect =  ::openfl::geom::Rectangle_obj::__new(null(),null(),null(),null());
            	}
}
