...
::Array< ::Dynamic> FlxPath_obj::get_nodes(){
            	HX_STACK_FRAME("flixel.util.FlxPath","get_nodes",0xc07828d7,"flixel.util.FlxPath.get_nodes","flixel/util/FlxPath.hx",796,0x22aae741)
            	HX_STACK_THIS(this)
...
::Array< ::Dynamic> FlxPath_obj::set_nodes(::Array< ::Dynamic> Nodes){
            	HX_STACK_FRAME("flixel.util.FlxPath","set_nodes",0xa3c914e3,"flixel.util.FlxPath.set_nodes","flixel/util/FlxPath.hx",800,0x22aae741)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Nodes,"Nodes")
HXLINE( 801)		Bool _hx_tmp = hx::IsNotNull( Nodes );
