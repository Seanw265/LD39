...
HXLINE( 217)		Float _hx_tmp = ::haxe::Timer_obj::getMS();
HXDLIN( 217)		this->mFireAt = (_hx_tmp + this->mTime);
...
void _hx_run(){
            	HX_STACK_FRAME("haxe.Timer","__default_run",0xdc2b9b9c,"haxe.Timer.__default_run","haxe/Timer.hx",260,0x1a690682)
            	HX_STACK_THIS(this)
            	}
...
void Timer_obj::stop(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 280)		Bool _hx_tmp = this->mRunning;
...
HXLINE( 284)					HX_VARI( Int,i) = _g1++;
HXLINE( 286)					Bool _hx_tmp1 = hx::IsEq( ::haxe::Timer_obj::sRunningTimers->__get(i).StaticCast<  ::haxe::Timer >(),hx::ObjectPtr<OBJ_>(this) );
HXDLIN( 286)					if (_hx_tmp1) {
HXLINE( 288)						::haxe::Timer_obj::sRunningTimers[i] = null();
HXLINE( 289)						goto _hx_goto_0;
            					}
            				}
            				_hx_goto_0:;
            			}
...
HXLINE( 302)		Bool _hx_tmp = (inTime >= this->mFireAt);
HXDLIN( 302)		if (_hx_tmp) {
HXLINE( 304)			hx::AddEq(this->mFireAt,this->mTime);
HXLINE( 305)			this->run();
            		}
            	}
...
::Array< ::Dynamic> Timer_obj::sRunningTimers;
 ...
 ::haxe::Timer Timer_obj::delay( ::Dynamic f,Int time){
            		...
            		void _hx_run(){
            			HX_STACK_FRAME("haxe.Timer","delay",0x3ed5f1b2,"haxe.Timer.delay","haxe/Timer.hx",227,0x1a690682)
HXLINE( 229)			t->stop();
HXLINE( 230)			f();
            		}
            		HX_END_LOCAL_FUNC0((void))
            	...
            	HX_STACK_ARG(f,"f")
            	HX_STACK_ARG(time,"time")
HXLINE( 225)		HX_VARI(  ::haxe::Timer,t) =  ::haxe::Timer_obj::__new(time);
...
HXLINE( 254)		Float _hx_tmp = ::haxe::Timer_obj::stamp();
HXDLIN( 254)		::haxe::Log_obj::trace(((_hx_tmp - t0) + HX_("s",73,00,00,00)),pos);
HXLINE( 255)		return r;
            	}
...
Float Timer_obj::stamp(){
            	HX_STACK_FRAME("haxe.Timer","stamp",0xebba8a32,"haxe.Timer.stamp","haxe/Timer.hx",272,0x1a690682)
HXLINE( 272)		Int _hx_tmp = ::lime::_hx_system::System_obj::getTimer();
HXDLIN( 272)		return ((Float)_hx_tmp / (Float)(int)1000);
            	}
...
HXLINE( 322)				Bool _hx_tmp = hx::IsNotNull( timer );
HXDLIN( 322)				if (_hx_tmp) {
HXLINE( 324)					timer->_hx___check(now);
            				}
HXLINE( 328)				Bool _hx_tmp1 = !(foundNull);
...
HXLINE( 332)		if (foundNull) {
            			...
            			Bool _hx_run( ::haxe::Timer val){
            				HX_STACK_FRAME("haxe.Timer","__checkTimers",0xb7078205,"haxe.Timer.__checkTimers","haxe/Timer.hx",334,0x1a690682)
...
{
{
            	HX_STACK_FRAME("haxe.Timer","boot",0xc6bd04e3,"haxe.Timer.boot","haxe/Timer.hx",206,0x1a690682)
