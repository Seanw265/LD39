...
Int Utf8_obj::compare(::String a,::String b){
            	HX_STACK_FRAME("haxe.Utf8","compare",0x9f848dd0,"haxe.Utf8.compare","/usr/local/lib/haxe/std/cpp/_std/haxe/Utf8.hx",78,0xb2cec866)
            	HX_STACK_ARG(a,"a")
            	HX_STACK_ARG(b,"b")
...
::String Utf8_obj::sub(::String s,Int pos,Int len){
            	HX_STACK_FRAME("haxe.Utf8","sub",0x67d06d2b,"haxe.Utf8.sub","/usr/local/lib/haxe/std/cpp/_std/haxe/Utf8.hx",82,0xb2cec866)
            	HX_STACK_ARG(s,"s")
