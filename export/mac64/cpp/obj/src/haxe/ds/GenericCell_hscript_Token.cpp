...
void GenericCell_hscript_Token_obj::__construct(::hx::EnumBase elt, ::haxe::ds::GenericCell_hscript_Token next){
            	HX_STACK_FRAME("haxe.ds.GenericCell_hscript_Token","new",0x1c0e2ea2,"haxe.ds.GenericCell_hscript_Token.new","/usr/local/lib/haxe/std/haxe/ds/GenericStack.hx",35,0xcaed4b39)
            	HX_STACK_THIS(this)
