...
void GenericStackIterator_hscript_Token_obj::__construct( ::haxe::ds::GenericCell_hscript_Token head){
            	HX_STACK_FRAME("haxe.ds._GenericStack.GenericStackIterator_hscript_Token","new",0xbf5d5a94,"haxe.ds._GenericStack.GenericStackIterator_hscript_Token.new","/usr/local/lib/haxe/std/haxe/ds/GenericStack.hx",45,0xcaed4b39)
            	HX_STACK_THIS(this)
...
Bool GenericStackIterator_hscript_Token_obj::hasNext(){
            	HX_STACK_FRAME("haxe.ds._GenericStack.GenericStackIterator_hscript_Token","hasNext",0xccb359a1,"haxe.ds._GenericStack.GenericStackIterator_hscript_Token.hasNext","/usr/local/lib/haxe/std/haxe/ds/GenericStack.hx",42,0xcaed4b39)
            	HX_STACK_THIS(this)
...
::hx::EnumBase GenericStackIterator_hscript_Token_obj::next(){
            	HX_STACK_FRAME("haxe.ds._GenericStack.GenericStackIterator_hscript_Token","next",0xb251e83f,"haxe.ds._GenericStack.GenericStackIterator_hscript_Token.next","/usr/local/lib/haxe/std/haxe/ds/GenericStack.hx",43,0xcaed4b39)
            	HX_STACK_THIS(this)
