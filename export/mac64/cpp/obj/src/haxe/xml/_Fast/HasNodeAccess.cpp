...
Bool HasNodeAccess_obj::resolve(::String name){
            	HX_STACK_FRAME("haxe.xml._Fast.HasNodeAccess","resolve",0x2b3f8e2c,"haxe.xml._Fast.HasNodeAccess.resolve","/usr/local/lib/haxe/std/haxe/xml/Fast.hx",87,0x1680b11e)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(name,"name")
HXLINE(  87)		return ( (Bool)( ::Dynamic(this->_hx___x->elementsNamed(name)->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) );
            	}
