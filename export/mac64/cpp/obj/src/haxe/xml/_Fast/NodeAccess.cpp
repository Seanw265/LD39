...
HXLINE(  33)		HX_VARI(  ::Xml,x) = ( ( ::Xml)( ::Dynamic(this->_hx___x->elementsNamed(name)->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE(  34)		Bool _hx_tmp = hx::IsNull( x );
...
HXLINE(  38)		return  ::haxe::xml::Fast_obj::__new(x);
            	}
