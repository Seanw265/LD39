...
HXLINE(1060)		this->audio =  ::haxe::ds::StringMap_obj::__new();
HXLINE(1061)		this->font =  ::haxe::ds::StringMap_obj::__new();
HXLINE(1062)		this->image =  ::haxe::ds::StringMap_obj::__new();
HXLINE(1063)		Float _hx_tmp = ::Math_obj::random();
HXDLIN(1063)		this->version = ::Std_obj::_hx_int((_hx_tmp * (int)1000000));
            	}
...
void AssetCache_obj::clear(::String prefix){
            	HX_STACK_FRAME("lime.AssetCache","clear",0xa2398fea,"lime.AssetCache.clear","lime/Assets.hx",1070,0x48c77341)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(prefix,"prefix")
HXLINE(1070)		Bool _hx_tmp = hx::IsNull( prefix );
HXDLIN(1070)		if (_hx_tmp) {
HXLINE(1072)			this->audio =  ::haxe::ds::StringMap_obj::__new();
HXLINE(1073)			this->font =  ::haxe::ds::StringMap_obj::__new();
HXLINE(1074)			this->image =  ::haxe::ds::StringMap_obj::__new();
            		}
            		else {
HXLINE(1078)			HX_VARI(  ::Dynamic,keys) = this->audio->keys();
HXLINE(1080)			while(true){
HXLINE(1080)				Bool _hx_tmp1 = !(( (Bool)( ::Dynamic(keys->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN(1080)				if (_hx_tmp1) {
HXLINE(1080)					goto _hx_goto_0;
            				}
HXDLIN(1080)				HX_VARI( ::String,key) = ( (::String)( ::Dynamic(keys->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE(1082)				Bool _hx_tmp2 = ::StringTools_obj::startsWith(key,prefix);
...
HXLINE(1092)			while(true){
HXLINE(1092)				Bool _hx_tmp3 = !(( (Bool)( ::Dynamic(keys1->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN(1092)				if (_hx_tmp3) {
HXLINE(1092)					goto _hx_goto_1;
            				}
HXDLIN(1092)				HX_VARI_NAME( ::String,key1,"key") = ( (::String)( ::Dynamic(keys1->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE(1094)				Bool _hx_tmp4 = ::StringTools_obj::startsWith(key1,prefix);
HXDLIN(1094)				if (_hx_tmp4) {
...
HXLINE(1104)				Bool _hx_tmp5 = !(( (Bool)( ::Dynamic(keys2->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN(1104)				if (_hx_tmp5) {
HXLINE(1104)					goto _hx_goto_2;
            				}
HXDLIN(1104)				HX_VARI_NAME( ::String,key2,"key") = ( (::String)( ::Dynamic(keys2->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE(1106)				Bool _hx_tmp6 = ::StringTools_obj::startsWith(key2,prefix);
