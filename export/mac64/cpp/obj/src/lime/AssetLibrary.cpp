...
void AssetLibrary_obj::__construct(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 889)		this->onChange =  ::lime::app::Event_Void_Void_obj::__new();
            	}
...
::String AssetLibrary_obj::getText(::String id){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE( 945)		HX_VARI(  ::lime::utils::Bytes,bytes) = this->getBytes(id);
HXLINE( 947)		Bool _hx_tmp = hx::IsNull( bytes );
HXDLIN( 947)		if (_hx_tmp) {
HXLINE( 949)			return null();
            		}
            		else {
HXLINE( 953)			return bytes->getString((int)0,bytes->length);
            		}
 ...
 ::lime::app::Future AssetLibrary_obj::load(){
            		HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_0, ::lime::AssetLibrary,_gthis) HXARGC(0)
            		 ::lime::AssetLibrary _hx_run(){
            			HX_STACK_FRAME("lime.AssetLibrary","load",0x688cfed0,"lime.AssetLibrary.load","lime/Assets.hx",982,0x48c77341)
...
HXLINE( 982)		return  ::lime::app::Future_obj::__new( ::Dynamic(new _hx_Closure_0(_gthis)));
            	}
 ...
 ::lime::app::Future AssetLibrary_obj::loadAudioBuffer(::String id){
            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_0,::String,id, ::lime::AssetLibrary,_gthis) HXARGC(0)
            		 ::lime::audio::AudioBuffer _hx_run(){
            			HX_STACK_FRAME("lime.AssetLibrary","loadAudioBuffer",0x68b85986,"lime.AssetLibrary.loadAudioBuffer","lime/Assets.hx",989,0x48c77341)
...
HXLINE( 989)		return  ::lime::app::Future_obj::__new( ::Dynamic(new _hx_Closure_0(id,_gthis)));
            	}
 ...
 ::lime::app::Future AssetLibrary_obj::loadBytes(::String id){
            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_0,::String,id, ::lime::AssetLibrary,_gthis) HXARGC(0)
            		 ::lime::utils::Bytes _hx_run(){
            			HX_STACK_FRAME("lime.AssetLibrary","loadBytes",0x3c9ac77b,"lime.AssetLibrary.loadBytes","lime/Assets.hx",996,0x48c77341)
...
HXLINE( 996)		return  ::lime::app::Future_obj::__new( ::Dynamic(new _hx_Closure_0(id,_gthis)));
            	}
 ...
 ::lime::app::Future AssetLibrary_obj::loadFont(::String id){
            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_0,::String,id, ::lime::AssetLibrary,_gthis) HXARGC(0)
            		 ::lime::text::Font _hx_run(){
            			HX_STACK_FRAME("lime.AssetLibrary","loadFont",0x57d630bf,"lime.AssetLibrary.loadFont","lime/Assets.hx",1003,0x48c77341)
...
HXLINE(1003)		return  ::lime::app::Future_obj::__new( ::Dynamic(new _hx_Closure_0(id,_gthis)));
            	}
 ...
 ::lime::app::Future AssetLibrary_obj::loadImage(::String id){
            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_0,::String,id, ::lime::AssetLibrary,_gthis) HXARGC(0)
            		 ::lime::graphics::Image _hx_run(){
            			HX_STACK_FRAME("lime.AssetLibrary","loadImage",0x3c6bde6b,"lime.AssetLibrary.loadImage","lime/Assets.hx",1010,0x48c77341)
...
HXLINE(1010)		return  ::lime::app::Future_obj::__new( ::Dynamic(new _hx_Closure_0(id,_gthis)));
            	}
 ...
 ::lime::app::Future AssetLibrary_obj::loadText(::String id){
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            		 ::lime::app::Future _hx_run( ::lime::utils::Bytes bytes){
            			...
            			::String _hx_run(){
            				HX_STACK_FRAME("lime.AssetLibrary","loadText",0x610f9f9d,"lime.AssetLibrary.loadText","lime/Assets.hx",1021,0x48c77341)
HXLINE(1021)				Bool _hx_tmp = hx::IsNull( bytes );
...
HXLINE(1021)				return null();
            			...
            			HX_STACK_FRAME("lime.AssetLibrary","loadText",0x610f9f9d,"lime.AssetLibrary.loadText","lime/Assets.hx",1019,0x48c77341)
            			HX_STACK_ARG(bytes,"bytes")
HXLINE(1019)			return  ::lime::app::Future_obj::__new( ::Dynamic(new _hx_Closure_0(bytes)));
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_STACK_FRAME("lime.AssetLibrary","loadText",0x610f9f9d,"lime.AssetLibrary.loadText","lime/Assets.hx",1017,0x48c77341)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
