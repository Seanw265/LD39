...
HXLINE(  80)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeApplication_obj::cffi_lime_application_create(hx::DynamicPtr( ::Dynamic(hx::Anon_obj::Create(0))))) );
HXDLIN(  80)		 ::Dynamic _hx_tmp = Dynamic(hx::DynamicPtr(inVal));
HXDLIN(  80)		this->handle = _hx_tmp;
            	}
...
Int NativeApplication_obj::exec(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  90)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(this->handleApplicationEvent_dyn());
HXDLIN(  90)		::lime::_backend::native::NativeApplication_obj::cffi_lime_application_event_manager_register(_hx_tmp,hx::DynamicPtr(this->applicationEventInfo));
HXLINE(  91)		 ::hx::Object * _hx_tmp1 = hx::DynamicPtr(this->handleDropEvent_dyn());
HXDLIN(  91)		::lime::_backend::native::NativeApplication_obj::cffi_lime_drop_event_manager_register(_hx_tmp1,hx::DynamicPtr(this->dropEventInfo));
HXLINE(  92)		 ::hx::Object * _hx_tmp2 = hx::DynamicPtr(this->handleGamepadEvent_dyn());
HXDLIN(  92)		::lime::_backend::native::NativeApplication_obj::cffi_lime_gamepad_event_manager_register(_hx_tmp2,hx::DynamicPtr(this->gamepadEventInfo));
HXLINE(  93)		 ::hx::Object * _hx_tmp3 = hx::DynamicPtr(this->handleJoystickEvent_dyn());
HXDLIN(  93)		::lime::_backend::native::NativeApplication_obj::cffi_lime_joystick_event_manager_register(_hx_tmp3,hx::DynamicPtr(this->joystickEventInfo));
HXLINE(  94)		 ::hx::Object * _hx_tmp4 = hx::DynamicPtr(this->handleKeyEvent_dyn());
HXDLIN(  94)		::lime::_backend::native::NativeApplication_obj::cffi_lime_key_event_manager_register(_hx_tmp4,hx::DynamicPtr(this->keyEventInfo));
HXLINE(  95)		 ::hx::Object * _hx_tmp5 = hx::DynamicPtr(this->handleMouseEvent_dyn());
HXDLIN(  95)		::lime::_backend::native::NativeApplication_obj::cffi_lime_mouse_event_manager_register(_hx_tmp5,hx::DynamicPtr(this->mouseEventInfo));
HXLINE(  96)		 ::hx::Object * _hx_tmp6 = hx::DynamicPtr(this->handleRenderEvent_dyn());
HXDLIN(  96)		::lime::_backend::native::NativeApplication_obj::cffi_lime_render_event_manager_register(_hx_tmp6,hx::DynamicPtr(this->renderEventInfo));
HXLINE(  97)		 ::hx::Object * _hx_tmp7 = hx::DynamicPtr(this->handleTextEvent_dyn());
HXDLIN(  97)		::lime::_backend::native::NativeApplication_obj::cffi_lime_text_event_manager_register(_hx_tmp7,hx::DynamicPtr(this->textEventInfo));
HXLINE(  98)		 ::hx::Object * _hx_tmp8 = hx::DynamicPtr(this->handleTouchEvent_dyn());
HXDLIN(  98)		::lime::_backend::native::NativeApplication_obj::cffi_lime_touch_event_manager_register(_hx_tmp8,hx::DynamicPtr(this->touchEventInfo));
HXLINE(  99)		 ::hx::Object * _hx_tmp9 = hx::DynamicPtr(this->handleWindowEvent_dyn());
HXDLIN(  99)		::lime::_backend::native::NativeApplication_obj::cffi_lime_window_event_manager_register(_hx_tmp9,hx::DynamicPtr(this->windowEventInfo));
HXLINE( 131)		 ::Dynamic handle = this->handle;
HXDLIN( 131)		HX_VARI( Int,result) = ( (Int)(::lime::_backend::native::NativeApplication_obj::cffi_lime_application_exec(hx::DynamicPtr(handle))) );
HXLINE( 132)		this->parent->onExit->dispatch(result);
...
HXDLIN( 149)			::lime::_backend::native::NativeApplication_obj::cffi_lime_application_quit(hx::DynamicPtr(handle));
            		}
            	}
...
Float NativeApplication_obj::getFrameRate(){
            	HX_STACK_FRAME("lime._backend.native.NativeApplication","getFrameRate",0xe79bf983,"lime._backend.native.NativeApplication.getFrameRate","lime/_backend/native/NativeApplication.hx",157,0xb13849fd)
            	HX_STACK_THIS(this)
...
void NativeApplication_obj::handleApplicationEvent(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 164)		HX_VARI( Int,_g) = this->applicationEventInfo->type;
...
void NativeApplication_obj::handleGamepadEvent(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 193)		HX_VARI( Int,_g) = this->gamepadEventInfo->type;
HXDLIN( 193)		switch((int)(_g)){
            			case (int)0: {
HXLINE( 197)				Int key = this->gamepadEventInfo->id;
HXDLIN( 197)				HX_VARI(  ::lime::ui::Gamepad,gamepad) = ::lime::ui::Gamepad_obj::devices->get(key).StaticCast<  ::lime::ui::Gamepad >();
HXLINE( 198)				Bool _hx_tmp = hx::IsNotNull( gamepad );
...
HXLINE( 198)					gamepad->onAxisMove->dispatch(this->gamepadEventInfo->axis,this->gamepadEventInfo->value);
            			...
            			break;
            			case (int)1: {
HXLINE( 202)				Int key1 = this->gamepadEventInfo->id;
HXDLIN( 202)				HX_VARI_NAME(  ::lime::ui::Gamepad,gamepad1,"gamepad") = ::lime::ui::Gamepad_obj::devices->get(key1).StaticCast<  ::lime::ui::Gamepad >();
HXLINE( 203)				Bool _hx_tmp1 = hx::IsNotNull( gamepad1 );
...
HXLINE( 203)					gamepad1->onButtonDown->dispatch(this->gamepadEventInfo->button);
            			...
            			break;
            			case (int)2: {
HXLINE( 207)				Int key2 = this->gamepadEventInfo->id;
HXDLIN( 207)				HX_VARI_NAME(  ::lime::ui::Gamepad,gamepad2,"gamepad") = ::lime::ui::Gamepad_obj::devices->get(key2).StaticCast<  ::lime::ui::Gamepad >();
HXLINE( 208)				Bool _hx_tmp2 = hx::IsNotNull( gamepad2 );
...
void NativeApplication_obj::handleJoystickEvent(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 225)		HX_VARI( Int,_g) = this->joystickEventInfo->type;
HXDLIN( 225)		switch((int)(_g)){
            			case (int)0: {
HXLINE( 229)				Int key = this->joystickEventInfo->id;
HXDLIN( 229)				HX_VARI(  ::lime::ui::Joystick,joystick) = ::lime::ui::Joystick_obj::devices->get(key).StaticCast<  ::lime::ui::Joystick >();
HXLINE( 230)				Bool _hx_tmp = hx::IsNotNull( joystick );
...
HXLINE( 230)					joystick->onAxisMove->dispatch(this->joystickEventInfo->index,this->joystickEventInfo->value);
            			...
            			break;
            			case (int)1: {
HXLINE( 234)				Int key1 = this->joystickEventInfo->id;
HXDLIN( 234)				HX_VARI_NAME(  ::lime::ui::Joystick,joystick1,"joystick") = ::lime::ui::Joystick_obj::devices->get(key1).StaticCast<  ::lime::ui::Joystick >();
HXLINE( 235)				Bool _hx_tmp1 = hx::IsNotNull( joystick1 );
...
HXLINE( 235)					joystick1->onHatMove->dispatch(this->joystickEventInfo->index,this->joystickEventInfo->x);
            			...
            			break;
            			case (int)2: {
HXLINE( 239)				Int key2 = this->joystickEventInfo->id;
HXDLIN( 239)				HX_VARI_NAME(  ::lime::ui::Joystick,joystick2,"joystick") = ::lime::ui::Joystick_obj::devices->get(key2).StaticCast<  ::lime::ui::Joystick >();
HXLINE( 240)				Bool _hx_tmp2 = hx::IsNotNull( joystick2 );
...
HXLINE( 240)					joystick2->onTrackballMove->dispatch(this->joystickEventInfo->index,this->joystickEventInfo->value);
            			...
            			break;
            			case (int)3: {
HXLINE( 244)				Int key3 = this->joystickEventInfo->id;
HXDLIN( 244)				HX_VARI_NAME(  ::lime::ui::Joystick,joystick3,"joystick") = ::lime::ui::Joystick_obj::devices->get(key3).StaticCast<  ::lime::ui::Joystick >();
HXLINE( 245)				Bool _hx_tmp3 = hx::IsNotNull( joystick3 );
...
HXLINE( 245)					joystick3->onButtonDown->dispatch(this->joystickEventInfo->index);
            			...
            			break;
            			case (int)4: {
HXLINE( 249)				Int key4 = this->joystickEventInfo->id;
HXDLIN( 249)				HX_VARI_NAME(  ::lime::ui::Joystick,joystick4,"joystick") = ::lime::ui::Joystick_obj::devices->get(key4).StaticCast<  ::lime::ui::Joystick >();
HXLINE( 250)				Bool _hx_tmp4 = hx::IsNotNull( joystick4 );
...
void NativeApplication_obj::handleKeyEvent(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 267)		Int key = this->keyEventInfo->windowID;
HXDLIN( 267)		HX_VARI(  ::lime::ui::Window,window) = this->parent->windowByID->get(key).StaticCast<  ::lime::ui::Window >();
HXLINE( 269)		Bool _hx_tmp = hx::IsNotNull( window );
...
HXDLIN( 297)			if ((keyCode == (int)102)) {
HXLINE( 297)				_hx_tmp6 = ::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier);
            			}
            			else {
HXLINE( 297)				_hx_tmp6 = false;
            			}
HXDLIN( 297)			if (_hx_tmp6) {
HXLINE( 297)				_hx_tmp5 = ::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier);
            			}
            			else {
HXLINE( 297)				_hx_tmp5 = false;
            			}
HXDLIN( 297)			if (_hx_tmp5) {
HXLINE( 297)				_hx_tmp4 = (type == (int)0);
            			}
            			else {
HXLINE( 297)				_hx_tmp4 = false;
            			}
HXDLIN( 297)			if (_hx_tmp4) {
HXLINE( 297)				_hx_tmp3 = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            			}
            			else {
...
HXLINE( 297)				_hx_tmp1 = !(window->onKeyDown->canceled);
            			}
            			else {
HXLINE( 297)				_hx_tmp1 = false;
            			}
HXDLIN( 297)			if (_hx_tmp1) {
HXLINE( 299)				window->set_fullscreen(!(window->_hx___fullscreen));
            			}
            		}
            	}
...
void NativeApplication_obj::handleMouseEvent(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 320)		Int key = this->mouseEventInfo->windowID;
HXDLIN( 320)		HX_VARI(  ::lime::ui::Window,window) = this->parent->windowByID->get(key).StaticCast<  ::lime::ui::Window >();
HXLINE( 322)		Bool _hx_tmp = hx::IsNotNull( window );
HXDLIN( 322)		if (_hx_tmp) {
HXLINE( 324)			HX_VARI( Int,_g) = this->mouseEventInfo->type;
HXDLIN( 324)			switch((int)(_g)){
            				case (int)0: {
...
HXLINE( 358)			{
HXLINE( 358)				HX_VARI( Int,_g2) = this->renderEventInfo->type;
HXDLIN( 358)				switch((int)(_g2)){
            					case (int)0: {
...
HXLINE( 364)						renderer->flip();
            					...
            					break;
            					case (int)1: {
HXLINE( 368)						Bool _hx_tmp = renderer->backend->useHardware;
...
HXLINE( 371)							renderer->onContextLost->dispatch();
            					...
            					break;
            					case (int)2: {
HXLINE( 377)						Bool _hx_tmp1 = renderer->backend->useHardware;
HXDLIN( 377)						if (_hx_tmp1) {
HXLINE( 382)							renderer->context = ::lime::graphics::RenderContext_obj::OPENGL( ::lime::graphics::GLRenderContext_obj::__new());
...
void NativeApplication_obj::handleSensorEvent(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 398)		Int key = this->sensorEventInfo->id;
HXDLIN( 398)		HX_VARI(  ::lime::_hx_system::Sensor,sensor) = ::lime::_hx_system::Sensor_obj::sensorByID->get(key).StaticCast<  ::lime::_hx_system::Sensor >();
HXLINE( 400)		Bool _hx_tmp = hx::IsNotNull( sensor );
...
void NativeApplication_obj::handleTextEvent(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 411)		Int key = this->textEventInfo->windowID;
HXDLIN( 411)		HX_VARI(  ::lime::ui::Window,window) = this->parent->windowByID->get(key).StaticCast<  ::lime::ui::Window >();
HXLINE( 413)		Bool _hx_tmp = hx::IsNotNull( window );
HXDLIN( 413)		if (_hx_tmp) {
HXLINE( 415)			HX_VARI( Int,_g) = this->textEventInfo->type;
HXDLIN( 415)			switch((int)(_g)){
            				case (int)0: {
...
void NativeApplication_obj::handleTouchEvent(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 436)		HX_VARI( Int,_g) = this->touchEventInfo->type;
HXDLIN( 436)		switch((int)(_g)){
            			case (int)0: {
HXLINE( 440)				HX_VARI(  ::lime::ui::Touch,touch) = this->unusedTouchesPool->pop().StaticCast<  ::lime::ui::Touch >();
HXLINE( 442)				Bool _hx_tmp = hx::IsNull( touch );
HXDLIN( 442)				if (_hx_tmp) {
HXLINE( 444)					touch =  ::lime::ui::Touch_obj::__new(this->touchEventInfo->x,this->touchEventInfo->y,this->touchEventInfo->id,this->touchEventInfo->dx,this->touchEventInfo->dy,this->touchEventInfo->pressure,this->touchEventInfo->device);
            				}
            				else {
...
HXLINE( 458)				{
HXLINE( 458)					Int key = touch->id;
HXDLIN( 458)					this->currentTouches->set(key,touch);
            				}
HXLINE( 460)				::lime::ui::Touch_obj::onStart->dispatch(touch);
            			}
            			break;
            			case (int)1: {
HXLINE( 464)				Int key1 = this->touchEventInfo->id;
HXDLIN( 464)				HX_VARI_NAME(  ::lime::ui::Touch,touch1,"touch") = this->currentTouches->get(key1).StaticCast<  ::lime::ui::Touch >();
HXLINE( 466)				Bool _hx_tmp1 = hx::IsNotNull( touch1 );
...
HXLINE( 476)					{
HXLINE( 476)						Int key2 = this->touchEventInfo->id;
HXDLIN( 476)						this->currentTouches->remove(key2);
            					}
HXLINE( 477)					this->unusedTouchesPool->add(touch1);
            			...
            			break;
            			case (int)2: {
HXLINE( 483)				Int key3 = this->touchEventInfo->id;
HXDLIN( 483)				HX_VARI_NAME(  ::lime::ui::Touch,touch2,"touch") = this->currentTouches->get(key3).StaticCast<  ::lime::ui::Touch >();
HXLINE( 485)				Bool _hx_tmp2 = hx::IsNotNull( touch2 );
...
void NativeApplication_obj::handleWindowEvent(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 506)		Int key = this->windowEventInfo->windowID;
HXDLIN( 506)		HX_VARI(  ::lime::ui::Window,window) = this->parent->windowByID->get(key).StaticCast<  ::lime::ui::Window >();
HXLINE( 508)		Bool _hx_tmp = hx::IsNotNull( window );
HXDLIN( 508)		if (_hx_tmp) {
HXLINE( 510)			HX_VARI( Int,_g) = this->windowEventInfo->type;
...
HXLINE( 520)					Bool _hx_tmp1 = !(window->onClose->canceled);
...
HXLINE( 579)		{
HXLINE( 579)			 ::Dynamic handle = this->handle;
HXDLIN( 579)			::lime::_backend::native::NativeApplication_obj::cffi_lime_application_set_frame_rate(hx::DynamicPtr(handle),value);
            		}
...
void NativeApplication_obj::updateTimer(){
            	HX_STACK_FRAME("lime._backend.native.NativeApplication","updateTimer",0x8a9bcb30,"lime._backend.native.NativeApplication.updateTimer","lime/_backend/native/NativeApplication.hx",588,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 588)		Bool _hx_tmp = (::haxe::Timer_obj::sRunningTimers->length > (int)0);
...
HXLINE( 594)					HX_VARI( Int,i) = _g1++;
HXLINE( 596)					timer = ::haxe::Timer_obj::sRunningTimers->__get(i).StaticCast<  ::haxe::Timer >();
HXLINE( 598)					Bool _hx_tmp1 = hx::IsNotNull( timer );
HXDLIN( 598)					if (_hx_tmp1) {
HXLINE( 600)						Bool _hx_tmp2 = (currentTime >= timer->mFireAt);
HXDLIN( 600)						if (_hx_tmp2) {
HXLINE( 602)							hx::AddEq(timer->mFireAt,timer->mTime);
...
HXLINE( 615)			if (foundNull) {
            				...
            				Bool _hx_run( ::haxe::Timer val){
            					HX_STACK_FRAME("lime._backend.native.NativeApplication","updateTimer",0x8a9bcb30,"lime._backend.native.NativeApplication.updateTimer","lime/_backend/native/NativeApplication.hx",617,0xb13849fd)
...
HX_DEFINE_DYNAMIC_FUNC0(NativeApplication_obj,updateTimer,(void))
 ...
 ::Dynamic NativeApplication_obj::lime_application_create( ::Dynamic config){
            	...
            	HX_STACK_ARG(config,"config")
HXLINE( 627)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_backend::native::NativeApplication_obj::cffi_lime_application_create(hx::DynamicPtr(config))) );
...
HXLINE( 628)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(callback);
HXDLIN( 628)		::lime::_backend::native::NativeApplication_obj::cffi_lime_application_event_manager_register(_hx_tmp,hx::DynamicPtr(eventObject));
            	}
...
HXLINE( 629)		return ( (Int)(::lime::_backend::native::NativeApplication_obj::cffi_lime_application_exec(hx::DynamicPtr(handle))) );
            	}
...
void NativeApplication_obj::lime_application_init( ::Dynamic handle){
            	...
            	HX_STACK_ARG(handle,"handle")
HXLINE( 630)		::lime::_backend::native::NativeApplication_obj::cffi_lime_application_init(hx::DynamicPtr(handle));
            	}
...
Int NativeApplication_obj::lime_application_quit( ::Dynamic handle){
            	...
            	HX_STACK_ARG(handle,"handle")
HXLINE( 631)		return ( (Int)(::lime::_backend::native::NativeApplication_obj::cffi_lime_application_quit(hx::DynamicPtr(handle))) );
            	}
...
void NativeApplication_obj::lime_application_set_frame_rate( ::Dynamic handle,Float value){
            	...
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(value,"value")
HXLINE( 632)		::lime::_backend::native::NativeApplication_obj::cffi_lime_application_set_frame_rate(hx::DynamicPtr(handle),value);
            	}
...
Bool NativeApplication_obj::lime_application_update( ::Dynamic handle){
            	...
            	HX_STACK_ARG(handle,"handle")
HXLINE( 633)		return ( (Bool)(::lime::_backend::native::NativeApplication_obj::cffi_lime_application_update(hx::DynamicPtr(handle))) );
            	}
...
void NativeApplication_obj::lime_drop_event_manager_register( ::Dynamic callback, ::Dynamic eventObject){
            	...
            	HX_STACK_ARG(callback,"callback")
            	HX_STACK_ARG(eventObject,"eventObject")
HXLINE( 634)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(callback);
HXDLIN( 634)		::lime::_backend::native::NativeApplication_obj::cffi_lime_drop_event_manager_register(_hx_tmp,hx::DynamicPtr(eventObject));
            	}
...
HXDLIN( 635)		::lime::_backend::native::NativeApplication_obj::cffi_lime_gamepad_event_manager_register(_hx_tmp,hx::DynamicPtr(eventObject));
            	}
...
HXDLIN( 636)		::lime::_backend::native::NativeApplication_obj::cffi_lime_joystick_event_manager_register(_hx_tmp,hx::DynamicPtr(eventObject));
            	}
...
HXDLIN( 637)		::lime::_backend::native::NativeApplication_obj::cffi_lime_key_event_manager_register(_hx_tmp,hx::DynamicPtr(eventObject));
            	}
...
HXDLIN( 638)		::lime::_backend::native::NativeApplication_obj::cffi_lime_mouse_event_manager_register(_hx_tmp,hx::DynamicPtr(eventObject));
            	}
...
HXDLIN( 639)		::lime::_backend::native::NativeApplication_obj::cffi_lime_render_event_manager_register(_hx_tmp,hx::DynamicPtr(eventObject));
            	}
...
HXDLIN( 640)		::lime::_backend::native::NativeApplication_obj::cffi_lime_sensor_event_manager_register(_hx_tmp,hx::DynamicPtr(eventObject));
            	}
...
HXDLIN( 641)		::lime::_backend::native::NativeApplication_obj::cffi_lime_text_event_manager_register(_hx_tmp,hx::DynamicPtr(eventObject));
            	}
...
HXDLIN( 642)		::lime::_backend::native::NativeApplication_obj::cffi_lime_touch_event_manager_register(_hx_tmp,hx::DynamicPtr(eventObject));
            	}
...
HXDLIN( 643)		::lime::_backend::native::NativeApplication_obj::cffi_lime_window_event_manager_register(_hx_tmp,hx::DynamicPtr(eventObject));
            	}
...
{
{
            	HX_STACK_FRAME("lime._backend.native.NativeApplication","boot",0x16d9a37e,"lime._backend.native.NativeApplication.boot","lime/_backend/native/NativeApplication.hx",627,0xb13849fd)
HXLINE( 627)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_application_create",75,25,1a,bb),HX_("oo",20,61,00,00),false);
HXDLIN( 627)		cffi_lime_application_create = inValue;
            	}
{
...
HXLINE( 628)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_application_event_manager_register",33,3f,87,01),HX_("oov",56,9b,54,00),false);
HXDLIN( 628)		cffi_lime_application_event_manager_register = inValue;
            	}
{
...
HXLINE( 629)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_application_exec",ca,f1,81,e2),HX_("oi",1a,61,00,00),false);
HXDLIN( 629)		cffi_lime_application_exec = inValue;
            	}
{
...
HXLINE( 630)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_application_init",49,39,1f,e5),HX_("ov",27,61,00,00),false);
HXDLIN( 630)		cffi_lime_application_init = inValue;
            	}
{
...
HXLINE( 631)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_application_quit",08,3e,6e,ea),HX_("oi",1a,61,00,00),false);
HXDLIN( 631)		cffi_lime_application_quit = inValue;
            	}
{
...
HXLINE( 632)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_application_set_frame_rate",a8,03,d7,1d),HX_("odv",c1,91,54,00),false);
HXDLIN( 632)		cffi_lime_application_set_frame_rate = inValue;
            	}
{
...
HXLINE( 633)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_application_update",82,44,10,c6),HX_("ob",13,61,00,00),false);
HXDLIN( 633)		cffi_lime_application_update = inValue;
            	}
{
...
HXLINE( 634)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_drop_event_manager_register",a0,48,49,3f),HX_("oov",56,9b,54,00),false);
HXDLIN( 634)		cffi_lime_drop_event_manager_register = inValue;
            	}
{
...
HXLINE( 635)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gamepad_event_manager_register",02,b7,1e,51),HX_("oov",56,9b,54,00),false);
HXDLIN( 635)		cffi_lime_gamepad_event_manager_register = inValue;
            	}
{
...
HXLINE( 636)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_joystick_event_manager_register",b3,14,1d,14),HX_("oov",56,9b,54,00),false);
HXDLIN( 636)		cffi_lime_joystick_event_manager_register = inValue;
            	}
{
...
HXLINE( 637)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_key_event_manager_register",c4,10,76,37),HX_("oov",56,9b,54,00),false);
HXDLIN( 637)		cffi_lime_key_event_manager_register = inValue;
            	}
{
...
HXLINE( 638)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_mouse_event_manager_register",7e,33,83,ea),HX_("oov",56,9b,54,00),false);
HXDLIN( 638)		cffi_lime_mouse_event_manager_register = inValue;
            	}
{
...
HXLINE( 639)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_render_event_manager_register",d9,6b,ed,ee),HX_("oov",56,9b,54,00),false);
HXDLIN( 639)		cffi_lime_render_event_manager_register = inValue;
            	}
{
...
HXLINE( 640)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_sensor_event_manager_register",75,01,d7,10),HX_("oov",56,9b,54,00),false);
HXDLIN( 640)		cffi_lime_sensor_event_manager_register = inValue;
            	}
{
...
HXLINE( 641)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_text_event_manager_register",e2,83,68,5d),HX_("oov",56,9b,54,00),false);
HXDLIN( 641)		cffi_lime_text_event_manager_register = inValue;
            	}
{
...
HXLINE( 642)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_touch_event_manager_register",24,25,f4,f5),HX_("oov",56,9b,54,00),false);
HXDLIN( 642)		cffi_lime_touch_event_manager_register = inValue;
            	}
{
...
HXLINE( 643)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_window_event_manager_register",7f,16,8e,0d),HX_("oov",56,9b,54,00),false);
HXDLIN( 643)		cffi_lime_window_event_manager_register = inValue;
            	}
}
