...
HXLINE( 771)		this->id = id;
HXLINE( 772)		this->index = index;
HXLINE( 773)		this->value = value;
HXLINE( 774)		this->x = x;
HXLINE( 775)		this->y = y;
            	}
...
Dynamic JoystickEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::JoystickEventInfo JoystickEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.JoystickEventInfo","clone",0x8796a4de,"lime._backend.native._NativeApplication.JoystickEventInfo.clone","lime/_backend/native/NativeApplication.hx",782,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 782)		return  ::lime::_backend::native::_NativeApplication::JoystickEventInfo_obj::__new(this->type,this->id,this->index,this->value,this->x,this->y);
            	}
