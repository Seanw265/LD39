...
HXLINE( 855)		this->type = type;
HXLINE( 856)		this->windowID = (int)0;
HXLINE( 857)		this->x = x;
HXLINE( 858)		this->y = y;
HXLINE( 859)		this->button = button;
HXLINE( 860)		this->movementX = movementX;
HXLINE( 861)		this->movementY = movementY;
            	}
...
Dynamic MouseEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::MouseEventInfo MouseEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.MouseEventInfo","clone",0xea05ad6f,"lime._backend.native._NativeApplication.MouseEventInfo.clone","lime/_backend/native/NativeApplication.hx",868,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE( 868)		return  ::lime::_backend::native::_NativeApplication::MouseEventInfo_obj::__new(this->type,this->windowID,this->x,this->y,this->button,this->movementX,this->movementY);
            	}
