...
Int y = __o_y.Default(0);
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE(1057)		this->type = type;
HXLINE(1058)		this->windowID = windowID;
HXLINE(1059)		this->width = width;
HXLINE(1060)		this->height = height;
HXLINE(1061)		this->x = x;
HXLINE(1062)		this->y = y;
            	}
...
Dynamic WindowEventInfo_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::_backend::native::_NativeApplication::WindowEventInfo WindowEventInfo_obj::clone(){
            	HX_STACK_FRAME("lime._backend.native._NativeApplication.WindowEventInfo","clone",0x3ae8cd6a,"lime._backend.native._NativeApplication.WindowEventInfo.clone","lime/_backend/native/NativeApplication.hx",1069,0xb13849fd)
            	HX_STACK_THIS(this)
HXLINE(1069)		return  ::lime::_backend::native::_NativeApplication::WindowEventInfo_obj::__new(this->type,this->windowID,this->width,this->height,this->x,this->y);
            	}
