...
{
	hx::ObjectPtr< Event_Int_lime_ui_JoystickHatPosition_Void_obj > _hx_result = new Event_Int_lime_ui_JoystickHatPosition_Void_obj();
...
hx::Val Event_Int_lime_ui_JoystickHatPosition_Void_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
hx::Val Event_Int_lime_ui_JoystickHatPosition_Void_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
...
#if HXCPP_SCRIPTABLE
static hx::StorageInfo Event_Int_lime_ui_JoystickHatPosition_Void_obj_sMemberStorageInfo[] = {
	{hx::fsBool,(int)offsetof(Event_Int_lime_ui_JoystickHatPosition_Void_obj,canceled),HX_HCSTRING("canceled","\x59","\x18","\x26","\x1f")},
	{hx::fsObject /*Array< bool >*/ ,(int)offsetof(Event_Int_lime_ui_JoystickHatPosition_Void_obj,_hx___repeat),HX_HCSTRING("__repeat","\x7b","\x02","\xac","\xae")},
	{hx::fsObject /*Array< int >*/ ,(int)offsetof(Event_Int_lime_ui_JoystickHatPosition_Void_obj,_hx___priorities),HX_HCSTRING("__priorities","\xe2","\xcb","\xe6","\x1c")},
	{hx::fsObject /*cpp::ArrayBase*/ ,(int)offsetof(Event_Int_lime_ui_JoystickHatPosition_Void_obj,_hx___listeners),HX_HCSTRING("__listeners","\x5f","\xae","\xba","\x21")},
	{ hx::fsUnknown, 0, null()}
};
static hx::StaticInfo *Event_Int_lime_ui_JoystickHatPosition_Void_obj_sStaticStorageInfo = 0;
#endif

static ::String Event_Int_lime_ui_JoystickHatPosition_Void_obj_sMemberFields[] = {
...
static void Event_Int_lime_ui_JoystickHatPosition_Void_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(Event_Int_lime_ui_JoystickHatPosition_Void_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void Event_Int_lime_ui_JoystickHatPosition_Void_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
void Event_Int_lime_ui_JoystickHatPosition_Void_obj::__register()
{
	...
	__mClass->mMarkFunc = Event_Int_lime_ui_JoystickHatPosition_Void_obj_sMarkStatics;
	__mClass->mStatics = hx::Class_obj::dupFunctions(0 /* sStaticFields */);
	__mClass->mMembers = hx::Class_obj::dupFunctions(Event_Int_lime_ui_JoystickHatPosition_Void_obj_sMemberFields);
	__mClass->mCanCast = hx::TCanCast< Event_Int_lime_ui_JoystickHatPosition_Void_obj >;
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = Event_Int_lime_ui_JoystickHatPosition_Void_obj_sVisitStatics;
#endif
#ifdef HXCPP_SCRIPTABLE
	__mClass->mMemberStorageInfo = Event_Int_lime_ui_JoystickHatPosition_Void_obj_sMemberStorageInfo;
#endif
#ifdef HXCPP_SCRIPTABLE
	__mClass->mStaticStorageInfo = Event_Int_lime_ui_JoystickHatPosition_Void_obj_sStaticStorageInfo;
#endif
