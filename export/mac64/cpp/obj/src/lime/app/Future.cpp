...
void Future_obj::__construct( ::Dynamic work){
            	HX_STACK_FRAME("lime.app.Future","new",0xc0e3b2bb,"lime.app.Future.new","lime/app/Future.hx",27,0x058e0853)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(work,"work")
HXLINE(  27)		Bool _hx_tmp = hx::IsNotNull( work );
HXDLIN(  27)		if (_hx_tmp) {
HXLINE(  29)			Bool _hx_tmp1 = hx::IsNull( ::lime::app::Future_obj::_hx___threadPool );
HXDLIN(  29)			if (_hx_tmp1) {
HXLINE(  31)				::lime::app::Future_obj::_hx___threadPool =  ::lime::_hx_system::ThreadPool_obj::__new(null(),null());
...
HXLINE(  38)			HX_VARI(  ::lime::app::Promise,promise) =  ::lime::app::Promise_obj::__new();
...
HXLINE(  50)		Bool _hx_tmp = hx::IsNotNull( listener );
HXDLIN(  50)		if (_hx_tmp) {
HXLINE(  52)			Bool _hx_tmp1 = this->_hx___completed;
HXDLIN(  52)			if (_hx_tmp1) {
HXLINE(  54)				listener(this->value);
            			}
            			else {
HXLINE(  56)				Bool _hx_tmp2 = !(this->_hx___errored);
HXDLIN(  56)				if (_hx_tmp2) {
HXLINE(  58)					Bool _hx_tmp3 = hx::IsNull( this->_hx___completeListeners );
...
HX_DEFINE_DYNAMIC_FUNC1(Future_obj,onComplete,return )
 ...
 ::lime::app::Future Future_obj::onError( ::Dynamic listener){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
HXLINE(  77)		Bool _hx_tmp = hx::IsNotNull( listener );
HXDLIN(  77)		if (_hx_tmp) {
HXLINE(  79)			Bool _hx_tmp1 = this->_hx___errored;
HXDLIN(  79)			if (_hx_tmp1) {
HXLINE(  81)				listener(this->_hx___errorMessage);
            			}
            			else {
HXLINE(  83)				Bool _hx_tmp2 = !(this->_hx___completed);
HXDLIN(  83)				if (_hx_tmp2) {
HXLINE(  85)					Bool _hx_tmp3 = hx::IsNull( this->_hx___errorListeners );
...
HX_DEFINE_DYNAMIC_FUNC1(Future_obj,onError,return )
 ...
 ::lime::app::Future Future_obj::onProgress( ::Dynamic listener){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(listener,"listener")
HXLINE( 104)		Bool _hx_tmp = hx::IsNotNull( listener );
HXDLIN( 104)		if (_hx_tmp) {
HXLINE( 106)			Bool _hx_tmp1 = hx::IsNull( this->_hx___progressListeners );
...
HX_DEFINE_DYNAMIC_FUNC1(Future_obj,onProgress,return )
 ...
 ::lime::app::Future Future_obj::then( ::Dynamic next){
            	HX_STACK_FRAME("lime.app.Future","then",0x0a523022,"lime.app.Future.then","lime/app/Future.hx",123,0x058e0853)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(next,"next")
HXLINE( 123)		Bool _hx_tmp = this->_hx___completed;
HXDLIN( 123)		if (_hx_tmp) {
HXLINE( 125)			return ( ( ::lime::app::Future)(next(this->value)) );
            		}
            		else {
HXLINE( 127)			Bool _hx_tmp1 = this->_hx___errored;
HXDLIN( 127)			if (_hx_tmp1) {
HXLINE( 129)				HX_VARI(  ::lime::app::Future,future) =  ::lime::app::Future_obj::__new(null());
...
HXLINE( 131)				return future;
            				...
            				void _hx_run( ::Dynamic val){
            					HX_STACK_FRAME("lime.app.Future","then",0x0a523022,"lime.app.Future.then","lime/app/Future.hx",140,0x058e0853)
...
HXLINE( 135)				HX_VARI(  ::lime::app::Promise,promise) =  ::lime::app::Promise_obj::__new();
...
Bool Future_obj::get_isCompleted(){
            	HX_STACK_FRAME("lime.app.Future","get_isCompleted",0x83e28eb3,"lime.app.Future.get_isCompleted","lime/app/Future.hx",201,0x058e0853)
            	HX_STACK_THIS(this)
...
HXLINE( 166)			HX_VARI(  ::Dynamic,result) =  ::Dynamic(state->__Field(HX_("work",d1,01,fd,4e),hx::paccDynamic))();
...
void Future_obj::threadPool_onComplete( ::Dynamic state){
            	...
            	HX_STACK_ARG(state,"state")
HXLINE( 180)		 ::Dynamic( ::Dynamic(state->__Field(HX_("promise",9b,cd,e9,f7),hx::paccDynamic))->__Field(HX_("complete",b9,00,c8,7f),hx::paccDynamic))( ::Dynamic(state->__Field(HX_("result",dd,68,84,08),hx::paccDynamic)));
            	}
...
void Future_obj::threadPool_onError( ::Dynamic state){
            	...
            	HX_STACK_ARG(state,"state")
HXLINE( 187)		 ::Dynamic( ::Dynamic(state->__Field(HX_("promise",9b,cd,e9,f7),hx::paccDynamic))->__Field(HX_("error",c8,cb,29,73),hx::paccDynamic))( ::Dynamic(state->__Field(HX_("error",c8,cb,29,73),hx::paccDynamic)));
            	}
