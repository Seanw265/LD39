...
void Promise_obj::__construct(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  16)		this->future =  ::lime::app::Future_obj::__new(null());
            	}
...
HXLINE(  23)		Bool _hx_tmp = !(this->future->_hx___errored);
HXDLIN(  23)		if (_hx_tmp) {
HXLINE(  25)			this->future->_hx___completed = true;
HXLINE(  26)			this->future->value = data;
HXLINE(  28)			Bool _hx_tmp1 = hx::IsNotNull( this->future->_hx___completeListeners );
...
HXLINE(  61)		Bool _hx_tmp = !(this->future->_hx___completed);
HXDLIN(  61)		if (_hx_tmp) {
HXLINE(  63)			this->future->_hx___errored = true;
HXLINE(  64)			this->future->_hx___errorMessage = msg;
HXLINE(  66)			Bool _hx_tmp1 = hx::IsNotNull( this->future->_hx___errorListeners );
...
HXLINE(  89)			Bool _hx_tmp1 = hx::IsNotNull( this->future->_hx___progressListeners );
...
Bool Promise_obj::get_isCompleted(){
            	HX_STACK_FRAME("lime.app.Promise","get_isCompleted",0xc2803f3f,"lime.app.Promise.get_isCompleted","lime/app/Promise.hx",115,0x10ba4f0b)
            	HX_STACK_THIS(this)
