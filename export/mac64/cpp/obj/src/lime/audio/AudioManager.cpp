...
HXLINE(  78)				 ::Dynamic _hx_tmp2 = alc->getCurrentContext();
HXDLIN(  78)				alc->processContext(_hx_tmp2);
            			}
            		}
            	}
...
void AudioManager_obj::shutdown(){
            	HX_STACK_FRAME("lime.audio.AudioManager","shutdown",0x46165d1c,"lime.audio.AudioManager.shutdown","lime/audio/AudioManager.hx",91,0x9f466694)
HXLINE(  91)		Bool _hx_tmp = hx::IsNotNull( ::lime::audio::AudioManager_obj::context );
HXDLIN(  91)		if (_hx_tmp) {
HXLINE(  93)			HX_VARI( ::hx::EnumBase,_g) = ::lime::audio::AudioManager_obj::context;
HXDLIN(  93)			Int _hx_tmp1 = ( ( ::hx::EnumBase)(_g) )->_hx_getIndex();
HXDLIN(  93)			if ((_hx_tmp1 == (int)0)) {
HXLINE(  95)				HX_VARI(  ::lime::audio::ALCAudioContext,alc) = _g->_hx_getObject(0).StaticCast<  ::lime::audio::ALCAudioContext >();
HXDLIN(  95)				{
HXLINE(  97)					HX_VARI(  ::Dynamic,currentContext) = alc->getCurrentContext();
HXLINE(  99)					Bool _hx_tmp2 = hx::IsNotNull( currentContext );
HXDLIN(  99)					if (_hx_tmp2) {
HXLINE( 101)						HX_VARI(  ::Dynamic,device) = alc->getContextsDevice(currentContext);
HXLINE( 102)						alc->makeContextCurrent(null());
HXLINE( 103)						alc->destroyContext(currentContext);
HXLINE( 104)						alc->closeDevice(device);
            					}
            				}
            			}
            		}
...
void AudioManager_obj::suspend(){
            	HX_STACK_FRAME("lime.audio.AudioManager","suspend",0xf724c1b6,"lime.audio.AudioManager.suspend","lime/audio/AudioManager.hx",119,0x9f466694)
HXLINE( 119)		Bool _hx_tmp = hx::IsNotNull( ::lime::audio::AudioManager_obj::context );
HXDLIN( 119)		if (_hx_tmp) {
HXLINE( 121)			HX_VARI( ::hx::EnumBase,_g) = ::lime::audio::AudioManager_obj::context;
HXDLIN( 121)			Int _hx_tmp1 = ( ( ::hx::EnumBase)(_g) )->_hx_getIndex();
HXDLIN( 121)			if ((_hx_tmp1 == (int)0)) {
HXLINE( 123)				HX_VARI(  ::lime::audio::ALCAudioContext,alc) = _g->_hx_getObject(0).StaticCast<  ::lime::audio::ALCAudioContext >();
HXLINE( 125)				 ::Dynamic _hx_tmp2 = alc->getCurrentContext();
HXDLIN( 125)				alc->suspendContext(_hx_tmp2);
            			}
            		}
            	}
