...
void ALC_obj::processContext( ::Dynamic context){
            	...
            	HX_STACK_ARG(context,"context")
HXLINE( 188)		::lime::audio::openal::ALC_obj::cffi_lime_alc_process_context(hx::DynamicPtr(context));
            	}
...
void ALC_obj::suspendContext( ::Dynamic context){
            	...
            	HX_STACK_ARG(context,"context")
HXLINE( 197)		::lime::audio::openal::ALC_obj::cffi_lime_alc_suspend_context(hx::DynamicPtr(context));
            	}
...
Bool ALC_obj::lime_alc_close_device( ::Dynamic device){
            	...
            	HX_STACK_ARG(device,"device")
HXLINE( 204)		return ( (Bool)(::lime::audio::openal::ALC_obj::cffi_lime_alc_close_device(hx::DynamicPtr(device))) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ALC_obj,lime_alc_close_device,return )
 ...
 ::Dynamic ALC_obj::lime_alc_create_context( ::Dynamic device, ::Dynamic attrlist){
            	...
            	HX_STACK_ARG(device,"device")
            	HX_STACK_ARG(attrlist,"attrlist")
HXLINE( 205)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(device);
HXDLIN( 205)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::audio::openal::ALC_obj::cffi_lime_alc_create_context(_hx_tmp,hx::DynamicPtr(attrlist))) );
...
void ALC_obj::lime_alc_destroy_context( ::Dynamic context){
            	...
            	HX_STACK_ARG(context,"context")
HXLINE( 206)		::lime::audio::openal::ALC_obj::cffi_lime_alc_destroy_context(hx::DynamicPtr(context));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ALC_obj,lime_alc_destroy_context,(void))
 ...
 ::Dynamic ALC_obj::lime_alc_get_contexts_device( ::Dynamic context){
            	...
            	HX_STACK_ARG(context,"context")
HXLINE( 207)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::audio::openal::ALC_obj::cffi_lime_alc_get_contexts_device(hx::DynamicPtr(context))) );
HXDLIN( 207)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE( 208)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::audio::openal::ALC_obj::cffi_lime_alc_get_current_context()) );
...
Int ALC_obj::lime_alc_get_error( ::Dynamic device){
            	...
            	HX_STACK_ARG(device,"device")
HXLINE( 209)		return ( (Int)(::lime::audio::openal::ALC_obj::cffi_lime_alc_get_error(hx::DynamicPtr(device))) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ALC_obj,lime_alc_get_error,return )
 ...
 ::Dynamic ALC_obj::lime_alc_get_integerv( ::Dynamic device,Int param,Int size){
            	...
            	HX_STACK_ARG(param,"param")
            	HX_STACK_ARG(size,"size")
HXLINE( 210)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::audio::openal::ALC_obj::cffi_lime_alc_get_integerv(hx::DynamicPtr(device),param,size)) );
HXDLIN( 210)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(ALC_obj,lime_alc_get_integerv,return )
 ...
 ::Dynamic ALC_obj::lime_alc_get_string( ::Dynamic device,Int param){
            	...
            	HX_STACK_ARG(device,"device")
            	HX_STACK_ARG(param,"param")
HXLINE( 211)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::audio::openal::ALC_obj::cffi_lime_alc_get_string(hx::DynamicPtr(device),param)) );
HXDLIN( 211)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
Bool ALC_obj::lime_alc_make_context_current( ::Dynamic context){
            	...
            	HX_STACK_ARG(context,"context")
HXLINE( 212)		return ( (Bool)(::lime::audio::openal::ALC_obj::cffi_lime_alc_make_context_current(hx::DynamicPtr(context))) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ALC_obj,lime_alc_make_context_current,return )
 ...
 ::Dynamic ALC_obj::lime_alc_open_device(::String devicename){
            	...
            	HX_STACK_ARG(devicename,"devicename")
HXLINE( 213)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::audio::openal::ALC_obj::cffi_lime_alc_open_device(devicename)) );
HXDLIN( 213)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
void ALC_obj::lime_alc_process_context( ::Dynamic context){
            	...
            	HX_STACK_ARG(context,"context")
HXLINE( 214)		::lime::audio::openal::ALC_obj::cffi_lime_alc_process_context(hx::DynamicPtr(context));
            	}
...
{
            	HX_STACK_FRAME("lime.audio.openal.ALC","boot",0xbf76a010,"lime.audio.openal.ALC.boot","lime/audio/openal/ALC.hx",204,0x52b9922d)
HXLINE( 204)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_alc_close_device",ee,17,5c,d1),HX_("ob",13,61,00,00),false);
HXDLIN( 204)		cffi_lime_alc_close_device = inValue;
            	}
{
            	HX_STACK_FRAME("lime.audio.openal.ALC","boot",0xbf76a010,"lime.audio.openal.ALC.boot","lime/audio/openal/ALC.hx",205,0x52b9922d)
HXLINE( 205)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_alc_create_context",1d,4b,86,d8),HX_("ooo",4f,9b,54,00),false);
HXDLIN( 205)		cffi_lime_alc_create_context = inValue;
            	}
{
            	HX_STACK_FRAME("lime.audio.openal.ALC","boot",0xbf76a010,"lime.audio.openal.ALC.boot","lime/audio/openal/ALC.hx",206,0x52b9922d)
HXLINE( 206)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_alc_destroy_context",99,a8,9a,12),HX_("ov",27,61,00,00),false);
HXDLIN( 206)		cffi_lime_alc_destroy_context = inValue;
            	}
{
            	HX_STACK_FRAME("lime.audio.openal.ALC","boot",0xbf76a010,"lime.audio.openal.ALC.boot","lime/audio/openal/ALC.hx",207,0x52b9922d)
HXLINE( 207)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_alc_get_contexts_device",d7,e3,ae,e6),HX_("oo",20,61,00,00),false);
HXDLIN( 207)		cffi_lime_alc_get_contexts_device = inValue;
            	}
{
            	HX_STACK_FRAME("lime.audio.openal.ALC","boot",0xbf76a010,"lime.audio.openal.ALC.boot","lime/audio/openal/ALC.hx",208,0x52b9922d)
HXLINE( 208)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_alc_get_current_context",6f,01,f1,48),HX_("o",6f,00,00,00),false);
HXDLIN( 208)		cffi_lime_alc_get_current_context = inValue;
            	}
{
            	HX_STACK_FRAME("lime.audio.openal.ALC","boot",0xbf76a010,"lime.audio.openal.ALC.boot","lime/audio/openal/ALC.hx",209,0x52b9922d)
HXLINE( 209)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_alc_get_error",0e,4d,6e,60),HX_("oi",1a,61,00,00),false);
HXDLIN( 209)		cffi_lime_alc_get_error = inValue;
            	}
{
            	HX_STACK_FRAME("lime.audio.openal.ALC","boot",0xbf76a010,"lime.audio.openal.ALC.boot","lime/audio/openal/ALC.hx",210,0x52b9922d)
HXLINE( 210)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_alc_get_integerv",72,57,31,49),HX_("oiio",80,b7,ae,49),false);
HXDLIN( 210)		cffi_lime_alc_get_integerv = inValue;
            	}
{
            	HX_STACK_FRAME("lime.audio.openal.ALC","boot",0xbf76a010,"lime.audio.openal.ALC.boot","lime/audio/openal/ALC.hx",211,0x52b9922d)
HXLINE( 211)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_alc_get_string",cb,c4,dc,bf),HX_("oio",15,96,54,00),false);
HXDLIN( 211)		cffi_lime_alc_get_string = inValue;
            	}
{
            	HX_STACK_FRAME("lime.audio.openal.ALC","boot",0xbf76a010,"lime.audio.openal.ALC.boot","lime/audio/openal/ALC.hx",212,0x52b9922d)
HXLINE( 212)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_alc_make_context_current",89,fe,9c,ca),HX_("ob",13,61,00,00),false);
HXDLIN( 212)		cffi_lime_alc_make_context_current = inValue;
            	}
{
            	HX_STACK_FRAME("lime.audio.openal.ALC","boot",0xbf76a010,"lime.audio.openal.ALC.boot","lime/audio/openal/ALC.hx",213,0x52b9922d)
HXLINE( 213)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_alc_open_device",5a,d6,40,50),HX_("so",9c,64,00,00),false);
HXDLIN( 213)		cffi_lime_alc_open_device = inValue;
            	}
{
            	HX_STACK_FRAME("lime.audio.openal.ALC","boot",0xbf76a010,"lime.audio.openal.ALC.boot","lime/audio/openal/ALC.hx",214,0x52b9922d)
HXLINE( 214)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_alc_process_context",0e,1b,b1,00),HX_("ov",27,61,00,00),false);
HXDLIN( 214)		cffi_lime_alc_process_context = inValue;
            	}
{
            	HX_STACK_FRAME("lime.audio.openal.ALC","boot",0xbf76a010,"lime.audio.openal.ALC.boot","lime/audio/openal/ALC.hx",215,0x52b9922d)
HXLINE( 215)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_alc_suspend_context",1b,fd,cc,57),HX_("ov",27,61,00,00),false);
HXDLIN( 215)		cffi_lime_alc_suspend_context = inValue;
            	}
}
