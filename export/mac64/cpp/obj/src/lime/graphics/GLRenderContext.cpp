...
HXDLIN( 382)		{
HXLINE( 382)			Int program1 = ( (Int)(program->id) );
HXDLIN( 382)			Int shader1 = ( (Int)(shader->id) );
HXDLIN( 382)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_attach_shader(program1,shader1);
            		}
            	}
...
HXLINE( 389)		Int program1 = ( (Int)(program->id) );
HXDLIN( 389)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_attrib_location(program1,index,name);
            	}
...
HXLINE( 396)		Int buffer1;
HXDLIN( 396)		Bool _hx_tmp = hx::IsNull( buffer );
HXDLIN( 396)		if (_hx_tmp) {
HXLINE( 396)			buffer1 = (int)0;
            		}
            		else {
HXLINE( 396)			buffer1 = buffer->id;
            		}
HXDLIN( 396)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_buffer(target,buffer1);
            	}
...
HXLINE( 403)		Int framebuffer1;
HXDLIN( 403)		Bool _hx_tmp = hx::IsNull( framebuffer );
HXDLIN( 403)		if (_hx_tmp) {
HXLINE( 403)			framebuffer1 = (int)0;
            		}
            		else {
HXLINE( 403)			framebuffer1 = framebuffer->id;
            		}
HXDLIN( 403)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_framebuffer(target,framebuffer1);
            	}
...
HXLINE( 410)		Int renderbuffer1;
HXDLIN( 410)		Bool _hx_tmp = hx::IsNull( renderbuffer );
HXDLIN( 410)		if (_hx_tmp) {
HXLINE( 410)			renderbuffer1 = (int)0;
            		}
            		else {
HXLINE( 410)			renderbuffer1 = renderbuffer->id;
            		}
HXDLIN( 410)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_renderbuffer(target,renderbuffer1);
            	}
...
void GLRenderContext_obj::bindTexture(Int target, ::lime::graphics::opengl::GLTexture texture){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(texture,"texture")
HXLINE( 417)		Int texture1;
HXDLIN( 417)		Bool _hx_tmp = hx::IsNull( texture );
HXDLIN( 417)		if (_hx_tmp) {
HXLINE( 417)			texture1 = (int)0;
            		}
            		else {
HXLINE( 417)			texture1 = texture->id;
            		}
HXDLIN( 417)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_texture(target,texture1);
            	}
...
void GLRenderContext_obj::compileShader( ::lime::graphics::opengl::GLShader shader){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(shader,"shader")
HXLINE( 515)		Int shader1 = ( (Int)(shader->id) );
HXDLIN( 515)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_compile_shader(shader1);
            	}
...
HXDLIN( 550)		Int _hx_tmp1 = ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_buffer()) );
...
HXDLIN( 557)		Int _hx_tmp1 = ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_framebuffer()) );
...
HXDLIN( 564)		Int _hx_tmp1 = ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_program()) );
...
HXDLIN( 571)		Int _hx_tmp1 = ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_render_buffer()) );
...
HXDLIN( 578)		Int _hx_tmp1 = ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_shader(type)) );
...
HXDLIN( 585)		Int _hx_tmp1 = ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_texture()) );
...
void GLRenderContext_obj::deleteBuffer( ::lime::graphics::opengl::GLBuffer buffer){
            	...
            	HX_STACK_ARG(buffer,"buffer")
HXLINE( 599)		{
HXLINE( 599)			Int buffer1 = ( (Int)(buffer->id) );
HXDLIN( 599)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_buffer(buffer1);
            		}
...
void GLRenderContext_obj::deleteFramebuffer( ::lime::graphics::opengl::GLFramebuffer framebuffer){
            	...
            	HX_STACK_ARG(framebuffer,"framebuffer")
HXLINE( 606)		{
HXLINE( 606)			Int framebuffer1 = ( (Int)(framebuffer->id) );
HXDLIN( 606)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_framebuffer(framebuffer1);
            		}
...
void GLRenderContext_obj::deleteProgram( ::lime::graphics::opengl::GLProgram program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE( 613)		{
HXLINE( 613)			Int program1 = ( (Int)(program->id) );
HXDLIN( 613)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_program(program1);
            		}
...
void GLRenderContext_obj::deleteRenderbuffer( ::lime::graphics::opengl::GLRenderbuffer renderbuffer){
            	...
            	HX_STACK_ARG(renderbuffer,"renderbuffer")
HXLINE( 620)		{
HXLINE( 620)			Int renderbuffer1 = ( (Int)(renderbuffer->id) );
HXDLIN( 620)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_render_buffer(renderbuffer1);
            		}
...
void GLRenderContext_obj::deleteShader( ::lime::graphics::opengl::GLShader shader){
            	...
            	HX_STACK_ARG(shader,"shader")
HXLINE( 627)		{
HXLINE( 627)			Int shader1 = ( (Int)(shader->id) );
HXDLIN( 627)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_shader(shader1);
            		}
...
void GLRenderContext_obj::deleteTexture( ::lime::graphics::opengl::GLTexture texture){
            	...
            	HX_STACK_ARG(texture,"texture")
HXLINE( 634)		{
HXLINE( 634)			Int texture1 = ( (Int)(texture->id) );
HXDLIN( 634)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_texture(texture1);
            		}
...
void GLRenderContext_obj::detachShader( ::lime::graphics::opengl::GLProgram program, ::lime::graphics::opengl::GLShader shader){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(shader,"shader")
HXLINE( 662)		Int program1 = ( (Int)(program->id) );
HXDLIN( 662)		Int shader1 = ( (Int)(shader->id) );
HXDLIN( 662)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_detach_shader(program1,shader1);
            	}
...
void GLRenderContext_obj::framebufferRenderbuffer(Int target,Int attachment,Int renderbuffertarget, ::lime::graphics::opengl::GLRenderbuffer renderbuffer){
            	...
            	HX_STACK_ARG(renderbuffer,"renderbuffer")
HXLINE( 725)		Int renderbuffer1 = ( (Int)(renderbuffer->id) );
HXDLIN( 725)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_framebuffer_renderbuffer(target,attachment,renderbuffertarget,renderbuffer1);
            	}
...
void GLRenderContext_obj::framebufferTexture2D(Int target,Int attachment,Int textarget, ::lime::graphics::opengl::GLTexture texture,Int level){
            	...
            	HX_STACK_ARG(texture,"texture")
            	HX_STACK_ARG(level,"level")
HXLINE( 732)		Int texture1 = ( (Int)(texture->id) );
HXDLIN( 732)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_framebuffer_texture2D(target,attachment,textarget,texture1,level);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(GLRenderContext_obj,generateMipmap,(void))
 ...
 ::Dynamic GLRenderContext_obj::getActiveAttrib( ::lime::graphics::opengl::GLProgram program,Int index){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(index,"index")
HXLINE( 753)		Int program1 = ( (Int)(program->id) );
HXDLIN( 753)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_active_attrib(program1,index)) );
...
HX_DEFINE_DYNAMIC_FUNC2(GLRenderContext_obj,getActiveAttrib,return )
 ...
 ::Dynamic GLRenderContext_obj::getActiveUniform( ::lime::graphics::opengl::GLProgram program,Int index){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(index,"index")
HXLINE( 760)		Int program1 = ( (Int)(program->id) );
HXDLIN( 760)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_active_uniform(program1,index)) );
...
Int GLRenderContext_obj::getAttribLocation( ::lime::graphics::opengl::GLProgram program,::String name){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(name,"name")
HXLINE( 774)		Int program1 = ( (Int)(program->id) );
HXDLIN( 774)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_attrib_location(program1,name)) );
            	}
...
::String GLRenderContext_obj::getProgramInfoLog( ::lime::graphics::opengl::GLProgram program){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
HXLINE( 823)		Int program1 = ( (Int)(program->id) );
HXDLIN( 823)		return ( (::String)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_program_info_log(program1)) );
            	}
...
Int GLRenderContext_obj::getProgramParameter( ::lime::graphics::opengl::GLProgram program,Int pname){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(pname,"pname")
HXLINE( 830)		Int program1 = ( (Int)(program->id) );
HXDLIN( 830)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_program_parameter(program1,pname)) );
            	}
...
::String GLRenderContext_obj::getShaderInfoLog( ::lime::graphics::opengl::GLShader shader){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(shader,"shader")
HXLINE( 844)		Int shader1 = ( (Int)(shader->id) );
HXDLIN( 844)		return ( (::String)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_shader_info_log(shader1)) );
            	}
...
Int GLRenderContext_obj::getShaderParameter( ::lime::graphics::opengl::GLShader shader,Int pname){
            	...
            	HX_STACK_ARG(shader,"shader")
            	HX_STACK_ARG(pname,"pname")
HXLINE( 851)		Int shader1 = ( (Int)(shader->id) );
HXDLIN( 851)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_shader_parameter(shader1,pname)) );
            	}
...
::String GLRenderContext_obj::getShaderSource( ::lime::graphics::opengl::GLShader shader){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(shader,"shader")
HXLINE( 865)		Int shader1 = ( (Int)(shader->id) );
HXDLIN( 865)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_shader_source(shader1)) );
...
HXLINE( 886)		Int program1 = ( (Int)(program->id) );
HXDLIN( 886)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_uniform(program1,location)) );
...
Int GLRenderContext_obj::getUniformLocation( ::lime::graphics::opengl::GLProgram program,::String name){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(name,"name")
HXLINE( 893)		Int program1 = ( (Int)(program->id) );
HXDLIN( 893)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_uniform_location(program1,name)) );
            	}
...
HXLINE( 921)			_hx_tmp = hx::IsGreater( buffer->id,(int)0 );
            		}
            		else {
HXLINE( 921)			_hx_tmp = false;
            		}
HXDLIN( 921)		if (_hx_tmp) {
HXLINE( 921)			Int buffer1 = ( (Int)(buffer->id) );
HXDLIN( 921)			return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_buffer(buffer1)) );
            		}
            		else {
...
HXLINE( 942)			_hx_tmp = hx::IsGreater( framebuffer->id,(int)0 );
            		}
            		else {
HXLINE( 942)			_hx_tmp = false;
            		}
HXDLIN( 942)		if (_hx_tmp) {
HXLINE( 942)			Int framebuffer1 = ( (Int)(framebuffer->id) );
HXDLIN( 942)			return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_framebuffer(framebuffer1)) );
            		}
            		else {
...
HXLINE( 949)			_hx_tmp = hx::IsGreater( program->id,(int)0 );
            		}
            		else {
HXLINE( 949)			_hx_tmp = false;
            		}
HXDLIN( 949)		if (_hx_tmp) {
HXLINE( 949)			Int program1 = ( (Int)(program->id) );
HXDLIN( 949)			return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_program(program1)) );
            		}
            		else {
...
HXLINE( 956)			_hx_tmp = hx::IsGreater( renderbuffer->id,(int)0 );
            		}
            		else {
HXLINE( 956)			_hx_tmp = false;
            		}
HXDLIN( 956)		if (_hx_tmp) {
HXLINE( 956)			Int renderbuffer1 = ( (Int)(renderbuffer->id) );
HXDLIN( 956)			return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_renderbuffer(renderbuffer1)) );
            		}
            		else {
...
HXLINE( 963)			_hx_tmp = hx::IsGreater( shader->id,(int)0 );
            		}
            		else {
HXLINE( 963)			_hx_tmp = false;
            		}
HXDLIN( 963)		if (_hx_tmp) {
HXLINE( 963)			Int shader1 = ( (Int)(shader->id) );
HXDLIN( 963)			return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_shader(shader1)) );
            		}
            		else {
...
HXLINE( 970)			_hx_tmp = hx::IsGreater( texture->id,(int)0 );
            		}
            		else {
HXLINE( 970)			_hx_tmp = false;
            		}
HXDLIN( 970)		if (_hx_tmp) {
HXLINE( 970)			Int texture1 = ( (Int)(texture->id) );
HXDLIN( 970)			return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_texture(texture1)) );
            		}
            		else {
...
void GLRenderContext_obj::linkProgram( ::lime::graphics::opengl::GLProgram program){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
HXLINE( 984)		Int program1 = ( (Int)(program->id) );
HXDLIN( 984)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_link_program(program1);
            	}
...
HXLINE(1033)		Int shader1 = ( (Int)(shader->id) );
HXDLIN(1033)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_shader_source(shader1,source);
            	}
...
void GLRenderContext_obj::useProgram( ::lime::graphics::opengl::GLProgram program){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
HXLINE(1250)		Int program1;
HXDLIN(1250)		Bool _hx_tmp = hx::IsNull( program );
HXDLIN(1250)		if (_hx_tmp) {
HXLINE(1250)			program1 = (int)0;
            		}
            		else {
HXLINE(1250)			program1 = program->id;
            		}
HXDLIN(1250)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_use_program(program1);
            	}
...
void GLRenderContext_obj::validateProgram( ::lime::graphics::opengl::GLProgram program){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(program,"program")
HXLINE(1257)		Int program1 = ( (Int)(program->id) );
HXDLIN(1257)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_validate_program(program1);
            	}
