...
HXLINE(  48)		this->bitsPerPixel = bitsPerPixel;
HXLINE(  49)		Int _hx_tmp;
HXDLIN(  49)		Bool _hx_tmp1 = hx::IsNull( format );
...
HXDLIN(  49)		this->format = _hx_tmp;
HXLINE(  50)		this->transparent = true;
            	}
...
Dynamic ImageBuffer_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::lime::graphics::ImageBuffer ImageBuffer_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  57)		HX_VARI(  ::lime::graphics::ImageBuffer,buffer) =  ::lime::graphics::ImageBuffer_obj::__new(this->data,this->width,this->height,this->bitsPerPixel,null());
HXLINE( 101)		Bool _hx_tmp = hx::IsNotNull( this->data );
HXDLIN( 101)		if (_hx_tmp) {
HXLINE( 103)			HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::io::Bytes_obj::alloc(this->data->byteLength);
HXLINE( 104)			bytes->blit((int)0,buffer->data->buffer,(int)0,this->data->byteLength);
HXLINE( 105)			HX_VAR_NAME(  ::lime::utils::ArrayBufferView,this1,"this");
HXDLIN( 105)			Bool _hx_tmp1 = hx::IsNotNull( bytes );
HXDLIN( 105)			if (_hx_tmp1) {
HXLINE( 105)				HX_VARI(  ::lime::utils::ArrayBufferView,_this) =  ::lime::utils::ArrayBufferView_obj::__new((int)0,(int)4);
HXDLIN( 105)				if ((hx::Mod((int)0,_this->bytesPerElement) != (int)0)) {
HXLINE( 105)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 105)				HX_VARI( Int,bufferByteLength) = bytes->length;
HXDLIN( 105)				{
HXLINE( 105)					if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 105)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
HXDLIN( 105)					if ((bufferByteLength < (int)0)) {
HXLINE( 105)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
            				}
HXDLIN( 105)				_this->buffer = bytes;
HXDLIN( 105)				_this->byteOffset = (int)0;
HXDLIN( 105)				_this->byteLength = bufferByteLength;
HXDLIN( 105)				Float _hx_tmp2 = ((Float)bufferByteLength / (Float)_this->bytesPerElement);
HXDLIN( 105)				_this->length = ::Std_obj::_hx_int(_hx_tmp2);
HXDLIN( 105)				this1 = _this;
            			}
            			else {
HXLINE( 105)				HX_STACK_DO_THROW(HX_("Invalid constructor arguments for Uint8Array",8b,64,02,e4));
            			}
HXDLIN( 105)			buffer->data = this1;
            		}
HXLINE( 110)		buffer->bitsPerPixel = this->bitsPerPixel;
HXLINE( 111)		buffer->format = this->format;
HXLINE( 112)		buffer->premultiplied = this->premultiplied;
HXLINE( 113)		buffer->transparent = this->transparent;
HXLINE( 114)		return buffer;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ImageBuffer_obj,clone,return )
 ...
 ::Dynamic ImageBuffer_obj::get_src(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 139)		return this->_hx___srcCustom;
            	}
...
HXLINE( 167)		this->_hx___srcCustom = value;
...
Int ImageBuffer_obj::get_stride(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 178)		return (this->width * (int)4);
            	}
