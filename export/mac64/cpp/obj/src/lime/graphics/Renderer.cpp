...
HXLINE(  15)		this->onRender =  ::lime::app::Event_Void_Void_obj::__new();
HXLINE(  14)		this->onContextRestored =  ::lime::app::Event_lime_graphics_RenderContext_Void_obj::__new();
HXLINE(  13)		this->onContextLost =  ::lime::app::Event_Void_Void_obj::__new();
