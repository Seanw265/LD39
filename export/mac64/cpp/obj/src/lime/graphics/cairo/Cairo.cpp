...
void Cairo_obj::__construct( ::Dynamic surface){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","new",0x5bfa2aca,"lime.graphics.cairo.Cairo.new","lime/graphics/cairo/Cairo.hx",45,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(surface,"surface")
HXLINE(  45)		Bool _hx_tmp = hx::IsNotNull( surface );
HXDLIN(  45)		if (_hx_tmp) {
HXLINE(  48)			 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_create(hx::DynamicPtr(surface))) );
HXDLIN(  48)			 ::Dynamic _hx_tmp1 = Dynamic(hx::DynamicPtr(inVal));
HXDLIN(  48)			this->handle = _hx_tmp1;
            		}
            	}
...
void Cairo_obj::arc(Float xc,Float yc,Float radius,Float angle1,Float angle2){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","arc",0x5bf058bc,"lime.graphics.cairo.Cairo.arc","lime/graphics/cairo/Cairo.hx",59,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(xc,"xc")
            	HX_STACK_ARG(yc,"yc")
...
HXLINE(  59)		 ::Dynamic handle = this->handle;
HXDLIN(  59)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_arc(hx::DynamicPtr(handle),xc,yc,radius,angle1,angle2);
            	}
...
void Cairo_obj::arcNegative(Float xc,Float yc,Float radius,Float angle1,Float angle2){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","arcNegative",0xdc455751,"lime.graphics.cairo.Cairo.arcNegative","lime/graphics/cairo/Cairo.hx",68,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(xc,"xc")
            	HX_STACK_ARG(yc,"yc")
            	HX_STACK_ARG(radius,"radius")
            	HX_STACK_ARG(angle1,"angle1")
            	HX_STACK_ARG(angle2,"angle2")
HXLINE(  68)		 ::Dynamic handle = this->handle;
HXDLIN(  68)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_arc_negative(hx::DynamicPtr(handle),xc,yc,radius,angle1,angle2);
            	}
...
void Cairo_obj::clip(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","clip",0x17ab3126,"lime.graphics.cairo.Cairo.clip","lime/graphics/cairo/Cairo.hx",77,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE(  77)		 ::Dynamic handle = this->handle;
HXDLIN(  77)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_clip(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::clipExtents(Float x1,Float y1,Float x2,Float y2){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","clipExtents",0x66b7e2c3,"lime.graphics.cairo.Cairo.clipExtents","lime/graphics/cairo/Cairo.hx",86,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x1,"x1")
            	HX_STACK_ARG(y1,"y1")
            	HX_STACK_ARG(x2,"x2")
            	HX_STACK_ARG(y2,"y2")
HXLINE(  86)		 ::Dynamic handle = this->handle;
HXDLIN(  86)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_clip_extents(hx::DynamicPtr(handle),x1,y1,x2,y2);
            	}
...
void Cairo_obj::clipPreserve(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","clipPreserve",0x0025ef12,"lime.graphics.cairo.Cairo.clipPreserve","lime/graphics/cairo/Cairo.hx",95,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE(  95)		 ::Dynamic handle = this->handle;
HXDLIN(  95)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_clip_preserve(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::closePath(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","closePath",0x73e96b67,"lime.graphics.cairo.Cairo.closePath","lime/graphics/cairo/Cairo.hx",104,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 104)		 ::Dynamic handle = this->handle;
HXDLIN( 104)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_close_path(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::copyPage(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","copyPage",0xf9d7e5fa,"lime.graphics.cairo.Cairo.copyPage","lime/graphics/cairo/Cairo.hx",113,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 113)		 ::Dynamic handle = this->handle;
HXDLIN( 113)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_copy_page(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::curveTo(Float x1,Float y1,Float x2,Float y2,Float x3,Float y3){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","curveTo",0x0ddd3774,"lime.graphics.cairo.Cairo.curveTo","lime/graphics/cairo/Cairo.hx",122,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x1,"x1")
            	HX_STACK_ARG(y1,"y1")
            	HX_STACK_ARG(x2,"x2")
...
HXDLIN( 122)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_curve_to(hx::DynamicPtr(handle),x1,y1,x2,y2,x3,y3);
            	}
...
void Cairo_obj::fill(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","fill",0x19a490d9,"lime.graphics.cairo.Cairo.fill","lime/graphics/cairo/Cairo.hx",131,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 131)		 ::Dynamic handle = this->handle;
HXDLIN( 131)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_fill(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::fillExtents(Float x1,Float y1,Float x2,Float y2){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","fillExtents",0x3c7e2f70,"lime.graphics.cairo.Cairo.fillExtents","lime/graphics/cairo/Cairo.hx",140,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x1,"x1")
            	HX_STACK_ARG(y1,"y1")
            	HX_STACK_ARG(x2,"x2")
...
HXDLIN( 140)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_fill_extents(hx::DynamicPtr(handle),x1,y1,x2,y2);
            	}
...
void Cairo_obj::fillPreserve(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","fillPreserve",0x37e2b9c5,"lime.graphics.cairo.Cairo.fillPreserve","lime/graphics/cairo/Cairo.hx",149,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 149)		 ::Dynamic handle = this->handle;
HXDLIN( 149)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_fill_preserve(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::identityMatrix(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","identityMatrix",0xb1e7bbf5,"lime.graphics.cairo.Cairo.identityMatrix","lime/graphics/cairo/Cairo.hx",158,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 158)		 ::Dynamic handle = this->handle;
HXDLIN( 158)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_identity_matrix(hx::DynamicPtr(handle));
            	}
...
Bool Cairo_obj::inClip(Float x,Float y){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","inClip",0x3186d12b,"lime.graphics.cairo.Cairo.inClip","lime/graphics/cairo/Cairo.hx",167,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 167)		 ::Dynamic handle = this->handle;
HXDLIN( 167)		return ( (Bool)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_in_clip(hx::DynamicPtr(handle),x,y)) );
            	}
...
Bool Cairo_obj::inFill(Float x,Float y){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","inFill",0x338030de,"lime.graphics.cairo.Cairo.inFill","lime/graphics/cairo/Cairo.hx",178,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 178)		 ::Dynamic handle = this->handle;
HXDLIN( 178)		return ( (Bool)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_in_fill(hx::DynamicPtr(handle),x,y)) );
            	}
...
Bool Cairo_obj::inStroke(Float x,Float y){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","inStroke",0xc49aa2d3,"lime.graphics.cairo.Cairo.inStroke","lime/graphics/cairo/Cairo.hx",189,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 189)		 ::Dynamic handle = this->handle;
HXDLIN( 189)		return ( (Bool)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_in_stroke(hx::DynamicPtr(handle),x,y)) );
            	}
...
void Cairo_obj::lineTo(Float x,Float y){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lineTo",0x9ffeca65,"lime.graphics.cairo.Cairo.lineTo","lime/graphics/cairo/Cairo.hx",200,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 200)		 ::Dynamic handle = this->handle;
HXDLIN( 200)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_line_to(hx::DynamicPtr(handle),x,y);
            	}
...
void Cairo_obj::moveTo(Float x,Float y){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","moveTo",0x800b56c2,"lime.graphics.cairo.Cairo.moveTo","lime/graphics/cairo/Cairo.hx",209,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 209)		 ::Dynamic handle = this->handle;
HXDLIN( 209)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_move_to(hx::DynamicPtr(handle),x,y);
            	}
...
void Cairo_obj::mask( ::Dynamic pattern){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","mask",0x1e3f0342,"lime.graphics.cairo.Cairo.mask","lime/graphics/cairo/Cairo.hx",218,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(pattern,"pattern")
HXLINE( 218)		 ::Dynamic handle = this->handle;
HXDLIN( 218)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(handle);
HXDLIN( 218)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_mask(_hx_tmp,hx::DynamicPtr(pattern));
            	}
...
void Cairo_obj::maskSurface( ::Dynamic surface,Float x,Float y){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","maskSurface",0x3893570b,"lime.graphics.cairo.Cairo.maskSurface","lime/graphics/cairo/Cairo.hx",227,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(surface,"surface")
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 227)		 ::Dynamic handle = this->handle;
HXDLIN( 227)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(handle);
HXDLIN( 227)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_mask_surface(_hx_tmp,hx::DynamicPtr(surface),x,y);
            	}
...
void Cairo_obj::newPath(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","newPath",0x3973698f,"lime.graphics.cairo.Cairo.newPath","lime/graphics/cairo/Cairo.hx",236,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 236)		 ::Dynamic handle = this->handle;
HXDLIN( 236)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_new_path(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::paint(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","paint",0x13100088,"lime.graphics.cairo.Cairo.paint","lime/graphics/cairo/Cairo.hx",245,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 245)		 ::Dynamic handle = this->handle;
HXDLIN( 245)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_paint(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::paintWithAlpha(Float alpha){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","paintWithAlpha",0x79d699d0,"lime.graphics.cairo.Cairo.paintWithAlpha","lime/graphics/cairo/Cairo.hx",254,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(alpha,"alpha")
HXLINE( 254)		 ::Dynamic handle = this->handle;
HXDLIN( 254)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_paint_with_alpha(hx::DynamicPtr(handle),alpha);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Cairo_obj,paintWithAlpha,(void))
 ...
 ::Dynamic Cairo_obj::popGroup(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","popGroup",0x2de29d44,"lime.graphics.cairo.Cairo.popGroup","lime/graphics/cairo/Cairo.hx",263,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 263)		 ::Dynamic handle = this->handle;
HXDLIN( 263)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_pop_group(hx::DynamicPtr(handle))) );
...
void Cairo_obj::popGroupToSource(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","popGroupToSource",0x2889961a,"lime.graphics.cairo.Cairo.popGroupToSource","lime/graphics/cairo/Cairo.hx",274,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 274)		 ::Dynamic handle = this->handle;
HXDLIN( 274)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_pop_group_to_source(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::pushGroup(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","pushGroup",0x3dd920ef,"lime.graphics.cairo.Cairo.pushGroup","lime/graphics/cairo/Cairo.hx",283,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 283)		 ::Dynamic handle = this->handle;
HXDLIN( 283)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_push_group(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::pushGroupWithContent(Int content){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","pushGroupWithContent",0x80fe7b24,"lime.graphics.cairo.Cairo.pushGroupWithContent","lime/graphics/cairo/Cairo.hx",292,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(content,"content")
HXLINE( 292)		 ::Dynamic handle = this->handle;
HXDLIN( 292)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_push_group_with_content(hx::DynamicPtr(handle),content);
            	}
...
void Cairo_obj::recreate( ::Dynamic surface){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","recreate",0x8765b845,"lime.graphics.cairo.Cairo.recreate","lime/graphics/cairo/Cairo.hx",301,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(surface,"surface")
HXLINE( 301)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_create(hx::DynamicPtr(surface))) );
HXDLIN( 301)		 ::Dynamic _hx_tmp = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 301)		this->handle = _hx_tmp;
            	}
...
HXLINE( 309)		 ::Dynamic handle = this->handle;
HXDLIN( 309)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_rectangle(hx::DynamicPtr(handle),x,y,width,height);
            	}
...
void Cairo_obj::relCurveTo(Float dx1,Float dy1,Float dx2,Float dy2,Float dx3,Float dy3){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","relCurveTo",0x07a5a287,"lime.graphics.cairo.Cairo.relCurveTo","lime/graphics/cairo/Cairo.hx",318,0x0918a4c7)
            	HX_STACK_THIS(this)
...
HXLINE( 318)		 ::Dynamic handle = this->handle;
HXDLIN( 318)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_rel_curve_to(hx::DynamicPtr(handle),dx1,dy1,dx2,dy2,dx3,dy3);
            	}
...
void Cairo_obj::relLineTo(Float dx,Float dy){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","relLineTo",0x8c73a2b2,"lime.graphics.cairo.Cairo.relLineTo","lime/graphics/cairo/Cairo.hx",327,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(dx,"dx")
            	HX_STACK_ARG(dy,"dy")
HXLINE( 327)		 ::Dynamic handle = this->handle;
HXDLIN( 327)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_rel_line_to(hx::DynamicPtr(handle),dx,dy);
            	}
...
void Cairo_obj::relMoveTo(Float dx,Float dy){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","relMoveTo",0x6c802f0f,"lime.graphics.cairo.Cairo.relMoveTo","lime/graphics/cairo/Cairo.hx",336,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(dx,"dx")
            	HX_STACK_ARG(dy,"dy")
HXLINE( 336)		 ::Dynamic handle = this->handle;
HXDLIN( 336)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_rel_move_to(hx::DynamicPtr(handle),dx,dy);
            	}
...
void Cairo_obj::resetClip(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","resetClip",0xe7777e29,"lime.graphics.cairo.Cairo.resetClip","lime/graphics/cairo/Cairo.hx",345,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 345)		 ::Dynamic handle = this->handle;
HXDLIN( 345)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_reset_clip(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::restore(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","restore",0xaa053eb8,"lime.graphics.cairo.Cairo.restore","lime/graphics/cairo/Cairo.hx",354,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 354)		 ::Dynamic handle = this->handle;
HXDLIN( 354)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_restore(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::save(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","save",0x22364d93,"lime.graphics.cairo.Cairo.save","lime/graphics/cairo/Cairo.hx",363,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 363)		 ::Dynamic handle = this->handle;
HXDLIN( 363)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_save(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::setFontSize(Float size){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","setFontSize",0xa7b85c5c,"lime.graphics.cairo.Cairo.setFontSize","lime/graphics/cairo/Cairo.hx",372,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(size,"size")
HXLINE( 372)		 ::Dynamic handle = this->handle;
HXDLIN( 372)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_font_size(hx::DynamicPtr(handle),size);
            	}
...
void Cairo_obj::setSourceRGB(Float r,Float g,Float b){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","setSourceRGB",0x59e04946,"lime.graphics.cairo.Cairo.setSourceRGB","lime/graphics/cairo/Cairo.hx",381,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(r,"r")
            	HX_STACK_ARG(g,"g")
            	HX_STACK_ARG(b,"b")
HXLINE( 381)		 ::Dynamic handle = this->handle;
HXDLIN( 381)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_source_rgb(hx::DynamicPtr(handle),r,g,b);
            	}
...
void Cairo_obj::setSourceRGBA(Float r,Float g,Float b,Float a){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","setSourceRGBA",0x4a5fd43b,"lime.graphics.cairo.Cairo.setSourceRGBA","lime/graphics/cairo/Cairo.hx",390,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(r,"r")
            	HX_STACK_ARG(g,"g")
            	HX_STACK_ARG(b,"b")
            	HX_STACK_ARG(a,"a")
HXLINE( 390)		 ::Dynamic handle = this->handle;
HXDLIN( 390)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_source_rgba(hx::DynamicPtr(handle),r,g,b,a);
            	}
...
void Cairo_obj::setSourceSurface( ::Dynamic surface,Float x,Float y){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","setSourceSurface",0xcd3700e6,"lime.graphics.cairo.Cairo.setSourceSurface","lime/graphics/cairo/Cairo.hx",399,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(surface,"surface")
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 399)		 ::Dynamic handle = this->handle;
HXDLIN( 399)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(handle);
HXDLIN( 399)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_source_surface(_hx_tmp,hx::DynamicPtr(surface),x,y);
            	}
...
void Cairo_obj::showPage(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","showPage",0xdcc04342,"lime.graphics.cairo.Cairo.showPage","lime/graphics/cairo/Cairo.hx",408,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 408)		 ::Dynamic handle = this->handle;
HXDLIN( 408)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_show_page(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::showText(::String utf8){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","showText",0xdf6835a0,"lime.graphics.cairo.Cairo.showText","lime/graphics/cairo/Cairo.hx",417,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(utf8,"utf8")
HXLINE( 417)		 ::Dynamic handle = this->handle;
HXDLIN( 417)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_show_text(hx::DynamicPtr(handle),utf8);
            	}
...
Int Cairo_obj::status(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","status",0xb95a6b08,"lime.graphics.cairo.Cairo.status","lime/graphics/cairo/Cairo.hx",426,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 426)		 ::Dynamic handle = this->handle;
HXDLIN( 426)		return ( (Int)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_status(hx::DynamicPtr(handle))) );
            	}
...
void Cairo_obj::stroke(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","stroke",0xc493378e,"lime.graphics.cairo.Cairo.stroke","lime/graphics/cairo/Cairo.hx",437,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 437)		 ::Dynamic handle = this->handle;
HXDLIN( 437)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_stroke(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::strokeExtents(Float x1,Float y1,Float x2,Float y2){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","strokeExtents",0x11faf95b,"lime.graphics.cairo.Cairo.strokeExtents","lime/graphics/cairo/Cairo.hx",446,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x1,"x1")
            	HX_STACK_ARG(y1,"y1")
            	HX_STACK_ARG(x2,"x2")
            	HX_STACK_ARG(y2,"y2")
HXLINE( 446)		 ::Dynamic handle = this->handle;
HXDLIN( 446)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_stroke_extents(hx::DynamicPtr(handle),x1,y1,x2,y2);
            	}
...
void Cairo_obj::strokePreserve(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","strokePreserve",0x2f969d7a,"lime.graphics.cairo.Cairo.strokePreserve","lime/graphics/cairo/Cairo.hx",455,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 455)		 ::Dynamic handle = this->handle;
HXDLIN( 455)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_stroke_preserve(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::transform( ::lime::math::Matrix3 matrix){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","transform",0xa55c3356,"lime.graphics.cairo.Cairo.transform","lime/graphics/cairo/Cairo.hx",464,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(matrix,"matrix")
HXLINE( 464)		 ::Dynamic handle = this->handle;
HXDLIN( 464)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(handle);
HXDLIN( 464)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_transform(_hx_tmp,hx::DynamicPtr(matrix));
            	}
...
void Cairo_obj::rotate(Float amount){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","rotate",0x7e7eca31,"lime.graphics.cairo.Cairo.rotate","lime/graphics/cairo/Cairo.hx",472,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(amount,"amount")
HXLINE( 472)		 ::Dynamic handle = this->handle;
HXDLIN( 472)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_rotate(hx::DynamicPtr(handle),amount);
            	}
...
void Cairo_obj::scale(Float x,Float y){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","scale",0xce901774,"lime.graphics.cairo.Cairo.scale","lime/graphics/cairo/Cairo.hx",480,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 480)		 ::Dynamic handle = this->handle;
HXDLIN( 480)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_scale(hx::DynamicPtr(handle),x,y);
            	}
...
void Cairo_obj::translate(Float x,Float y){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","translate",0xa948dd38,"lime.graphics.cairo.Cairo.translate","lime/graphics/cairo/Cairo.hx",489,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 489)		 ::Dynamic handle = this->handle;
HXDLIN( 489)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_translate(hx::DynamicPtr(handle),x,y);
            	}
...
Int Cairo_obj::get_antialias(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","get_antialias",0x6c40ed6f,"lime.graphics.cairo.Cairo.get_antialias","lime/graphics/cairo/Cairo.hx",504,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 507)		 ::Dynamic handle = this->handle;
HXDLIN( 507)		return ( (Int)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_antialias(hx::DynamicPtr(handle))) );
            	}
...
Int Cairo_obj::set_antialias(Int value){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","set_antialias",0xb146cf7b,"lime.graphics.cairo.Cairo.set_antialias","lime/graphics/cairo/Cairo.hx",515,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 518)		{
HXLINE( 518)			 ::Dynamic handle = this->handle;
HXDLIN( 518)			::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_antialias(hx::DynamicPtr(handle),value);
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(Cairo_obj,set_antialias,return )
 ...
 ::lime::math::Vector2 Cairo_obj::get_currentPoint(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","get_currentPoint",0x71e87136,"lime.graphics.cairo.Cairo.get_currentPoint","lime/graphics/cairo/Cairo.hx",526,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 529)		 ::Dynamic handle = this->handle;
HXDLIN( 529)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_current_point(hx::DynamicPtr(handle))) );
HXDLIN( 529)		HX_VARI(  ::Dynamic,vec) = Dynamic(hx::DynamicPtr(inVal));
HXLINE( 530)		return  ::lime::math::Vector2_obj::__new( ::Dynamic(vec->__Field(HX_("x",78,00,00,00),hx::paccDynamic)), ::Dynamic(vec->__Field(HX_("y",79,00,00,00),hx::paccDynamic)));
            	}
...
::Array< Float > Cairo_obj::get_dash(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","get_dash",0xed05b631,"lime.graphics.cairo.Cairo.get_dash","lime/graphics/cairo/Cairo.hx",538,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 541)		 ::Dynamic handle = this->handle;
HXDLIN( 541)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_dash(hx::DynamicPtr(handle))) );
HXDLIN( 541)		HX_VARI(  ::Dynamic,result) = Dynamic(hx::DynamicPtr(inVal));
...
::Array< Float > Cairo_obj::set_dash(::Array< Float > value){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","set_dash",0x9b630fa5,"lime.graphics.cairo.Cairo.set_dash","lime/graphics/cairo/Cairo.hx",550,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 553)		{
HXLINE( 553)			 ::Dynamic handle = this->handle;
HXDLIN( 553)			 ::hx::Object * _hx_tmp = hx::DynamicPtr(handle);
HXDLIN( 553)			::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_dash(_hx_tmp,hx::DynamicPtr(value));
            		}
...
Int Cairo_obj::get_dashCount(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","get_dashCount",0x2993ecde,"lime.graphics.cairo.Cairo.get_dashCount","lime/graphics/cairo/Cairo.hx",561,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 564)		 ::Dynamic handle = this->handle;
HXDLIN( 564)		return ( (Int)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_dash_count(hx::DynamicPtr(handle))) );
            	}
...
Int Cairo_obj::get_fillRule(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","get_fillRule",0xee732d7e,"lime.graphics.cairo.Cairo.get_fillRule","lime/graphics/cairo/Cairo.hx",572,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 575)		 ::Dynamic handle = this->handle;
HXDLIN( 575)		return ( (Int)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_fill_rule(hx::DynamicPtr(handle))) );
            	}
...
Int Cairo_obj::set_fillRule(Int value){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","set_fillRule",0x036c50f2,"lime.graphics.cairo.Cairo.set_fillRule","lime/graphics/cairo/Cairo.hx",583,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 586)		{
HXLINE( 586)			 ::Dynamic handle = this->handle;
HXDLIN( 586)			::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_fill_rule(hx::DynamicPtr(handle),value);
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(Cairo_obj,set_fillRule,return )
 ...
 ::Dynamic Cairo_obj::get_fontFace(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","get_fontFace",0x47e18e6b,"lime.graphics.cairo.Cairo.get_fontFace","lime/graphics/cairo/Cairo.hx",594,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 597)		 ::Dynamic handle = this->handle;
HXDLIN( 597)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_font_face(hx::DynamicPtr(handle))) );
HXDLIN( 597)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Cairo_obj,get_fontFace,return )
 ...
 ::Dynamic Cairo_obj::set_fontFace( ::Dynamic value){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","set_fontFace",0x5cdab1df,"lime.graphics.cairo.Cairo.set_fontFace","lime/graphics/cairo/Cairo.hx",605,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 608)		{
HXLINE( 608)			 ::Dynamic handle = this->handle;
HXDLIN( 608)			 ::hx::Object * _hx_tmp = hx::DynamicPtr(handle);
HXDLIN( 608)			::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_font_face(_hx_tmp,hx::DynamicPtr(value));
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(Cairo_obj,set_fontFace,return )
 ...
 ::Dynamic Cairo_obj::get_fontOptions(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","get_fontOptions",0x8029ee50,"lime.graphics.cairo.Cairo.get_fontOptions","lime/graphics/cairo/Cairo.hx",619,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 619)		 ::Dynamic handle = this->handle;
HXDLIN( 619)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_font_options(hx::DynamicPtr(handle))) );
HXDLIN( 619)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Cairo_obj,get_fontOptions,return )
 ...
 ::Dynamic Cairo_obj::set_fontOptions( ::Dynamic value){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","set_fontOptions",0x7bf56b5c,"lime.graphics.cairo.Cairo.set_fontOptions","lime/graphics/cairo/Cairo.hx",627,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 630)		{
HXLINE( 630)			 ::Dynamic handle = this->handle;
HXDLIN( 630)			 ::hx::Object * _hx_tmp = hx::DynamicPtr(handle);
HXDLIN( 630)			::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_font_options(_hx_tmp,hx::DynamicPtr(value));
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(Cairo_obj,set_fontOptions,return )
 ...
 ::Dynamic Cairo_obj::get_groupTarget(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","get_groupTarget",0x8da19cf1,"lime.graphics.cairo.Cairo.get_groupTarget","lime/graphics/cairo/Cairo.hx",641,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 641)		 ::Dynamic handle = this->handle;
HXDLIN( 641)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_group_target(hx::DynamicPtr(handle))) );
HXDLIN( 641)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
Bool Cairo_obj::get_hasCurrentPoint(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","get_hasCurrentPoint",0x7885e152,"lime.graphics.cairo.Cairo.get_hasCurrentPoint","lime/graphics/cairo/Cairo.hx",649,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 652)		 ::Dynamic handle = this->handle;
HXDLIN( 652)		return ( (Bool)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_has_current_point(hx::DynamicPtr(handle))) );
            	}
...
Int Cairo_obj::get_lineCap(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","get_lineCap",0x4e10b8ff,"lime.graphics.cairo.Cairo.get_lineCap","lime/graphics/cairo/Cairo.hx",660,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 663)		 ::Dynamic handle = this->handle;
HXDLIN( 663)		return ( (Int)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_line_cap(hx::DynamicPtr(handle))) );
            	}
...
Int Cairo_obj::set_lineCap(Int value){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","set_lineCap",0x587dc00b,"lime.graphics.cairo.Cairo.set_lineCap","lime/graphics/cairo/Cairo.hx",671,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 674)		{
HXLINE( 674)			 ::Dynamic handle = this->handle;
HXDLIN( 674)			::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_line_cap(hx::DynamicPtr(handle),value);
            		}
...
Int Cairo_obj::get_lineJoin(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","get_lineJoin",0x053c3e5d,"lime.graphics.cairo.Cairo.get_lineJoin","lime/graphics/cairo/Cairo.hx",682,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 685)		 ::Dynamic handle = this->handle;
HXDLIN( 685)		return ( (Int)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_line_join(hx::DynamicPtr(handle))) );
            	}
...
Int Cairo_obj::set_lineJoin(Int value){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","set_lineJoin",0x1a3561d1,"lime.graphics.cairo.Cairo.set_lineJoin","lime/graphics/cairo/Cairo.hx",693,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 696)		{
HXLINE( 696)			 ::Dynamic handle = this->handle;
HXDLIN( 696)			::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_line_join(hx::DynamicPtr(handle),value);
            		}
...
Float Cairo_obj::get_lineWidth(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","get_lineWidth",0x07b4d033,"lime.graphics.cairo.Cairo.get_lineWidth","lime/graphics/cairo/Cairo.hx",704,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 707)		 ::Dynamic handle = this->handle;
HXDLIN( 707)		return ( (Float)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_line_width(hx::DynamicPtr(handle))) );
            	}
...
Float Cairo_obj::set_lineWidth(Float value){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","set_lineWidth",0x4cbab23f,"lime.graphics.cairo.Cairo.set_lineWidth","lime/graphics/cairo/Cairo.hx",715,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 718)		{
HXLINE( 718)			 ::Dynamic handle = this->handle;
HXDLIN( 718)			::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_line_width(hx::DynamicPtr(handle),value);
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(Cairo_obj,set_lineWidth,return )
 ...
 ::lime::math::Matrix3 Cairo_obj::get_matrix(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","get_matrix",0x1c6bcce0,"lime.graphics.cairo.Cairo.get_matrix","lime/graphics/cairo/Cairo.hx",726,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 729)		 ::Dynamic handle = this->handle;
HXDLIN( 729)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_matrix(hx::DynamicPtr(handle))) );
HXDLIN( 729)		HX_VARI(  ::Dynamic,m) = Dynamic(hx::DynamicPtr(inVal));
HXLINE( 730)		return  ::lime::math::Matrix3_obj::__new( ::Dynamic(m->__Field(HX_("a",61,00,00,00),hx::paccDynamic)), ::Dynamic(m->__Field(HX_("b",62,00,00,00),hx::paccDynamic)), ::Dynamic(m->__Field(HX_("c",63,00,00,00),hx::paccDynamic)), ::Dynamic(m->__Field(HX_("d",64,00,00,00),hx::paccDynamic)), ::Dynamic(m->__Field(HX_("tx",84,65,00,00),hx::paccDynamic)), ::Dynamic(m->__Field(HX_("ty",85,65,00,00),hx::paccDynamic)));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Cairo_obj,get_matrix,return )
 ...
 ::lime::math::Matrix3 Cairo_obj::set_matrix( ::lime::math::Matrix3 value){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","set_matrix",0x1fe96b54,"lime.graphics.cairo.Cairo.set_matrix","lime/graphics/cairo/Cairo.hx",738,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 741)		{
HXLINE( 741)			 ::Dynamic handle = this->handle;
HXDLIN( 741)			 ::hx::Object * _hx_tmp = hx::DynamicPtr(handle);
HXDLIN( 741)			::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_matrix(_hx_tmp,hx::DynamicPtr(value));
            		}
...
Float Cairo_obj::get_miterLimit(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","get_miterLimit",0xea472f15,"lime.graphics.cairo.Cairo.get_miterLimit","lime/graphics/cairo/Cairo.hx",749,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 752)		 ::Dynamic handle = this->handle;
HXDLIN( 752)		return ( (Float)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_miter_limit(hx::DynamicPtr(handle))) );
            	}
...
Float Cairo_obj::set_miterLimit(Float value){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","set_miterLimit",0x0a671789,"lime.graphics.cairo.Cairo.set_miterLimit","lime/graphics/cairo/Cairo.hx",760,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 763)		{
HXLINE( 763)			 ::Dynamic handle = this->handle;
HXDLIN( 763)			::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_miter_limit(hx::DynamicPtr(handle),value);
            		}
...
Int Cairo_obj::get_operator(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","get_operator",0xc620d803,"lime.graphics.cairo.Cairo.get_operator","lime/graphics/cairo/Cairo.hx",771,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 774)		 ::Dynamic handle = this->handle;
HXDLIN( 774)		return ( (Int)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_operator(hx::DynamicPtr(handle))) );
            	}
...
Int Cairo_obj::set_operator(Int value){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","set_operator",0xdb19fb77,"lime.graphics.cairo.Cairo.set_operator","lime/graphics/cairo/Cairo.hx",782,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 785)		{
HXLINE( 785)			 ::Dynamic handle = this->handle;
HXDLIN( 785)			::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_operator(hx::DynamicPtr(handle),value);
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(Cairo_obj,set_operator,return )
 ...
 ::Dynamic Cairo_obj::get_source(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","get_source",0x92d5477a,"lime.graphics.cairo.Cairo.get_source","lime/graphics/cairo/Cairo.hx",793,0x0918a4c7)
            	HX_STACK_THIS(this)
HXLINE( 796)		 ::Dynamic handle = this->handle;
HXDLIN( 796)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_source(hx::DynamicPtr(handle))) );
HXDLIN( 796)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Cairo_obj,get_source,return )
 ...
 ::Dynamic Cairo_obj::set_source( ::Dynamic value){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","set_source",0x9652e5ee,"lime.graphics.cairo.Cairo.set_source","lime/graphics/cairo/Cairo.hx",804,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 807)		{
HXLINE( 807)			 ::Dynamic handle = this->handle;
HXDLIN( 807)			 ::hx::Object * _hx_tmp = hx::DynamicPtr(handle);
HXDLIN( 807)			::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_source(_hx_tmp,hx::DynamicPtr(value));
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(Cairo_obj,set_source,return )
 ...
 ::Dynamic Cairo_obj::get_target(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 818)		 ::Dynamic handle = this->handle;
HXDLIN( 818)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_target(hx::DynamicPtr(handle))) );
HXDLIN( 818)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
Float Cairo_obj::get_tolerance(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 829)		 ::Dynamic handle = this->handle;
HXDLIN( 829)		return ( (Float)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_tolerance(hx::DynamicPtr(handle))) );
            	}
...
Float Cairo_obj::set_tolerance(Float value){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","set_tolerance",0x6ed935da,"lime.graphics.cairo.Cairo.set_tolerance","lime/graphics/cairo/Cairo.hx",837,0x0918a4c7)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 840)		{
HXLINE( 840)			 ::Dynamic handle = this->handle;
HXDLIN( 840)			::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_tolerance(hx::DynamicPtr(handle),value);
            		}
...
HXLINE( 851)		return ( (Int)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_version()) );
            	}
...
HXLINE( 862)		return ( (::String)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_version_string()) );
            	}
...
void Cairo_obj::lime_cairo_arc( ::Dynamic handle,Float xc,Float yc,Float radius,Float angle1,Float angle2){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_arc",0x19e3c0c7,"lime.graphics.cairo.Cairo.lime_cairo_arc","lime/graphics/cairo/Cairo.hx",878,0x0918a4c7)
            	...
            	HX_STACK_ARG(angle1,"angle1")
            	HX_STACK_ARG(angle2,"angle2")
HXLINE( 878)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_arc(hx::DynamicPtr(handle),xc,yc,radius,angle1,angle2);
            	}
...
void Cairo_obj::lime_cairo_arc_negative( ::Dynamic handle,Float xc,Float yc,Float radius,Float angle1,Float angle2){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_arc_negative",0xfe5f8c2d,"lime.graphics.cairo.Cairo.lime_cairo_arc_negative","lime/graphics/cairo/Cairo.hx",879,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(xc,"xc")
            	HX_STACK_ARG(yc,"yc")
            	HX_STACK_ARG(radius,"radius")
            	HX_STACK_ARG(angle1,"angle1")
            	HX_STACK_ARG(angle2,"angle2")
HXLINE( 879)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_arc_negative(hx::DynamicPtr(handle),xc,yc,radius,angle1,angle2);
            	}
...
void Cairo_obj::lime_cairo_clip( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_clip",0x8eb2d2bb,"lime.graphics.cairo.Cairo.lime_cairo_clip","lime/graphics/cairo/Cairo.hx",880,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 880)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_clip(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::lime_cairo_clip_preserve( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_clip_preserve",0x4638e110,"lime.graphics.cairo.Cairo.lime_cairo_clip_preserve","lime/graphics/cairo/Cairo.hx",881,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 881)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_clip_preserve(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::lime_cairo_clip_extents( ::Dynamic handle,Float x1,Float y1,Float x2,Float y2){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_clip_extents",0x5941ba85,"lime.graphics.cairo.Cairo.lime_cairo_clip_extents","lime/graphics/cairo/Cairo.hx",882,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(x1,"x1")
            	HX_STACK_ARG(y1,"y1")
            	HX_STACK_ARG(x2,"x2")
            	HX_STACK_ARG(y2,"y2")
HXLINE( 882)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_clip_extents(hx::DynamicPtr(handle),x1,y1,x2,y2);
            	}
...
void Cairo_obj::lime_cairo_close_path( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_close_path",0xcf2794f7,"lime.graphics.cairo.Cairo.lime_cairo_close_path","lime/graphics/cairo/Cairo.hx",883,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 883)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_close_path(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::lime_cairo_copy_page( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_copy_page",0x07d7328e,"lime.graphics.cairo.Cairo.lime_cairo_copy_page","lime/graphics/cairo/Cairo.hx",884,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 884)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_copy_page(hx::DynamicPtr(handle));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Cairo_obj,lime_cairo_copy_page,(void))
 ...
 ::Dynamic Cairo_obj::lime_cairo_create( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_create",0x30d0dba7,"lime.graphics.cairo.Cairo.lime_cairo_create","lime/graphics/cairo/Cairo.hx",885,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 885)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_create(hx::DynamicPtr(handle))) );
HXDLIN( 885)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
void Cairo_obj::lime_cairo_curve_to( ::Dynamic handle,Float x1,Float y1,Float x2,Float y2,Float x3,Float y3){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_curve_to",0x685c3bb6,"lime.graphics.cairo.Cairo.lime_cairo_curve_to","lime/graphics/cairo/Cairo.hx",886,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(x1,"x1")
            	HX_STACK_ARG(y1,"y1")
            	HX_STACK_ARG(x2,"x2")
            	...
            	HX_STACK_ARG(x3,"x3")
            	HX_STACK_ARG(y3,"y3")
HXLINE( 886)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_curve_to(hx::DynamicPtr(handle),x1,y1,x2,y2,x3,y3);
            	}
...
void Cairo_obj::lime_cairo_fill( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_fill",0x90ac326e,"lime.graphics.cairo.Cairo.lime_cairo_fill","lime/graphics/cairo/Cairo.hx",887,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 887)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_fill(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::lime_cairo_fill_extents( ::Dynamic handle,Float x1,Float y1,Float x2,Float y2){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_fill_extents",0x90fe8538,"lime.graphics.cairo.Cairo.lime_cairo_fill_extents","lime/graphics/cairo/Cairo.hx",888,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(x1,"x1")
            	HX_STACK_ARG(y1,"y1")
            	HX_STACK_ARG(x2,"x2")
            	HX_STACK_ARG(y2,"y2")
HXLINE( 888)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_fill_extents(hx::DynamicPtr(handle),x1,y1,x2,y2);
            	}
...
void Cairo_obj::lime_cairo_fill_preserve( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_fill_preserve",0xd3ad72fd,"lime.graphics.cairo.Cairo.lime_cairo_fill_preserve","lime/graphics/cairo/Cairo.hx",889,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 889)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_fill_preserve(hx::DynamicPtr(handle));
            	}
...
Int Cairo_obj::lime_cairo_get_antialias( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_get_antialias",0x1d14f13a,"lime.graphics.cairo.Cairo.lime_cairo_get_antialias","lime/graphics/cairo/Cairo.hx",890,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 890)		return ( (Int)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_antialias(hx::DynamicPtr(handle))) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Cairo_obj,lime_cairo_get_antialias,return )
 ...
 ::Dynamic Cairo_obj::lime_cairo_get_current_point( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_get_current_point",0x91185916,"lime.graphics.cairo.Cairo.lime_cairo_get_current_point","lime/graphics/cairo/Cairo.hx",891,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 891)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_current_point(hx::DynamicPtr(handle))) );
HXDLIN( 891)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Cairo_obj,lime_cairo_get_current_point,return )
 ...
 ::Dynamic Cairo_obj::lime_cairo_get_dash( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_get_dash",0x41a64646,"lime.graphics.cairo.Cairo.lime_cairo_get_dash","lime/graphics/cairo/Cairo.hx",892,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 892)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_dash(hx::DynamicPtr(handle))) );
HXDLIN( 892)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
Int Cairo_obj::lime_cairo_get_dash_count( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_get_dash_count",0x85c7cad6,"lime.graphics.cairo.Cairo.lime_cairo_get_dash_count","lime/graphics/cairo/Cairo.hx",893,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 893)		return ( (Int)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_dash_count(hx::DynamicPtr(handle))) );
            	}
...
Int Cairo_obj::lime_cairo_get_fill_rule( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_get_fill_rule",0xe1696604,"lime.graphics.cairo.Cairo.lime_cairo_get_fill_rule","lime/graphics/cairo/Cairo.hx",894,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 894)		return ( (Int)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_fill_rule(hx::DynamicPtr(handle))) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Cairo_obj,lime_cairo_get_fill_rule,return )
 ...
 ::Dynamic Cairo_obj::lime_cairo_get_font_face( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_get_font_face",0xb6a01ed9,"lime.graphics.cairo.Cairo.lime_cairo_get_font_face","lime/graphics/cairo/Cairo.hx",895,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 895)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_font_face(hx::DynamicPtr(handle))) );
HXDLIN( 895)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Cairo_obj,lime_cairo_get_font_face,return )
 ...
 ::Dynamic Cairo_obj::lime_cairo_get_font_options( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_get_font_options",0xd39ad6a2,"lime.graphics.cairo.Cairo.lime_cairo_get_font_options","lime/graphics/cairo/Cairo.hx",896,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 896)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_font_options(hx::DynamicPtr(handle))) );
HXDLIN( 896)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Cairo_obj,lime_cairo_get_font_options,return )
 ...
 ::Dynamic Cairo_obj::lime_cairo_get_group_target( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_get_group_target",0x0cf0cc85,"lime.graphics.cairo.Cairo.lime_cairo_get_group_target","lime/graphics/cairo/Cairo.hx",897,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 897)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_group_target(hx::DynamicPtr(handle))) );
HXDLIN( 897)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
Int Cairo_obj::lime_cairo_get_line_cap( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_get_line_cap",0x02a755fb,"lime.graphics.cairo.Cairo.lime_cairo_get_line_cap","lime/graphics/cairo/Cairo.hx",898,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 898)		return ( (Int)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_line_cap(hx::DynamicPtr(handle))) );
            	}
...
Int Cairo_obj::lime_cairo_get_line_join( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_get_line_join",0x546efde1,"lime.graphics.cairo.Cairo.lime_cairo_get_line_join","lime/graphics/cairo/Cairo.hx",899,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 899)		return ( (Int)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_line_join(hx::DynamicPtr(handle))) );
            	}
...
Float Cairo_obj::lime_cairo_get_line_width( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_get_line_width",0x04e9a42f,"lime.graphics.cairo.Cairo.lime_cairo_get_line_width","lime/graphics/cairo/Cairo.hx",900,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 900)		return ( (Float)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_line_width(hx::DynamicPtr(handle))) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Cairo_obj,lime_cairo_get_line_width,return )
 ...
 ::Dynamic Cairo_obj::lime_cairo_get_matrix( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_get_matrix",0x46604c35,"lime.graphics.cairo.Cairo.lime_cairo_get_matrix","lime/graphics/cairo/Cairo.hx",901,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 901)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_matrix(hx::DynamicPtr(handle))) );
...
Float Cairo_obj::lime_cairo_get_miter_limit( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_get_miter_limit",0xf5108dcd,"lime.graphics.cairo.Cairo.lime_cairo_get_miter_limit","lime/graphics/cairo/Cairo.hx",902,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 902)		return ( (Float)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_miter_limit(hx::DynamicPtr(handle))) );
            	}
...
Int Cairo_obj::lime_cairo_get_operator( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_get_operator",0xb5b39698,"lime.graphics.cairo.Cairo.lime_cairo_get_operator","lime/graphics/cairo/Cairo.hx",903,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 903)		return ( (Int)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_operator(hx::DynamicPtr(handle))) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Cairo_obj,lime_cairo_get_operator,return )
 ...
 ::Dynamic Cairo_obj::lime_cairo_get_source( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_get_source",0xbcc9c6cf,"lime.graphics.cairo.Cairo.lime_cairo_get_source","lime/graphics/cairo/Cairo.hx",904,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 904)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_source(hx::DynamicPtr(handle))) );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Cairo_obj,lime_cairo_get_source,return )
 ...
 ::Dynamic Cairo_obj::lime_cairo_get_target( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_get_target",0x11850945,"lime.graphics.cairo.Cairo.lime_cairo_get_target","lime/graphics/cairo/Cairo.hx",905,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 905)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_target(hx::DynamicPtr(handle))) );
...
Float Cairo_obj::lime_cairo_get_tolerance( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_get_tolerance",0xdaa75799,"lime.graphics.cairo.Cairo.lime_cairo_get_tolerance","lime/graphics/cairo/Cairo.hx",906,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 906)		return ( (Float)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_get_tolerance(hx::DynamicPtr(handle))) );
            	}
...
Bool Cairo_obj::lime_cairo_has_current_point( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_has_current_point",0x624fe6da,"lime.graphics.cairo.Cairo.lime_cairo_has_current_point","lime/graphics/cairo/Cairo.hx",907,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 907)		return ( (Bool)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_has_current_point(hx::DynamicPtr(handle))) );
            	}
...
void Cairo_obj::lime_cairo_identity_matrix( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_identity_matrix",0x53186457,"lime.graphics.cairo.Cairo.lime_cairo_identity_matrix","lime/graphics/cairo/Cairo.hx",908,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 908)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_identity_matrix(hx::DynamicPtr(handle));
            	}
...
Bool Cairo_obj::lime_cairo_in_clip( ::Dynamic handle,Float x,Float y){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_in_clip",0x72e7919f,"lime.graphics.cairo.Cairo.lime_cairo_in_clip","lime/graphics/cairo/Cairo.hx",909,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 909)		return ( (Bool)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_in_clip(hx::DynamicPtr(handle),x,y)) );
            	}
...
Bool Cairo_obj::lime_cairo_in_fill( ::Dynamic handle,Float x,Float y){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_in_fill",0x74e0f152,"lime.graphics.cairo.Cairo.lime_cairo_in_fill","lime/graphics/cairo/Cairo.hx",910,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 910)		return ( (Bool)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_in_fill(hx::DynamicPtr(handle),x,y)) );
            	}
...
Bool Cairo_obj::lime_cairo_in_stroke( ::Dynamic handle,Float x,Float y){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_in_stroke",0xb0036847,"lime.graphics.cairo.Cairo.lime_cairo_in_stroke","lime/graphics/cairo/Cairo.hx",911,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 911)		return ( (Bool)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_in_stroke(hx::DynamicPtr(handle),x,y)) );
            	}
...
void Cairo_obj::lime_cairo_line_to( ::Dynamic handle,Float x,Float y){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_line_to",0x942a751b,"lime.graphics.cairo.Cairo.lime_cairo_line_to","lime/graphics/cairo/Cairo.hx",912,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 912)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_line_to(hx::DynamicPtr(handle),x,y);
            	}
...
void Cairo_obj::lime_cairo_mask( ::Dynamic handle, ::Dynamic pattern){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_mask",0x9546a4d7,"lime.graphics.cairo.Cairo.lime_cairo_mask","lime/graphics/cairo/Cairo.hx",913,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(pattern,"pattern")
HXLINE( 913)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(handle);
HXDLIN( 913)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_mask(_hx_tmp,hx::DynamicPtr(pattern));
            	}
...
void Cairo_obj::lime_cairo_mask_surface( ::Dynamic handle, ::Dynamic surface,Float x,Float y){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_mask_surface",0xb24b9385,"lime.graphics.cairo.Cairo.lime_cairo_mask_surface","lime/graphics/cairo/Cairo.hx",914,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(surface,"surface")
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 914)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(handle);
HXDLIN( 914)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_mask_surface(_hx_tmp,hx::DynamicPtr(surface),x,y);
            	}
...
void Cairo_obj::lime_cairo_move_to( ::Dynamic handle,Float x,Float y){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_move_to",0xbf18ba1e,"lime.graphics.cairo.Cairo.lime_cairo_move_to","lime/graphics/cairo/Cairo.hx",915,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 915)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_move_to(hx::DynamicPtr(handle),x,y);
            	}
...
void Cairo_obj::lime_cairo_new_path( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_new_path",0x0d080a8f,"lime.graphics.cairo.Cairo.lime_cairo_new_path","lime/graphics/cairo/Cairo.hx",916,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 916)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_new_path(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::lime_cairo_paint( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_paint",0xc2b5c153,"lime.graphics.cairo.Cairo.lime_cairo_paint","lime/graphics/cairo/Cairo.hx",917,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 917)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_paint(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::lime_cairo_paint_with_alpha( ::Dynamic handle,Float alpha){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_paint_with_alpha",0x495de3d1,"lime.graphics.cairo.Cairo.lime_cairo_paint_with_alpha","lime/graphics/cairo/Cairo.hx",918,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(alpha,"alpha")
HXLINE( 918)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_paint_with_alpha(hx::DynamicPtr(handle),alpha);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Cairo_obj,lime_cairo_paint_with_alpha,(void))
 ...
 ::Dynamic Cairo_obj::lime_cairo_pop_group( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_pop_group",0xf563e306,"lime.graphics.cairo.Cairo.lime_cairo_pop_group","lime/graphics/cairo/Cairo.hx",919,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 919)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_pop_group(hx::DynamicPtr(handle))) );
HXDLIN( 919)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
void Cairo_obj::lime_cairo_pop_group_to_source( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_pop_group_to_source",0x4c0274a6,"lime.graphics.cairo.Cairo.lime_cairo_pop_group_to_source","lime/graphics/cairo/Cairo.hx",920,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 920)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_pop_group_to_source(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::lime_cairo_push_group( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_push_group",0x4f379205,"lime.graphics.cairo.Cairo.lime_cairo_push_group","lime/graphics/cairo/Cairo.hx",921,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 921)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_push_group(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::lime_cairo_push_group_with_content( ::Dynamic handle,Int content){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_push_group_with_content",0x55fd347a,"lime.graphics.cairo.Cairo.lime_cairo_push_group_with_content","lime/graphics/cairo/Cairo.hx",922,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(content,"content")
HXLINE( 922)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_push_group_with_content(hx::DynamicPtr(handle),content);
            	}
...
void Cairo_obj::lime_cairo_rectangle( ::Dynamic handle,Float x,Float y,Float width,Float height){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_rectangle",0x31235c64,"lime.graphics.cairo.Cairo.lime_cairo_rectangle","lime/graphics/cairo/Cairo.hx",923,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE( 923)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_rectangle(hx::DynamicPtr(handle),x,y,width,height);
            	}
...
void Cairo_obj::lime_cairo_rel_curve_to( ::Dynamic handle,Float dx1,Float dy1,Float dx2,Float dy2,Float dx3,Float dy3){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_rel_curve_to",0x2afa781c,"lime.graphics.cairo.Cairo.lime_cairo_rel_curve_to","lime/graphics/cairo/Cairo.hx",924,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(dx1,"dx1")
            	HX_STACK_ARG(dy1,"dy1")
            	HX_STACK_ARG(dx2,"dx2")
            	...
            	HX_STACK_ARG(dx3,"dx3")
            	HX_STACK_ARG(dy3,"dy3")
HXLINE( 924)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_rel_curve_to(hx::DynamicPtr(handle),dx1,dy1,dx2,dy2,dx3,dy3);
            	}
...
void Cairo_obj::lime_cairo_rel_line_to( ::Dynamic handle,Float dx,Float dy){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_rel_line_to",0xcc244775,"lime.graphics.cairo.Cairo.lime_cairo_rel_line_to","lime/graphics/cairo/Cairo.hx",925,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(dx,"dx")
            	HX_STACK_ARG(dy,"dy")
HXLINE( 925)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_rel_line_to(hx::DynamicPtr(handle),dx,dy);
            	}
...
void Cairo_obj::lime_cairo_rel_move_to( ::Dynamic handle,Float dx,Float dy){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_rel_move_to",0xf7128c78,"lime.graphics.cairo.Cairo.lime_cairo_rel_move_to","lime/graphics/cairo/Cairo.hx",926,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(dx,"dx")
            	HX_STACK_ARG(dy,"dy")
HXLINE( 926)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_rel_move_to(hx::DynamicPtr(handle),dx,dy);
            	}
...
void Cairo_obj::lime_cairo_reset_clip( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_reset_clip",0xe452f8ab,"lime.graphics.cairo.Cairo.lime_cairo_reset_clip","lime/graphics/cairo/Cairo.hx",927,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 927)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_reset_clip(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::lime_cairo_restore( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_restore",0xdf350843,"lime.graphics.cairo.Cairo.lime_cairo_restore","lime/graphics/cairo/Cairo.hx",928,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 928)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_restore(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::lime_cairo_rotate( ::Dynamic handle,Float amount){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_rotate",0x7fe1bb06,"lime.graphics.cairo.Cairo.lime_cairo_rotate","lime/graphics/cairo/Cairo.hx",929,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(amount,"amount")
HXLINE( 929)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_rotate(hx::DynamicPtr(handle),amount);
            	}
...
void Cairo_obj::lime_cairo_save( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_save",0x993def28,"lime.graphics.cairo.Cairo.lime_cairo_save","lime/graphics/cairo/Cairo.hx",930,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 930)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_save(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::lime_cairo_scale( ::Dynamic handle,Float x,Float y){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_scale",0x7e35d83f,"lime.graphics.cairo.Cairo.lime_cairo_scale","lime/graphics/cairo/Cairo.hx",931,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 931)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_scale(hx::DynamicPtr(handle),x,y);
            	}
...
void Cairo_obj::lime_cairo_set_antialias( ::Dynamic handle,Int cap){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_set_antialias",0x621ad346,"lime.graphics.cairo.Cairo.lime_cairo_set_antialias","lime/graphics/cairo/Cairo.hx",932,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(cap,"cap")
HXLINE( 932)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_antialias(hx::DynamicPtr(handle),cap);
            	}
...
void Cairo_obj::lime_cairo_set_dash( ::Dynamic handle, ::Dynamic dash){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_set_dash",0xf0039fba,"lime.graphics.cairo.Cairo.lime_cairo_set_dash","lime/graphics/cairo/Cairo.hx",933,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(dash,"dash")
HXLINE( 933)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(handle);
HXDLIN( 933)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_dash(_hx_tmp,hx::DynamicPtr(dash));
            	}
...
void Cairo_obj::lime_cairo_set_fill_rule( ::Dynamic handle,Int cap){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_set_fill_rule",0x266f4810,"lime.graphics.cairo.Cairo.lime_cairo_set_fill_rule","lime/graphics/cairo/Cairo.hx",934,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(cap,"cap")
HXLINE( 934)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_fill_rule(hx::DynamicPtr(handle),cap);
            	}
...
void Cairo_obj::lime_cairo_set_font_face( ::Dynamic handle, ::Dynamic face){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_set_font_face",0xfba600e5,"lime.graphics.cairo.Cairo.lime_cairo_set_font_face","lime/graphics/cairo/Cairo.hx",935,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(face,"face")
HXLINE( 935)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(handle);
HXDLIN( 935)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_font_face(_hx_tmp,hx::DynamicPtr(face));
            	}
...
void Cairo_obj::lime_cairo_set_font_options( ::Dynamic handle, ::Dynamic options){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_set_font_options",0x29dcc416,"lime.graphics.cairo.Cairo.lime_cairo_set_font_options","lime/graphics/cairo/Cairo.hx",936,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(options,"options")
HXLINE( 936)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(handle);
HXDLIN( 936)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_font_options(_hx_tmp,hx::DynamicPtr(options));
            	}
...
void Cairo_obj::lime_cairo_set_font_size( ::Dynamic handle,Float size){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_set_font_size",0x0443ed09,"lime.graphics.cairo.Cairo.lime_cairo_set_font_size","lime/graphics/cairo/Cairo.hx",937,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(size,"size")
HXLINE( 937)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_font_size(hx::DynamicPtr(handle),size);
            	}
...
void Cairo_obj::lime_cairo_set_line_cap( ::Dynamic handle,Int cap){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_set_line_cap",0x17a0796f,"lime.graphics.cairo.Cairo.lime_cairo_set_line_cap","lime/graphics/cairo/Cairo.hx",938,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(cap,"cap")
HXLINE( 938)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_line_cap(hx::DynamicPtr(handle),cap);
            	}
...
void Cairo_obj::lime_cairo_set_line_join( ::Dynamic handle,Int join){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_set_line_join",0x9974dfed,"lime.graphics.cairo.Cairo.lime_cairo_set_line_join","lime/graphics/cairo/Cairo.hx",939,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(join,"join")
HXLINE( 939)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_line_join(hx::DynamicPtr(handle),join);
            	}
...
void Cairo_obj::lime_cairo_set_line_width( ::Dynamic handle,Float width){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_set_line_width",0x25098ca3,"lime.graphics.cairo.Cairo.lime_cairo_set_line_width","lime/graphics/cairo/Cairo.hx",940,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(width,"width")
HXLINE( 940)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_line_width(hx::DynamicPtr(handle),width);
            	}
...
void Cairo_obj::lime_cairo_set_matrix( ::Dynamic handle, ::Dynamic matrix){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_set_matrix",0x49ddeaa9,"lime.graphics.cairo.Cairo.lime_cairo_set_matrix","lime/graphics/cairo/Cairo.hx",941,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(matrix,"matrix")
HXLINE( 941)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(handle);
HXDLIN( 941)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_matrix(_hx_tmp,hx::DynamicPtr(matrix));
            	}
...
void Cairo_obj::lime_cairo_set_miter_limit( ::Dynamic handle,Float miterLimit){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_set_miter_limit",0xf0dc0ad9,"lime.graphics.cairo.Cairo.lime_cairo_set_miter_limit","lime/graphics/cairo/Cairo.hx",942,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(miterLimit,"miterLimit")
HXLINE( 942)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_miter_limit(hx::DynamicPtr(handle),miterLimit);
            	}
...
void Cairo_obj::lime_cairo_set_operator( ::Dynamic handle,Int op){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_set_operator",0xcaacba0c,"lime.graphics.cairo.Cairo.lime_cairo_set_operator","lime/graphics/cairo/Cairo.hx",943,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(op,"op")
HXLINE( 943)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_operator(hx::DynamicPtr(handle),op);
            	}
...
void Cairo_obj::lime_cairo_set_source( ::Dynamic handle, ::Dynamic pattern){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_set_source",0xc0476543,"lime.graphics.cairo.Cairo.lime_cairo_set_source","lime/graphics/cairo/Cairo.hx",944,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(pattern,"pattern")
HXLINE( 944)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(handle);
HXDLIN( 944)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_source(_hx_tmp,hx::DynamicPtr(pattern));
            	}
...
void Cairo_obj::lime_cairo_set_source_rgb( ::Dynamic handle,Float r,Float g,Float b){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_set_source_rgb",0x3b58e2d1,"lime.graphics.cairo.Cairo.lime_cairo_set_source_rgb","lime/graphics/cairo/Cairo.hx",945,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(r,"r")
            	HX_STACK_ARG(g,"g")
            	HX_STACK_ARG(b,"b")
HXLINE( 945)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_source_rgb(hx::DynamicPtr(handle),r,g,b);
            	}
...
void Cairo_obj::lime_cairo_set_source_rgba( ::Dynamic handle,Float r,Float g,Float b,Float a){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_set_source_rgba",0xb26d9470,"lime.graphics.cairo.Cairo.lime_cairo_set_source_rgba","lime/graphics/cairo/Cairo.hx",946,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(r,"r")
            	HX_STACK_ARG(g,"g")
            	HX_STACK_ARG(b,"b")
            	HX_STACK_ARG(a,"a")
HXLINE( 946)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_source_rgba(hx::DynamicPtr(handle),r,g,b,a);
            	}
...
void Cairo_obj::lime_cairo_set_source_surface( ::Dynamic handle, ::Dynamic surface,Float x,Float y){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_set_source_surface",0xe9e49ff1,"lime.graphics.cairo.Cairo.lime_cairo_set_source_surface","lime/graphics/cairo/Cairo.hx",947,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(surface,"surface")
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 947)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(handle);
HXDLIN( 947)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_source_surface(_hx_tmp,hx::DynamicPtr(surface),x,y);
            	}
...
void Cairo_obj::lime_cairo_set_tolerance( ::Dynamic handle,Float tolerance){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_set_tolerance",0x1fad39a5,"lime.graphics.cairo.Cairo.lime_cairo_set_tolerance","lime/graphics/cairo/Cairo.hx",948,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(tolerance,"tolerance")
HXLINE( 948)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_tolerance(hx::DynamicPtr(handle),tolerance);
            	}
...
void Cairo_obj::lime_cairo_show_page( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_show_page",0xb0407446,"lime.graphics.cairo.Cairo.lime_cairo_show_page","lime/graphics/cairo/Cairo.hx",949,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 949)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_show_page(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::lime_cairo_show_text( ::Dynamic handle,::String text){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_show_text",0xb2e866a4,"lime.graphics.cairo.Cairo.lime_cairo_show_text","lime/graphics/cairo/Cairo.hx",950,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(text,"text")
HXLINE( 950)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_show_text(hx::DynamicPtr(handle),text);
            	}
...
Int Cairo_obj::lime_cairo_status( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_status",0xbabd5bdd,"lime.graphics.cairo.Cairo.lime_cairo_status","lime/graphics/cairo/Cairo.hx",951,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 951)		return ( (Int)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_status(hx::DynamicPtr(handle))) );
            	}
...
void Cairo_obj::lime_cairo_stroke( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_stroke",0xc5f62863,"lime.graphics.cairo.Cairo.lime_cairo_stroke","lime/graphics/cairo/Cairo.hx",952,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 952)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_stroke(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::lime_cairo_stroke_extents( ::Dynamic handle,Float x1,Float y1,Float x2,Float y2){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_stroke_extents",0xa1cef82d,"lime.graphics.cairo.Cairo.lime_cairo_stroke_extents","lime/graphics/cairo/Cairo.hx",953,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(x1,"x1")
            	HX_STACK_ARG(y1,"y1")
            	HX_STACK_ARG(x2,"x2")
            	HX_STACK_ARG(y2,"y2")
HXLINE( 953)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_stroke_extents(hx::DynamicPtr(handle),x1,y1,x2,y2);
            	}
...
void Cairo_obj::lime_cairo_stroke_preserve( ::Dynamic handle){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_stroke_preserve",0x79419668,"lime.graphics.cairo.Cairo.lime_cairo_stroke_preserve","lime/graphics/cairo/Cairo.hx",954,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
HXLINE( 954)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_stroke_preserve(hx::DynamicPtr(handle));
            	}
...
void Cairo_obj::lime_cairo_transform( ::Dynamic handle, ::Dynamic matrix){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_transform",0x5d39b5a1,"lime.graphics.cairo.Cairo.lime_cairo_transform","lime/graphics/cairo/Cairo.hx",955,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(matrix,"matrix")
HXLINE( 955)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(handle);
HXDLIN( 955)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_transform(_hx_tmp,hx::DynamicPtr(matrix));
            	}
...
void Cairo_obj::lime_cairo_translate( ::Dynamic handle,Float x,Float y){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_translate",0x61265f83,"lime.graphics.cairo.Cairo.lime_cairo_translate","lime/graphics/cairo/Cairo.hx",956,0x0918a4c7)
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 956)		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_translate(hx::DynamicPtr(handle),x,y);
            	}
...
Int Cairo_obj::lime_cairo_version(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_version",0xf176880d,"lime.graphics.cairo.Cairo.lime_cairo_version","lime/graphics/cairo/Cairo.hx",957,0x0918a4c7)
HXLINE( 957)		return ( (Int)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_version()) );
            	}
...
::String Cairo_obj::lime_cairo_version_string(){
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","lime_cairo_version_string",0xfd217e03,"lime.graphics.cairo.Cairo.lime_cairo_version_string","lime/graphics/cairo/Cairo.hx",958,0x0918a4c7)
HXLINE( 958)		return ( (::String)(::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_version_string()) );
            	}
...
{
{
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","boot",0x17044688,"lime.graphics.cairo.Cairo.boot","lime/graphics/cairo/Cairo.hx",878,0x0918a4c7)
HXLINE( 878)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_arc",f1,76,fc,f9),HX_("odddddv",41,24,f6,d9),false);
HXDLIN( 878)		cffi_lime_cairo_arc = inValue;
            	}
{
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","boot",0x17044688,"lime.graphics.cairo.Cairo.boot","lime/graphics/cairo/Cairo.hx",879,0x0918a4c7)
HXLINE( 879)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_arc_negative",c3,c0,b7,d8),HX_("odddddv",41,24,f6,d9),false);
HXDLIN( 879)		cffi_lime_cairo_arc_negative = inValue;
            	}
{
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","boot",0x17044688,"lime.graphics.cairo.Cairo.boot","lime/graphics/cairo/Cairo.hx",880,0x0918a4c7)
HXLINE( 880)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_clip",51,81,39,c4),HX_("ov",27,61,00,00),false);
HXDLIN( 880)		cffi_lime_cairo_clip = inValue;
            	}
{
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","boot",0x17044688,"lime.graphics.cairo.Cairo.boot","lime/graphics/cairo/Cairo.hx",881,0x0918a4c7)
HXLINE( 881)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_clip_preserve",ba,af,0e,79),HX_("ov",27,61,00,00),false);
HXDLIN( 881)		cffi_lime_cairo_clip_preserve = inValue;
            	}
{
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","boot",0x17044688,"lime.graphics.cairo.Cairo.boot","lime/graphics/cairo/Cairo.hx",882,0x0918a4c7)
HXLINE( 882)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_clip_extents",1b,ef,99,33),HX_("oddddv",a7,9e,14,38),false);
HXDLIN( 882)		cffi_lime_cairo_clip_extents = inValue;
            	}
{
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","boot",0x17044688,"lime.graphics.cairo.Cairo.boot","lime/graphics/cairo/Cairo.hx",883,0x0918a4c7)
HXLINE( 883)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_close_path",0d,58,78,e1),HX_("ov",27,61,00,00),false);
HXDLIN( 883)		cffi_lime_cairo_close_path = inValue;
            	}
{
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","boot",0x17044688,"lime.graphics.cairo.Cairo.boot","lime/graphics/cairo/Cairo.hx",884,0x0918a4c7)
HXLINE( 884)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_copy_page",38,e4,e1,1e),HX_("ov",27,61,00,00),false);
HXDLIN( 884)		cffi_lime_cairo_copy_page = inValue;
            	}
{
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","boot",0x17044688,"lime.graphics.cairo.Cairo.boot","lime/graphics/cairo/Cairo.hx",885,0x0918a4c7)
HXLINE( 885)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_create",bd,db,50,d8),HX_("oo",20,61,00,00),false);
HXDLIN( 885)		cffi_lime_cairo_create = inValue;
            	}
{
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","boot",0x17044688,"lime.graphics.cairo.Cairo.boot","lime/graphics/cairo/Cairo.hx",886,0x0918a4c7)
HXLINE( 886)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_curve_to",4c,ed,ec,ef),HX_("oddddddv",67,85,69,dd),false);
HXDLIN( 886)		cffi_lime_cairo_curve_to = inValue;
            	}
{
...
HXLINE( 887)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_fill",04,e1,32,c6),HX_("ov",27,61,00,00),false);
HXDLIN( 887)		cffi_lime_cairo_fill = inValue;
            	}
{
...
HXLINE( 888)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_fill_extents",ce,b9,56,6b),HX_("oddddv",a7,9e,14,38),false);
HXDLIN( 888)		cffi_lime_cairo_fill_extents = inValue;
            	}
{
...
HXLINE( 889)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_fill_preserve",a7,41,83,06),HX_("ov",27,61,00,00),false);
HXDLIN( 889)		cffi_lime_cairo_fill_preserve = inValue;
            	}
{
...
HXLINE( 890)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_get_antialias",e4,bf,ea,4f),HX_("oi",1a,61,00,00),false);
HXDLIN( 890)		cffi_lime_cairo_get_antialias = inValue;
            	}
{
...
HXLINE( 891)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_get_current_point",c0,c4,0b,c0),HX_("oo",20,61,00,00),false);
HXDLIN( 891)		cffi_lime_cairo_get_current_point = inValue;
            	}
{
...
HXLINE( 892)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_get_dash",dc,f7,36,c9),HX_("oo",20,61,00,00),false);
HXDLIN( 892)		cffi_lime_cairo_get_dash = inValue;
            	}
{
...
HXLINE( 893)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_get_dash_count",ec,d0,06,ce),HX_("oi",1a,61,00,00),false);
HXDLIN( 893)		cffi_lime_cairo_get_dash_count = inValue;
            	}
{
...
HXLINE( 894)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_get_fill_rule",ae,34,3f,14),HX_("oi",1a,61,00,00),false);
HXDLIN( 894)		cffi_lime_cairo_get_fill_rule = inValue;
            	}
{
...
HXLINE( 895)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_get_font_face",83,ed,75,e9),HX_("oo",20,61,00,00),false);
HXDLIN( 895)		cffi_lime_cairo_get_font_face = inValue;
            	}
{
...
HXLINE( 896)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_get_font_options",38,0e,38,ee),HX_("oo",20,61,00,00),false);
HXDLIN( 896)		cffi_lime_cairo_get_font_options = inValue;
            	}
{
...
HXLINE( 897)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_get_group_target",1b,04,8e,27),HX_("oo",20,61,00,00),false);
HXDLIN( 897)		cffi_lime_cairo_get_group_target = inValue;
            	}
{
...
HXLINE( 898)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_get_line_cap",91,8a,ff,dc),HX_("oi",1a,61,00,00),false);
HXDLIN( 898)		cffi_lime_cairo_get_line_cap = inValue;
            	}
{
...
HXLINE( 899)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_get_line_join",8b,cc,44,87),HX_("oi",1a,61,00,00),false);
HXDLIN( 899)		cffi_lime_cairo_get_line_join = inValue;
            	}
{
...
HXLINE( 900)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_get_line_width",45,aa,28,4d),HX_("od",15,61,00,00),false);
HXDLIN( 900)		cffi_lime_cairo_get_line_width = inValue;
            	}
{
...
HXLINE( 901)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_get_matrix",4b,0f,b1,58),HX_("oo",20,61,00,00),false);
HXDLIN( 901)		cffi_lime_cairo_get_matrix = inValue;
            	}
{
...
HXLINE( 902)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_get_miter_limit",f7,da,f6,e3),HX_("od",15,61,00,00),false);
HXDLIN( 902)		cffi_lime_cairo_get_miter_limit = inValue;
            	}
{
...
HXLINE( 903)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_get_operator",2e,cb,0b,90),HX_("oi",1a,61,00,00),false);
HXDLIN( 903)		cffi_lime_cairo_get_operator = inValue;
            	}
{
...
HXLINE( 904)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_get_source",e5,89,1a,cf),HX_("oo",20,61,00,00),false);
HXDLIN( 904)		cffi_lime_cairo_get_source = inValue;
            	}
{
...
HXLINE( 905)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_get_target",5b,cc,d5,23),HX_("oo",20,61,00,00),false);
HXDLIN( 905)		cffi_lime_cairo_get_target = inValue;
            	}
{
...
HXLINE( 906)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_get_tolerance",43,26,7d,0d),HX_("od",15,61,00,00),false);
HXDLIN( 906)		cffi_lime_cairo_get_tolerance = inValue;
            	}
{
...
HXLINE( 907)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_has_current_point",84,52,43,91),HX_("ob",13,61,00,00),false);
HXDLIN( 907)		cffi_lime_cairo_has_current_point = inValue;
            	}
{
...
HXLINE( 908)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_identity_matrix",81,b1,fe,41),HX_("ov",27,61,00,00),false);
HXDLIN( 908)		cffi_lime_cairo_identity_matrix = inValue;
            	}
{
...
HXLINE( 909)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_in_clip",c9,a4,67,5b),HX_("oddb",d3,e7,aa,49),false);
HXDLIN( 909)		cffi_lime_cairo_in_clip = inValue;
            	}
{
...
HXLINE( 910)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_in_fill",7c,04,61,5d),HX_("oddb",d3,e7,aa,49),false);
HXDLIN( 910)		cffi_lime_cairo_in_fill = inValue;
            	}
{
...
HXLINE( 911)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_in_stroke",f1,19,0e,c7),HX_("oddb",d3,e7,aa,49),false);
HXDLIN( 911)		cffi_lime_cairo_in_stroke = inValue;
            	}
{
...
HXLINE( 912)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_line_to",45,88,aa,7c),HX_("oddv",e7,e7,aa,49),false);
HXDLIN( 912)		cffi_lime_cairo_line_to = inValue;
            	}
{
...
HXLINE( 913)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_mask",6d,53,cd,ca),HX_("oov",56,9b,54,00),false);
HXDLIN( 913)		cffi_lime_cairo_mask = inValue;
            	}
{
...
HXLINE( 914)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_mask_surface",1b,c8,a3,8c),HX_("ooddv",d6,4b,25,33),false);
HXDLIN( 914)		cffi_lime_cairo_mask_surface = inValue;
            	}
{
...
HXLINE( 915)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_move_to",48,cd,98,a7),HX_("oddv",e7,e7,aa,49),false);
HXDLIN( 915)		cffi_lime_cairo_move_to = inValue;
            	}
{
...
HXLINE( 916)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_new_path",25,bc,98,94),HX_("ov",27,61,00,00),false);
HXDLIN( 916)		cffi_lime_cairo_new_path = inValue;
            	}
{
...
HXLINE( 917)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_paint",fd,d5,07,63),HX_("ov",27,61,00,00),false);
HXDLIN( 917)		cffi_lime_cairo_paint = inValue;
            	}
{
...
HXLINE( 918)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_paint_with_alpha",67,1b,fb,63),HX_("odv",c1,91,54,00),false);
HXDLIN( 918)		cffi_lime_cairo_paint_with_alpha = inValue;
            	}
{
...
HXLINE( 919)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_pop_group",b0,94,6e,0c),HX_("oo",20,61,00,00),false);
HXDLIN( 919)		cffi_lime_cairo_pop_group = inValue;
            	}
{
...
HXLINE( 920)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_pop_group_to_source",d0,9e,67,af),HX_("ov",27,61,00,00),false);
HXDLIN( 920)		cffi_lime_cairo_pop_group_to_source = inValue;
            	}
{
...
HXLINE( 921)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_push_group",1b,55,88,61),HX_("ov",27,61,00,00),false);
HXDLIN( 921)		cffi_lime_cairo_push_group = inValue;
            	}
{
...
HXLINE( 922)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_push_group_with_content",a4,bb,13,d3),HX_("oiv",1c,96,54,00),false);
HXDLIN( 922)		cffi_lime_cairo_push_group_with_content = inValue;
            	}
{
...
HXLINE( 923)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_rectangle",0e,0e,2e,48),HX_("oddddv",a7,9e,14,38),false);
HXDLIN( 923)		cffi_lime_cairo_rectangle = inValue;
            	}
{
...
HXLINE( 924)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_rel_curve_to",b2,ac,52,05),HX_("oddddddv",67,85,69,dd),false);
HXDLIN( 924)		cffi_lime_cairo_rel_curve_to = inValue;
            	}
{
...
HXLINE( 925)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_rel_line_to",9f,37,7e,c0),HX_("oddv",e7,e7,aa,49),false);
HXDLIN( 925)		cffi_lime_cairo_rel_line_to = inValue;
            	}
{
...
HXLINE( 926)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_rel_move_to",a2,7c,6c,eb),HX_("oddv",e7,e7,aa,49),false);
HXDLIN( 926)		cffi_lime_cairo_rel_move_to = inValue;
            	}
{
...
HXLINE( 927)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_reset_clip",c1,bb,a3,f6),HX_("ov",27,61,00,00),false);
HXDLIN( 927)		cffi_lime_cairo_reset_clip = inValue;
            	}
{
...
HXLINE( 928)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_restore",6d,1b,b5,c7),HX_("ov",27,61,00,00),false);
HXDLIN( 928)		cffi_lime_cairo_restore = inValue;
            	}
{
...
HXLINE( 929)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_rotate",1c,bb,61,27),HX_("odv",c1,91,54,00),false);
HXDLIN( 929)		cffi_lime_cairo_rotate = inValue;
            	}
{
...
HXLINE( 930)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_save",be,9d,c4,ce),HX_("ov",27,61,00,00),false);
HXDLIN( 930)		cffi_lime_cairo_save = inValue;
            	}
{
...
HXLINE( 931)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_scale",e9,ec,87,1e),HX_("oddv",e7,e7,aa,49),false);
HXDLIN( 931)		cffi_lime_cairo_scale = inValue;
            	}
{
...
HXLINE( 932)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_set_antialias",f0,a1,f0,94),HX_("oiv",1c,96,54,00),false);
HXDLIN( 932)		cffi_lime_cairo_set_antialias = inValue;
            	}
{
...
HXLINE( 933)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_set_dash",50,51,94,77),HX_("oov",56,9b,54,00),false);
HXDLIN( 933)		cffi_lime_cairo_set_dash = inValue;
            	}
{
...
HXLINE( 934)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_set_fill_rule",ba,16,45,59),HX_("oiv",1c,96,54,00),false);
HXDLIN( 934)		cffi_lime_cairo_set_fill_rule = inValue;
            	}
{
...
HXLINE( 935)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_set_font_face",8f,cf,7b,2e),HX_("oov",56,9b,54,00),false);
HXDLIN( 935)		cffi_lime_cairo_set_font_face = inValue;
            	}
{
...
HXLINE( 936)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_set_font_options",ac,fb,79,44),HX_("oov",56,9b,54,00),false);
HXDLIN( 936)		cffi_lime_cairo_set_font_options = inValue;
            	}
{
...
HXLINE( 937)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_set_font_size",b3,bb,19,37),HX_("odv",c1,91,54,00),false);
HXDLIN( 937)		cffi_lime_cairo_set_font_size = inValue;
            	}
{
...
HXLINE( 938)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_set_line_cap",05,ae,f8,f1),HX_("oiv",1c,96,54,00),false);
HXDLIN( 938)		cffi_lime_cairo_set_line_cap = inValue;
            	}
{
...
HXLINE( 939)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_set_line_join",97,ae,4a,cc),HX_("oiv",1c,96,54,00),false);
HXDLIN( 939)		cffi_lime_cairo_set_line_join = inValue;
            	}
{
...
HXLINE( 940)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_set_line_width",b9,92,48,6d),HX_("odv",c1,91,54,00),false);
HXDLIN( 940)		cffi_lime_cairo_set_line_width = inValue;
            	}
{
...
HXLINE( 941)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_set_matrix",bf,ad,2e,5c),HX_("oov",56,9b,54,00),false);
HXDLIN( 941)		cffi_lime_cairo_set_matrix = inValue;
            	}
{
...
HXLINE( 942)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_set_miter_limit",03,58,c2,df),HX_("odv",c1,91,54,00),false);
HXDLIN( 942)		cffi_lime_cairo_set_miter_limit = inValue;
            	}
{
...
HXLINE( 943)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_set_operator",a2,ee,04,a5),HX_("oiv",1c,96,54,00),false);
HXDLIN( 943)		cffi_lime_cairo_set_operator = inValue;
            	}
{
...
HXLINE( 944)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_set_source",59,28,98,d2),HX_("oov",56,9b,54,00),false);
HXDLIN( 944)		cffi_lime_cairo_set_source = inValue;
            	}
{
...
HXLINE( 945)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_set_source_rgb",e7,e8,97,83),HX_("odddv",01,f3,df,2b),false);
HXDLIN( 945)		cffi_lime_cairo_set_source_rgb = inValue;
            	}
{
...
HXLINE( 946)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_set_source_rgba",9a,e1,53,a1),HX_("oddddv",a7,9e,14,38),false);
HXDLIN( 946)		cffi_lime_cairo_set_source_rgba = inValue;
            	}
{
...
HXLINE( 947)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_set_source_surface",07,69,ef,cf),HX_("ooddv",d6,4b,25,33),false);
HXDLIN( 947)		cffi_lime_cairo_set_source_surface = inValue;
            	}
{
...
HXLINE( 948)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_set_tolerance",4f,08,83,52),HX_("odv",c1,91,54,00),false);
HXDLIN( 948)		cffi_lime_cairo_set_tolerance = inValue;
            	}
{
...
HXLINE( 949)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_show_page",f0,25,4b,c7),HX_("ov",27,61,00,00),false);
HXDLIN( 949)		cffi_lime_cairo_show_page = inValue;
            	}
{
...
HXLINE( 950)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_show_text",4e,18,f3,c9),HX_("osv",d2,9e,54,00),false);
HXDLIN( 950)		cffi_lime_cairo_show_text = inValue;
            	}
{
            	HX_STACK_FRAME("lime.graphics.cairo.Cairo","boot",0x17044688,"lime.graphics.cairo.Cairo.boot","lime/graphics/cairo/Cairo.hx",951,0x0918a4c7)
HXLINE( 951)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_status",f3,5b,3d,62),HX_("oi",1a,61,00,00),false);
HXDLIN( 951)		cffi_lime_cairo_status = inValue;
            	}
{
...
HXLINE( 952)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_stroke",79,28,76,6d),HX_("ov",27,61,00,00),false);
HXDLIN( 952)		cffi_lime_cairo_stroke = inValue;
            	}
{
...
HXLINE( 953)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_stroke_extents",43,fe,0d,ea),HX_("oddddv",a7,9e,14,38),false);
HXDLIN( 953)		cffi_lime_cairo_stroke_extents = inValue;
            	}
{
...
HXLINE( 954)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_stroke_preserve",92,e3,27,68),HX_("ov",27,61,00,00),false);
HXDLIN( 954)		cffi_lime_cairo_stroke_preserve = inValue;
            	}
{
...
HXLINE( 955)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_transform",4b,67,44,74),HX_("oov",56,9b,54,00),false);
HXDLIN( 955)		cffi_lime_cairo_transform = inValue;
            	}
{
...
HXLINE( 956)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_translate",2d,11,31,78),HX_("oddv",e7,e7,aa,49),false);
HXDLIN( 956)		cffi_lime_cairo_translate = inValue;
            	}
{
...
HXLINE( 957)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_version",37,9b,f6,d9),HX_("i",69,00,00,00),false);
HXDLIN( 957)		cffi_lime_cairo_version = inValue;
            	}
{
...
HXLINE( 958)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_cairo_version_string",19,84,60,45),HX_("s",73,00,00,00),false);
HXDLIN( 958)		cffi_lime_cairo_version_string = inValue;
            	}
}
