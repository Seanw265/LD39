...
HXLINE(  34)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::format::PNG_obj::cffi_lime_png_decode_bytes(hx::DynamicPtr(bytes),decodeData)) );
HXDLIN(  34)		HX_VARI(  ::Dynamic,bufferData) = Dynamic(hx::DynamicPtr(inVal));
HXLINE(  36)		Bool _hx_tmp = hx::IsNotNull( bufferData );
HXDLIN(  36)		if (_hx_tmp) {
HXLINE(  38)			HX_VARI(  ::lime::graphics::ImageBuffer,buffer) =  ::lime::graphics::ImageBuffer_obj::__new( ::Dynamic(bufferData->__Field(HX_("data",2a,56,63,42),hx::paccDynamic)), ::Dynamic(bufferData->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic)), ::Dynamic(bufferData->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic)), ::Dynamic(bufferData->__Field(HX_("bpp",e2,be,4a,00),hx::paccDynamic)), ::Dynamic(bufferData->__Field(HX_("format",37,8f,8e,fd),hx::paccDynamic)));
HXLINE(  39)			buffer->transparent =  ::Dynamic(bufferData->__Field(HX_("transparent",52,2b,ba,22),hx::paccDynamic));
HXLINE(  40)			return  ::lime::graphics::Image_obj::__new(buffer,null(),null(),null(),null(),null(),null());
            		}
...
Bool decodeData = __o_decodeData.Default(true);
            	...
            	HX_STACK_ARG(decodeData,"decodeData")
HXLINE(  55)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::format::PNG_obj::cffi_lime_png_decode_file(path,decodeData)) );
HXDLIN(  55)		HX_VARI(  ::Dynamic,bufferData) = Dynamic(hx::DynamicPtr(inVal));
HXLINE(  57)		Bool _hx_tmp = hx::IsNotNull( bufferData );
HXDLIN(  57)		if (_hx_tmp) {
HXLINE(  59)			HX_VARI(  ::lime::graphics::ImageBuffer,buffer) =  ::lime::graphics::ImageBuffer_obj::__new( ::Dynamic(bufferData->__Field(HX_("data",2a,56,63,42),hx::paccDynamic)), ::Dynamic(bufferData->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic)), ::Dynamic(bufferData->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic)), ::Dynamic(bufferData->__Field(HX_("bpp",e2,be,4a,00),hx::paccDynamic)), ::Dynamic(bufferData->__Field(HX_("format",37,8f,8e,fd),hx::paccDynamic)));
HXLINE(  60)			buffer->transparent =  ::Dynamic(bufferData->__Field(HX_("transparent",52,2b,ba,22),hx::paccDynamic));
HXLINE(  61)			return  ::lime::graphics::Image_obj::__new(buffer,null(),null(),null(),null(),null(),null());
            		}
...
HXDLIN(  74)		Bool _hx_tmp1 = !(image->get_premultiplied());
HXDLIN(  74)		if (_hx_tmp1) {
HXLINE(  74)			Int _hx_tmp2 = image->get_format();
HXDLIN(  74)			_hx_tmp = (_hx_tmp2 != (int)0);
            		}
            		else {
...
HXLINE(  88)		Bool _hx_tmp3 = ::lime::_hx_system::CFFI_obj::enabled;
HXDLIN(  88)		if (_hx_tmp3) {
HXLINE(  90)			 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::format::PNG_obj::cffi_lime_image_encode(hx::DynamicPtr(image->buffer),(int)0,(int)0)) );
HXDLIN(  90)			HX_VARI(  ::Dynamic,data) = Dynamic(hx::DynamicPtr(inVal));
HXLINE(  91)			return  ::haxe::io::Bytes_obj::__new( ::Dynamic(data->__Field(HX_("length",e6,94,07,9f),hx::paccDynamic)), ::Dynamic(data->__Field(HX_("b",62,00,00,00),hx::paccDynamic)));
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(PNG_obj,encode,return )
 ...
 ::Dynamic PNG_obj::lime_png_decode_bytes( ::Dynamic data,Bool decodeData){
            	...
            	HX_STACK_ARG(decodeData,"decodeData")
HXLINE( 172)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::format::PNG_obj::cffi_lime_png_decode_bytes(hx::DynamicPtr(data),decodeData)) );
HXDLIN( 172)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(PNG_obj,lime_png_decode_bytes,return )
 ...
 ::Dynamic PNG_obj::lime_png_decode_file(::String path,Bool decodeData){
            	...
            	HX_STACK_ARG(path,"path")
            	HX_STACK_ARG(decodeData,"decodeData")
HXLINE( 173)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::format::PNG_obj::cffi_lime_png_decode_file(path,decodeData)) );
...
HXLINE( 174)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::format::PNG_obj::cffi_lime_image_encode(hx::DynamicPtr(data),type,quality)) );
HXDLIN( 174)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
{
{
            	HX_STACK_FRAME("lime.graphics.format.PNG","boot",0x7ab2bb24,"lime.graphics.format.PNG.boot","lime/graphics/format/PNG.hx",172,0x0cfd2463)
HXLINE( 172)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_png_decode_bytes",9a,13,98,26),HX_("obo",fc,8f,54,00),false);
HXDLIN( 172)		cffi_lime_png_decode_bytes = inValue;
            	}
{
            	HX_STACK_FRAME("lime.graphics.format.PNG","boot",0x7ab2bb24,"lime.graphics.format.PNG.boot","lime/graphics/format/PNG.hx",173,0x0cfd2463)
HXLINE( 173)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_png_decode_file",2d,7e,35,25),HX_("sbo",00,99,57,00),false);
HXDLIN( 173)		cffi_lime_png_decode_file = inValue;
            	}
{
            	HX_STACK_FRAME("lime.graphics.format.PNG","boot",0x7ab2bb24,"lime.graphics.format.PNG.boot","lime/graphics/format/PNG.hx",174,0x0cfd2463)
HXLINE( 174)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_image_encode",64,48,63,9c),HX_("oiio",80,b7,ae,49),false);
HXDLIN( 174)		cffi_lime_image_encode = inValue;
            	}
}
