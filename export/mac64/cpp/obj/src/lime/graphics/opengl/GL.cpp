...
HXLINE( 399)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_active_texture(texture);
            	}
...
HXLINE( 412)		program->attach(shader);
HXLINE( 413)		{
HXLINE( 413)			Int program1 = ( (Int)(program->id) );
HXDLIN( 413)			Int shader1 = ( (Int)(shader->id) );
HXDLIN( 413)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_attach_shader(program1,shader1);
            		}
            	}
...
HXLINE( 427)		Int program1 = ( (Int)(program->id) );
HXDLIN( 427)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_attrib_location(program1,index,name);
            	}
...
HXLINE( 440)		Int buffer1;
HXDLIN( 440)		Bool _hx_tmp = hx::IsNull( buffer );
HXDLIN( 440)		if (_hx_tmp) {
HXLINE( 440)			buffer1 = (int)0;
            		}
            		else {
HXLINE( 440)			buffer1 = buffer->id;
            		}
HXDLIN( 440)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_buffer(target,buffer1);
            	}
...
HXLINE( 453)		Int framebuffer1;
HXDLIN( 453)		Bool _hx_tmp = hx::IsNull( framebuffer );
HXDLIN( 453)		if (_hx_tmp) {
HXLINE( 453)			framebuffer1 = (int)0;
            		}
            		else {
HXLINE( 453)			framebuffer1 = framebuffer->id;
            		}
HXDLIN( 453)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_framebuffer(target,framebuffer1);
            	}
...
HXLINE( 466)		Int renderbuffer1;
HXDLIN( 466)		Bool _hx_tmp = hx::IsNull( renderbuffer );
HXDLIN( 466)		if (_hx_tmp) {
HXLINE( 466)			renderbuffer1 = (int)0;
            		}
            		else {
HXLINE( 466)			renderbuffer1 = renderbuffer->id;
            		}
HXDLIN( 466)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_renderbuffer(target,renderbuffer1);
            	}
...
void GL_obj::bindTexture(Int target, ::lime::graphics::opengl::GLTexture texture){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(texture,"texture")
HXLINE( 479)		Int texture1;
HXDLIN( 479)		Bool _hx_tmp = hx::IsNull( texture );
HXDLIN( 479)		if (_hx_tmp) {
HXLINE( 479)			texture1 = (int)0;
            		}
            		else {
HXLINE( 479)			texture1 = texture->id;
            		}
HXDLIN( 479)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_texture(target,texture1);
            	}
...
HXLINE( 492)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_color(red,green,blue,alpha);
            	}
...
HXLINE( 505)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_equation(mode);
            	}
...
HXLINE( 518)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_equation_separate(modeRGB,modeAlpha);
            	}
...
HXLINE( 531)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_func(sfactor,dfactor);
            	}
...
HXLINE( 544)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_func_separate(srcRGB,dstRGB,srcAlpha,dstAlpha);
            	}
...
HXLINE( 557)		Int byteOffset = data->byteOffset;
HXDLIN( 557)		Int size = data->byteLength;
HXDLIN( 557)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_buffer_data(target,hx::DynamicPtr(data->buffer),byteOffset,size,usage);
            	}
...
void GL_obj::bufferSubData(Int target,Int offset, ::lime::utils::ArrayBufferView data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE( 572)		Int byteOffset = data->byteOffset;
HXDLIN( 572)		Int size = data->byteLength;
HXDLIN( 572)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_buffer_sub_data(target,offset,hx::DynamicPtr(data->buffer),byteOffset,size);
            	}
...
Int GL_obj::checkFramebufferStatus(Int target){
            	...
            	HX_STACK_ARG(target,"target")
HXLINE( 587)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_check_framebuffer_status(target)) );
            	}
...
HXLINE( 602)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_clear(mask);
            	}
...
void GL_obj::clearColor(Float red,Float green,Float blue,Float alpha){
            	...
            	HX_STACK_ARG(blue,"blue")
            	HX_STACK_ARG(alpha,"alpha")
HXLINE( 615)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_clear_color(red,green,blue,alpha);
            	}
...
HXLINE( 628)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_clear_depth(depth);
            	}
...
void GL_obj::clearStencil(Int s){
            	...
            	HX_STACK_ARG(s,"s")
HXLINE( 641)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_clear_stencil(s);
            	}
...
void GL_obj::colorMask(Bool red,Bool green,Bool blue,Bool alpha){
            	...
            	HX_STACK_ARG(blue,"blue")
            	HX_STACK_ARG(alpha,"alpha")
HXLINE( 654)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_color_mask(red,green,blue,alpha);
            	}
...
void GL_obj::compileShader( ::lime::graphics::opengl::GLShader shader){
            	...
            	HX_STACK_ARG(shader,"shader")
HXLINE( 667)		Int shader1 = ( (Int)(shader->id) );
HXDLIN( 667)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_compile_shader(shader1);
            	}
...
void GL_obj::compressedTexImage2D(Int target,Int level,Int internalformat,Int width,Int height,Int border, ::lime::utils::ArrayBufferView data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE( 680)		HX_VAR(  ::haxe::io::Bytes,buffer);
HXDLIN( 680)		Bool _hx_tmp = hx::IsNull( data );
HXDLIN( 680)		if (_hx_tmp) {
HXLINE( 680)			buffer = null();
            		}
            		else {
HXLINE( 680)			buffer = data->buffer;
            		}
HXLINE( 681)		{
HXLINE( 681)			Int byteOffset;
HXDLIN( 681)			Bool _hx_tmp1 = hx::IsNull( data );
HXDLIN( 681)			if (_hx_tmp1) {
HXLINE( 681)				byteOffset = (int)0;
            			}
            			else {
HXLINE( 681)				byteOffset = data->byteOffset;
            			}
HXDLIN( 681)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_compressed_tex_image_2d(target,level,internalformat,width,height,border,hx::DynamicPtr(buffer),byteOffset);
            		}
            	}
...
void GL_obj::compressedTexSubImage2D(Int target,Int level,Int xoffset,Int yoffset,Int width,Int height,Int format, ::lime::utils::ArrayBufferView data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE( 696)		HX_VAR(  ::haxe::io::Bytes,buffer);
HXDLIN( 696)		Bool _hx_tmp = hx::IsNull( data );
HXDLIN( 696)		if (_hx_tmp) {
HXLINE( 696)			buffer = null();
            		}
            		else {
HXLINE( 696)			buffer = data->buffer;
            		}
HXLINE( 697)		{
HXLINE( 697)			Int byteOffset;
HXDLIN( 697)			Bool _hx_tmp1 = hx::IsNull( data );
HXDLIN( 697)			if (_hx_tmp1) {
HXLINE( 697)				byteOffset = (int)0;
            			}
            			else {
HXLINE( 697)				byteOffset = data->byteOffset;
            			}
HXDLIN( 697)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_compressed_tex_sub_image_2d(target,level,xoffset,yoffset,width,height,format,hx::DynamicPtr(buffer),byteOffset);
            		}
            	}
...
void GL_obj::copyTexImage2D(Int target,Int level,Int internalformat,Int x,Int y,Int width,Int height,Int border){
            	...
            	HX_STACK_ARG(height,"height")
            	HX_STACK_ARG(border,"border")
HXLINE( 712)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_copy_tex_image_2d(target,level,internalformat,x,y,width,height,border);
            	}
...
void GL_obj::copyTexSubImage2D(Int target,Int level,Int xoffset,Int yoffset,Int x,Int y,Int width,Int height){
            	...
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE( 725)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_copy_tex_sub_image_2d(target,level,xoffset,yoffset,x,y,width,height);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC8(GL_obj,copyTexSubImage2D,(void))
 ...
 ::lime::graphics::opengl::GLBuffer GL_obj::createBuffer(){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","createBuffer",0x3ea5f4f0,"lime.graphics.opengl.GL.createBuffer","lime/graphics/opengl/GL.hx",738,0xa5aa2623)
HXLINE( 738)		Int _hx_tmp = ::lime::graphics::opengl::GL_obj::get_version();
HXDLIN( 738)		Int _hx_tmp1 = ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_buffer()) );
HXDLIN( 738)		return  ::lime::graphics::opengl::GLBuffer_obj::__new(_hx_tmp,_hx_tmp1);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(GL_obj,createBuffer,return )
 ...
 ::lime::graphics::opengl::GLFramebuffer GL_obj::createFramebuffer(){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","createFramebuffer",0x051616fd,"lime.graphics.opengl.GL.createFramebuffer","lime/graphics/opengl/GL.hx",754,0xa5aa2623)
HXLINE( 754)		Int _hx_tmp = ::lime::graphics::opengl::GL_obj::get_version();
HXDLIN( 754)		Int _hx_tmp1 = ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_framebuffer()) );
HXDLIN( 754)		return  ::lime::graphics::opengl::GLFramebuffer_obj::__new(_hx_tmp,_hx_tmp1);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(GL_obj,createFramebuffer,return )
 ...
 ::lime::graphics::opengl::GLProgram GL_obj::createProgram(){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","createProgram",0xd4f90494,"lime.graphics.opengl.GL.createProgram","lime/graphics/opengl/GL.hx",770,0xa5aa2623)
HXLINE( 770)		Int _hx_tmp = ::lime::graphics::opengl::GL_obj::get_version();
HXDLIN( 770)		Int _hx_tmp1 = ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_program()) );
HXDLIN( 770)		return  ::lime::graphics::opengl::GLProgram_obj::__new(_hx_tmp,_hx_tmp1);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(GL_obj,createProgram,return )
 ...
 ::lime::graphics::opengl::GLRenderbuffer GL_obj::createRenderbuffer(){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","createRenderbuffer",0xf4ca18c6,"lime.graphics.opengl.GL.createRenderbuffer","lime/graphics/opengl/GL.hx",785,0xa5aa2623)
HXLINE( 785)		Int _hx_tmp = ::lime::graphics::opengl::GL_obj::get_version();
HXDLIN( 785)		Int _hx_tmp1 = ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_render_buffer()) );
HXDLIN( 785)		return  ::lime::graphics::opengl::GLRenderbuffer_obj::__new(_hx_tmp,_hx_tmp1);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(GL_obj,createRenderbuffer,return )
 ...
 ::lime::graphics::opengl::GLShader GL_obj::createShader(Int type){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","createShader",0x8b31f715,"lime.graphics.opengl.GL.createShader","lime/graphics/opengl/GL.hx",801,0xa5aa2623)
            	HX_STACK_ARG(type,"type")
HXLINE( 801)		Int _hx_tmp = ::lime::graphics::opengl::GL_obj::get_version();
HXDLIN( 801)		Int _hx_tmp1 = ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_shader(type)) );
HXDLIN( 801)		return  ::lime::graphics::opengl::GLShader_obj::__new(_hx_tmp,_hx_tmp1);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(GL_obj,createShader,return )
 ...
 ::lime::graphics::opengl::GLTexture GL_obj::createTexture(){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","createTexture",0x7fe082eb,"lime.graphics.opengl.GL.createTexture","lime/graphics/opengl/GL.hx",816,0xa5aa2623)
HXLINE( 816)		Int _hx_tmp = ::lime::graphics::opengl::GL_obj::get_version();
HXDLIN( 816)		Int _hx_tmp1 = ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_texture()) );
HXDLIN( 816)		return  ::lime::graphics::opengl::GLTexture_obj::__new(_hx_tmp,_hx_tmp1);
            	}
...
void GL_obj::cullFace(Int mode){
            	...
            	HX_STACK_ARG(mode,"mode")
HXLINE( 832)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_cull_face(mode);
            	}
...
void GL_obj::deleteBuffer( ::lime::graphics::opengl::GLBuffer buffer){
            	...
            	HX_STACK_ARG(buffer,"buffer")
HXLINE( 845)		{
HXLINE( 845)			Int buffer1 = ( (Int)(buffer->id) );
HXDLIN( 845)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_buffer(buffer1);
            		}
HXLINE( 846)		buffer->invalidate();
            	}
...
void GL_obj::deleteFramebuffer( ::lime::graphics::opengl::GLFramebuffer framebuffer){
            	...
            	HX_STACK_ARG(framebuffer,"framebuffer")
HXLINE( 860)		{
HXLINE( 860)			Int framebuffer1 = ( (Int)(framebuffer->id) );
HXDLIN( 860)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_framebuffer(framebuffer1);
            		}
HXLINE( 861)		framebuffer->invalidate();
            	}
...
void GL_obj::deleteProgram( ::lime::graphics::opengl::GLProgram program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE( 875)		{
HXLINE( 875)			Int program1 = ( (Int)(program->id) );
HXDLIN( 875)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_program(program1);
            		}
HXLINE( 876)		program->invalidate();
            	}
...
void GL_obj::deleteRenderbuffer( ::lime::graphics::opengl::GLRenderbuffer renderbuffer){
            	...
            	HX_STACK_ARG(renderbuffer,"renderbuffer")
HXLINE( 890)		{
HXLINE( 890)			Int renderbuffer1 = ( (Int)(renderbuffer->id) );
HXDLIN( 890)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_render_buffer(renderbuffer1);
            		}
HXLINE( 891)		renderbuffer->invalidate();
            	}
...
void GL_obj::deleteShader( ::lime::graphics::opengl::GLShader shader){
            	...
            	HX_STACK_ARG(shader,"shader")
HXLINE( 905)		{
HXLINE( 905)			Int shader1 = ( (Int)(shader->id) );
HXDLIN( 905)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_shader(shader1);
            		}
HXLINE( 906)		shader->invalidate();
            	}
...
void GL_obj::deleteTexture( ::lime::graphics::opengl::GLTexture texture){
            	...
            	HX_STACK_ARG(texture,"texture")
HXLINE( 920)		{
HXLINE( 920)			Int texture1 = ( (Int)(texture->id) );
HXDLIN( 920)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_texture(texture1);
            		}
HXLINE( 921)		texture->invalidate();
            	}
...
HXLINE( 935)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_depth_func(func);
            	}
...
HXLINE( 948)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_depth_mask(flag);
            	}
...
HXLINE( 961)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_depth_range(zNear,zFar);
            	}
...
void GL_obj::detachShader( ::lime::graphics::opengl::GLProgram program, ::lime::graphics::opengl::GLShader shader){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(shader,"shader")
HXLINE( 974)		Int program1 = ( (Int)(program->id) );
HXDLIN( 974)		Int shader1 = ( (Int)(shader->id) );
HXDLIN( 974)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_detach_shader(program1,shader1);
            	}
...
HXLINE( 987)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_disable(cap);
            	}
...
void GL_obj::disableVertexAttribArray(Int index){
            	...
            	HX_STACK_ARG(index,"index")
HXLINE(1000)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_disable_vertex_attrib_array(index);
            	}
...
HXLINE(1013)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_draw_arrays(mode,first,count);
            	}
...
void GL_obj::drawElements(Int mode,Int count,Int type,Int offset){
            	...
            	HX_STACK_ARG(type,"type")
            	HX_STACK_ARG(offset,"offset")
HXLINE(1026)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_draw_elements(mode,count,type,offset);
            	}
...
void GL_obj::enable(Int cap){
            	...
            	HX_STACK_ARG(cap,"cap")
HXLINE(1039)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_enable(cap);
            	}
...
void GL_obj::enableVertexAttribArray(Int index){
            	...
            	HX_STACK_ARG(index,"index")
HXLINE(1052)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_enable_vertex_attrib_array(index);
            	}
...
HXLINE(1065)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_finish();
            	}
...
HXLINE(1078)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_flush();
            	}
...
void GL_obj::framebufferRenderbuffer(Int target,Int attachment,Int renderbuffertarget, ::lime::graphics::opengl::GLRenderbuffer renderbuffer){
            	...
            	HX_STACK_ARG(renderbuffer,"renderbuffer")
HXLINE(1091)		Int renderbuffer1 = ( (Int)(renderbuffer->id) );
HXDLIN(1091)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_framebuffer_renderbuffer(target,attachment,renderbuffertarget,renderbuffer1);
            	}
...
void GL_obj::framebufferTexture2D(Int target,Int attachment,Int textarget, ::lime::graphics::opengl::GLTexture texture,Int level){
            	...
            	HX_STACK_ARG(texture,"texture")
            	HX_STACK_ARG(level,"level")
HXLINE(1104)		Int texture1 = ( (Int)(texture->id) );
HXDLIN(1104)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_framebuffer_texture2D(target,attachment,textarget,texture1,level);
            	}
...
void GL_obj::frontFace(Int mode){
            	...
            	HX_STACK_ARG(mode,"mode")
HXLINE(1117)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_front_face(mode);
            	}
...
void GL_obj::generateMipmap(Int target){
            	...
            	HX_STACK_ARG(target,"target")
HXLINE(1130)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_generate_mipmap(target);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(GL_obj,generateMipmap,(void))
 ...
 ::Dynamic GL_obj::getActiveAttrib( ::lime::graphics::opengl::GLProgram program,Int index){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(index,"index")
HXLINE(1143)		Int program1 = ( (Int)(program->id) );
HXDLIN(1143)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_active_attrib(program1,index)) );
HXDLIN(1143)		HX_VARI(  ::Dynamic,result) = Dynamic(hx::DynamicPtr(inVal));
HXLINE(1144)		return result;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(GL_obj,getActiveAttrib,return )
 ...
 ::Dynamic GL_obj::getActiveUniform( ::lime::graphics::opengl::GLProgram program,Int index){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(index,"index")
HXLINE(1160)		Int program1 = ( (Int)(program->id) );
HXDLIN(1160)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_active_uniform(program1,index)) );
HXDLIN(1160)		HX_VARI(  ::Dynamic,result) = Dynamic(hx::DynamicPtr(inVal));
HXLINE(1161)		return result;
            	}
...
::Array< ::Dynamic> GL_obj::getAttachedShaders( ::lime::graphics::opengl::GLProgram program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE(1177)		return program->getShaders();
            	}
...
Int GL_obj::getAttribLocation( ::lime::graphics::opengl::GLProgram program,::String name){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","getAttribLocation",0x953d4281,"lime.graphics.opengl.GL.getAttribLocation","lime/graphics/opengl/GL.hx",1192,0xa5aa2623)
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(name,"name")
HXLINE(1192)		Int program1 = ( (Int)(program->id) );
HXDLIN(1192)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_attrib_location(program1,name)) );
            	}
...
HXLINE(1207)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_buffer_parameter(target,pname)) );
            	}
...
HXLINE(1223)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_context_attributes()) );
HXDLIN(1223)		HX_VARI(  ::Dynamic,base) = Dynamic(hx::DynamicPtr(inVal));
HXLINE(1224)		base->__SetField(HX_("premultipliedAlpha",28,8e,5c,1a),false,hx::paccDynamic);
HXLINE(1225)		base->__SetField(HX_("preserveDrawingBuffer",92,bb,1e,4b),false,hx::paccDynamic);
HXLINE(1226)		return base;
            	}
...
HXLINE(1245)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_error()) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(GL_obj,getError,return )
 ...
 ::Dynamic GL_obj::getExtension(::String name){
            	...
            	HX_STACK_ARG(name,"name")
HXLINE(1260)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_extension(name)) );
HXDLIN(1260)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
Int GL_obj::getFramebufferAttachmentParameter(Int target,Int attachment,Int pname){
            	...
            	HX_STACK_ARG(attachment,"attachment")
            	HX_STACK_ARG(pname,"pname")
HXLINE(1273)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_framebuffer_attachment_parameter(target,attachment,pname)) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(GL_obj,getFramebufferAttachmentParameter,return )
 ...
 ::Dynamic GL_obj::getParameter(Int pname){
            	...
            	HX_STACK_ARG(pname,"pname")
HXLINE(1289)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_parameter(pname)) );
HXDLIN(1289)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
::String GL_obj::getProgramInfoLog( ::lime::graphics::opengl::GLProgram program){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","getProgramInfoLog",0x06201974,"lime.graphics.opengl.GL.getProgramInfoLog","lime/graphics/opengl/GL.hx",1304,0xa5aa2623)
            	HX_STACK_ARG(program,"program")
HXLINE(1304)		Int program1 = ( (Int)(program->id) );
HXDLIN(1304)		return ( (::String)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_program_info_log(program1)) );
            	}
...
Int GL_obj::getProgramParameter( ::lime::graphics::opengl::GLProgram program,Int pname){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","getProgramParameter",0x12242de7,"lime.graphics.opengl.GL.getProgramParameter","lime/graphics/opengl/GL.hx",1319,0xa5aa2623)
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(pname,"pname")
HXLINE(1319)		Int program1 = ( (Int)(program->id) );
HXDLIN(1319)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_program_parameter(program1,pname)) );
            	}
...
Int GL_obj::getRenderbufferParameter(Int target,Int pname){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(pname,"pname")
HXLINE(1335)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_render_buffer_parameter(target,pname)) );
            	}
...
::String GL_obj::getShaderInfoLog( ::lime::graphics::opengl::GLShader shader){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","getShaderInfoLog",0x433f2f6f,"lime.graphics.opengl.GL.getShaderInfoLog","lime/graphics/opengl/GL.hx",1351,0xa5aa2623)
            	HX_STACK_ARG(shader,"shader")
HXLINE(1351)		Int shader1 = ( (Int)(shader->id) );
HXDLIN(1351)		return ( (::String)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_shader_info_log(shader1)) );
            	}
...
Int GL_obj::getShaderParameter( ::lime::graphics::opengl::GLShader shader,Int pname){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","getShaderParameter",0x25b0f8a2,"lime.graphics.opengl.GL.getShaderParameter","lime/graphics/opengl/GL.hx",1366,0xa5aa2623)
            	HX_STACK_ARG(shader,"shader")
            	HX_STACK_ARG(pname,"pname")
HXLINE(1366)		Int shader1 = ( (Int)(shader->id) );
HXDLIN(1366)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_shader_parameter(shader1,pname)) );
            	}
...
HXLINE(1382)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_shader_precision_format(shadertype,precisiontype)) );
HXDLIN(1382)		HX_VARI(  ::Dynamic,result) = Dynamic(hx::DynamicPtr(inVal));
HXLINE(1383)		return result;
            	}
...
::String GL_obj::getShaderSource( ::lime::graphics::opengl::GLShader shader){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","getShaderSource",0x0ffe4842,"lime.graphics.opengl.GL.getShaderSource","lime/graphics/opengl/GL.hx",1399,0xa5aa2623)
            	HX_STACK_ARG(shader,"shader")
HXLINE(1399)		Int shader1 = ( (Int)(shader->id) );
HXDLIN(1399)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_shader_source(shader1)) );
HXDLIN(1399)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE(1414)		HX_VARI( ::Array< ::String >,result) = ::Array_obj< ::String >::__new();
HXLINE(1415)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_supported_extensions(hx::DynamicPtr(result));
HXLINE(1416)		return result;
            	}
...
Int GL_obj::getTexParameter(Int target,Int pname){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(pname,"pname")
HXLINE(1431)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_tex_parameter(target,pname)) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(GL_obj,getTexParameter,return )
 ...
 ::Dynamic GL_obj::getUniform( ::lime::graphics::opengl::GLProgram program,Int location){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","getUniform",0xcb066212,"lime.graphics.opengl.GL.getUniform","lime/graphics/opengl/GL.hx",1447,0xa5aa2623)
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(location,"location")
HXLINE(1447)		Int program1 = ( (Int)(program->id) );
HXDLIN(1447)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_uniform(program1,location)) );
HXDLIN(1447)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
Int GL_obj::getUniformLocation( ::lime::graphics::opengl::GLProgram program,::String name){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","getUniformLocation",0x3f29ee67,"lime.graphics.opengl.GL.getUniformLocation","lime/graphics/opengl/GL.hx",1463,0xa5aa2623)
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(name,"name")
HXLINE(1463)		Int program1 = ( (Int)(program->id) );
HXDLIN(1463)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_uniform_location(program1,name)) );
            	}
...
Int GL_obj::getVertexAttrib(Int index,Int pname){
            	...
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(pname,"pname")
HXLINE(1478)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_vertex_attrib(index,pname)) );
            	}
...
Int GL_obj::getVertexAttribOffset(Int index,Int pname){
            	...
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(pname,"pname")
HXLINE(1493)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_vertex_attrib_offset(index,pname)) );
            	}
...
void GL_obj::hint(Int target,Int mode){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(mode,"mode")
HXLINE(1508)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_hint(target,mode);
            	}
...
Bool GL_obj::isBuffer( ::lime::graphics::opengl::GLBuffer buffer){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","isBuffer",0x3244d65e,"lime.graphics.opengl.GL.isBuffer","lime/graphics/opengl/GL.hx",1519,0xa5aa2623)
            	HX_STACK_ARG(buffer,"buffer")
HXLINE(1519)		Bool _hx_tmp;
HXDLIN(1519)		Bool _hx_tmp1 = hx::IsNotNull( buffer );
HXDLIN(1519)		if (_hx_tmp1) {
HXLINE(1519)			_hx_tmp = hx::IsGreater( buffer->id,(int)0 );
            		}
            		else {
HXLINE(1519)			_hx_tmp = false;
            		}
HXDLIN(1519)		if (_hx_tmp) {
HXLINE(1519)			Int buffer1 = ( (Int)(buffer->id) );
HXDLIN(1519)			return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_buffer(buffer1)) );
            		}
            		else {
...
Bool GL_obj::isEnabled(Int cap){
            	...
            	HX_STACK_ARG(cap,"cap")
HXLINE(1543)		return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_enabled(cap)) );
            	}
...
Bool GL_obj::isFramebuffer( ::lime::graphics::opengl::GLFramebuffer framebuffer){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","isFramebuffer",0x7c2946cf,"lime.graphics.opengl.GL.isFramebuffer","lime/graphics/opengl/GL.hx",1556,0xa5aa2623)
            	HX_STACK_ARG(framebuffer,"framebuffer")
HXLINE(1556)		Bool _hx_tmp;
HXDLIN(1556)		Bool _hx_tmp1 = hx::IsNotNull( framebuffer );
HXDLIN(1556)		if (_hx_tmp1) {
HXLINE(1556)			_hx_tmp = hx::IsGreater( framebuffer->id,(int)0 );
            		}
            		else {
HXLINE(1556)			_hx_tmp = false;
            		}
HXDLIN(1556)		if (_hx_tmp) {
HXLINE(1556)			Int framebuffer1 = ( (Int)(framebuffer->id) );
HXDLIN(1556)			return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_framebuffer(framebuffer1)) );
            		}
            		else {
HXLINE(1556)			return false;
            		}
HXDLIN(1556)		return false;
            	}
...
Bool GL_obj::isProgram( ::lime::graphics::opengl::GLProgram program){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","isProgram",0x0c5f6366,"lime.graphics.opengl.GL.isProgram","lime/graphics/opengl/GL.hx",1569,0xa5aa2623)
            	HX_STACK_ARG(program,"program")
HXLINE(1569)		Bool _hx_tmp;
HXDLIN(1569)		Bool _hx_tmp1 = hx::IsNotNull( program );
HXDLIN(1569)		if (_hx_tmp1) {
HXLINE(1569)			_hx_tmp = hx::IsGreater( program->id,(int)0 );
            		}
            		else {
HXLINE(1569)			_hx_tmp = false;
            		}
HXDLIN(1569)		if (_hx_tmp) {
HXLINE(1569)			Int program1 = ( (Int)(program->id) );
HXDLIN(1569)			return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_program(program1)) );
            		}
            		else {
...
Bool GL_obj::isRenderbuffer( ::lime::graphics::opengl::GLRenderbuffer renderbuffer){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","isRenderbuffer",0xae80c0b4,"lime.graphics.opengl.GL.isRenderbuffer","lime/graphics/opengl/GL.hx",1582,0xa5aa2623)
            	HX_STACK_ARG(renderbuffer,"renderbuffer")
HXLINE(1582)		Bool _hx_tmp;
HXDLIN(1582)		Bool _hx_tmp1 = hx::IsNotNull( renderbuffer );
HXDLIN(1582)		if (_hx_tmp1) {
HXLINE(1582)			_hx_tmp = hx::IsGreater( renderbuffer->id,(int)0 );
            		}
            		else {
HXLINE(1582)			_hx_tmp = false;
            		}
HXDLIN(1582)		if (_hx_tmp) {
HXLINE(1582)			Int renderbuffer1 = ( (Int)(renderbuffer->id) );
HXDLIN(1582)			return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_renderbuffer(renderbuffer1)) );
            		}
            		else {
...
Bool GL_obj::isShader( ::lime::graphics::opengl::GLShader shader){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","isShader",0x7ed0d883,"lime.graphics.opengl.GL.isShader","lime/graphics/opengl/GL.hx",1595,0xa5aa2623)
            	HX_STACK_ARG(shader,"shader")
HXLINE(1595)		Bool _hx_tmp;
HXDLIN(1595)		Bool _hx_tmp1 = hx::IsNotNull( shader );
HXDLIN(1595)		if (_hx_tmp1) {
HXLINE(1595)			_hx_tmp = hx::IsGreater( shader->id,(int)0 );
            		}
            		else {
HXLINE(1595)			_hx_tmp = false;
            		}
HXDLIN(1595)		if (_hx_tmp) {
HXLINE(1595)			Int shader1 = ( (Int)(shader->id) );
HXDLIN(1595)			return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_shader(shader1)) );
            		}
            		else {
...
Bool GL_obj::isTexture( ::lime::graphics::opengl::GLTexture texture){
            	HX_STACK_FRAME("lime.graphics.opengl.GL","isTexture",0xb746e1bd,"lime.graphics.opengl.GL.isTexture","lime/graphics/opengl/GL.hx",1608,0xa5aa2623)
            	HX_STACK_ARG(texture,"texture")
HXLINE(1608)		Bool _hx_tmp;
HXDLIN(1608)		Bool _hx_tmp1 = hx::IsNotNull( texture );
HXDLIN(1608)		if (_hx_tmp1) {
HXLINE(1608)			_hx_tmp = hx::IsGreater( texture->id,(int)0 );
            		}
            		else {
HXLINE(1608)			_hx_tmp = false;
            		}
HXDLIN(1608)		if (_hx_tmp) {
HXLINE(1608)			Int texture1 = ( (Int)(texture->id) );
HXDLIN(1608)			return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_texture(texture1)) );
            		}
            		else {
...
void GL_obj::lineWidth(Float width){
            	...
            	HX_STACK_ARG(width,"width")
HXLINE(1621)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_line_width(width);
            	}
...
void GL_obj::linkProgram( ::lime::graphics::opengl::GLProgram program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE(1632)		Int program1 = ( (Int)(program->id) );
HXDLIN(1632)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_link_program(program1);
            	}
...
HXLINE(1643)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_pixel_storei(pname,param);
            	}
...
HXLINE(1654)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_polygon_offset(factor,units);
            	}
...
HXLINE(1665)		HX_VAR(  ::haxe::io::Bytes,buffer);
HXDLIN(1665)		Bool _hx_tmp = hx::IsNull( pixels );
HXDLIN(1665)		if (_hx_tmp) {
HXLINE(1665)			buffer = null();
            		}
            		else {
HXLINE(1665)			buffer = pixels->buffer;
            		}
HXLINE(1666)		{
HXLINE(1666)			Int byteOffset;
HXDLIN(1666)			Bool _hx_tmp1 = hx::IsNull( pixels );
HXDLIN(1666)			if (_hx_tmp1) {
HXLINE(1666)				byteOffset = (int)0;
            			}
            			else {
HXLINE(1666)				byteOffset = pixels->byteOffset;
            			}
HXDLIN(1666)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_read_pixels(x,y,width,height,format,type,hx::DynamicPtr(buffer),byteOffset);
            		}
            	}
...
void GL_obj::renderbufferStorage(Int target,Int internalformat,Int width,Int height){
            	...
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE(1679)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_renderbuffer_storage(target,internalformat,width,height);
            	}
...
HXLINE(1690)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_sample_coverage(value,invert);
            	}
...
void GL_obj::scissor(Int x,Int y,Int width,Int height){
            	...
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE(1701)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_scissor(x,y,width,height);
            	}
...
HXLINE(1712)		Int shader1 = ( (Int)(shader->id) );
HXDLIN(1712)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_shader_source(shader1,source);
            	}
...
void GL_obj::stencilFunc(Int func,Int ref,Int mask){
            	...
            	HX_STACK_ARG(mask,"mask")
HXLINE(1723)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_func(func,ref,mask);
            	}
...
void GL_obj::stencilFuncSeparate(Int face,Int func,Int ref,Int mask){
            	...
            	HX_STACK_ARG(ref,"ref")
            	HX_STACK_ARG(mask,"mask")
HXLINE(1734)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_func_separate(face,func,ref,mask);
            	}
...
void GL_obj::stencilMask(Int mask){
            	...
            	HX_STACK_ARG(mask,"mask")
HXLINE(1745)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_mask(mask);
            	}
...
void GL_obj::stencilMaskSeparate(Int face,Int mask){
            	...
            	HX_STACK_ARG(face,"face")
            	HX_STACK_ARG(mask,"mask")
HXLINE(1756)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_mask_separate(face,mask);
            	}
...
HXLINE(1767)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_op(fail,zfail,zpass);
            	}
...
void GL_obj::stencilOpSeparate(Int face,Int fail,Int zfail,Int zpass){
            	...
            	HX_STACK_ARG(zfail,"zfail")
            	HX_STACK_ARG(zpass,"zpass")
HXLINE(1778)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_op_separate(face,fail,zfail,zpass);
            	}
...
void GL_obj::texImage2D(Int target,Int level,Int internalformat,Int width,Int height,Int border,Int format,Int type, ::lime::utils::ArrayBufferView pixels){
            	...
            	HX_STACK_ARG(type,"type")
            	HX_STACK_ARG(pixels,"pixels")
HXLINE(1789)		HX_VAR(  ::haxe::io::Bytes,buffer);
HXDLIN(1789)		Bool _hx_tmp = hx::IsNull( pixels );
HXDLIN(1789)		if (_hx_tmp) {
HXLINE(1789)			buffer = null();
            		}
            		else {
HXLINE(1789)			buffer = pixels->buffer;
            		}
HXLINE(1790)		{
HXLINE(1790)			Int byteOffset;
HXDLIN(1790)			Bool _hx_tmp1 = hx::IsNull( pixels );
HXDLIN(1790)			if (_hx_tmp1) {
HXLINE(1790)				byteOffset = (int)0;
            			}
            			else {
HXLINE(1790)				byteOffset = pixels->byteOffset;
            			}
HXDLIN(1790)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_image_2d(target,level,internalformat,width,height,border,format,type,hx::DynamicPtr(buffer),byteOffset);
            		}
            	}
...
void GL_obj::texParameterf(Int target,Int pname,Float param){
            	...
            	HX_STACK_ARG(pname,"pname")
            	HX_STACK_ARG(param,"param")
HXLINE(1803)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_parameterf(target,pname,param);
            	}
...
void GL_obj::texParameteri(Int target,Int pname,Int param){
            	...
            	HX_STACK_ARG(pname,"pname")
            	HX_STACK_ARG(param,"param")
HXLINE(1814)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_parameteri(target,pname,param);
            	}
...
void GL_obj::texSubImage2D(Int target,Int level,Int xoffset,Int yoffset,Int width,Int height,Int format,Int type, ::lime::utils::ArrayBufferView pixels){
            	...
            	HX_STACK_ARG(type,"type")
            	HX_STACK_ARG(pixels,"pixels")
HXLINE(1825)		HX_VAR(  ::haxe::io::Bytes,buffer);
HXDLIN(1825)		Bool _hx_tmp = hx::IsNull( pixels );
HXDLIN(1825)		if (_hx_tmp) {
HXLINE(1825)			buffer = null();
            		}
            		else {
HXLINE(1825)			buffer = pixels->buffer;
            		}
HXLINE(1826)		{
HXLINE(1826)			Int byteOffset;
HXDLIN(1826)			Bool _hx_tmp1 = hx::IsNull( pixels );
HXDLIN(1826)			if (_hx_tmp1) {
HXLINE(1826)				byteOffset = (int)0;
            			}
            			else {
HXLINE(1826)				byteOffset = pixels->byteOffset;
            			}
HXDLIN(1826)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_sub_image_2d(target,level,xoffset,yoffset,width,height,format,type,hx::DynamicPtr(buffer),byteOffset);
            		}
            	}
...
void GL_obj::uniform1f(Int location,Float x){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(x,"x")
HXLINE(1839)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform1f(location,x);
            	}
...
void GL_obj::uniform1fv(Int location, ::lime::utils::ArrayBufferView x){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(x,"x")
HXLINE(1850)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform1fv(location,hx::DynamicPtr(x->buffer));
            	}
...
void GL_obj::uniform1i(Int location,Int x){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(x,"x")
HXLINE(1863)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform1i(location,x);
            	}
...
void GL_obj::uniform1iv(Int location, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(1874)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform1iv(location,hx::DynamicPtr(v->buffer));
            	}
...
void GL_obj::uniform2f(Int location,Float x,Float y){
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE(1887)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform2f(location,x,y);
            	}
...
void GL_obj::uniform2fv(Int location, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(1898)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform2fv(location,hx::DynamicPtr(v->buffer));
            	}
...
void GL_obj::uniform2i(Int location,Int x,Int y){
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE(1911)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform2i(location,x,y);
            	}
...
void GL_obj::uniform2iv(Int location, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(1922)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform2iv(location,hx::DynamicPtr(v->buffer));
            	}
...
void GL_obj::uniform3f(Int location,Float x,Float y,Float z){
            	...
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(z,"z")
HXLINE(1935)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform3f(location,x,y,z);
            	}
...
void GL_obj::uniform3fv(Int location, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(1946)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform3fv(location,hx::DynamicPtr(v->buffer));
            	}
...
void GL_obj::uniform3i(Int location,Int x,Int y,Int z){
            	...
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(z,"z")
HXLINE(1959)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform3i(location,x,y,z);
            	}
...
void GL_obj::uniform3iv(Int location, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(1970)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform3iv(location,hx::DynamicPtr(v->buffer));
            	}
...
void GL_obj::uniform4f(Int location,Float x,Float y,Float z,Float w){
            	...
            	HX_STACK_ARG(z,"z")
            	HX_STACK_ARG(w,"w")
HXLINE(1983)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform4f(location,x,y,z,w);
            	}
...
void GL_obj::uniform4fv(Int location, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(1994)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform4fv(location,hx::DynamicPtr(v->buffer));
            	}
...
void GL_obj::uniform4i(Int location,Int x,Int y,Int z,Int w){
            	...
            	HX_STACK_ARG(z,"z")
            	HX_STACK_ARG(w,"w")
HXLINE(2007)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform4i(location,x,y,z,w);
            	}
...
void GL_obj::uniform4iv(Int location, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(2018)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform4iv(location,hx::DynamicPtr(v->buffer));
            	}
...
void GL_obj::uniformMatrix2fv(Int location,Bool transpose, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(v,"v")
HXLINE(2031)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform_matrix(location,transpose,hx::DynamicPtr(v->buffer),(int)2);
            	}
...
void GL_obj::uniformMatrix3fv(Int location,Bool transpose, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(transpose,"transpose")
            	HX_STACK_ARG(v,"v")
HXLINE(2044)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform_matrix(location,transpose,hx::DynamicPtr(v->buffer),(int)3);
            	}
...
void GL_obj::uniformMatrix4fv(Int location,Bool transpose, ::lime::utils::ArrayBufferView v){
            	...
            	HX_STACK_ARG(transpose,"transpose")
            	HX_STACK_ARG(v,"v")
HXLINE(2057)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform_matrix(location,transpose,hx::DynamicPtr(v->buffer),(int)4);
            	}
...
void GL_obj::useProgram( ::lime::graphics::opengl::GLProgram program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE(2077)		Int program1;
HXDLIN(2077)		Bool _hx_tmp = hx::IsNull( program );
HXDLIN(2077)		if (_hx_tmp) {
HXLINE(2077)			program1 = (int)0;
            		}
            		else {
HXLINE(2077)			program1 = program->id;
            		}
HXDLIN(2077)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_use_program(program1);
            	}
...
void GL_obj::validateProgram( ::lime::graphics::opengl::GLProgram program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE(2088)		Int program1 = ( (Int)(program->id) );
HXDLIN(2088)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_validate_program(program1);
            	}
...
void GL_obj::vertexAttrib1f(Int indx,Float x){
            	...
            	HX_STACK_ARG(x,"x")
HXLINE(2099)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib1f(indx,x);
            	}
...
HXLINE(2110)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib1fv(indx,hx::DynamicPtr(values->buffer));
            	}
...
void GL_obj::vertexAttrib2f(Int indx,Float x,Float y){
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE(2123)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib2f(indx,x,y);
            	}
...
void GL_obj::vertexAttrib2fv(Int indx, ::lime::utils::ArrayBufferView values){
            	...
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(values,"values")
HXLINE(2134)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib2fv(indx,hx::DynamicPtr(values->buffer));
            	}
...
void GL_obj::vertexAttrib3f(Int indx,Float x,Float y,Float z){
            	...
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(z,"z")
HXLINE(2147)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib3f(indx,x,y,z);
            	}
...
void GL_obj::vertexAttrib3fv(Int indx, ::lime::utils::ArrayBufferView values){
            	...
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(values,"values")
HXLINE(2158)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib3fv(indx,hx::DynamicPtr(values->buffer));
            	}
...
void GL_obj::vertexAttrib4f(Int indx,Float x,Float y,Float z,Float w){
            	...
            	HX_STACK_ARG(z,"z")
            	HX_STACK_ARG(w,"w")
HXLINE(2171)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib4f(indx,x,y,z,w);
            	}
...
void GL_obj::vertexAttrib4fv(Int indx, ::lime::utils::ArrayBufferView values){
            	...
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(values,"values")
HXLINE(2182)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib4fv(indx,hx::DynamicPtr(values->buffer));
            	}
...
void GL_obj::vertexAttribPointer(Int indx,Int size,Int type,Bool normalized,Int stride,Int offset){
            	...
            	HX_STACK_ARG(offset,"offset")
HXLINE(2195)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib_pointer(indx,size,type,normalized,stride,offset);
            	}
...
void GL_obj::viewport(Int x,Int y,Int width,Int height){
            	...
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE(2206)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_viewport(x,y,width,height);
            	}
...
void GL_obj::lime_gl_active_texture(Int texture){
            	...
            	HX_STACK_ARG(texture,"texture")
HXLINE(2216)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_active_texture(texture);
            	}
...
void GL_obj::lime_gl_attach_shader(Int program,Int shader){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(shader,"shader")
HXLINE(2217)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_attach_shader(program,shader);
            	}
...
void GL_obj::lime_gl_bind_attrib_location(Int program,Int index,::String name){
            	...
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(name,"name")
HXLINE(2218)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_attrib_location(program,index,name);
            	}
...
void GL_obj::lime_gl_bind_buffer(Int target,Int buffer){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(buffer,"buffer")
HXLINE(2219)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_buffer(target,buffer);
            	}
...
void GL_obj::lime_gl_bind_framebuffer(Int target,Int framebuffer){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(framebuffer,"framebuffer")
HXLINE(2220)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_framebuffer(target,framebuffer);
            	}
...
void GL_obj::lime_gl_bind_renderbuffer(Int target,Int renderbuffer){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(renderbuffer,"renderbuffer")
HXLINE(2221)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_renderbuffer(target,renderbuffer);
            	}
...
void GL_obj::lime_gl_bind_texture(Int target,Int texture){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(texture,"texture")
HXLINE(2222)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_bind_texture(target,texture);
            	}
...
void GL_obj::lime_gl_blend_color(float red,float green,float blue,float alpha){
            	...
            	HX_STACK_ARG(blue,"blue")
            	HX_STACK_ARG(alpha,"alpha")
HXLINE(2223)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_color(red,green,blue,alpha);
            	}
...
void GL_obj::lime_gl_blend_equation(Int mode){
            	...
            	HX_STACK_ARG(mode,"mode")
HXLINE(2224)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_equation(mode);
            	}
...
void GL_obj::lime_gl_blend_equation_separate(Int modeRGB,Int modeAlpha){
            	...
            	HX_STACK_ARG(modeRGB,"modeRGB")
            	HX_STACK_ARG(modeAlpha,"modeAlpha")
HXLINE(2225)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_equation_separate(modeRGB,modeAlpha);
            	}
...
void GL_obj::lime_gl_blend_func(Int sfactor,Int dfactor){
            	...
            	HX_STACK_ARG(sfactor,"sfactor")
            	HX_STACK_ARG(dfactor,"dfactor")
HXLINE(2226)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_func(sfactor,dfactor);
            	}
...
void GL_obj::lime_gl_blend_func_separate(Int srcRGB,Int dstRGB,Int srcAlpha,Int dstAlpha){
            	...
            	HX_STACK_ARG(srcAlpha,"srcAlpha")
            	HX_STACK_ARG(dstAlpha,"dstAlpha")
HXLINE(2227)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_blend_func_separate(srcRGB,dstRGB,srcAlpha,dstAlpha);
            	}
...
void GL_obj::lime_gl_buffer_data(Int target, ::Dynamic buffer,Int byteOffset,Int size,Int usage){
            	...
            	HX_STACK_ARG(size,"size")
            	HX_STACK_ARG(usage,"usage")
HXLINE(2228)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_buffer_data(target,hx::DynamicPtr(buffer),byteOffset,size,usage);
            	}
...
void GL_obj::lime_gl_buffer_sub_data(Int target,Int offset, ::Dynamic buffer,Int byteOffset,Int size){
            	...
            	HX_STACK_ARG(byteOffset,"byteOffset")
            	HX_STACK_ARG(size,"size")
HXLINE(2229)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_buffer_sub_data(target,offset,hx::DynamicPtr(buffer),byteOffset,size);
            	}
...
Int GL_obj::lime_gl_check_framebuffer_status(Int target){
            	...
            	HX_STACK_ARG(target,"target")
HXLINE(2230)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_check_framebuffer_status(target)) );
            	}
...
void GL_obj::lime_gl_clear(Int mask){
            	...
            	HX_STACK_ARG(mask,"mask")
HXLINE(2231)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_clear(mask);
            	}
...
void GL_obj::lime_gl_clear_color(float red,float green,float blue,float alpha){
            	...
            	HX_STACK_ARG(blue,"blue")
            	HX_STACK_ARG(alpha,"alpha")
HXLINE(2232)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_clear_color(red,green,blue,alpha);
            	}
...
void GL_obj::lime_gl_clear_depth(float depth){
            	...
            	HX_STACK_ARG(depth,"depth")
HXLINE(2233)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_clear_depth(depth);
            	}
...
void GL_obj::lime_gl_clear_stencil(Int s){
            	...
            	HX_STACK_ARG(s,"s")
HXLINE(2234)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_clear_stencil(s);
            	}
...
void GL_obj::lime_gl_color_mask(Bool red,Bool green,Bool blue,Bool alpha){
            	...
            	HX_STACK_ARG(blue,"blue")
            	HX_STACK_ARG(alpha,"alpha")
HXLINE(2235)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_color_mask(red,green,blue,alpha);
            	}
...
void GL_obj::lime_gl_compile_shader(Int shader){
            	...
            	HX_STACK_ARG(shader,"shader")
HXLINE(2236)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_compile_shader(shader);
            	}
...
void GL_obj::lime_gl_compressed_tex_image_2d(Int target,Int level,Int internalformat,Int width,Int height,Int border, ::Dynamic buffer,Int byteOffset){
            	...
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(byteOffset,"byteOffset")
HXLINE(2237)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_compressed_tex_image_2d(target,level,internalformat,width,height,border,hx::DynamicPtr(buffer),byteOffset);
            	}
...
void GL_obj::lime_gl_compressed_tex_sub_image_2d(Int target,Int level,Int xoffset,Int yoffset,Int width,Int height,Int format, ::Dynamic buffer,Int byteOffset){
            	...
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(byteOffset,"byteOffset")
HXLINE(2238)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_compressed_tex_sub_image_2d(target,level,xoffset,yoffset,width,height,format,hx::DynamicPtr(buffer),byteOffset);
            	}
...
void GL_obj::lime_gl_copy_tex_image_2d(Int target,Int level,Int internalformat,Int x,Int y,Int width,Int height,Int border){
            	...
            	HX_STACK_ARG(height,"height")
            	HX_STACK_ARG(border,"border")
HXLINE(2239)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_copy_tex_image_2d(target,level,internalformat,x,y,width,height,border);
            	}
...
void GL_obj::lime_gl_copy_tex_sub_image_2d(Int target,Int level,Int xoffset,Int yoffset,Int x,Int y,Int width,Int height){
            	...
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE(2240)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_copy_tex_sub_image_2d(target,level,xoffset,yoffset,x,y,width,height);
            	}
...
HXLINE(2241)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_buffer()) );
            	}
...
HXLINE(2242)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_framebuffer()) );
            	}
...
HXLINE(2243)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_program()) );
            	}
...
HXLINE(2244)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_render_buffer()) );
            	}
...
Int GL_obj::lime_gl_create_shader(Int type){
            	...
            	HX_STACK_ARG(type,"type")
HXLINE(2245)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_shader(type)) );
            	}
...
HXLINE(2246)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_create_texture()) );
            	}
...
void GL_obj::lime_gl_cull_face(Int mode){
            	...
            	HX_STACK_ARG(mode,"mode")
HXLINE(2247)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_cull_face(mode);
            	}
...
void GL_obj::lime_gl_delete_buffer(Int buffer){
            	...
            	HX_STACK_ARG(buffer,"buffer")
HXLINE(2248)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_buffer(buffer);
            	}
...
void GL_obj::lime_gl_delete_framebuffer(Int framebuffer){
            	...
            	HX_STACK_ARG(framebuffer,"framebuffer")
HXLINE(2249)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_framebuffer(framebuffer);
            	}
...
void GL_obj::lime_gl_delete_program(Int program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE(2250)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_program(program);
            	}
...
void GL_obj::lime_gl_delete_render_buffer(Int renderbuffer){
            	...
            	HX_STACK_ARG(renderbuffer,"renderbuffer")
HXLINE(2251)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_render_buffer(renderbuffer);
            	}
...
void GL_obj::lime_gl_delete_shader(Int shader){
            	...
            	HX_STACK_ARG(shader,"shader")
HXLINE(2252)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_shader(shader);
            	}
...
void GL_obj::lime_gl_delete_texture(Int texture){
            	...
            	HX_STACK_ARG(texture,"texture")
HXLINE(2253)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_delete_texture(texture);
            	}
...
void GL_obj::lime_gl_depth_func(Int func){
            	...
            	HX_STACK_ARG(func,"func")
HXLINE(2254)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_depth_func(func);
            	}
...
void GL_obj::lime_gl_depth_mask(Bool flag){
            	...
            	HX_STACK_ARG(flag,"flag")
HXLINE(2255)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_depth_mask(flag);
            	}
...
void GL_obj::lime_gl_depth_range(float zNear,float zFar){
            	...
            	HX_STACK_ARG(zNear,"zNear")
            	HX_STACK_ARG(zFar,"zFar")
HXLINE(2256)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_depth_range(zNear,zFar);
            	}
...
void GL_obj::lime_gl_detach_shader(Int program,Int shader){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(shader,"shader")
HXLINE(2257)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_detach_shader(program,shader);
            	}
...
void GL_obj::lime_gl_disable(Int cap){
            	...
            	HX_STACK_ARG(cap,"cap")
HXLINE(2258)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_disable(cap);
            	}
...
void GL_obj::lime_gl_disable_vertex_attrib_array(Int index){
            	...
            	HX_STACK_ARG(index,"index")
HXLINE(2259)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_disable_vertex_attrib_array(index);
            	}
...
void GL_obj::lime_gl_draw_arrays(Int mode,Int first,Int count){
            	...
            	HX_STACK_ARG(first,"first")
            	HX_STACK_ARG(count,"count")
HXLINE(2260)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_draw_arrays(mode,first,count);
            	}
...
void GL_obj::lime_gl_draw_elements(Int mode,Int count,Int type,Int offset){
            	...
            	HX_STACK_ARG(type,"type")
            	HX_STACK_ARG(offset,"offset")
HXLINE(2261)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_draw_elements(mode,count,type,offset);
            	}
...
void GL_obj::lime_gl_enable(Int cap){
            	...
            	HX_STACK_ARG(cap,"cap")
HXLINE(2262)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_enable(cap);
            	}
...
void GL_obj::lime_gl_enable_vertex_attrib_array(Int index){
            	...
            	HX_STACK_ARG(index,"index")
HXLINE(2263)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_enable_vertex_attrib_array(index);
            	}
...
HXLINE(2264)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_finish();
            	}
...
HXLINE(2265)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_flush();
            	}
...
void GL_obj::lime_gl_framebuffer_renderbuffer(Int target,Int attachment,Int renderbuffertarget,Int renderbuffer){
            	...
            	HX_STACK_ARG(renderbuffertarget,"renderbuffertarget")
            	HX_STACK_ARG(renderbuffer,"renderbuffer")
HXLINE(2266)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_framebuffer_renderbuffer(target,attachment,renderbuffertarget,renderbuffer);
            	}
...
void GL_obj::lime_gl_framebuffer_texture2D(Int target,Int attachment,Int textarget,Int texture,Int level){
            	...
            	HX_STACK_ARG(texture,"texture")
            	HX_STACK_ARG(level,"level")
HXLINE(2267)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_framebuffer_texture2D(target,attachment,textarget,texture,level);
            	}
...
void GL_obj::lime_gl_front_face(Int mode){
            	...
            	HX_STACK_ARG(mode,"mode")
HXLINE(2268)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_front_face(mode);
            	}
...
void GL_obj::lime_gl_generate_mipmap(Int target){
            	...
            	HX_STACK_ARG(target,"target")
HXLINE(2269)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_generate_mipmap(target);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(GL_obj,lime_gl_generate_mipmap,(void))
 ...
 ::Dynamic GL_obj::lime_gl_get_active_attrib(Int program,Int index){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(index,"index")
HXLINE(2270)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_active_attrib(program,index)) );
HXDLIN(2270)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(GL_obj,lime_gl_get_active_attrib,return )
 ...
 ::Dynamic GL_obj::lime_gl_get_active_uniform(Int program,Int index){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(index,"index")
HXLINE(2271)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_active_uniform(program,index)) );
HXDLIN(2271)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
Int GL_obj::lime_gl_get_attrib_location(Int program,::String name){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(name,"name")
HXLINE(2272)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_attrib_location(program,name)) );
            	}
...
Int GL_obj::lime_gl_get_buffer_parameter(Int target,Int pname){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(pname,"pname")
HXLINE(2273)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_buffer_parameter(target,pname)) );
            	}
...
HXLINE(2274)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_context_attributes()) );
HXDLIN(2274)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE(2275)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_error()) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(GL_obj,lime_gl_get_error,return )
 ...
 ::Dynamic GL_obj::lime_gl_get_extension(::String name){
            	...
            	HX_STACK_ARG(name,"name")
HXLINE(2276)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_extension(name)) );
...
Int GL_obj::lime_gl_get_framebuffer_attachment_parameter(Int target,Int attachment,Int pname){
            	...
            	HX_STACK_ARG(attachment,"attachment")
            	HX_STACK_ARG(pname,"pname")
HXLINE(2277)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_framebuffer_attachment_parameter(target,attachment,pname)) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(GL_obj,lime_gl_get_framebuffer_attachment_parameter,return )
 ...
 ::Dynamic GL_obj::lime_gl_get_parameter(Int pname){
            	...
            	HX_STACK_ARG(pname,"pname")
HXLINE(2278)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_parameter(pname)) );
HXDLIN(2278)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
::String GL_obj::lime_gl_get_program_info_log(Int program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE(2279)		return ( (::String)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_program_info_log(program)) );
            	}
...
Int GL_obj::lime_gl_get_program_parameter(Int program,Int pname){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(pname,"pname")
HXLINE(2280)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_program_parameter(program,pname)) );
            	}
...
Int GL_obj::lime_gl_get_render_buffer_parameter(Int target,Int pname){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(pname,"pname")
HXLINE(2281)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_render_buffer_parameter(target,pname)) );
            	}
...
::String GL_obj::lime_gl_get_shader_info_log(Int shader){
            	...
            	HX_STACK_ARG(shader,"shader")
HXLINE(2282)		return ( (::String)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_shader_info_log(shader)) );
            	}
...
Int GL_obj::lime_gl_get_shader_parameter(Int shader,Int pname){
            	...
            	HX_STACK_ARG(shader,"shader")
            	HX_STACK_ARG(pname,"pname")
HXLINE(2283)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_shader_parameter(shader,pname)) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(GL_obj,lime_gl_get_shader_parameter,return )
 ...
 ::Dynamic GL_obj::lime_gl_get_shader_precision_format(Int shadertype,Int precisiontype){
            	...
            	HX_STACK_ARG(shadertype,"shadertype")
            	HX_STACK_ARG(precisiontype,"precisiontype")
HXLINE(2284)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_shader_precision_format(shadertype,precisiontype)) );
HXDLIN(2284)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(GL_obj,lime_gl_get_shader_precision_format,return )
 ...
 ::Dynamic GL_obj::lime_gl_get_shader_source(Int shader){
            	...
            	HX_STACK_ARG(shader,"shader")
HXLINE(2285)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_shader_source(shader)) );
HXDLIN(2285)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE(2286)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_supported_extensions(hx::DynamicPtr(result));
            	}
...
Int GL_obj::lime_gl_get_tex_parameter(Int target,Int pname){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(pname,"pname")
HXLINE(2287)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_tex_parameter(target,pname)) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(GL_obj,lime_gl_get_tex_parameter,return )
 ...
 ::Dynamic GL_obj::lime_gl_get_uniform(Int program,Int location){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(location,"location")
HXLINE(2288)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_uniform(program,location)) );
HXDLIN(2288)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
Int GL_obj::lime_gl_get_uniform_location(Int program,::String name){
            	...
            	HX_STACK_ARG(program,"program")
            	HX_STACK_ARG(name,"name")
HXLINE(2289)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_uniform_location(program,name)) );
            	}
...
Int GL_obj::lime_gl_get_vertex_attrib(Int index,Int pname){
            	...
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(pname,"pname")
HXLINE(2290)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_vertex_attrib(index,pname)) );
            	}
...
Int GL_obj::lime_gl_get_vertex_attrib_offset(Int index,Int pname){
            	...
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(pname,"pname")
HXLINE(2291)		return ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_vertex_attrib_offset(index,pname)) );
            	}
...
void GL_obj::lime_gl_hint(Int target,Int mode){
            	...
            	HX_STACK_ARG(target,"target")
            	HX_STACK_ARG(mode,"mode")
HXLINE(2292)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_hint(target,mode);
            	}
...
Bool GL_obj::lime_gl_is_buffer(Int buffer){
            	...
            	HX_STACK_ARG(buffer,"buffer")
HXLINE(2293)		return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_buffer(buffer)) );
            	}
...
Bool GL_obj::lime_gl_is_enabled(Int cap){
            	...
            	HX_STACK_ARG(cap,"cap")
HXLINE(2294)		return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_enabled(cap)) );
            	}
...
Bool GL_obj::lime_gl_is_framebuffer(Int framebuffer){
            	...
            	HX_STACK_ARG(framebuffer,"framebuffer")
HXLINE(2295)		return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_framebuffer(framebuffer)) );
            	}
...
Bool GL_obj::lime_gl_is_program(Int program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE(2296)		return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_program(program)) );
            	}
...
Bool GL_obj::lime_gl_is_renderbuffer(Int renderbuffer){
            	...
            	HX_STACK_ARG(renderbuffer,"renderbuffer")
HXLINE(2297)		return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_renderbuffer(renderbuffer)) );
            	}
...
Bool GL_obj::lime_gl_is_shader(Int shader){
            	...
            	HX_STACK_ARG(shader,"shader")
HXLINE(2298)		return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_shader(shader)) );
            	}
...
Bool GL_obj::lime_gl_is_texture(Int texture){
            	...
            	HX_STACK_ARG(texture,"texture")
HXLINE(2299)		return ( (Bool)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_is_texture(texture)) );
            	}
...
void GL_obj::lime_gl_line_width(float width){
            	...
            	HX_STACK_ARG(width,"width")
HXLINE(2300)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_line_width(width);
            	}
...
void GL_obj::lime_gl_link_program(Int program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE(2301)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_link_program(program);
            	}
...
void GL_obj::lime_gl_pixel_storei(Int pname,Int param){
            	...
            	HX_STACK_ARG(pname,"pname")
            	HX_STACK_ARG(param,"param")
HXLINE(2302)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_pixel_storei(pname,param);
            	}
...
void GL_obj::lime_gl_polygon_offset(float factor,float units){
            	...
            	HX_STACK_ARG(factor,"factor")
            	HX_STACK_ARG(units,"units")
HXLINE(2303)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_polygon_offset(factor,units);
            	}
...
void GL_obj::lime_gl_read_pixels(Int x,Int y,Int width,Int height,Int format,Int type, ::Dynamic buffer,Int byteOffset){
            	...
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(byteOffset,"byteOffset")
HXLINE(2304)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_read_pixels(x,y,width,height,format,type,hx::DynamicPtr(buffer),byteOffset);
            	}
...
void GL_obj::lime_gl_renderbuffer_storage(Int target,Int internalformat,Int width,Int height){
            	...
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE(2305)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_renderbuffer_storage(target,internalformat,width,height);
            	}
...
void GL_obj::lime_gl_sample_coverage(float value,Bool invert){
            	...
            	HX_STACK_ARG(value,"value")
            	HX_STACK_ARG(invert,"invert")
HXLINE(2306)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_sample_coverage(value,invert);
            	}
...
void GL_obj::lime_gl_scissor(Int x,Int y,Int width,Int height){
            	...
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE(2307)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_scissor(x,y,width,height);
            	}
...
void GL_obj::lime_gl_shader_source(Int shader,::String source){
            	...
            	HX_STACK_ARG(shader,"shader")
            	HX_STACK_ARG(source,"source")
HXLINE(2308)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_shader_source(shader,source);
            	}
...
void GL_obj::lime_gl_stencil_func(Int func,Int ref,Int mask){
            	...
            	HX_STACK_ARG(ref,"ref")
            	HX_STACK_ARG(mask,"mask")
HXLINE(2309)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_func(func,ref,mask);
            	}
...
void GL_obj::lime_gl_stencil_func_separate(Int face,Int func,Int ref,Int mask){
            	...
            	HX_STACK_ARG(ref,"ref")
            	HX_STACK_ARG(mask,"mask")
HXLINE(2310)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_func_separate(face,func,ref,mask);
            	}
...
void GL_obj::lime_gl_stencil_mask(Int mask){
            	...
            	HX_STACK_ARG(mask,"mask")
HXLINE(2311)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_mask(mask);
            	}
...
void GL_obj::lime_gl_stencil_mask_separate(Int face,Int mask){
            	...
            	HX_STACK_ARG(face,"face")
            	HX_STACK_ARG(mask,"mask")
HXLINE(2312)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_mask_separate(face,mask);
            	}
...
void GL_obj::lime_gl_stencil_op(Int fail,Int zfail,Int zpass){
            	...
            	HX_STACK_ARG(zfail,"zfail")
            	HX_STACK_ARG(zpass,"zpass")
HXLINE(2313)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_op(fail,zfail,zpass);
            	}
...
void GL_obj::lime_gl_stencil_op_separate(Int face,Int fail,Int zfail,Int zpass){
            	...
            	HX_STACK_ARG(zfail,"zfail")
            	HX_STACK_ARG(zpass,"zpass")
HXLINE(2314)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_stencil_op_separate(face,fail,zfail,zpass);
            	}
...
void GL_obj::lime_gl_tex_image_2d(Int target,Int level,Int internalformat,Int width,Int height,Int border,Int format,Int type, ::Dynamic buffer,Int byteOffset){
            	...
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(byteOffset,"byteOffset")
HXLINE(2315)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_image_2d(target,level,internalformat,width,height,border,format,type,hx::DynamicPtr(buffer),byteOffset);
            	}
...
void GL_obj::lime_gl_tex_parameterf(Int target,Int pname,float param){
            	...
            	HX_STACK_ARG(pname,"pname")
            	HX_STACK_ARG(param,"param")
HXLINE(2316)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_parameterf(target,pname,param);
            	}
...
void GL_obj::lime_gl_tex_parameteri(Int target,Int pname,Int param){
            	...
            	HX_STACK_ARG(pname,"pname")
            	HX_STACK_ARG(param,"param")
HXLINE(2317)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_parameteri(target,pname,param);
            	}
...
void GL_obj::lime_gl_tex_sub_image_2d(Int target,Int level,Int xoffset,Int yoffset,Int width,Int height,Int format,Int type, ::Dynamic buffer,Int byteOffset){
            	...
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(byteOffset,"byteOffset")
HXLINE(2318)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_tex_sub_image_2d(target,level,xoffset,yoffset,width,height,format,type,hx::DynamicPtr(buffer),byteOffset);
            	}
...
void GL_obj::lime_gl_uniform1f(Int location,float x){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(x,"x")
HXLINE(2319)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform1f(location,x);
            	}
...
void GL_obj::lime_gl_uniform1fv(Int location, ::Dynamic v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(2320)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform1fv(location,hx::DynamicPtr(v));
            	}
...
void GL_obj::lime_gl_uniform1i(Int location,Int x){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(x,"x")
HXLINE(2321)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform1i(location,x);
            	}
...
void GL_obj::lime_gl_uniform1iv(Int location, ::Dynamic v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(2322)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform1iv(location,hx::DynamicPtr(v));
            	}
...
void GL_obj::lime_gl_uniform2f(Int location,float x,float y){
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE(2323)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform2f(location,x,y);
            	}
...
void GL_obj::lime_gl_uniform2fv(Int location, ::Dynamic v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(2324)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform2fv(location,hx::DynamicPtr(v));
            	}
...
void GL_obj::lime_gl_uniform2i(Int location,Int x,Int y){
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE(2325)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform2i(location,x,y);
            	}
...
void GL_obj::lime_gl_uniform2iv(Int location, ::Dynamic v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(2326)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform2iv(location,hx::DynamicPtr(v));
            	}
...
void GL_obj::lime_gl_uniform3f(Int location,float x,float y,float z){
            	...
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(z,"z")
HXLINE(2327)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform3f(location,x,y,z);
            	}
...
void GL_obj::lime_gl_uniform3fv(Int location, ::Dynamic v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(2328)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform3fv(location,hx::DynamicPtr(v));
            	}
...
void GL_obj::lime_gl_uniform3i(Int location,Int x,Int y,Int z){
            	...
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(z,"z")
HXLINE(2329)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform3i(location,x,y,z);
            	}
...
void GL_obj::lime_gl_uniform3iv(Int location, ::Dynamic v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(2330)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform3iv(location,hx::DynamicPtr(v));
            	}
...
void GL_obj::lime_gl_uniform4f(Int location,float x,float y,float z,float w){
            	...
            	HX_STACK_ARG(z,"z")
            	HX_STACK_ARG(w,"w")
HXLINE(2331)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform4f(location,x,y,z,w);
            	}
...
void GL_obj::lime_gl_uniform4fv(Int location, ::Dynamic v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(2332)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform4fv(location,hx::DynamicPtr(v));
            	}
...
void GL_obj::lime_gl_uniform4i(Int location,Int x,Int y,Int z,Int w){
            	...
            	HX_STACK_ARG(z,"z")
            	HX_STACK_ARG(w,"w")
HXLINE(2333)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform4i(location,x,y,z,w);
            	}
...
void GL_obj::lime_gl_uniform4iv(Int location, ::Dynamic v){
            	...
            	HX_STACK_ARG(location,"location")
            	HX_STACK_ARG(v,"v")
HXLINE(2334)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform4iv(location,hx::DynamicPtr(v));
            	}
...
void GL_obj::lime_gl_uniform_matrix(Int location,Bool transpose, ::Dynamic buffer,Int count){
            	...
            	HX_STACK_ARG(buffer,"buffer")
            	HX_STACK_ARG(count,"count")
HXLINE(2335)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_uniform_matrix(location,transpose,hx::DynamicPtr(buffer),count);
            	}
...
void GL_obj::lime_gl_use_program(Int program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE(2336)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_use_program(program);
            	}
...
void GL_obj::lime_gl_validate_program(Int program){
            	...
            	HX_STACK_ARG(program,"program")
HXLINE(2337)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_validate_program(program);
            	}
...
HXLINE(2338)		return ( (::String)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_version()) );
            	}
...
void GL_obj::lime_gl_vertex_attrib1f(Int indx,float x){
            	...
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(x,"x")
HXLINE(2339)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib1f(indx,x);
            	}
...
void GL_obj::lime_gl_vertex_attrib1fv(Int indx, ::Dynamic values){
            	...
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(values,"values")
HXLINE(2340)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib1fv(indx,hx::DynamicPtr(values));
            	}
...
void GL_obj::lime_gl_vertex_attrib2f(Int indx,float x,float y){
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE(2341)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib2f(indx,x,y);
            	}
...
void GL_obj::lime_gl_vertex_attrib2fv(Int indx, ::Dynamic values){
            	...
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(values,"values")
HXLINE(2342)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib2fv(indx,hx::DynamicPtr(values));
            	}
...
void GL_obj::lime_gl_vertex_attrib3f(Int indx,float x,float y,float z){
            	...
            	HX_STACK_ARG(y,"y")
            	HX_STACK_ARG(z,"z")
HXLINE(2343)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib3f(indx,x,y,z);
            	}
...
void GL_obj::lime_gl_vertex_attrib3fv(Int indx, ::Dynamic values){
            	...
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(values,"values")
HXLINE(2344)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib3fv(indx,hx::DynamicPtr(values));
            	}
...
void GL_obj::lime_gl_vertex_attrib4f(Int indx,float x,float y,float z,float w){
            	...
            	HX_STACK_ARG(z,"z")
            	HX_STACK_ARG(w,"w")
HXLINE(2345)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib4f(indx,x,y,z,w);
            	}
...
void GL_obj::lime_gl_vertex_attrib4fv(Int indx, ::Dynamic values){
            	...
            	HX_STACK_ARG(indx,"indx")
            	HX_STACK_ARG(values,"values")
HXLINE(2346)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib4fv(indx,hx::DynamicPtr(values));
            	}
...
void GL_obj::lime_gl_vertex_attrib_pointer(Int indx,Int size,Int type,Bool normalized,Int stride,Int offset){
            	...
            	HX_STACK_ARG(stride,"stride")
            	HX_STACK_ARG(offset,"offset")
HXLINE(2347)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_vertex_attrib_pointer(indx,size,type,normalized,stride,offset);
            	}
...
void GL_obj::lime_gl_viewport(Int x,Int y,Int width,Int height){
            	...
            	HX_STACK_ARG(width,"width")
            	HX_STACK_ARG(height,"height")
HXLINE(2348)		::lime::graphics::opengl::GL_obj::cffi_lime_gl_viewport(x,y,width,height);
            	}
...
{
            	HX_STACK_FRAME("lime.graphics.opengl.GL","boot",0x82b18806,"lime.graphics.opengl.GL.boot","lime/graphics/opengl/GL.hx",224,0xa5aa2623)
...
{
            	HX_STACK_FRAME("lime.graphics.opengl.GL","boot",0x82b18806,"lime.graphics.opengl.GL.boot","lime/graphics/opengl/GL.hx",367,0xa5aa2623)
HXLINE( 367)		NONE = (int)0;
            	}
{
            	HX_STACK_FRAME("lime.graphics.opengl.GL","boot",0x82b18806,"lime.graphics.opengl.GL.boot","lime/graphics/opengl/GL.hx",369,0xa5aa2623)
...
{
            	HX_STACK_FRAME("lime.graphics.opengl.GL","boot",0x82b18806,"lime.graphics.opengl.GL.boot","lime/graphics/opengl/GL.hx",375,0xa5aa2623)
...
{
            	HX_STACK_FRAME("lime.graphics.opengl.GL","boot",0x82b18806,"lime.graphics.opengl.GL.boot","lime/graphics/opengl/GL.hx",379,0xa5aa2623)
HXLINE( 379)		INVALID_FRAMEBUFFER_OPERATION = (int)1286;
            	}
{
            	HX_STACK_FRAME("lime.graphics.opengl.GL","boot",0x82b18806,"lime.graphics.opengl.GL.boot","lime/graphics/opengl/GL.hx",381,0xa5aa2623)
...
{
            	HX_STACK_FRAME("lime.graphics.opengl.GL","boot",0x82b18806,"lime.graphics.opengl.GL.boot","lime/graphics/opengl/GL.hx",2216,0xa5aa2623)
HXLINE(2216)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_active_texture",52,df,77,b3),HX_("iv",ed,5b,00,00),false);
HXDLIN(2216)		cffi_lime_gl_active_texture = inValue;
            	}
{
            	HX_STACK_FRAME("lime.graphics.opengl.GL","boot",0x82b18806,"lime.graphics.opengl.GL.boot","lime/graphics/opengl/GL.hx",2217,0xa5aa2623)
HXLINE(2217)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_attach_shader",6f,78,09,06),HX_("iiv",96,08,50,00),false);
HXDLIN(2217)		cffi_lime_gl_attach_shader = inValue;
            	}
{
            	HX_STACK_FRAME("lime.graphics.opengl.GL","boot",0x82b18806,"lime.graphics.opengl.GL.boot","lime/graphics/opengl/GL.hx",2218,0xa5aa2623)
HXLINE(2218)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_bind_attrib_location",78,d0,23,1a),HX_("iisv",83,78,b7,45),false);
HXDLIN(2218)		cffi_lime_gl_bind_attrib_location = inValue;
            	}
{
            	HX_STACK_FRAME("lime.graphics.opengl.GL","boot",0x82b18806,"lime.graphics.opengl.GL.boot","lime/graphics/opengl/GL.hx",2219,0xa5aa2623)
HXLINE(2219)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_bind_buffer",52,57,d9,e2),HX_("iiv",96,08,50,00),false);
HXDLIN(2219)		cffi_lime_gl_bind_buffer = inValue;
            	}
{
            	HX_STACK_FRAME("lime.graphics.opengl.GL","boot",0x82b18806,"lime.graphics.opengl.GL.boot","lime/graphics/opengl/GL.hx",2220,0xa5aa2623)
HXLINE(2220)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_bind_framebuffer",5b,d1,58,70),HX_("iiv",96,08,50,00),false);
HXDLIN(2220)		cffi_lime_gl_bind_framebuffer = inValue;
            	}
{
...
HXLINE(2221)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_bind_renderbuffer",a8,70,ea,63),HX_("iiv",96,08,50,00),false);
HXDLIN(2221)		cffi_lime_gl_bind_renderbuffer = inValue;
            	}
{
...
HXLINE(2222)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_bind_texture",49,36,a3,88),HX_("iiv",96,08,50,00),false);
HXDLIN(2222)		cffi_lime_gl_bind_texture = inValue;
            	}
{
...
HXLINE(2223)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_blend_color",85,d0,ce,3a),HX_("ffffv",f6,ad,98,fe),false);
HXDLIN(2223)		cffi_lime_gl_blend_color = inValue;
            	}
{
...
HXLINE(2224)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_blend_equation",aa,fd,08,1f),HX_("iv",ed,5b,00,00),false);
HXDLIN(2224)		cffi_lime_gl_blend_equation = inValue;
            	}
{
...
HXLINE(2225)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_blend_equation_separate",d8,13,95,58),HX_("iiv",96,08,50,00),false);
HXDLIN(2225)		cffi_lime_gl_blend_equation_separate = inValue;
            	}
{
...
HXLINE(2226)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_blend_func",62,46,02,e9),HX_("iiv",96,08,50,00),false);
HXDLIN(2226)		cffi_lime_gl_blend_func = inValue;
            	}
{
...
HXLINE(2227)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_blend_func_separate",20,f4,b8,2e),HX_("iiiiv",b6,58,ca,ba),false);
HXDLIN(2227)		cffi_lime_gl_blend_func_separate = inValue;
            	}
{
...
HXLINE(2228)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_buffer_data",d9,31,40,74),HX_("ioiiiv",b3,b6,aa,2a),false);
HXDLIN(2228)		cffi_lime_gl_buffer_data = inValue;
            	}
{
...
HXLINE(2229)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_buffer_sub_data",b8,37,6c,ab),HX_("iioiiv",67,83,3a,ba),false);
HXDLIN(2229)		cffi_lime_gl_buffer_sub_data = inValue;
            	}
{
...
HXLINE(2230)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_check_framebuffer_status",0b,35,e1,ea),HX_("ii",e0,5b,00,00),false);
HXDLIN(2230)		cffi_lime_gl_check_framebuffer_status = inValue;
            	}
{
...
HXLINE(2231)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_clear",5d,92,00,3b),HX_("iv",ed,5b,00,00),false);
HXDLIN(2231)		cffi_lime_gl_clear = inValue;
            	}
{
...
HXLINE(2232)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_clear_color",c1,ee,49,1a),HX_("ffffv",f6,ad,98,fe),false);
HXDLIN(2232)		cffi_lime_gl_clear_color = inValue;
            	}
{
...
HXLINE(2233)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_clear_depth",61,6e,17,a7),HX_("fv",50,59,00,00),false);
HXDLIN(2233)		cffi_lime_gl_clear_depth = inValue;
            	}
{
...
HXLINE(2234)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_clear_stencil",da,ce,51,44),HX_("iv",ed,5b,00,00),false);
HXDLIN(2234)		cffi_lime_gl_clear_stencil = inValue;
            	}
{
...
HXLINE(2235)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_color_mask",b8,f1,a7,79),HX_("bbbbv",f6,74,56,ae),false);
HXDLIN(2235)		cffi_lime_gl_color_mask = inValue;
            	}
{
...
HXLINE(2236)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_compile_shader",e1,d4,68,7c),HX_("iv",ed,5b,00,00),false);
HXDLIN(2236)		cffi_lime_gl_compile_shader = inValue;
            	}
{
...
HXLINE(2237)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_compressed_tex_image_2d",bc,70,b8,76),HX_("iiiiiioiv",7c,5e,4a,bf),false);
HXDLIN(2237)		cffi_lime_gl_compressed_tex_image_2d = inValue;
            	}
{
...
HXLINE(2238)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_compressed_tex_sub_image_2d",9b,19,2d,07),HX_("iiiiiiioiv",f3,88,d5,9d),false);
HXDLIN(2238)		cffi_lime_gl_compressed_tex_sub_image_2d = inValue;
            	}
{
...
HXLINE(2239)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_copy_tex_image_2d",08,15,17,3a),HX_("iiiiiiiiv",f6,d0,45,bf),false);
HXDLIN(2239)		cffi_lime_gl_copy_tex_image_2d = inValue;
            	}
{
...
HXLINE(2240)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_copy_tex_sub_image_2d",e7,d3,21,4b),HX_("iiiiiiiiv",f6,d0,45,bf),false);
HXDLIN(2240)		cffi_lime_gl_copy_tex_sub_image_2d = inValue;
            	}
{
...
HXLINE(2241)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_create_buffer",f3,ef,e7,8a),HX_("i",69,00,00,00),false);
HXDLIN(2241)		cffi_lime_gl_create_buffer = inValue;
            	}
{
...
HXLINE(2242)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_create_framebuffer",1a,51,d8,73),HX_("i",69,00,00,00),false);
HXDLIN(2242)		cffi_lime_gl_create_framebuffer = inValue;
            	}
{
...
HXLINE(2243)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_create_program",31,ac,72,42),HX_("i",69,00,00,00),false);
HXDLIN(2243)		cffi_lime_gl_create_program = inValue;
            	}
{
...
HXLINE(2244)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_create_render_buffer",76,7b,e1,18),HX_("i",69,00,00,00),false);
HXDLIN(2244)		cffi_lime_gl_create_render_buffer = inValue;
            	}
{
...
HXLINE(2245)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_create_shader",18,f2,73,d7),HX_("ii",e0,5b,00,00),false);
HXDLIN(2245)		cffi_lime_gl_create_shader = inValue;
            	}
{
...
HXLINE(2246)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_create_texture",88,2a,5a,ed),HX_("i",69,00,00,00),false);
HXDLIN(2246)		cffi_lime_gl_create_texture = inValue;
            	}
{
...
HXLINE(2247)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_cull_face",5a,6e,d7,a6),HX_("iv",ed,5b,00,00),false);
HXDLIN(2247)		cffi_lime_gl_cull_face = inValue;
            	}
{
...
HXLINE(2248)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_delete_buffer",a4,aa,2e,01),HX_("iv",ed,5b,00,00),false);
HXDLIN(2248)		cffi_lime_gl_delete_buffer = inValue;
            	}
{
...
HXLINE(2249)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_delete_framebuffer",c9,34,1a,a6),HX_("iv",ed,5b,00,00),false);
HXDLIN(2249)		cffi_lime_gl_delete_framebuffer = inValue;
            	}
{
...
HXLINE(2250)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_delete_program",60,4c,0f,4a),HX_("iv",ed,5b,00,00),false);
HXDLIN(2250)		cffi_lime_gl_delete_program = inValue;
            	}
{
...
HXLINE(2251)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_delete_render_buffer",e5,e8,26,ca),HX_("iv",ed,5b,00,00),false);
HXDLIN(2251)		cffi_lime_gl_delete_render_buffer = inValue;
            	}
{
...
HXLINE(2252)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_delete_shader",c9,ac,ba,4d),HX_("iv",ed,5b,00,00),false);
HXDLIN(2252)		cffi_lime_gl_delete_shader = inValue;
            	}
{
...
HXLINE(2253)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_delete_texture",b7,ca,f6,f4),HX_("iv",ed,5b,00,00),false);
HXDLIN(2253)		cffi_lime_gl_delete_texture = inValue;
            	}
{
...
HXLINE(2254)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_depth_func",70,78,16,ad),HX_("iv",ed,5b,00,00),false);
HXDLIN(2254)		cffi_lime_gl_depth_func = inValue;
            	}
{
...
HXLINE(2255)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_depth_mask",18,ce,a7,b1),HX_("bv",d4,55,00,00),false);
HXDLIN(2255)		cffi_lime_gl_depth_mask = inValue;
            	}
{
...
HXLINE(2256)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_depth_range",11,9f,29,a2),HX_("ffv",36,bf,4d,00),false);
HXDLIN(2256)		cffi_lime_gl_depth_range = inValue;
            	}
{
...
HXLINE(2257)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_detach_shader",a1,84,13,fd),HX_("iiv",96,08,50,00),false);
HXDLIN(2257)		cffi_lime_gl_detach_shader = inValue;
            	}
{
...
HXLINE(2258)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_disable",b8,5e,23,70),HX_("iv",ed,5b,00,00),false);
HXDLIN(2258)		cffi_lime_gl_disable = inValue;
            	}
{
...
HXLINE(2259)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_disable_vertex_attrib_array",58,ba,8e,0a),HX_("iv",ed,5b,00,00),false);
HXDLIN(2259)		cffi_lime_gl_disable_vertex_attrib_array = inValue;
            	}
{
...
HXLINE(2260)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_draw_arrays",a5,43,0c,17),HX_("iiiv",cd,6f,b7,45),false);
HXDLIN(2260)		cffi_lime_gl_draw_arrays = inValue;
            	}
{
...
HXLINE(2261)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_draw_elements",e2,d1,98,b9),HX_("iiiiv",b6,58,ca,ba),false);
HXDLIN(2261)		cffi_lime_gl_draw_elements = inValue;
            	}
{
...
HXLINE(2262)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_enable",b3,43,5f,56),HX_("iv",ed,5b,00,00),false);
HXDLIN(2262)		cffi_lime_gl_enable = inValue;
            	}
{
...
HXLINE(2263)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_enable_vertex_attrib_array",d3,1e,a2,ea),HX_("iv",ed,5b,00,00),false);
HXDLIN(2263)		cffi_lime_gl_enable_vertex_attrib_array = inValue;
            	}
{
...
HXLINE(2264)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_finish",83,d5,56,e4),HX_("v",76,00,00,00),false);
HXDLIN(2264)		cffi_lime_gl_finish = inValue;
            	}
{
...
HXLINE(2265)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_flush",94,83,40,f5),HX_("v",76,00,00,00),false);
HXDLIN(2265)		cffi_lime_gl_flush = inValue;
            	}
{
...
HXLINE(2266)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_framebuffer_renderbuffer",d8,1b,4b,9a),HX_("iiiiv",b6,58,ca,ba),false);
HXDLIN(2266)		cffi_lime_gl_framebuffer_renderbuffer = inValue;
            	}
{
...
HXLINE(2267)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_framebuffer_texture2D",2b,bd,7d,0a),HX_("iiiiiv",ad,3b,43,b6),false);
HXDLIN(2267)		cffi_lime_gl_framebuffer_texture2D = inValue;
            	}
{
...
HXLINE(2268)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_front_face",63,a0,73,7d),HX_("iv",ed,5b,00,00),false);
HXDLIN(2268)		cffi_lime_gl_front_face = inValue;
            	}
{
...
HXLINE(2269)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_generate_mipmap",62,a5,38,e6),HX_("iv",ed,5b,00,00),false);
HXDLIN(2269)		cffi_lime_gl_generate_mipmap = inValue;
            	}
{
...
HXLINE(2270)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_active_attrib",0a,40,b7,d1),HX_("iio",8f,08,50,00),false);
HXDLIN(2270)		cffi_lime_gl_get_active_attrib = inValue;
            	}
{
...
HXLINE(2271)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_active_uniform",74,90,d7,2a),HX_("iio",8f,08,50,00),false);
HXDLIN(2271)		cffi_lime_gl_get_active_uniform = inValue;
            	}
{
...
HXLINE(2272)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_attrib_location",f1,00,cb,a5),HX_("isi",3f,11,50,00),false);
HXDLIN(2272)		cffi_lime_gl_get_attrib_location = inValue;
            	}
{
...
HXLINE(2273)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_buffer_parameter",a3,5c,c0,74),HX_("iii",89,08,50,00),false);
HXDLIN(2273)		cffi_lime_gl_get_buffer_parameter = inValue;
            	}
{
...
HXLINE(2274)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_context_attributes",e0,c6,c6,3e),HX_("o",6f,00,00,00),false);
HXDLIN(2274)		cffi_lime_gl_get_context_attributes = inValue;
            	}
{
...
HXLINE(2275)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_error",ef,f0,e0,f5),HX_("i",69,00,00,00),false);
HXDLIN(2275)		cffi_lime_gl_get_error = inValue;
            	}
{
...
HXLINE(2276)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_extension",26,d8,5e,d7),HX_("so",9c,64,00,00),false);
HXDLIN(2276)		cffi_lime_gl_get_extension = inValue;
            	}
{
...
HXLINE(2277)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_framebuffer_attachment_parameter",18,53,fb,61),HX_("iiii",c0,6f,b7,45),false);
HXDLIN(2277)		cffi_lime_gl_get_framebuffer_attachment_parameter = inValue;
            	}
{
...
HXLINE(2278)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_parameter",50,7a,fe,3a),HX_("io",e6,5b,00,00),false);
HXDLIN(2278)		cffi_lime_gl_get_parameter = inValue;
            	}
{
...
HXLINE(2279)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_program_info_log",87,8b,1c,48),HX_("is",ea,5b,00,00),false);
HXDLIN(2279)		cffi_lime_gl_get_program_info_log = inValue;
            	}
{
...
HXLINE(2280)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_program_parameter",95,8c,e9,12),HX_("iii",89,08,50,00),false);
HXDLIN(2280)		cffi_lime_gl_get_program_parameter = inValue;
            	}
{
...
HXLINE(2281)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_render_buffer_parameter",9a,8b,13,f8),HX_("iii",89,08,50,00),false);
HXDLIN(2281)		cffi_lime_gl_get_render_buffer_parameter = inValue;
            	}
{
...
HXLINE(2282)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_shader_info_log",74,08,6b,9a),HX_("is",ea,5b,00,00),false);
HXDLIN(2282)		cffi_lime_gl_get_shader_info_log = inValue;
            	}
{
...
HXLINE(2283)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_shader_parameter",08,5f,48,c5),HX_("iii",89,08,50,00),false);
HXDLIN(2283)		cffi_lime_gl_get_shader_parameter = inValue;
            	}
{
...
HXLINE(2284)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_shader_precision_format",d9,5f,b1,89),HX_("iio",8f,08,50,00),false);
HXDLIN(2284)		cffi_lime_gl_get_shader_precision_format = inValue;
            	}
{
...
HXLINE(2285)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_shader_source",1c,86,a3,e7),HX_("io",e6,5b,00,00),false);
HXDLIN(2285)		cffi_lime_gl_get_shader_source = inValue;
            	}
{
...
HXLINE(2286)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_supported_extensions",7e,b4,30,92),HX_("ov",27,61,00,00),false);
HXDLIN(2286)		cffi_lime_gl_get_supported_extensions = inValue;
            	}
{
...
HXLINE(2287)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_tex_parameter",38,3a,ff,30),HX_("iii",89,08,50,00),false);
HXDLIN(2287)		cffi_lime_gl_get_tex_parameter = inValue;
            	}
{
...
HXLINE(2288)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_uniform",1b,3e,0c,b0),HX_("iio",8f,08,50,00),false);
HXDLIN(2288)		cffi_lime_gl_get_uniform = inValue;
            	}
{
...
HXLINE(2289)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_uniform_location",19,0c,33,6c),HX_("isi",3f,11,50,00),false);
HXDLIN(2289)		cffi_lime_gl_get_uniform_location = inValue;
            	}
{
...
HXLINE(2290)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_vertex_attrib",2c,36,2d,8c),HX_("iii",89,08,50,00),false);
HXDLIN(2290)		cffi_lime_gl_get_vertex_attrib = inValue;
            	}
{
...
HXLINE(2291)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_get_vertex_attrib_offset",86,d0,e7,4a),HX_("iii",89,08,50,00),false);
HXDLIN(2291)		cffi_lime_gl_get_vertex_attrib_offset = inValue;
            	}
{
...
HXLINE(2292)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_hint",b7,26,75,cc),HX_("iiv",96,08,50,00),false);
HXDLIN(2292)		cffi_lime_gl_hint = inValue;
            	}
{
...
HXLINE(2293)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_is_buffer",c5,ec,c6,b4),HX_("ib",d9,5b,00,00),false);
HXDLIN(2293)		cffi_lime_gl_is_buffer = inValue;
            	}
{
...
HXLINE(2294)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_is_enabled",1c,a1,e8,45),HX_("ib",d9,5b,00,00),false);
HXDLIN(2294)		cffi_lime_gl_is_enabled = inValue;
            	}
{
...
HXLINE(2295)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_is_framebuffer",08,9b,19,ab),HX_("ib",d9,5b,00,00),false);
HXDLIN(2295)		cffi_lime_gl_is_framebuffer = inValue;
            	}
{
...
HXLINE(2296)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_is_program",1f,e7,b0,bb),HX_("ib",d9,5b,00,00),false);
HXDLIN(2296)		cffi_lime_gl_is_program = inValue;
            	}
{
...
HXLINE(2297)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_is_renderbuffer",5b,1e,da,91),HX_("ib",d9,5b,00,00),false);
HXDLIN(2297)		cffi_lime_gl_is_renderbuffer = inValue;
            	}
{
...
HXLINE(2298)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_is_shader",ea,ee,52,01),HX_("ib",d9,5b,00,00),false);
HXDLIN(2298)		cffi_lime_gl_is_shader = inValue;
            	}
{
...
HXLINE(2299)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_is_texture",76,65,98,66),HX_("ib",d9,5b,00,00),false);
HXDLIN(2299)		cffi_lime_gl_is_texture = inValue;
            	}
{
...
HXLINE(2300)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_line_width",6b,71,5f,53),HX_("fv",50,59,00,00),false);
HXDLIN(2300)		cffi_lime_gl_line_width = inValue;
            	}
{
...
HXLINE(2301)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_link_program",2f,df,cf,33),HX_("iv",ed,5b,00,00),false);
HXDLIN(2301)		cffi_lime_gl_link_program = inValue;
            	}
{
...
HXLINE(2302)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_pixel_storei",71,b2,56,3d),HX_("iiv",96,08,50,00),false);
HXDLIN(2302)		cffi_lime_gl_pixel_storei = inValue;
            	}
{
...
HXLINE(2303)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_polygon_offset",28,8f,6c,e3),HX_("ffv",36,bf,4d,00),false);
HXDLIN(2303)		cffi_lime_gl_polygon_offset = inValue;
            	}
{
...
HXLINE(2304)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_read_pixels",06,09,69,f5),HX_("iiiiiioiv",7c,5e,4a,bf),false);
HXDLIN(2304)		cffi_lime_gl_read_pixels = inValue;
            	}
{
...
HXLINE(2305)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_renderbuffer_storage",c2,94,f1,7b),HX_("iiiiv",b6,58,ca,ba),false);
HXDLIN(2305)		cffi_lime_gl_renderbuffer_storage = inValue;
            	}
{
...
HXLINE(2306)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_sample_coverage",ad,98,c5,86),HX_("fbv",ba,bb,4d,00),false);
HXDLIN(2306)		cffi_lime_gl_sample_coverage = inValue;
            	}
{
...
HXLINE(2307)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_scissor",ec,1c,b2,c3),HX_("iiiiv",b6,58,ca,ba),false);
HXDLIN(2307)		cffi_lime_gl_scissor = inValue;
            	}
{
...
HXLINE(2308)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_shader_source",c5,d2,e2,7f),HX_("isv",4c,11,50,00),false);
HXDLIN(2308)		cffi_lime_gl_shader_source = inValue;
            	}
{
...
HXLINE(2309)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_stencil_func",d7,b0,4f,64),HX_("iiiv",cd,6f,b7,45),false);
HXDLIN(2309)		cffi_lime_gl_stencil_func = inValue;
            	}
{
...
HXLINE(2310)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_stencil_func_separate",0b,13,77,19),HX_("iiiiv",b6,58,ca,ba),false);
HXDLIN(2310)		cffi_lime_gl_stencil_func_separate = inValue;
            	}
{
...
HXLINE(2311)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_stencil_mask",7f,06,e1,68),HX_("iv",ed,5b,00,00),false);
HXDLIN(2311)		cffi_lime_gl_stencil_mask = inValue;
            	}
{
...
HXLINE(2312)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_stencil_mask_separate",63,c8,71,65),HX_("iiv",96,08,50,00),false);
HXDLIN(2312)		cffi_lime_gl_stencil_mask_separate = inValue;
            	}
{
...
HXLINE(2313)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_stencil_op",f4,8b,0c,a5),HX_("iiiv",cd,6f,b7,45),false);
HXDLIN(2313)		cffi_lime_gl_stencil_op = inValue;
            	}
{
...
HXLINE(2314)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_stencil_op_separate",4e,6c,36,5e),HX_("iiiiv",b6,58,ca,ba),false);
HXDLIN(2314)		cffi_lime_gl_stencil_op_separate = inValue;
            	}
{
...
HXLINE(2315)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_tex_image_2d",5e,ab,7a,34),HX_("iiiiiiiioiv",9c,86,0f,79),false);
HXDLIN(2315)		cffi_lime_gl_tex_image_2d = inValue;
            	}
{
...
HXLINE(2316)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_tex_parameterf",65,7e,77,4d),HX_("iifv",30,6d,b7,45),false);
HXDLIN(2316)		cffi_lime_gl_tex_parameterf = inValue;
            	}
{
...
HXLINE(2317)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_tex_parameteri",68,7e,77,4d),HX_("iiiv",cd,6f,b7,45),false);
HXDLIN(2317)		cffi_lime_gl_tex_parameteri = inValue;
            	}
{
...
HXLINE(2318)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_tex_sub_image_2d",3d,4d,7e,52),HX_("iiiiiiiioiv",9c,86,0f,79),false);
HXDLIN(2318)		cffi_lime_gl_tex_sub_image_2d = inValue;
            	}
{
...
HXLINE(2319)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform1f",19,ea,eb,46),HX_("ifv",f9,05,50,00),false);
HXDLIN(2319)		cffi_lime_gl_uniform1f = inValue;
            	}
{
...
HXLINE(2320)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform1fv",3d,ec,80,c7),HX_("iov",d0,0d,50,00),false);
HXDLIN(2320)		cffi_lime_gl_uniform1fv = inValue;
            	}
{
...
HXLINE(2321)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform1i",1c,ea,eb,46),HX_("iiv",96,08,50,00),false);
HXDLIN(2321)		cffi_lime_gl_uniform1i = inValue;
            	}
{
...
HXLINE(2322)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform1iv",da,ee,80,c7),HX_("iov",d0,0d,50,00),false);
HXDLIN(2322)		cffi_lime_gl_uniform1iv = inValue;
            	}
{
...
HXLINE(2323)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform2f",f8,ea,eb,46),HX_("iffv",6d,26,b5,45),false);
HXDLIN(2323)		cffi_lime_gl_uniform2f = inValue;
            	}
{
...
HXLINE(2324)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform2fv",7e,ae,81,c7),HX_("iov",d0,0d,50,00),false);
HXDLIN(2324)		cffi_lime_gl_uniform2fv = inValue;
            	}
{
...
HXLINE(2325)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform2i",fb,ea,eb,46),HX_("iiiv",cd,6f,b7,45),false);
HXDLIN(2325)		cffi_lime_gl_uniform2i = inValue;
            	}
{
...
HXLINE(2326)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform2iv",1b,b1,81,c7),HX_("iov",d0,0d,50,00),false);
HXDLIN(2326)		cffi_lime_gl_uniform2iv = inValue;
            	}
{
...
HXLINE(2327)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform3f",d7,eb,eb,46),HX_("ifffv",79,6b,cc,b8),false);
HXDLIN(2327)		cffi_lime_gl_uniform3f = inValue;
            	}
{
...
HXLINE(2328)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform3fv",bf,70,82,c7),HX_("iov",d0,0d,50,00),false);
HXDLIN(2328)		cffi_lime_gl_uniform3fv = inValue;
            	}
{
...
HXLINE(2329)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform3i",da,eb,eb,46),HX_("iiiiv",b6,58,ca,ba),false);
HXDLIN(2329)		cffi_lime_gl_uniform3i = inValue;
            	}
{
...
HXLINE(2330)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform3iv",5c,73,82,c7),HX_("iov",d0,0d,50,00),false);
HXDLIN(2330)		cffi_lime_gl_uniform3iv = inValue;
            	}
{
...
HXLINE(2331)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform4f",b6,ec,eb,46),HX_("iffffv",ed,90,11,fa),false);
HXDLIN(2331)		cffi_lime_gl_uniform4f = inValue;
            	}
{
...
HXLINE(2332)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform4fv",00,33,83,c7),HX_("iov",d0,0d,50,00),false);
HXDLIN(2332)		cffi_lime_gl_uniform4fv = inValue;
            	}
{
...
HXLINE(2333)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform4i",b9,ec,eb,46),HX_("iiiiiv",ad,3b,43,b6),false);
HXDLIN(2333)		cffi_lime_gl_uniform4i = inValue;
            	}
{
...
HXLINE(2334)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform4iv",9d,35,83,c7),HX_("iov",d0,0d,50,00),false);
HXDLIN(2334)		cffi_lime_gl_uniform4iv = inValue;
            	}
{
...
HXLINE(2335)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_uniform_matrix",5c,9a,cc,b2),HX_("iboiv",e3,67,2e,b6),false);
HXDLIN(2335)		cffi_lime_gl_uniform_matrix = inValue;
            	}
{
...
HXLINE(2336)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_use_program",1c,8c,b8,22),HX_("iv",ed,5b,00,00),false);
HXDLIN(2336)		cffi_lime_gl_use_program = inValue;
            	}
{
...
HXLINE(2337)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_validate_program",cb,eb,10,5b),HX_("iv",ed,5b,00,00),false);
HXDLIN(2337)		cffi_lime_gl_validate_program = inValue;
            	}
{
...
HXLINE(2338)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_version",e8,db,bc,3b),HX_("s",73,00,00,00),false);
HXDLIN(2338)		cffi_lime_gl_version = inValue;
            	}
{
...
HXLINE(2339)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_vertex_attrib1f",2a,cd,b2,7a),HX_("ifv",f9,05,50,00),false);
HXDLIN(2339)		cffi_lime_gl_vertex_attrib1f = inValue;
            	}
{
...
HXLINE(2340)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_vertex_attrib1fv",0c,b8,c0,e1),HX_("iov",d0,0d,50,00),false);
HXDLIN(2340)		cffi_lime_gl_vertex_attrib1fv = inValue;
            	}
{
...
HXLINE(2341)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_vertex_attrib2f",09,ce,b2,7a),HX_("iffv",6d,26,b5,45),false);
HXDLIN(2341)		cffi_lime_gl_vertex_attrib2f = inValue;
            	}
{
...
HXLINE(2342)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_vertex_attrib2fv",4d,7a,c1,e1),HX_("iov",d0,0d,50,00),false);
HXDLIN(2342)		cffi_lime_gl_vertex_attrib2fv = inValue;
            	}
{
...
HXLINE(2343)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_vertex_attrib3f",e8,ce,b2,7a),HX_("ifffv",79,6b,cc,b8),false);
HXDLIN(2343)		cffi_lime_gl_vertex_attrib3f = inValue;
            	}
{
...
HXLINE(2344)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_vertex_attrib3fv",8e,3c,c2,e1),HX_("iov",d0,0d,50,00),false);
HXDLIN(2344)		cffi_lime_gl_vertex_attrib3fv = inValue;
            	}
{
...
HXLINE(2345)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_vertex_attrib4f",c7,cf,b2,7a),HX_("iffffv",ed,90,11,fa),false);
HXDLIN(2345)		cffi_lime_gl_vertex_attrib4f = inValue;
            	}
{
...
HXLINE(2346)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_vertex_attrib4fv",cf,fe,c2,e1),HX_("iov",d0,0d,50,00),false);
HXDLIN(2346)		cffi_lime_gl_vertex_attrib4fv = inValue;
            	}
{
...
HXLINE(2347)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_vertex_attrib_pointer",13,fa,74,15),HX_("iiibiiv",7d,72,f0,bf),false);
HXDLIN(2347)		cffi_lime_gl_vertex_attrib_pointer = inValue;
            	}
{
...
HXLINE(2348)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_gl_viewport",96,8d,70,cf),HX_("iiiiv",b6,58,ca,ba),false);
HXDLIN(2348)		cffi_lime_gl_viewport = inValue;
            	}
}
