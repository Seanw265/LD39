...
Bool GLObject_obj::isValid(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  31)		Bool _hx_tmp = hx::IsNotNull( this->id );
...
::String GLObject_obj::toString(){
            	HX_STACK_FRAME("lime.graphics.opengl.GLObject","toString",0x511dc841,"lime.graphics.opengl.GLObject.toString","lime/graphics/opengl/GLObject.hx",39,0x63842264)
            	HX_STACK_THIS(this)
HXLINE(  39)		::String _hx_tmp = this->getType();
HXDLIN(  39)		::String _hx_tmp1 = (_hx_tmp + HX_("(",28,00,00,00));
HXDLIN(  39)		::String _hx_tmp2 = ::Std_obj::string(this->id);
HXDLIN(  39)		return ((_hx_tmp1 + _hx_tmp2) + HX_(")",29,00,00,00));
            	}
