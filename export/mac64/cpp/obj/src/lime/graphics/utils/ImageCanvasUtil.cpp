...
HXLINE(  27)		::lime::graphics::utils::ImageCanvasUtil_obj::createImageData(image);
...
HXLINE(  38)		Bool _hx_tmp = hx::IsNotNull( buffer->_hx___srcImage );
HXDLIN(  38)		if (_hx_tmp) {
HXLINE(  40)			Bool _hx_tmp1 = hx::IsNull( buffer->_hx___srcCanvas );
HXDLIN(  40)			if (_hx_tmp1) {
HXLINE(  42)				::lime::graphics::utils::ImageCanvasUtil_obj::createCanvas(image, ::Dynamic(buffer->_hx___srcImage->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic)), ::Dynamic(buffer->_hx___srcImage->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic)));
HXLINE(  43)				 ::Dynamic(buffer->_hx___srcContext->__Field(HX_("drawImage",b7,54,74,85),hx::paccDynamic))(buffer->_hx___srcImage,(int)0,(int)0);
            			}
HXLINE(  47)			buffer->_hx___srcImage = null();
            		}
            		else {
HXLINE(  49)			Bool _hx_tmp2;
HXDLIN(  49)			Bool _hx_tmp3 = hx::IsNotNull( buffer->data );
HXDLIN(  49)			if (_hx_tmp3) {
HXLINE(  49)				_hx_tmp2 = hx::IsNull( buffer->_hx___srcCanvas );
            			}
            			else {
HXLINE(  49)				_hx_tmp2 = false;
            			}
HXDLIN(  49)			if (_hx_tmp2) {
HXLINE(  51)				::lime::graphics::utils::ImageCanvasUtil_obj::createCanvas(image,buffer->width,buffer->height);
HXLINE(  52)				::lime::graphics::utils::ImageCanvasUtil_obj::createImageData(image);
            			}
            			else {
HXLINE(  54)				Bool _hx_tmp4;
HXDLIN(  54)				Bool _hx_tmp5 = hx::IsNull( buffer->data );
HXDLIN(  54)				if (_hx_tmp5) {
HXLINE(  54)					_hx_tmp4 = hx::IsNotNull( buffer->_hx___srcImageData );
            				}
            				else {
...
HXLINE(  84)		::lime::graphics::utils::ImageCanvasUtil_obj::createImageData(sourceImage);
HXLINE(  85)		::lime::graphics::utils::ImageCanvasUtil_obj::convertToCanvas(image);
HXLINE(  86)		::lime::graphics::utils::ImageCanvasUtil_obj::createImageData(image);
...
HXDLIN(  95)		Bool _hx_tmp5 = hx::IsNotNull( destPoint );
...
HXDLIN( 101)		Bool _hx_tmp7 = hx::IsNotNull( alphaImage );
HXDLIN( 101)		if (_hx_tmp7) {
HXLINE( 101)			_hx_tmp6 = alphaImage->get_transparent();
            		}
            		else {
HXLINE( 101)			_hx_tmp6 = false;
            		}
HXDLIN( 101)		if (_hx_tmp6) {
HXLINE( 103)			Bool _hx_tmp8 = hx::IsNull( alphaPoint );
HXDLIN( 103)			if (_hx_tmp8) {
HXLINE( 103)				alphaPoint =  ::lime::math::Vector2_obj::__new(null(),null());
            			}
HXLINE( 107)			HX_VARI(  ::lime::graphics::Image,tempData) = image->clone();
HXLINE( 108)			 ::lime::math::Rectangle _hx_tmp9 =  ::lime::math::Rectangle_obj::__new(alphaPoint->x,alphaPoint->y,sourceRect->width,sourceRect->height);
HXDLIN( 108)			tempData->copyChannel(alphaImage,_hx_tmp9, ::lime::math::Vector2_obj::__new(sourceRect->x,sourceRect->y),::lime::graphics::ImageChannel_obj::ALPHA_dyn(),::lime::graphics::ImageChannel_obj::ALPHA_dyn());
HXLINE( 109)			sourceImage = tempData;
            		}
HXLINE( 113)		::lime::graphics::utils::ImageCanvasUtil_obj::sync(image,true);
HXLINE( 115)		if (!(mergeAlpha)) {
HXLINE( 117)			Bool _hx_tmp10;
HXDLIN( 117)			Bool _hx_tmp11 = image->get_transparent();
HXDLIN( 117)			if (_hx_tmp11) {
HXLINE( 117)				_hx_tmp10 = sourceImage->get_transparent();
            			}
            			else {
HXLINE( 117)				_hx_tmp10 = false;
            			}
HXDLIN( 117)			if (_hx_tmp10) {
HXLINE( 119)				 ::Dynamic _hx_tmp12 =  ::Dynamic(image->buffer->_hx___srcContext->__Field(HX_("clearRect",51,35,68,bf),hx::paccDynamic));
HXDLIN( 119)				Float _hx_tmp13 = (destPoint->x + image->offsetX);
HXDLIN( 119)				Float _hx_tmp14 = (destPoint->y + image->offsetY);
HXDLIN( 119)				Float _hx_tmp15 = (sourceRect->width + image->offsetX);
HXDLIN( 119)				Float _hx_tmp16 = (sourceRect->height + image->offsetY);
HXDLIN( 119)				_hx_tmp12(_hx_tmp13,_hx_tmp14,_hx_tmp15,_hx_tmp16);
            			}
            		}
HXLINE( 125)		::lime::graphics::utils::ImageCanvasUtil_obj::sync(sourceImage,false);
HXLINE( 127)		 ::Dynamic _hx_tmp17 = sourceImage->buffer->get_src();
HXDLIN( 127)		Bool _hx_tmp18 = hx::IsNotNull( _hx_tmp17 );
HXDLIN( 127)		if (_hx_tmp18) {
HXLINE( 129)			 ::Dynamic _hx_tmp19 =  ::Dynamic(image->buffer->_hx___srcContext->__Field(HX_("drawImage",b7,54,74,85),hx::paccDynamic));
HXDLIN( 129)			 ::Dynamic _hx_tmp20 = sourceImage->buffer->get_src();
HXDLIN( 129)			Float _hx_tmp21 = (sourceRect->x + sourceImage->offsetX);
HXDLIN( 129)			Int _hx_tmp22 = ::Std_obj::_hx_int(_hx_tmp21);
HXDLIN( 129)			Float _hx_tmp23 = (sourceRect->y + sourceImage->offsetY);
HXDLIN( 129)			Int _hx_tmp24 = ::Std_obj::_hx_int(_hx_tmp23);
HXDLIN( 129)			Int _hx_tmp25 = ::Std_obj::_hx_int(sourceRect->width);
HXDLIN( 129)			Int _hx_tmp26 = ::Std_obj::_hx_int(sourceRect->height);
HXDLIN( 129)			Float _hx_tmp27 = (destPoint->x + image->offsetX);
HXDLIN( 129)			Int _hx_tmp28 = ::Std_obj::_hx_int(_hx_tmp27);
HXDLIN( 129)			Float _hx_tmp29 = (destPoint->y + image->offsetY);
HXDLIN( 129)			Int _hx_tmp30 = ::Std_obj::_hx_int(_hx_tmp29);
HXDLIN( 129)			Int _hx_tmp31 = ::Std_obj::_hx_int(sourceRect->width);
HXDLIN( 129)			Int _hx_tmp32 = ::Std_obj::_hx_int(sourceRect->height);
HXDLIN( 129)			_hx_tmp19(_hx_tmp20,_hx_tmp22,_hx_tmp24,_hx_tmp25,_hx_tmp26,_hx_tmp28,_hx_tmp30,_hx_tmp31,_hx_tmp32);
            		}
            	}
...
HXLINE( 200)		::lime::graphics::utils::ImageCanvasUtil_obj::sync(image,true);
...
HXDLIN( 204)			Bool _hx_tmp4 = image->get_transparent();
...
HXLINE( 220)			Bool _hx_tmp5 = image->get_transparent();
...
HXLINE( 227)			Bool _hx_tmp6 = image->get_transparent();
...
HXLINE( 232)		 ::Dynamic _hx_tmp7 =  ::Dynamic(image->buffer->_hx___srcContext->__Field(HX_("fillRect",47,45,b9,6c),hx::paccDynamic));
HXDLIN( 232)		Float _hx_tmp8 = (rect->x + image->offsetX);
HXDLIN( 232)		Float _hx_tmp9 = (rect->y + image->offsetY);
HXDLIN( 232)		Float _hx_tmp10 = (rect->width + image->offsetX);
HXDLIN( 232)		Float _hx_tmp11 = (rect->height + image->offsetY);
HXDLIN( 232)		_hx_tmp7(_hx_tmp8,_hx_tmp9,_hx_tmp10,_hx_tmp11);
            	}
...
HXLINE( 240)		::lime::graphics::utils::ImageCanvasUtil_obj::createImageData(image);
...
HXLINE( 250)		::lime::graphics::utils::ImageCanvasUtil_obj::createImageData(image);
...
HXLINE( 260)		::lime::graphics::utils::ImageCanvasUtil_obj::createImageData(image);
...
HXLINE( 270)		::lime::graphics::utils::ImageCanvasUtil_obj::createImageData(image);
...
HXLINE( 280)		::lime::graphics::utils::ImageCanvasUtil_obj::createImageData(sourceImage);
HXLINE( 281)		::lime::graphics::utils::ImageCanvasUtil_obj::convertToCanvas(image);
HXLINE( 282)		::lime::graphics::utils::ImageCanvasUtil_obj::createImageData(image);
...
HXLINE( 293)		Bool _hx_tmp = hx::IsNull( buffer->_hx___srcCanvas );
HXDLIN( 293)		if (_hx_tmp) {
HXLINE( 295)			::lime::graphics::utils::ImageCanvasUtil_obj::createCanvas(image,newWidth,newHeight);
HXLINE( 296)			 ::Dynamic _hx_tmp1 =  ::Dynamic(buffer->_hx___srcContext->__Field(HX_("drawImage",b7,54,74,85),hx::paccDynamic));
HXDLIN( 296)			 ::Dynamic _hx_tmp2 = buffer->get_src();
HXDLIN( 296)			_hx_tmp1(_hx_tmp2,(int)0,(int)0,newWidth,newHeight);
            		}
            		else {
HXLINE( 300)			::lime::graphics::utils::ImageCanvasUtil_obj::sync(image,true);
HXLINE( 301)			HX_VARI(  ::Dynamic,sourceCanvas) = buffer->_hx___srcCanvas;
HXLINE( 302)			buffer->_hx___srcCanvas = null();
HXLINE( 303)			::lime::graphics::utils::ImageCanvasUtil_obj::createCanvas(image,newWidth,newHeight);
HXLINE( 304)			 ::Dynamic(buffer->_hx___srcContext->__Field(HX_("drawImage",b7,54,74,85),hx::paccDynamic))(sourceCanvas,(int)0,(int)0,newWidth,newHeight);
            		}
            	}
...
HXLINE( 316)		::lime::graphics::utils::ImageCanvasUtil_obj::sync(image,true);
HXLINE( 318)		 ::Dynamic(image->buffer->_hx___srcContext->__Field(HX_("clearRect",51,35,68,bf),hx::paccDynamic))(x,y,image->width,image->height);
HXLINE( 319)		 ::Dynamic(image->buffer->_hx___srcContext->__Field(HX_("drawImage",b7,54,74,85),hx::paccDynamic))(image->buffer->_hx___srcCanvas,x,y);
            	}
...
HXLINE( 327)		::lime::graphics::utils::ImageCanvasUtil_obj::createImageData(image);
...
HXLINE( 337)		::lime::graphics::utils::ImageCanvasUtil_obj::createImageData(image);
...
HXLINE( 347)		::lime::graphics::utils::ImageCanvasUtil_obj::createImageData(image);
