...
HXLINE(1304)		this->image = image;
HXLINE(1306)		Bool _hx_tmp = hx::IsNull( rect );
HXDLIN(1306)		if (_hx_tmp) {
HXLINE(1308)			this->rect = image->get_rect();
            		}
            		else {
HXLINE(1312)			Bool _hx_tmp1 = (rect->x < (int)0);
HXDLIN(1312)			if (_hx_tmp1) {
HXLINE(1312)				rect->x = (int)0;
            			}
HXLINE(1313)			Bool _hx_tmp2 = (rect->y < (int)0);
HXDLIN(1313)			if (_hx_tmp2) {
HXLINE(1313)				rect->y = (int)0;
            			}
HXLINE(1314)			Bool _hx_tmp3 = ((rect->x + rect->width) > image->width);
HXDLIN(1314)			if (_hx_tmp3) {
HXLINE(1314)				rect->width = (image->width - rect->x);
            			}
HXLINE(1315)			Bool _hx_tmp4 = ((rect->y + rect->height) > image->height);
HXDLIN(1315)			if (_hx_tmp4) {
HXLINE(1315)				rect->height = (image->height - rect->y);
            			}
HXLINE(1316)			Bool _hx_tmp5 = (rect->width < (int)0);
HXDLIN(1316)			if (_hx_tmp5) {
HXLINE(1316)				rect->width = (int)0;
            			}
HXLINE(1317)			Bool _hx_tmp6 = (rect->height < (int)0);
HXDLIN(1317)			if (_hx_tmp6) {
HXLINE(1317)				rect->height = (int)0;
            			}
HXLINE(1318)			this->rect = rect;
            		}
HXLINE(1322)		this->stride = image->buffer->get_stride();
HXLINE(1324)		this->x = ::Math_obj::ceil(this->rect->x);
HXLINE(1325)		this->y = ::Math_obj::ceil(this->rect->y);
HXLINE(1326)		this->width = ::Math_obj::floor(this->rect->width);
HXLINE(1327)		this->height = ::Math_obj::floor(this->rect->height);
HXLINE(1328)		Int _hx_tmp7 = (this->stride * (this->y + image->offsetY));
HXDLIN(1328)		Int _hx_tmp8 = ((this->x + image->offsetX) * (int)4);
HXDLIN(1328)		this->offset = (_hx_tmp7 + _hx_tmp8);
            	}
...
HXLINE(1335)		this->rect->_hx___contract(x,y,width,height);
HXLINE(1337)		this->x = ::Math_obj::ceil(this->rect->x);
HXLINE(1338)		this->y = ::Math_obj::ceil(this->rect->y);
HXLINE(1339)		this->width = ::Math_obj::floor(this->rect->width);
HXLINE(1340)		this->height = ::Math_obj::floor(this->rect->height);
HXLINE(1341)		Int _hx_tmp = (this->stride * (this->y + this->image->offsetY));
HXDLIN(1341)		Int _hx_tmp1 = ((this->x + this->image->offsetX) * (int)4);
HXDLIN(1341)		this->offset = (_hx_tmp + _hx_tmp1);
            	}
...
Int ImageDataView_obj::row(Int y){
            	HX_STACK_FRAME("lime.graphics.utils._ImageDataUtil.ImageDataView","row",0xaa078a77,"lime.graphics.utils._ImageDataUtil.ImageDataView.row","lime/graphics/utils/ImageDataUtil.hx",1348,0x494d921f)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(y,"y")
HXLINE(1348)		return (this->offset + (this->stride * y));
            	}
