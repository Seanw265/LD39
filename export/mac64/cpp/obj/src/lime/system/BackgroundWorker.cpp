...
void BackgroundWorker_obj::__construct(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  26)		this->onProgress =  ::lime::app::Event_Dynamic_Void_obj::__new();
HXLINE(  25)		this->onError =  ::lime::app::Event_Dynamic_Void_obj::__new();
HXLINE(  24)		this->onComplete =  ::lime::app::Event_Dynamic_Void_obj::__new();
HXLINE(  23)		this->doWork =  ::lime::app::Event_Dynamic_Void_obj::__new();
            	}
