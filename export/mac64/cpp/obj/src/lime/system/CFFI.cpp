...
HXLINE(  99)			Bool _hx_tmp2 = ::lime::_hx_system::CFFI_obj::_hx___moduleNames->exists(library);
HXDLIN(  99)			if (_hx_tmp2) {
HXLINE( 102)				return ::cpp::Lib_obj::load(( (::String)(::lime::_hx_system::CFFI_obj::_hx___moduleNames->get(library)) ),method,args);
            			}
HXLINE( 127)			::lime::_hx_system::CFFI_obj::_hx___moduleNames->set(library,library);
HXLINE( 129)			result = ::lime::_hx_system::CFFI_obj::_hx___tryLoad((HX_("./",41,28,00,00) + library),library,method,args);
HXLINE( 131)			Bool _hx_tmp3 = hx::IsNull( result );
HXDLIN( 131)			if (_hx_tmp3) {
HXLINE( 133)				result = ::lime::_hx_system::CFFI_obj::_hx___tryLoad((HX_(".\\",6e,28,00,00) + library),library,method,args);
            			}
HXLINE( 137)			Bool _hx_tmp4 = hx::IsNull( result );
HXDLIN( 137)			if (_hx_tmp4) {
HXLINE( 139)				result = ::lime::_hx_system::CFFI_obj::_hx___tryLoad(library,library,method,args);
            			}
HXLINE( 143)			Bool _hx_tmp5 = hx::IsNull( result );
HXDLIN( 143)			if (_hx_tmp5) {
HXLINE( 145)				HX_VAR( ::String,slash);
HXDLIN( 145)				::String _hx_tmp6 = ::lime::_hx_system::CFFI_obj::_hx___sysName().substr((int)7,null()).toLowerCase();
HXDLIN( 145)				if ((_hx_tmp6 == HX_("windows",83,de,74,e8))) {
HXLINE( 145)					slash = HX_("\\",5c,00,00,00);
            				}
            				else {
HXLINE( 145)					slash = HX_("/",2f,00,00,00);
            				}
HXLINE( 146)				HX_VARI( ::String,haxelib) = ::lime::_hx_system::CFFI_obj::_hx___findHaxelib(HX_("lime",15,17,b3,47));
HXLINE( 148)				if ((haxelib != HX_("",00,00,00,00))) {
HXLINE( 150)					::String _hx_tmp7 = (((haxelib + slash) + HX_("ndll",36,b8,01,49)) + slash);
HXDLIN( 150)					::String _hx_tmp8 = ::lime::_hx_system::CFFI_obj::_hx___sysName();
HXDLIN( 150)					result = ::lime::_hx_system::CFFI_obj::_hx___tryLoad((((_hx_tmp7 + _hx_tmp8) + slash) + library),library,method,args);
HXLINE( 152)					Bool _hx_tmp9 = hx::IsNull( result );
HXDLIN( 152)					if (_hx_tmp9) {
HXLINE( 154)						::String _hx_tmp10 = (((haxelib + slash) + HX_("ndll",36,b8,01,49)) + slash);
HXDLIN( 154)						::String _hx_tmp11 = ::lime::_hx_system::CFFI_obj::_hx___sysName();
HXDLIN( 154)						result = ::lime::_hx_system::CFFI_obj::_hx___tryLoad(((((_hx_tmp10 + _hx_tmp11) + HX_("64",3e,2f,00,00)) + slash) + library),library,method,args);
            					}
            				}
            			}
HXLINE( 162)			::String _hx_tmp12 = ::Std_obj::string(result);
HXDLIN( 162)			::lime::_hx_system::CFFI_obj::_hx___loaderTrace((HX_("Result : ",e9,19,2c,14) + _hx_tmp12));
            		}
...
HXLINE( 209)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 211)			HX_VARI(  ::sys::io::Process,proc) =  ::sys::io::Process_obj::__new(HX_("haxelib",df,b6,80,08),::Array_obj< ::String >::__new(2)->init(0,HX_("path",a5,e5,51,4a))->init(1,library));
HXLINE( 213)			Bool _hx_tmp = hx::IsNotNull( proc );
...
HXLINE( 223)						::String _hx_tmp1 = s.substr((int)0,(int)1);
HXDLIN( 223)						if ((_hx_tmp1 != HX_("-",2d,00,00,00))) {
...
HXLINE( 254)		HX_VARI(  ::Dynamic,get_env) = ::cpp::Lib_obj::load(HX_("std",a3,a8,57,00),HX_("get_env",84,cc,c1,26),(int)1);
HXLINE( 255)		 ::Dynamic _hx_tmp = get_env(HX_("OPENFL_LOAD_DEBUG",a9,1b,ff,9b));
HXDLIN( 255)		HX_VARI( Bool,debug) = hx::IsNotNull( _hx_tmp );
HXLINE( 260)		if (debug) {
...
HXLINE( 327)		HX_VARI(  ::Dynamic,sys_string) = ::cpp::Lib_obj::load(HX_("std",a3,a8,57,00),HX_("sys_string",03,f9,de,46),(int)0);
...
HXLINE( 355)			Bool _hx_tmp = hx::IsNotNull( result );
