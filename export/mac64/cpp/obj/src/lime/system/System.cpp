...
HXLINE( 128)		Bool _hx_tmp = hx::IsNotNull( ::lime::app::Application_obj::current );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(System_obj,exit,(void))
 ...
 ::lime::_hx_system::Display System_obj::getDisplay(Int id){
            	...
            	HX_STACK_ARG(id,"id")
HXLINE( 152)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_hx_system::System_obj::cffi_lime_system_get_display(id)) );
HXDLIN( 152)		HX_VARI(  ::Dynamic,displayInfo) = Dynamic(hx::DynamicPtr(inVal));
HXLINE( 154)		Bool _hx_tmp = hx::IsNotNull( displayInfo );
HXDLIN( 154)		if (_hx_tmp) {
HXLINE( 156)			HX_VARI(  ::lime::_hx_system::Display,display) =  ::lime::_hx_system::Display_obj::__new();
HXLINE( 157)			display->id = id;
HXLINE( 158)			display->name =  ::Dynamic(displayInfo->__Field(HX_("name",4b,72,ff,48),hx::paccDynamic));
HXLINE( 159)			display->bounds =  ::lime::math::Rectangle_obj::__new( ::Dynamic( ::Dynamic(displayInfo->__Field(HX_("bounds",75,86,1d,66),hx::paccDynamic))->__Field(HX_("x",78,00,00,00),hx::paccDynamic)), ::Dynamic( ::Dynamic(displayInfo->__Field(HX_("bounds",75,86,1d,66),hx::paccDynamic))->__Field(HX_("y",79,00,00,00),hx::paccDynamic)), ::Dynamic( ::Dynamic(displayInfo->__Field(HX_("bounds",75,86,1d,66),hx::paccDynamic))->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic)), ::Dynamic( ::Dynamic(displayInfo->__Field(HX_("bounds",75,86,1d,66),hx::paccDynamic))->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic)));
HXLINE( 160)			display->dpi =  ::Dynamic(displayInfo->__Field(HX_("dpi",5d,43,4c,00),hx::paccDynamic));
...
HXLINE( 212)		return ( (Int)(::lime::_hx_system::System_obj::cffi_lime_system_get_timer()) );
            	}
...
Bool lazy = __o_lazy.Default(false);
            	HX_STACK_FRAME("lime.system.System","load",0x1dbaa99f,"lime.system.System.load","lime/system/System.hx",227,0x6434b429)
...
HXLINE( 245)		return ( (Bool)(::lime::_hx_system::System_obj::cffi_lime_system_get_allow_screen_timeout()) );
            	}
...
HXLINE( 256)		return ( (Bool)(::lime::_hx_system::System_obj::cffi_lime_system_set_allow_screen_timeout(value)) );
            	}
...
HXLINE( 267)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_hx_system::System_obj::cffi_lime_system_get_directory((int)0,null(),null())) );
HXDLIN( 267)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE( 287)		HX_VARI( ::String,company) = HX_("MyCompany",11,c3,2e,cc);
HXLINE( 288)		HX_VARI( ::String,file) = HX_("MyApplication",24,d3,d1,1c);
HXLINE( 290)		Bool _hx_tmp;
HXDLIN( 290)		Bool _hx_tmp1 = hx::IsNotNull( ::lime::app::Application_obj::current );
...
HXLINE( 292)			Bool _hx_tmp2 = hx::IsNotNull( ( (::String)(::lime::app::Application_obj::current->config->__Field(HX_("company",3d,15,69,83),hx::paccDynamic)) ) );
HXDLIN( 292)			if (_hx_tmp2) {
HXLINE( 294)				company = ( (::String)(::lime::app::Application_obj::current->config->__Field(HX_("company",3d,15,69,83),hx::paccDynamic)) );
            			}
HXLINE( 298)			Bool _hx_tmp3 = hx::IsNotNull( ( (::String)(::lime::app::Application_obj::current->config->__Field(HX_("file",7c,ce,bb,43),hx::paccDynamic)) ) );
HXDLIN( 298)			if (_hx_tmp3) {
HXLINE( 300)				file = ( (::String)(::lime::app::Application_obj::current->config->__Field(HX_("file",7c,ce,bb,43),hx::paccDynamic)) );
            			}
            		}
HXLINE( 307)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_hx_system::System_obj::cffi_lime_system_get_directory((int)1,company,file)) );
...
HXLINE( 328)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_hx_system::System_obj::cffi_lime_system_get_directory((int)2,null(),null())) );
HXDLIN( 328)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE( 349)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_hx_system::System_obj::cffi_lime_system_get_directory((int)3,null(),null())) );
HXDLIN( 349)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE( 370)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_hx_system::System_obj::cffi_lime_system_get_directory((int)4,null(),null())) );
HXDLIN( 370)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE( 381)		return ( (Int)(::lime::_hx_system::System_obj::cffi_lime_system_get_num_displays()) );
            	}
...
HXLINE( 392)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_hx_system::System_obj::cffi_lime_system_get_directory((int)5,null(),null())) );
HXDLIN( 392)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE( 431)		return ( (Bool)(::lime::_hx_system::System_obj::cffi_lime_system_get_allow_screen_timeout()) );
            	}
...
Bool System_obj::lime_system_set_allow_screen_timeout(Bool value){
            	...
            	HX_STACK_ARG(value,"value")
HXLINE( 432)		return ( (Bool)(::lime::_hx_system::System_obj::cffi_lime_system_set_allow_screen_timeout(value)) );
            	}
...
HXLINE( 433)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_hx_system::System_obj::cffi_lime_system_get_directory(type,company,title)) );
...
HXLINE( 434)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::_hx_system::System_obj::cffi_lime_system_get_display(index)) );
HXDLIN( 434)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE( 435)		return ( (Int)(::lime::_hx_system::System_obj::cffi_lime_system_get_num_displays()) );
            	}
...
HXLINE( 436)		return ( (Float)(::lime::_hx_system::System_obj::cffi_lime_system_get_timer()) );
            	}
...
{
{
            	HX_STACK_FRAME("lime.system.System","boot",0x171e93ab,"lime.system.System.boot","lime/system/System.hx",431,0x6434b429)
HXLINE( 431)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_system_get_allow_screen_timeout",73,89,73,7a),HX_("b",62,00,00,00),false);
HXDLIN( 431)		cffi_lime_system_get_allow_screen_timeout = inValue;
            	}
{
            	HX_STACK_FRAME("lime.system.System","boot",0x171e93ab,"lime.system.System.boot","lime/system/System.hx",432,0x6434b429)
HXLINE( 432)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_system_set_allow_screen_timeout",e7,0a,4e,8d),HX_("bb",c0,55,00,00),false);
HXDLIN( 432)		cffi_lime_system_set_allow_screen_timeout = inValue;
            	}
{
            	HX_STACK_FRAME("lime.system.System","boot",0x171e93ab,"lime.system.System.boot","lime/system/System.hx",433,0x6434b429)
HXLINE( 433)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_system_get_directory",5e,9e,04,7c),HX_("isso",06,0f,bf,45),false);
HXDLIN( 433)		cffi_lime_system_get_directory = inValue;
            	}
{
            	HX_STACK_FRAME("lime.system.System","boot",0x171e93ab,"lime.system.System.boot","lime/system/System.hx",434,0x6434b429)
HXLINE( 434)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_system_get_display",f3,47,82,d2),HX_("io",e6,5b,00,00),false);
HXDLIN( 434)		cffi_lime_system_get_display = inValue;
            	}
{
            	HX_STACK_FRAME("lime.system.System","boot",0x171e93ab,"lime.system.System.boot","lime/system/System.hx",435,0x6434b429)
HXLINE( 435)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_system_get_num_displays",f9,90,37,4f),HX_("i",69,00,00,00),false);
HXDLIN( 435)		cffi_lime_system_get_num_displays = inValue;
            	}
{
            	HX_STACK_FRAME("lime.system.System","boot",0x171e93ab,"lime.system.System.boot","lime/system/System.hx",436,0x6434b429)
HXLINE( 436)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_system_get_timer",36,5f,72,67),HX_("d",64,00,00,00),false);
HXDLIN( 436)		cffi_lime_system_get_timer = inValue;
            	}
}
