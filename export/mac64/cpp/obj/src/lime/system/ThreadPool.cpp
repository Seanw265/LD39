...
HXLINE(  25)		this->onProgress =  ::lime::app::Event_Dynamic_Void_obj::__new();
HXLINE(  24)		this->onError =  ::lime::app::Event_Dynamic_Void_obj::__new();
HXLINE(  23)		this->onComplete =  ::lime::app::Event_Dynamic_Void_obj::__new();
HXLINE(  20)		this->doWork =  ::lime::app::Event_Dynamic_Void_obj::__new();
