...
HXLINE( 115)		 ::Dynamic handle = this->src;
HXDLIN( 115)		return ( (Int)(::lime::text::Font_obj::cffi_lime_font_get_glyph_index(hx::DynamicPtr(handle),character)) );
            	}
...
HXLINE( 126)		 ::Dynamic handle = this->src;
HXDLIN( 126)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::text::Font_obj::cffi_lime_font_get_glyph_indices(hx::DynamicPtr(handle),characters)) );
HXDLIN( 126)		HX_VARI(  ::Dynamic,glyphs) = Dynamic(hx::DynamicPtr(inVal));
...
HXLINE( 138)		 ::Dynamic handle = this->src;
HXDLIN( 138)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::text::Font_obj::cffi_lime_font_get_glyph_metrics(hx::DynamicPtr(handle),glyph)) );
HXDLIN( 138)		HX_VARI(  ::Dynamic,value) = Dynamic(hx::DynamicPtr(inVal));
HXLINE( 139)		HX_VARI(  ::lime::text::GlyphMetrics,metrics) =  ::lime::text::GlyphMetrics_obj::__new();
HXLINE( 141)		metrics->advance =  ::lime::math::Vector2_obj::__new( ::Dynamic(value->__Field(HX_("horizontalAdvance",fe,57,3e,ce),hx::paccDynamic)), ::Dynamic(value->__Field(HX_("verticalAdvance",ac,8e,f7,57),hx::paccDynamic)));
HXLINE( 142)		metrics->height =  ::Dynamic(value->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic));
HXLINE( 143)		metrics->horizontalBearing =  ::lime::math::Vector2_obj::__new( ::Dynamic(value->__Field(HX_("horizontalBearingX",ae,21,22,6c),hx::paccDynamic)), ::Dynamic(value->__Field(HX_("horizontalBearingY",af,21,22,6c),hx::paccDynamic)));
HXLINE( 144)		metrics->verticalBearing =  ::lime::math::Vector2_obj::__new( ::Dynamic(value->__Field(HX_("verticalBearingX",40,c3,78,64),hx::paccDynamic)), ::Dynamic(value->__Field(HX_("verticalBearingY",41,c3,78,64),hx::paccDynamic)));
...
HXLINE( 158)		this->_hx___setSize(fontSize);
HXLINE( 160)		HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::io::Bytes_obj::alloc((int)0);
HXLINE( 165)		 ::Dynamic handle = this->src;
HXDLIN( 165)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(handle);
HXDLIN( 165)		Bool _hx_tmp1 = ( (Bool)(::lime::text::Font_obj::cffi_lime_font_render_glyph(_hx_tmp,glyph,hx::DynamicPtr(bytes))) );
HXDLIN( 165)		if (_hx_tmp1) {
HXLINE( 168)			HX_VARI( Int,width) = ((int)((int)((int)bytes->b->__get((int)4) | (int)((int)bytes->b->__get((int)5) << (int)(int)8)) | (int)((int)bytes->b->__get((int)6) << (int)(int)16)) | (int)((int)bytes->b->__get((int)7) << (int)(int)24));
HXLINE( 169)			HX_VARI( Int,height) = ((int)((int)((int)bytes->b->__get((int)8) | (int)((int)bytes->b->__get((int)9) << (int)(int)8)) | (int)((int)bytes->b->__get((int)10) << (int)(int)16)) | (int)((int)bytes->b->__get((int)11) << (int)(int)24));
HXLINE( 170)			HX_VARI( Int,x) = ((int)((int)((int)bytes->b->__get((int)12) | (int)((int)bytes->b->__get((int)13) << (int)(int)8)) | (int)((int)bytes->b->__get((int)14) << (int)(int)16)) | (int)((int)bytes->b->__get((int)15) << (int)(int)24));
HXLINE( 171)			HX_VARI( Int,y) = ((int)((int)((int)bytes->b->__get((int)16) | (int)((int)bytes->b->__get((int)17) << (int)(int)8)) | (int)((int)bytes->b->__get((int)18) << (int)(int)16)) | (int)((int)bytes->b->__get((int)19) << (int)(int)24));
HXLINE( 173)			HX_VARI(  ::haxe::io::Bytes,data) = bytes->sub((int)20,(width * height));
HXLINE( 176)			HX_VAR_NAME(  ::lime::utils::ArrayBufferView,this1,"this");
HXDLIN( 176)			Bool _hx_tmp2 = hx::IsNotNull( data );
HXDLIN( 176)			if (_hx_tmp2) {
HXLINE( 176)				HX_VARI(  ::lime::utils::ArrayBufferView,_this) =  ::lime::utils::ArrayBufferView_obj::__new((int)0,(int)4);
HXDLIN( 176)				if ((hx::Mod((int)0,_this->bytesPerElement) != (int)0)) {
HXLINE( 176)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 176)				HX_VARI( Int,bufferByteLength) = data->length;
HXDLIN( 176)				{
HXLINE( 176)					if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 176)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
HXDLIN( 176)					if ((bufferByteLength < (int)0)) {
HXLINE( 176)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
            				}
HXDLIN( 176)				_this->buffer = data;
HXDLIN( 176)				_this->byteOffset = (int)0;
HXDLIN( 176)				_this->byteLength = bufferByteLength;
HXDLIN( 176)				Float _hx_tmp3 = ((Float)bufferByteLength / (Float)_this->bytesPerElement);
HXDLIN( 176)				_this->length = ::Std_obj::_hx_int(_hx_tmp3);
HXDLIN( 176)				this1 = _this;
            			}
            			else {
HXLINE( 176)				HX_STACK_DO_THROW(HX_("Invalid constructor arguments for Uint8Array",8b,64,02,e4));
            			}
HXDLIN( 176)			HX_VARI(  ::lime::graphics::ImageBuffer,buffer) =  ::lime::graphics::ImageBuffer_obj::__new(this1,width,height,(int)1,null());
HXLINE( 177)			HX_VARI(  ::lime::graphics::Image,image) =  ::lime::graphics::Image_obj::__new(buffer,(int)0,(int)0,width,height,null(),null());
HXLINE( 178)			image->x = x;
HXLINE( 179)			image->y = y;
...
HXLINE( 364)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::text::Font_obj::cffi_lime_font_load(hx::DynamicPtr(bytes))) );
HXDLIN( 364)		 ::Dynamic _hx_tmp = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 364)		this->src = _hx_tmp;
HXLINE( 366)		Bool _hx_tmp1;
HXDLIN( 366)		Bool _hx_tmp2 = hx::IsNotNull( this->src );
HXDLIN( 366)		if (_hx_tmp2) {
HXLINE( 366)			_hx_tmp1 = hx::IsNull( this->name );
            		}
            		else {
HXLINE( 366)			_hx_tmp1 = false;
            		}
HXDLIN( 366)		if (_hx_tmp1) {
HXLINE( 368)			 ::Dynamic handle = this->src;
HXDLIN( 368)			 ::hx::Object * inVal1 = ( ( ::hx::Object *)(::lime::text::Font_obj::cffi_lime_font_get_family_name(hx::DynamicPtr(handle))) );
HXDLIN( 368)			 ::Dynamic _hx_tmp3 = Dynamic(hx::DynamicPtr(inVal1));
HXDLIN( 368)			this->name = ( (::String)(_hx_tmp3) );
            		}
            	}
...
HXLINE( 385)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::text::Font_obj::cffi_lime_font_load(hx::DynamicPtr(this->_hx___fontPath))) );
HXDLIN( 385)		 ::Dynamic _hx_tmp = Dynamic(hx::DynamicPtr(inVal));
HXDLIN( 385)		this->src = _hx_tmp;
HXLINE( 387)		Bool _hx_tmp1;
HXDLIN( 387)		Bool _hx_tmp2 = hx::IsNotNull( this->src );
...
HXLINE( 389)			 ::Dynamic handle = this->src;
HXDLIN( 389)			 ::hx::Object * inVal1 = ( ( ::hx::Object *)(::lime::text::Font_obj::cffi_lime_font_get_family_name(hx::DynamicPtr(handle))) );
HXDLIN( 389)			 ::Dynamic _hx_tmp3 = Dynamic(hx::DynamicPtr(inVal1));
HXDLIN( 389)			this->name = ( (::String)(_hx_tmp3) );
            		}
            	}
...
HXLINE( 401)		 ::Dynamic handle = this->src;
HXDLIN( 401)		::lime::text::Font_obj::cffi_lime_font_set_size(hx::DynamicPtr(handle),size);
            	}
...
Int Font_obj::get_ascender(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 417)		 ::Dynamic handle = this->src;
HXDLIN( 417)		return ( (Int)(::lime::text::Font_obj::cffi_lime_font_get_ascender(hx::DynamicPtr(handle))) );
            	}
...
Int Font_obj::get_descender(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 428)		 ::Dynamic handle = this->src;
HXDLIN( 428)		return ( (Int)(::lime::text::Font_obj::cffi_lime_font_get_descender(hx::DynamicPtr(handle))) );
            	}
...
Int Font_obj::get_height(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 439)		 ::Dynamic handle = this->src;
HXDLIN( 439)		return ( (Int)(::lime::text::Font_obj::cffi_lime_font_get_height(hx::DynamicPtr(handle))) );
            	}
...
Int Font_obj::get_numGlyphs(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 450)		 ::Dynamic handle = this->src;
HXDLIN( 450)		return ( (Int)(::lime::text::Font_obj::cffi_lime_font_get_num_glyphs(hx::DynamicPtr(handle))) );
            	}
...
Int Font_obj::get_underlinePosition(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 461)		 ::Dynamic handle = this->src;
HXDLIN( 461)		return ( (Int)(::lime::text::Font_obj::cffi_lime_font_get_underline_position(hx::DynamicPtr(handle))) );
            	}
...
Int Font_obj::get_underlineThickness(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 472)		 ::Dynamic handle = this->src;
HXDLIN( 472)		return ( (Int)(::lime::text::Font_obj::cffi_lime_font_get_underline_thickness(hx::DynamicPtr(handle))) );
            	}
...
Int Font_obj::get_unitsPerEM(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 483)		 ::Dynamic handle = this->src;
HXDLIN( 483)		return ( (Int)(::lime::text::Font_obj::cffi_lime_font_get_units_per_em(hx::DynamicPtr(handle))) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Font_obj,get_unitsPerEM,return )
 ...
 ::lime::text::Font Font_obj::fromBytes( ::haxe::io::Bytes bytes){
            	...
            	HX_STACK_ARG(bytes,"bytes")
HXLINE(  86)		HX_VARI(  ::lime::text::Font,font) =  ::lime::text::Font_obj::__new(null());
HXLINE(  87)		font->_hx___fromBytes(bytes);
HXLINE(  90)		Bool _hx_tmp = hx::IsNotNull( font->src );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,fromBytes,return )
 ...
 ::lime::text::Font Font_obj::fromFile(::String path){
            	...
            	HX_STACK_ARG(path,"path")
HXLINE( 100)		HX_VARI(  ::lime::text::Font,font) =  ::lime::text::Font_obj::__new(null());
HXLINE( 101)		font->_hx___fromFile(path);
HXLINE( 104)		Bool _hx_tmp = hx::IsNotNull( font->src );
...
HXLINE( 499)		return ( (Int)(::lime::text::Font_obj::cffi_lime_font_get_ascender(hx::DynamicPtr(handle))) );
            	}
...
Int Font_obj::lime_font_get_descender( ::Dynamic handle){
            	...
            	HX_STACK_ARG(handle,"handle")
HXLINE( 500)		return ( (Int)(::lime::text::Font_obj::cffi_lime_font_get_descender(hx::DynamicPtr(handle))) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,lime_font_get_descender,return )
 ...
 ::Dynamic Font_obj::lime_font_get_family_name( ::Dynamic handle){
            	...
            	HX_STACK_ARG(handle,"handle")
HXLINE( 501)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::text::Font_obj::cffi_lime_font_get_family_name(hx::DynamicPtr(handle))) );
...
Int Font_obj::lime_font_get_glyph_index( ::Dynamic handle,::String character){
            	...
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(character,"character")
HXLINE( 502)		return ( (Int)(::lime::text::Font_obj::cffi_lime_font_get_glyph_index(hx::DynamicPtr(handle),character)) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Font_obj,lime_font_get_glyph_index,return )
 ...
 ::Dynamic Font_obj::lime_font_get_glyph_indices( ::Dynamic handle,::String characters){
            	...
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(characters,"characters")
HXLINE( 503)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::text::Font_obj::cffi_lime_font_get_glyph_indices(hx::DynamicPtr(handle),characters)) );
HXDLIN( 503)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
HXLINE( 504)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::text::Font_obj::cffi_lime_font_get_glyph_metrics(hx::DynamicPtr(handle),index)) );
...
Int Font_obj::lime_font_get_height( ::Dynamic handle){
            	...
            	HX_STACK_ARG(handle,"handle")
HXLINE( 505)		return ( (Int)(::lime::text::Font_obj::cffi_lime_font_get_height(hx::DynamicPtr(handle))) );
            	}
...
Int Font_obj::lime_font_get_num_glyphs( ::Dynamic handle){
            	...
            	HX_STACK_ARG(handle,"handle")
HXLINE( 506)		return ( (Int)(::lime::text::Font_obj::cffi_lime_font_get_num_glyphs(hx::DynamicPtr(handle))) );
            	}
...
Int Font_obj::lime_font_get_underline_position( ::Dynamic handle){
            	...
            	HX_STACK_ARG(handle,"handle")
HXLINE( 507)		return ( (Int)(::lime::text::Font_obj::cffi_lime_font_get_underline_position(hx::DynamicPtr(handle))) );
            	}
...
Int Font_obj::lime_font_get_underline_thickness( ::Dynamic handle){
            	...
            	HX_STACK_ARG(handle,"handle")
HXLINE( 508)		return ( (Int)(::lime::text::Font_obj::cffi_lime_font_get_underline_thickness(hx::DynamicPtr(handle))) );
            	}
...
Int Font_obj::lime_font_get_units_per_em( ::Dynamic handle){
            	...
            	HX_STACK_ARG(handle,"handle")
HXLINE( 509)		return ( (Int)(::lime::text::Font_obj::cffi_lime_font_get_units_per_em(hx::DynamicPtr(handle))) );
            	}
...
HXLINE( 510)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::text::Font_obj::cffi_lime_font_load(hx::DynamicPtr(data))) );
HXDLIN( 510)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,lime_font_load,return )
 ...
 ::Dynamic Font_obj::lime_font_outline_decompose( ::Dynamic handle,Int size){
            	...
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(size,"size")
HXLINE( 511)		 ::hx::Object * inVal = ( ( ::hx::Object *)(::lime::text::Font_obj::cffi_lime_font_outline_decompose(hx::DynamicPtr(handle),size)) );
HXDLIN( 511)		return Dynamic(hx::DynamicPtr(inVal));
            	}
...
Bool Font_obj::lime_font_render_glyph( ::Dynamic handle,Int index, ::Dynamic data){
            	...
            	HX_STACK_ARG(index,"index")
            	HX_STACK_ARG(data,"data")
HXLINE( 512)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(handle);
HXDLIN( 512)		return ( (Bool)(::lime::text::Font_obj::cffi_lime_font_render_glyph(_hx_tmp,index,hx::DynamicPtr(data))) );
            	}
...
Bool Font_obj::lime_font_render_glyphs( ::Dynamic handle, ::Dynamic indices, ::Dynamic data){
            	...
            	HX_STACK_ARG(data,"data")
HXLINE( 513)		 ::hx::Object * _hx_tmp = hx::DynamicPtr(handle);
HXDLIN( 513)		 ::hx::Object * _hx_tmp1 = hx::DynamicPtr(indices);
HXDLIN( 513)		return ( (Bool)(::lime::text::Font_obj::cffi_lime_font_render_glyphs(_hx_tmp,_hx_tmp1,hx::DynamicPtr(data))) );
            	}
...
void Font_obj::lime_font_set_size( ::Dynamic handle,Int size){
            	...
            	HX_STACK_ARG(handle,"handle")
            	HX_STACK_ARG(size,"size")
HXLINE( 514)		::lime::text::Font_obj::cffi_lime_font_set_size(hx::DynamicPtr(handle),size);
            	}
...
{
{
            	HX_STACK_FRAME("lime.text.Font","boot",0xc0f4f549,"lime.text.Font.boot","lime/text/Font.hx",499,0x3be57807)
HXLINE( 499)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_font_get_ascender",06,f1,b5,57),HX_("oi",1a,61,00,00),false);
HXDLIN( 499)		cffi_lime_font_get_ascender = inValue;
            	}
{
            	HX_STACK_FRAME("lime.text.Font","boot",0xc0f4f549,"lime.text.Font.boot","lime/text/Font.hx",500,0x3be57807)
HXLINE( 500)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_font_get_descender",68,c1,2f,64),HX_("oi",1a,61,00,00),false);
HXDLIN( 500)		cffi_lime_font_get_descender = inValue;
            	}
{
            	HX_STACK_FRAME("lime.text.Font","boot",0xc0f4f549,"lime.text.Font.boot","lime/text/Font.hx",501,0x3be57807)
HXLINE( 501)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_font_get_family_name",97,ce,b2,b4),HX_("oo",20,61,00,00),false);
HXDLIN( 501)		cffi_lime_font_get_family_name = inValue;
            	}
{
            	HX_STACK_FRAME("lime.text.Font","boot",0xc0f4f549,"lime.text.Font.boot","lime/text/Font.hx",502,0x3be57807)
HXLINE( 502)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_font_get_glyph_index",90,3b,dd,a2),HX_("osi",c5,9e,54,00),false);
HXDLIN( 502)		cffi_lime_font_get_glyph_index = inValue;
            	}
{
            	HX_STACK_FRAME("lime.text.Font","boot",0xc0f4f549,"lime.text.Font.boot","lime/text/Font.hx",503,0x3be57807)
HXLINE( 503)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_font_get_glyph_indices",25,83,e4,03),HX_("oso",cb,9e,54,00),false);
HXDLIN( 503)		cffi_lime_font_get_glyph_indices = inValue;
            	}
{
            	HX_STACK_FRAME("lime.text.Font","boot",0xc0f4f549,"lime.text.Font.boot","lime/text/Font.hx",504,0x3be57807)
HXLINE( 504)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_font_get_glyph_metrics",41,de,64,4d),HX_("oio",15,96,54,00),false);
HXDLIN( 504)		cffi_lime_font_get_glyph_metrics = inValue;
            	}
{
            	HX_STACK_FRAME("lime.text.Font","boot",0xc0f4f549,"lime.text.Font.boot","lime/text/Font.hx",505,0x3be57807)
HXLINE( 505)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_font_get_height",f6,3e,aa,fc),HX_("oi",1a,61,00,00),false);
HXDLIN( 505)		cffi_lime_font_get_height = inValue;
            	}
{
            	HX_STACK_FRAME("lime.text.Font","boot",0xc0f4f549,"lime.text.Font.boot","lime/text/Font.hx",506,0x3be57807)
HXLINE( 506)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_font_get_num_glyphs",ef,8b,e7,ad),HX_("oi",1a,61,00,00),false);
HXDLIN( 506)		cffi_lime_font_get_num_glyphs = inValue;
            	}
{
            	HX_STACK_FRAME("lime.text.Font","boot",0xc0f4f549,"lime.text.Font.boot","lime/text/Font.hx",507,0x3be57807)
HXLINE( 507)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_font_get_underline_position",0b,93,8e,28),HX_("oi",1a,61,00,00),false);
HXDLIN( 507)		cffi_lime_font_get_underline_position = inValue;
            	}
{
            	HX_STACK_FRAME("lime.text.Font","boot",0xc0f4f549,"lime.text.Font.boot","lime/text/Font.hx",508,0x3be57807)
HXLINE( 508)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_font_get_underline_thickness",d2,14,47,de),HX_("oi",1a,61,00,00),false);
HXDLIN( 508)		cffi_lime_font_get_underline_thickness = inValue;
            	}
{
            	HX_STACK_FRAME("lime.text.Font","boot",0xc0f4f549,"lime.text.Font.boot","lime/text/Font.hx",509,0x3be57807)
HXLINE( 509)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_font_get_units_per_em",29,72,55,dc),HX_("oi",1a,61,00,00),false);
HXDLIN( 509)		cffi_lime_font_get_units_per_em = inValue;
            	}
{
            	HX_STACK_FRAME("lime.text.Font","boot",0xc0f4f549,"lime.text.Font.boot","lime/text/Font.hx",510,0x3be57807)
HXLINE( 510)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_font_load",ec,08,6e,02),HX_("oo",20,61,00,00),false);
HXDLIN( 510)		cffi_lime_font_load = inValue;
            	}
{
            	HX_STACK_FRAME("lime.text.Font","boot",0xc0f4f549,"lime.text.Font.boot","lime/text/Font.hx",511,0x3be57807)
HXLINE( 511)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_font_outline_decompose",ee,da,88,55),HX_("oio",15,96,54,00),false);
HXDLIN( 511)		cffi_lime_font_outline_decompose = inValue;
            	}
{
            	HX_STACK_FRAME("lime.text.Font","boot",0xc0f4f549,"lime.text.Font.boot","lime/text/Font.hx",512,0x3be57807)
HXLINE( 512)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_font_render_glyph",89,79,39,0f),HX_("oiob",ad,bc,ae,49),false);
HXDLIN( 512)		cffi_lime_font_render_glyph = inValue;
            	}
{
            	HX_STACK_FRAME("lime.text.Font","boot",0xc0f4f549,"lime.text.Font.boot","lime/text/Font.hx",513,0x3be57807)
HXLINE( 513)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_font_render_glyphs",ca,de,10,43),HX_("ooob",33,4a,b3,49),false);
HXDLIN( 513)		cffi_lime_font_render_glyphs = inValue;
            	}
{
            	HX_STACK_FRAME("lime.text.Font","boot",0xc0f4f549,"lime.text.Font.boot","lime/text/Font.hx",514,0x3be57807)
HXLINE( 514)		 ::Dynamic inValue = ::cpp::Prime_obj::_loadPrime(HX_("lime",15,17,b3,47),HX_("lime_font_set_size",84,ff,47,dd),HX_("oiv",1c,96,54,00),false);
HXDLIN( 514)		cffi_lime_font_set_size = inValue;
            	}
}
