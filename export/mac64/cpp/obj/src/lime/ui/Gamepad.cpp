...
void Gamepad_obj::__construct(Int id){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(  26)		this->onDisconnect =  ::lime::app::Event_Void_Void_obj::__new();
HXLINE(  25)		this->onButtonUp =  ::lime::app::Event_lime_ui_GamepadButton_Void_obj::__new();
HXLINE(  24)		this->onButtonDown =  ::lime::app::Event_lime_ui_GamepadButton_Void_obj::__new();
HXLINE(  23)		this->onAxisMove =  ::lime::app::Event_lime_ui_GamepadAxis_Float_Void_obj::__new();
...
HXLINE(  17)		onConnect =  ::lime::app::Event_lime_ui_Gamepad_Void_obj::__new();
            	}
{
