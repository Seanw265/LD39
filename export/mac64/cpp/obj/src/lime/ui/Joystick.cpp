...
void Joystick_obj::__construct(Int id){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
HXLINE(  30)		this->onTrackballMove =  ::lime::app::Event_Int_Float_Void_obj::__new();
HXLINE(  29)		this->onHatMove =  ::lime::app::Event_Int_lime_ui_JoystickHatPosition_Void_obj::__new();
HXLINE(  28)		this->onDisconnect =  ::lime::app::Event_Void_Void_obj::__new();
HXLINE(  27)		this->onButtonUp =  ::lime::app::Event_Int_Void_obj::__new();
HXLINE(  26)		this->onButtonDown =  ::lime::app::Event_Int_Void_obj::__new();
HXLINE(  25)		this->onAxisMove =  ::lime::app::Event_Int_Float_Void_obj::__new();
...
HXLINE(  15)		onConnect =  ::lime::app::Event_lime_ui_Joystick_Void_obj::__new();
            	}
{
