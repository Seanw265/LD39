...
HXLINE(  55)		this->onTextInput =  ::lime::app::Event_String_Void_obj::__new();
HXLINE(  54)		this->onTextEdit =  ::lime::app::Event_String_Int_Int_Void_obj::__new();
HXLINE(  53)		this->onRestore =  ::lime::app::Event_Void_Void_obj::__new();
HXLINE(  52)		this->onResize =  ::lime::app::Event_Int_Int_Void_obj::__new();
HXLINE(  51)		this->onMove =  ::lime::app::Event_Float_Float_Void_obj::__new();
HXLINE(  50)		this->onMouseWheel =  ::lime::app::Event_Float_Float_Void_obj::__new();
HXLINE(  49)		this->onMouseUp =  ::lime::app::Event_Float_Float_Int_Void_obj::__new();
HXLINE(  48)		this->onMouseMoveRelative =  ::lime::app::Event_Float_Float_Void_obj::__new();
HXLINE(  47)		this->onMouseMove =  ::lime::app::Event_Float_Float_Void_obj::__new();
HXLINE(  46)		this->onMouseDown =  ::lime::app::Event_Float_Float_Int_Void_obj::__new();
HXLINE(  45)		this->onMinimize =  ::lime::app::Event_Void_Void_obj::__new();
HXLINE(  44)		this->onLeave =  ::lime::app::Event_Void_Void_obj::__new();
HXLINE(  43)		this->onKeyUp =  ::lime::app::Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void_obj::__new();
HXLINE(  42)		this->onKeyDown =  ::lime::app::Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void_obj::__new();
HXLINE(  41)		this->onFullscreen =  ::lime::app::Event_Void_Void_obj::__new();
HXLINE(  40)		this->onFocusOut =  ::lime::app::Event_Void_Void_obj::__new();
HXLINE(  39)		this->onFocusIn =  ::lime::app::Event_Void_Void_obj::__new();
HXLINE(  38)		this->onEnter =  ::lime::app::Event_Void_Void_obj::__new();
HXLINE(  37)		this->onDropFile =  ::lime::app::Event_String_Void_obj::__new();
HXLINE(  36)		this->onDeactivate =  ::lime::app::Event_Void_Void_obj::__new();
HXLINE(  35)		this->onCreate =  ::lime::app::Event_Void_Void_obj::__new();
HXLINE(  34)		this->onClose =  ::lime::app::Event_Void_Void_obj::__new();
HXLINE(  33)		this->onActivate =  ::lime::app::Event_Void_Void_obj::__new();
