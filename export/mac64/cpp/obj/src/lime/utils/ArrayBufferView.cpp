...
Int ArrayBufferView_obj::toByteLength(Int elemCount){
            	HX_STACK_FRAME("lime.utils.ArrayBufferView","toByteLength",0x7dea5d8f,"lime.utils.ArrayBufferView.toByteLength","lime/utils/ArrayBufferView.hx",268,0xb543acf8)
            	HX_STACK_THIS(this)
...
HXLINE( 280)		{
HXLINE( 280)			HX_VARI( Int,_g) = this->type;
HXDLIN( 280)			switch((int)(_g)){
            				case (int)0: {
...
HXLINE( 284)						{
HXLINE( 285)							Float _hx_tmp = array->__get(i);
HXLINE( 284)							HX_VARI( Int,value) = ::Std_obj::_hx_int(_hx_tmp);
HXDLIN( 284)							::__hxcpp_memory_set_byte(this->buffer->b,pos,value);
            						}
HXLINE( 286)						++i;
            					}
            				}
...
HXLINE( 292)						Float _hx_tmp1 = array->__get(i);
HXDLIN( 292)						Int _hx_tmp2 = ::Std_obj::_hx_int(_hx_tmp1);
HXLINE( 291)						::lime::utils::ArrayBufferIO_obj::setInt16(this->buffer,pos1,_hx_tmp2,null());
HXLINE( 293)						++i;
            					}
            				}
            				break;
...
HXLINE( 298)						{
HXLINE( 299)							Float _hx_tmp3 = array->__get(i);
HXLINE( 298)							HX_VARI_NAME( Int,value1,"value") = ::Std_obj::_hx_int(_hx_tmp3);
HXDLIN( 298)							::__hxcpp_memory_set_i32(this->buffer->b,pos2,value1);
            						}
HXLINE( 300)						++i;
            					}
            				}
...
HXLINE( 305)						{
HXLINE( 306)							Float _hx_tmp4 = array->__get(i);
HXLINE( 305)							HX_VARI_NAME( Int,value2,"value") = ::Std_obj::_hx_int(_hx_tmp4);
HXDLIN( 305)							::__hxcpp_memory_set_byte(this->buffer->b,pos3,value2);
            						}
HXLINE( 307)						++i;
            					}
            				}
...
HXLINE( 326)						{
HXLINE( 327)							Float _hx_tmp5 = array->__get(i);
HXLINE( 326)							Int value3 = ::Std_obj::_hx_int(_hx_tmp5);
HXDLIN( 326)							{
HXLINE( 326)								HX_VARI_NAME( Int,_hx_int,"int") = value3;
HXDLIN( 326)								Float _hx_tmp6;
HXDLIN( 326)								if ((_hx_int < (int)0)) {
HXLINE( 326)									_hx_tmp6 = (((Float)4294967296.0) + _hx_int);
            								}
            								else {
HXLINE( 326)									_hx_tmp6 = (_hx_int + ((Float)0.0));
            								}
HXDLIN( 326)								HX_VARI( Int,_out) = ::Std_obj::_hx_int(_hx_tmp6);
HXDLIN( 326)								Bool _hx_tmp7 = (_out > (int)255);
HXDLIN( 326)								if (_hx_tmp7) {
HXLINE( 326)									_out = (int)255;
            								}
            								else {
HXLINE( 326)									_out = _out;
            								}
HXDLIN( 326)								HX_VAR_NAME( Int,value4,"value");
HXDLIN( 326)								if ((_out < (int)0)) {
HXLINE( 326)									value4 = (int)0;
            								}
            								else {
HXLINE( 326)									value4 = _out;
            								}
HXDLIN( 326)								::__hxcpp_memory_set_byte(this->buffer->b,pos4,value4);
            							}
            						}
HXLINE( 328)						++i;
            					}
...
HXLINE( 312)						{
HXLINE( 313)							Float _hx_tmp8 = array->__get(i);
HXLINE( 312)							HX_VARI_NAME( Int,value5,"value") = ::Std_obj::_hx_int(_hx_tmp8);
HXDLIN( 312)							::__hxcpp_memory_set_ui16(this->buffer->b,pos5,value5);
            						}
HXLINE( 314)						++i;
            					}
            				}
...
HXLINE( 319)						{
HXLINE( 320)							Float _hx_tmp9 = array->__get(i);
HXLINE( 319)							HX_VARI_NAME( Int,value6,"value") = ::Std_obj::_hx_int(_hx_tmp9);
HXDLIN( 319)							::__hxcpp_memory_set_ui32(this->buffer->b,pos6,value6);
            						}
HXLINE( 321)						++i;
            					}
            				}
...
HXLINE( 332)						HX_VARI_NAME( Int,pos7,"pos") = ((offset + i) * this->bytesPerElement);
HXLINE( 333)						{
HXLINE( 333)							HX_VARI_NAME( Float,value7,"value") = array->__get(i);
HXDLIN( 333)							::__hxcpp_memory_set_float(this->buffer->b,pos7,value7);
            						}
HXLINE( 335)						++i;
            					}
            				}
...
HXLINE( 339)						HX_VARI_NAME( Int,pos8,"pos") = ((offset + i) * this->bytesPerElement);
HXLINE( 340)						{
HXLINE( 340)							HX_VARI_NAME( Float,value8,"value") = array->__get(i);
HXDLIN( 340)							::__hxcpp_memory_set_double(this->buffer->b,pos8,value8);
            						}
HXLINE( 342)						++i;
            					}
            				}
