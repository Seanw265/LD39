...
Float Float32Array_Impl__obj::__get( ::lime::utils::ArrayBufferView this1,Int idx){
            	HX_STACK_FRAME("lime.utils._Float32Array.Float32Array_Impl_","__get",0xe855e76d,"lime.utils._Float32Array.Float32Array_Impl_.__get","lime/utils/Float32Array.hx",118,0x8d160228)
            	HX_STACK_ARG(this1,"this1")
            	HX_STACK_ARG(idx,"idx")
HXLINE( 118)		Int byteOffset = (this1->byteOffset + (idx * (int)4));
HXDLIN( 118)		return ::__hxcpp_memory_get_float(this1->buffer->b,byteOffset);
            	}
...
Float Float32Array_Impl__obj::__set( ::lime::utils::ArrayBufferView this1,Int idx,Float val){
            	HX_STACK_FRAME("lime.utils._Float32Array.Float32Array_Impl_","__set",0xe85f0279,"lime.utils._Float32Array.Float32Array_Impl_.__set","lime/utils/Float32Array.hx",124,0x8d160228)
            	HX_STACK_ARG(this1,"this1")
            	HX_STACK_ARG(idx,"idx")
            	HX_STACK_ARG(val,"val")
HXLINE( 124)		Int byteOffset = (this1->byteOffset + (idx * (int)4));
HXDLIN( 124)		::__hxcpp_memory_set_float(this1->buffer->b,byteOffset,val);
...
{
{
            	HX_STACK_FRAME("lime.utils._Float32Array.Float32Array_Impl_","boot",0x5a51aa1b,"lime.utils._Float32Array.Float32Array_Impl_.boot","lime/utils/Float32Array.hx",69,0x8d160228)
