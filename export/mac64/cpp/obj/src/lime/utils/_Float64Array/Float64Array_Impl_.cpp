...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Float64Array_Impl__obj,subarray,return )
 ...
 ::Dynamic byteOffset = __o_byteOffset.Default(0);
            	HX_STACK_FRAME("lime.utils._Float64Array.Float64Array_Impl_","fromBytes",0x75afb378,"lime.utils._Float64Array.Float64Array_Impl_.fromBytes","lime/utils/Float64Array.hx",100,0x73d83bc7)
...
HXLINE( 100)			HX_VARI(  ::lime::utils::ArrayBufferView,_this) =  ::lime::utils::ArrayBufferView_obj::__new((int)0,(int)9);
...
HXLINE( 100)			HX_STACK_DO_THROW(HX_("Invalid constructor arguments for Float64Array",8f,de,6b,1e));
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Float64Array_Impl__obj,fromBytes,return )
 ...
 ::haxe::io::Bytes Float64Array_Impl__obj::toBytes( ::lime::utils::ArrayBufferView this1){
            	HX_STACK_FRAME("lime.utils._Float64Array.Float64Array_Impl_","toBytes",0xdbbc6207,"lime.utils._Float64Array.Float64Array_Impl_.toBytes","lime/utils/Float64Array.hx",104,0x73d83bc7)
            	HX_STACK_ARG(this1,"this1")
...
Float Float64Array_Impl__obj::__get( ::lime::utils::ArrayBufferView this1,Int idx){
            	HX_STACK_FRAME("lime.utils._Float64Array.Float64Array_Impl_","__get",0x92c4aacd,"lime.utils._Float64Array.Float64Array_Impl_.__get","lime/utils/Float64Array.hx",115,0x73d83bc7)
            	HX_STACK_ARG(this1,"this1")
            	HX_STACK_ARG(idx,"idx")
HXLINE( 115)		Int byteOffset = (this1->byteOffset + (idx * (int)8));
HXDLIN( 115)		return ::__hxcpp_memory_get_double(this1->buffer->b,byteOffset);
            	}
...
Float Float64Array_Impl__obj::__set( ::lime::utils::ArrayBufferView this1,Int idx,Float val){
            	HX_STACK_FRAME("lime.utils._Float64Array.Float64Array_Impl_","__set",0x92cdc5d9,"lime.utils._Float64Array.Float64Array_Impl_.__set","lime/utils/Float64Array.hx",121,0x73d83bc7)
            	HX_STACK_ARG(this1,"this1")
            	HX_STACK_ARG(idx,"idx")
            	HX_STACK_ARG(val,"val")
HXLINE( 121)		Int byteOffset = (this1->byteOffset + (idx * (int)8));
HXDLIN( 121)		::__hxcpp_memory_set_double(this1->buffer->b,byteOffset,val);
...
{
{
            	HX_STACK_FRAME("lime.utils._Float64Array.Float64Array_Impl_","boot",0x289272bb,"lime.utils._Float64Array.Float64Array_Impl_.boot","lime/utils/Float64Array.hx",68,0x73d83bc7)
HXLINE(  68)		BYTES_PER_ELEMENT = (int)8;
            	}
}
