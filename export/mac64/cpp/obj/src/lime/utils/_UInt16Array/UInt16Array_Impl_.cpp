...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(UInt16Array_Impl__obj,subarray,return )
 ...
 ::Dynamic byteOffset = __o_byteOffset.Default(0);
            	HX_STACK_FRAME("lime.utils._UInt16Array.UInt16Array_Impl_","fromBytes",0x3c5adfb0,"lime.utils._UInt16Array.UInt16Array_Impl_.fromBytes","lime/utils/UInt16Array.hx",100,0x124ad8bc)
...
HXLINE( 100)			HX_VARI(  ::lime::utils::ArrayBufferView,_this) =  ::lime::utils::ArrayBufferView_obj::__new((int)0,(int)6);
...
HXLINE( 100)			HX_STACK_DO_THROW(HX_("Invalid constructor arguments for Uint16Array",ea,c2,7c,de));
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(UInt16Array_Impl__obj,fromBytes,return )
 ...
 ::haxe::io::Bytes UInt16Array_Impl__obj::toBytes( ::lime::utils::ArrayBufferView this1){
            	HX_STACK_FRAME("lime.utils._UInt16Array.UInt16Array_Impl_","toBytes",0x3715903f,"lime.utils._UInt16Array.UInt16Array_Impl_.toBytes","lime/utils/UInt16Array.hx",104,0x124ad8bc)
            	HX_STACK_ARG(this1,"this1")
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(UInt16Array_Impl__obj,get_length,return )
 ...
 ::Dynamic UInt16Array_Impl__obj::__get( ::lime::utils::ArrayBufferView this1,Int idx){
            	HX_STACK_FRAME("lime.utils._UInt16Array.UInt16Array_Impl_","__get",0x5be75b05,"lime.utils._UInt16Array.UInt16Array_Impl_.__get","lime/utils/UInt16Array.hx",115,0x124ad8bc)
            	HX_STACK_ARG(this1,"this1")
            	HX_STACK_ARG(idx,"idx")
HXLINE( 115)		Int byteOffset = (this1->byteOffset + (idx * (int)2));
HXDLIN( 115)		Int _hx_tmp = ::__hxcpp_memory_get_ui16(this1->buffer->b,byteOffset);
HXDLIN( 115)		return ((int)_hx_tmp & (int)(int)65535);
            	}
...
Int UInt16Array_Impl__obj::__set( ::lime::utils::ArrayBufferView this1,Int idx,Int val){
            	HX_STACK_FRAME("lime.utils._UInt16Array.UInt16Array_Impl_","__set",0x5bf07611,"lime.utils._UInt16Array.UInt16Array_Impl_.__set","lime/utils/UInt16Array.hx",121,0x124ad8bc)
            	HX_STACK_ARG(this1,"this1")
            	HX_STACK_ARG(idx,"idx")
            	HX_STACK_ARG(val,"val")
HXLINE( 121)		Int byteOffset = (this1->byteOffset + (idx * (int)2));
HXDLIN( 121)		::__hxcpp_memory_set_ui16(this1->buffer->b,byteOffset,val);
...
{
{
            	HX_STACK_FRAME("lime.utils._UInt16Array.UInt16Array_Impl_","boot",0xe126b183,"lime.utils._UInt16Array.UInt16Array_Impl_.boot","lime/utils/UInt16Array.hx",68,0x124ad8bc)
