...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(UInt8ClampedArray_Impl__obj,get_length,return )
 ...
 ::Dynamic UInt8ClampedArray_Impl__obj::__get( ::lime::utils::ArrayBufferView this1,Int idx){
            	HX_STACK_FRAME("lime.utils._UInt8ClampedArray.UInt8ClampedArray_Impl_","__get",0xd3f9af4b,"lime.utils._UInt8ClampedArray.UInt8ClampedArray_Impl_.__get","lime/utils/UInt8ClampedArray.hx",123,0x6c0e3319)
            	HX_STACK_ARG(this1,"this1")
            	HX_STACK_ARG(idx,"idx")
HXLINE( 123)		Int byteOffset = (this1->byteOffset + idx);
HXDLIN( 123)		Int _hx_tmp = ::__hxcpp_memory_get_byte(this1->buffer->b,byteOffset);
HXDLIN( 123)		return ((int)_hx_tmp & (int)(int)255);
            	}
...
Int UInt8ClampedArray_Impl__obj::__set( ::lime::utils::ArrayBufferView this1,Int idx,Int val){
            	HX_STACK_FRAME("lime.utils._UInt8ClampedArray.UInt8ClampedArray_Impl_","__set",0xd402ca57,"lime.utils._UInt8ClampedArray.UInt8ClampedArray_Impl_.__set","lime/utils/UInt8ClampedArray.hx",129,0x6c0e3319)
            	HX_STACK_ARG(this1,"this1")
            	HX_STACK_ARG(idx,"idx")
            	HX_STACK_ARG(val,"val")
HXLINE( 129)		Int byteOffset = (this1->byteOffset + idx);
HXDLIN( 129)		HX_VARI_NAME( Int,_hx_int,"int") = val;
HXDLIN( 129)		Float _hx_tmp;
HXDLIN( 129)		if ((_hx_int < (int)0)) {
HXLINE( 129)			_hx_tmp = (((Float)4294967296.0) + _hx_int);
            		}
            		else {
HXLINE( 129)			_hx_tmp = (_hx_int + ((Float)0.0));
            		}
HXDLIN( 129)		HX_VARI( Int,_out) = ::Std_obj::_hx_int(_hx_tmp);
HXDLIN( 129)		Bool _hx_tmp1 = (_out > (int)255);
HXDLIN( 129)		if (_hx_tmp1) {
HXLINE( 129)			_out = (int)255;
            		}
            		else {
HXLINE( 129)			_out = _out;
            		}
HXDLIN( 129)		HX_VAR( Int,value);
HXDLIN( 129)		if ((_out < (int)0)) {
HXLINE( 129)			value = (int)0;
            		}
            		else {
HXLINE( 129)			value = _out;
            		}
HXDLIN( 129)		::__hxcpp_memory_set_byte(this1->buffer->b,byteOffset,value);
...
::String UInt8ClampedArray_Impl__obj::toString( ::lime::utils::ArrayBufferView this1){
            	...
            	HX_STACK_ARG(this1,"this1")
HXLINE( 132)		Bool _hx_tmp = hx::IsNotNull( this1 );
...
{
{
            	HX_STACK_FRAME("lime.utils._UInt8ClampedArray.UInt8ClampedArray_Impl_","boot",0xbf4007fd,"lime.utils._UInt8ClampedArray.UInt8ClampedArray_Impl_.boot","lime/utils/UInt8ClampedArray.hx",76,0x6c0e3319)
