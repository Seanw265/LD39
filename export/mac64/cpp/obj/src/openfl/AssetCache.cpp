...
HXLINE( 925)		this->bitmapData =  ::haxe::ds::StringMap_obj::__new();
HXLINE( 926)		this->font =  ::haxe::ds::StringMap_obj::__new();
HXLINE( 927)		this->sound =  ::haxe::ds::StringMap_obj::__new();
            	}
...
void AssetCache_obj::clear(::String prefix){
            	HX_STACK_FRAME("openfl.AssetCache","clear",0x1c26890f,"openfl.AssetCache.clear","openfl/Assets.hx",934,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(prefix,"prefix")
HXLINE( 934)		Bool _hx_tmp = hx::IsNull( prefix );
HXDLIN( 934)		if (_hx_tmp) {
HXLINE( 936)			this->bitmapData =  ::haxe::ds::StringMap_obj::__new();
HXLINE( 937)			this->font =  ::haxe::ds::StringMap_obj::__new();
HXLINE( 938)			this->sound =  ::haxe::ds::StringMap_obj::__new();
            		}
            		else {
HXLINE( 942)			HX_VARI(  ::Dynamic,keys) = this->bitmapData->keys();
HXLINE( 944)			while(true){
HXLINE( 944)				Bool _hx_tmp1 = !(( (Bool)( ::Dynamic(keys->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN( 944)				if (_hx_tmp1) {
HXLINE( 944)					goto _hx_goto_0;
            				}
HXDLIN( 944)				HX_VARI( ::String,key) = ( (::String)( ::Dynamic(keys->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE( 946)				Bool _hx_tmp2 = ::StringTools_obj::startsWith(key,prefix);
...
HXLINE( 956)				Bool _hx_tmp3 = !(( (Bool)( ::Dynamic(keys1->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN( 956)				if (_hx_tmp3) {
HXLINE( 956)					goto _hx_goto_1;
            				}
HXDLIN( 956)				HX_VARI_NAME( ::String,key1,"key") = ( (::String)( ::Dynamic(keys1->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE( 958)				Bool _hx_tmp4 = ::StringTools_obj::startsWith(key1,prefix);
...
HXLINE( 968)				Bool _hx_tmp5 = !(( (Bool)( ::Dynamic(keys2->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic))()) ));
HXDLIN( 968)				if (_hx_tmp5) {
HXLINE( 968)					goto _hx_goto_2;
            				}
HXDLIN( 968)				HX_VARI_NAME( ::String,key2,"key") = ( (::String)( ::Dynamic(keys2->__Field(HX_("next",f3,84,02,49),hx::paccDynamic))()) );
HXLINE( 970)				Bool _hx_tmp6 = ::StringTools_obj::startsWith(key2,prefix);
...
HX_DEFINE_DYNAMIC_FUNC1(AssetCache_obj,clear,(void))
 ...
 ::openfl::display::BitmapData AssetCache_obj::getBitmapData(::String id){
            	HX_STACK_FRAME("openfl.AssetCache","getBitmapData",0x76047b71,"openfl.AssetCache.getBitmapData","openfl/Assets.hx",985,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
HX_DEFINE_DYNAMIC_FUNC1(AssetCache_obj,getBitmapData,return )
 ...
 ::openfl::text::Font AssetCache_obj::getFont(::String id){
            	HX_STACK_FRAME("openfl.AssetCache","getFont",0xc4a48987,"openfl.AssetCache.getFont","openfl/Assets.hx",992,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
HX_DEFINE_DYNAMIC_FUNC1(AssetCache_obj,getFont,return )
 ...
 ::openfl::media::Sound AssetCache_obj::getSound(::String id){
            	HX_STACK_FRAME("openfl.AssetCache","getSound",0xc78ea217,"openfl.AssetCache.getSound","openfl/Assets.hx",999,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
Bool AssetCache_obj::hasBitmapData(::String id){
            	HX_STACK_FRAME("openfl.AssetCache","hasBitmapData",0x33e8d735,"openfl.AssetCache.hasBitmapData","openfl/Assets.hx",1006,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
Bool AssetCache_obj::hasFont(::String id){
            	HX_STACK_FRAME("openfl.AssetCache","hasFont",0xc165fa4b,"openfl.AssetCache.hasFont","openfl/Assets.hx",1013,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
Bool AssetCache_obj::hasSound(::String id){
            	HX_STACK_FRAME("openfl.AssetCache","hasSound",0xf40fdcd3,"openfl.AssetCache.hasSound","openfl/Assets.hx",1020,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
Bool AssetCache_obj::removeBitmapData(::String id){
            	HX_STACK_FRAME("openfl.AssetCache","removeBitmapData",0x7d8dc6db,"openfl.AssetCache.removeBitmapData","openfl/Assets.hx",1027,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
Bool AssetCache_obj::removeFont(::String id){
            	HX_STACK_FRAME("openfl.AssetCache","removeFont",0x7ce60971,"openfl.AssetCache.removeFont","openfl/Assets.hx",1034,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
Bool AssetCache_obj::removeSound(::String id){
            	HX_STACK_FRAME("openfl.AssetCache","removeSound",0x489d0eed,"openfl.AssetCache.removeSound","openfl/Assets.hx",1041,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
void AssetCache_obj::setBitmapData(::String id, ::openfl::display::BitmapData bitmapData){
            	HX_STACK_FRAME("openfl.AssetCache","setBitmapData",0xbb0a5d7d,"openfl.AssetCache.setBitmapData","openfl/Assets.hx",1048,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
void AssetCache_obj::setFont(::String id, ::openfl::text::Font font){
            	HX_STACK_FRAME("openfl.AssetCache","setFont",0xb7a61a93,"openfl.AssetCache.setFont","openfl/Assets.hx",1055,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
void AssetCache_obj::setSound(::String id, ::openfl::media::Sound sound){
            	HX_STACK_FRAME("openfl.AssetCache","setSound",0x75ebfb8b,"openfl.AssetCache.setSound","openfl/Assets.hx",1062,0x989d477c)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(id,"id")
...
Bool AssetCache_obj::get_enabled(){
            	HX_STACK_FRAME("openfl.AssetCache","get_enabled",0xcdc8099a,"openfl.AssetCache.get_enabled","openfl/Assets.hx",1076,0x989d477c)
            	HX_STACK_THIS(this)
...
Bool AssetCache_obj::set_enabled(Bool value){
            	HX_STACK_FRAME("openfl.AssetCache","set_enabled",0xd83510a6,"openfl.AssetCache.set_enabled","openfl/Assets.hx",1083,0x989d477c)
            	HX_STACK_THIS(this)
