...
::openfl::_internal::renderer::DrawCommandType DrawCommandType_obj::DRAW_PATH;
...
bool DrawCommandType_obj::__GetStatic(const ::String &inName, ::Dynamic &outValue, hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("DRAW_PATH",00,c7,6b,9a)) { outValue = DrawCommandType_obj::DRAW_PATH; return true; }
...
int DrawCommandType_obj::__FindIndex(::String inName)
{
	...
	if (inName==HX_("DRAW_PATH",00,c7,6b,9a)) return 7;
	if (inName==HX_("DRAW_RECT",7f,2e,c1,9b)) return 8;
	if (inName==HX_("DRAW_ROUND_RECT",b0,a9,34,42)) return 9;
	if (inName==HX_("DRAW_TILES",aa,4b,c0,d6)) return 10;
	if (inName==HX_("DRAW_TRIANGLES",50,bd,1f,61)) return 11;
	if (inName==HX_("END_FILL",c7,2c,f5,27)) return 12;
	if (inName==HX_("LINE_BITMAP_STYLE",ec,c7,38,2d)) return 13;
	if (inName==HX_("LINE_GRADIENT_STYLE",6d,7d,1a,a1)) return 14;
	if (inName==HX_("LINE_STYLE",46,73,8d,dd)) return 15;
	if (inName==HX_("LINE_TO",26,f0,91,9f)) return 16;
	if (inName==HX_("MOVE_TO",29,35,80,ca)) return 17;
	if (inName==HX_("OVERRIDE_MATRIX",14,63,08,a8)) return 18;
	if (inName==HX_("UNKNOWN",6a,f7,4e,61)) return 19;
...
int DrawCommandType_obj::__FindArgCount(::String inName)
{
	...
	if (inName==HX_("DRAW_PATH",00,c7,6b,9a)) return 0;
...
hx::Val DrawCommandType_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("DRAW_PATH",00,c7,6b,9a)) return DRAW_PATH;
...
static void DrawCommandType_obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(DrawCommandType_obj::DRAW_PATH,"DRAW_PATH");
...
static void DrawCommandType_obj_sVisitStatic(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(DrawCommandType_obj::DRAW_PATH,"DRAW_PATH");
...
DRAW_PATH = hx::CreateEnum< DrawCommandType_obj >(HX_HCSTRING("DRAW_PATH","\x00","\xc7","\x6b","\x9a"),7,0);
DRAW_RECT = hx::CreateEnum< DrawCommandType_obj >(HX_HCSTRING("DRAW_RECT","\x7f","\x2e","\xc1","\x9b"),8,0);
DRAW_ROUND_RECT = hx::CreateEnum< DrawCommandType_obj >(HX_HCSTRING("DRAW_ROUND_RECT","\xb0","\xa9","\x34","\x42"),9,0);
DRAW_TILES = hx::CreateEnum< DrawCommandType_obj >(HX_HCSTRING("DRAW_TILES","\xaa","\x4b","\xc0","\xd6"),10,0);
DRAW_TRIANGLES = hx::CreateEnum< DrawCommandType_obj >(HX_HCSTRING("DRAW_TRIANGLES","\x50","\xbd","\x1f","\x61"),11,0);
END_FILL = hx::CreateEnum< DrawCommandType_obj >(HX_HCSTRING("END_FILL","\xc7","\x2c","\xf5","\x27"),12,0);
LINE_BITMAP_STYLE = hx::CreateEnum< DrawCommandType_obj >(HX_HCSTRING("LINE_BITMAP_STYLE","\xec","\xc7","\x38","\x2d"),13,0);
LINE_GRADIENT_STYLE = hx::CreateEnum< DrawCommandType_obj >(HX_HCSTRING("LINE_GRADIENT_STYLE","\x6d","\x7d","\x1a","\xa1"),14,0);
LINE_STYLE = hx::CreateEnum< DrawCommandType_obj >(HX_HCSTRING("LINE_STYLE","\x46","\x73","\x8d","\xdd"),15,0);
LINE_TO = hx::CreateEnum< DrawCommandType_obj >(HX_HCSTRING("LINE_TO","\x26","\xf0","\x91","\x9f"),16,0);
MOVE_TO = hx::CreateEnum< DrawCommandType_obj >(HX_HCSTRING("MOVE_TO","\x29","\x35","\x80","\xca"),17,0);
OVERRIDE_MATRIX = hx::CreateEnum< DrawCommandType_obj >(HX_HCSTRING("OVERRIDE_MATRIX","\x14","\x63","\x08","\xa8"),18,0);
UNKNOWN = hx::CreateEnum< DrawCommandType_obj >(HX_HCSTRING("UNKNOWN","\x6a","\xf7","\x4e","\x61"),19,0);
}
