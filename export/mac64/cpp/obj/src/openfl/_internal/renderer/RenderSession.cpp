...
void RenderSession_obj::__construct(){
            	HX_STACK_FRAME("openfl._internal.renderer.RenderSession","new",0x2c15cbb7,"openfl._internal.renderer.RenderSession.new","openfl/_internal/renderer/RenderSession.hx",36,0x8a77a218)
            	HX_STACK_THIS(this)
HXLINE(  36)		this->activeTextures = (int)0;
            	}
