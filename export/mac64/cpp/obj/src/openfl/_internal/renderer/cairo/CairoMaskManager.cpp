...
HXLINE(  31)		HX_VARI(  ::openfl::geom::Matrix,transform) = mask->_hx___getWorldTransform();
...
HXLINE(  46)		HX_VARI(  ::lime::graphics::cairo::Cairo,cairo) = this->renderSession->cairo;
HXLINE(  47)		cairo->save();
HXLINE(  49)		cairo->set_matrix( ::lime::math::Matrix3_obj::__new(transform->a,transform->c,transform->b,transform->d,transform->tx,transform->ty));
HXLINE(  51)		cairo->newPath();
HXLINE(  52)		cairo->rectangle(rect->x,rect->y,rect->width,rect->height);
HXLINE(  53)		cairo->clip();
            	}
...
void CairoMaskManager_obj::popMask(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  60)		this->renderSession->cairo->restore();
            	}


void CairoMaskManager_obj::popRect(){
            	HX_STACK_FRAME("openfl._internal.renderer.cairo.CairoMaskManager","popRect",0x200d9681,"openfl._internal.renderer.cairo.CairoMaskManager.popRect","openfl/_internal/renderer/cairo/CairoMaskManager.hx",67,0xc9e099a4)
            	HX_STACK_THIS(this)
HXLINE(  67)		this->renderSession->cairo->restore();
            	}
