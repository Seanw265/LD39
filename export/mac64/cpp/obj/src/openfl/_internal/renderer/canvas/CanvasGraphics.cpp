...
Bool CanvasGraphics_obj::isCCW(Float x1,Float y1,Float x2,Float y2,Float x3,Float y3){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","isCCW",0xce74af1d,"openfl._internal.renderer.canvas.CanvasGraphics.isCCW","openfl/_internal/renderer/canvas/CanvasGraphics.hx",438,0x0b9ff65e)
            	HX_STACK_ARG(x1,"x1")
            	HX_STACK_ARG(y1,"y1")
            	HX_STACK_ARG(x2,"x2")
            	HX_STACK_ARG(y2,"y2")
            	HX_STACK_ARG(x3,"x3")
            	HX_STACK_ARG(y3,"y3")
HXLINE( 438)		return ((((x2 - x1) * (y3 - y1)) - ((y2 - y1) * (x3 - x1))) < (int)0);
            	}
...
HXLINE( 445)		HX_VARI( Float,max) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 446)		HX_VARI( Float,tmp) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 447)		HX_VARI( Int,len) = uvt->length;
HXLINE( 449)		{
HXLINE( 449)			HX_VARI( Int,_g1) = (int)1;
HXDLIN( 449)			HX_VARI( Int,_g) = (len + (int)1);
HXDLIN( 449)			while((_g1 < _g)){
HXLINE( 449)				HX_VARI( Int,t) = _g1++;
...
HXLINE( 457)				tmp = uvt->__get((t - (int)1));
HXLINE( 459)				Bool _hx_tmp1 = (max < tmp);
HXDLIN( 459)				if (_hx_tmp1) {
HXLINE( 461)					max = tmp;
            				}
            			}
            		}
HXLINE( 467)		HX_VARI_NAME( ::Array< Float >,this1,"this") = ::Array_obj< Float >::__new();
HXDLIN( 467)		this1->__SetSizeExact(null());
HXDLIN( 467)		HX_VARI( ::Array< Float >,result) = this1;
HXLINE( 469)		{
HXLINE( 469)			HX_VARI_NAME( Int,_g11,"_g1") = (int)1;
HXDLIN( 469)			HX_VARI_NAME( Int,_g2,"_g") = (len + (int)1);
HXDLIN( 469)			while((_g11 < _g2)){
HXLINE( 469)				HX_VARI_NAME( Int,t1,"t") = _g11++;
HXLINE( 471)				Bool _hx_tmp2;
HXDLIN( 471)				if (skipT) {
HXLINE( 471)					_hx_tmp2 = (hx::Mod(t1,(int)3) == (int)0);
            				}
            				else {
...
HXLINE( 477)				Float _hx_tmp3 = ((Float)uvt->__get((t1 - (int)1)) / (Float)max);
HXDLIN( 477)				result->push(_hx_tmp3);
            			}
            		}
HXLINE( 481)		return  ::Dynamic(hx::Anon_obj::Create(2)
...
{
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","boot",0x56fa6b22,"openfl._internal.renderer.canvas.CanvasGraphics.boot","openfl/_internal/renderer/canvas/CanvasGraphics.hx",47,0x0b9ff65e)
HXLINE(  47)		fillCommands =  ::openfl::_internal::renderer::DrawCommandBuffer_obj::__new();
            	}
{
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","boot",0x56fa6b22,"openfl._internal.renderer.canvas.CanvasGraphics.boot","openfl/_internal/renderer/canvas/CanvasGraphics.hx",54,0x0b9ff65e)
