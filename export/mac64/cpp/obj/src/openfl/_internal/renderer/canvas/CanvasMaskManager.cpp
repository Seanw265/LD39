...
HXLINE(  29)		HX_VARI(  ::openfl::geom::Matrix,transform) = mask->_hx___getWorldTransform();
...
HXLINE(  45)		HX_VARI(  ::lime::graphics::CanvasRenderContext,context) = this->renderSession->context;
HXLINE(  46)		context->save();
HXLINE(  48)		context->setTransform(transform->a,transform->b,transform->c,transform->d,transform->tx,transform->ty);
HXLINE(  50)		context->beginPath();
HXLINE(  51)		context->rect(rect->x,rect->y,rect->width,rect->height);
HXLINE(  52)		context->clip();
            	}
...
void CanvasMaskManager_obj::popMask(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  59)		this->renderSession->context->restore();
            	}


void CanvasMaskManager_obj::popRect(){
            	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasMaskManager","popRect",0xebc46cf5,"openfl._internal.renderer.canvas.CanvasMaskManager.popRect","openfl/_internal/renderer/canvas/CanvasMaskManager.hx",66,0x595783d2)
            	HX_STACK_THIS(this)
HXLINE(  66)		this->renderSession->context->restore();
            	}
