...
HXLINE(1339)		super::__construct(width,height);
HXLINE(1341)		HX_STACK_DO_THROW(HX_("ConsoleRenderer not supported",db,b9,d4,90));
            	}
...
hx::ObjectPtr< ConsoleRenderer_obj > ConsoleRenderer_obj::__new(Int width,Int height, ::lime::graphics::ConsoleRenderContext ctx)
{
	...
	_hx_result->__construct(width,height,ctx);
	return _hx_result;
}
