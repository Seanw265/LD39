...
HXLINE(  81)				return hitTest;
            			}
            		}
            		else {
HXLINE(  86)			Bool _hx_tmp2;
HXDLIN(  86)			Bool _hx_tmp3;
HXDLIN(  86)			Bool _hx_tmp4 = !(!(hitObject->get_visible()));
HXDLIN(  86)			if (_hx_tmp4) {
HXLINE(  86)				_hx_tmp3 = this->_hx___isMask;
            			}
            			else {
...
HXDLIN(  86)				if (interactiveOnly) {
HXLINE(  86)					_hx_tmp5 = !(this->mouseEnabled);
            				}
            				else {
HXLINE(  86)					_hx_tmp5 = false;
            				}
HXDLIN(  86)				if (_hx_tmp5) {
HXLINE(  86)					_hx_tmp2 = !(this->mouseChildren);
            				}
            				else {
...
HXDLIN(  87)			 ::openfl::display::DisplayObject _hx_tmp7 = this->get_mask();
HXDLIN(  87)			Bool _hx_tmp8 = hx::IsNotNull( _hx_tmp7 );
HXDLIN(  87)			if (_hx_tmp8) {
HXLINE(  87)				_hx_tmp6 = !(this->get_mask()->_hx___hitTestMask(x,y));
            			}
            			else {
...
HXLINE(  89)			Bool _hx_tmp9 = this->super::_hx___hitTest(x,y,shapeFlag,stack,interactiveOnly,hitObject);
HXDLIN(  89)			if (_hx_tmp9) {
HXLINE(  91)				return interactiveOnly;
            			}
            			else {
HXLINE(  93)				Bool _hx_tmp10;
HXDLIN(  93)				Bool _hx_tmp11;
HXDLIN(  93)				Bool _hx_tmp12;
HXDLIN(  93)				if (!(!(interactiveOnly))) {
HXLINE(  93)					_hx_tmp12 = this->mouseEnabled;
            				}
            				else {
HXLINE(  93)					_hx_tmp12 = true;
            				}
HXDLIN(  93)				if (_hx_tmp12) {
HXLINE(  93)					_hx_tmp11 = hx::IsNotNull( this->_hx___graphics );
            				}
            				else {
HXLINE(  93)					_hx_tmp11 = false;
            				}
HXDLIN(  93)				if (_hx_tmp11) {
HXLINE(  93)					 ::openfl::geom::Matrix _hx_tmp13 = this->_hx___getWorldTransform();
HXDLIN(  93)					_hx_tmp10 = this->_hx___graphics->_hx___hitTest(x,y,shapeFlag,_hx_tmp13);
            				}
            				else {
HXLINE(  93)					_hx_tmp10 = false;
            				}
HXDLIN(  93)				if (_hx_tmp10) {
HXLINE(  95)					Bool _hx_tmp14 = hx::IsNotNull( stack );
HXDLIN(  95)					if (_hx_tmp14) {
HXLINE(  97)						stack->push(hitObject);
            					}
...
Bool Sprite_obj::_hx___hitTestMask(Float x,Float y){
            	...
            	HX_STACK_ARG(x,"x")
            	HX_STACK_ARG(y,"y")
HXLINE( 114)		Bool _hx_tmp = this->super::_hx___hitTestMask(x,y);
HXDLIN( 114)		if (_hx_tmp) {
HXLINE( 116)			return true;
            		}
            		else {
HXLINE( 118)			Bool _hx_tmp1;
HXDLIN( 118)			Bool _hx_tmp2 = hx::IsNotNull( this->_hx___graphics );
HXDLIN( 118)			if (_hx_tmp2) {
HXLINE( 118)				 ::openfl::geom::Matrix _hx_tmp3 = this->_hx___getWorldTransform();
HXDLIN( 118)				_hx_tmp1 = this->_hx___graphics->_hx___hitTest(x,y,true,_hx_tmp3);
            			}
            			else {
...
HXLINE( 124)		return false;
 ...
 ::openfl::display::Graphics Sprite_obj::get_graphics(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 138)		Bool _hx_tmp = hx::IsNull( this->_hx___graphics );
HXDLIN( 138)		if (_hx_tmp) {
HXLINE( 140)			this->_hx___graphics =  ::openfl::display::Graphics_obj::__new();
HXLINE( 141)			this->_hx___graphics->_hx___owner = hx::ObjectPtr<OBJ_>(this);
            		}
HXLINE( 145)		return this->_hx___graphics;
            	}
...
Bool Sprite_obj::get_tabEnabled(){
            	HX_STACK_FRAME("openfl.display.Sprite","get_tabEnabled",0x5c66fc94,"openfl.display.Sprite.get_tabEnabled","openfl/display/Sprite.hx",152,0xd5438ced)
            	HX_STACK_THIS(this)
HXLINE( 152)		if (!(this->_hx___tabEnabled)) {
HXLINE( 152)			return this->buttonMode;
            		}
            		else {
