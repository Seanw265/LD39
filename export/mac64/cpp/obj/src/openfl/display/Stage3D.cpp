...
HXLINE(  29)		if (::openfl::display::OpenGLView_obj::get_isSupported()) {
...
HXLINE(  34)				_gthis->dispatchEvent( ::openfl::events::Event_obj::__new(HX_("context3DCreate",7c,bf,59,7b),null(),null()));
            			}
...
HXLINE(  31)			::haxe::Timer_obj::delay( ::Dynamic(new _hx_Closure_0(_gthis)),(int)1);
            			...
            			HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_1, ::openfl::display::Stage3D,_gthis) HXARGC(0)
            			void _hx_run(){
            				HX_STACK_FRAME("openfl.display.Stage3D","requestContext3D",0x80c219da,"openfl.display.Stage3D.requestContext3D","openfl/display/Stage3D.hx",42,0x37141b9b)
HXLINE(  42)				_gthis->dispatchEvent( ::openfl::events::ErrorEvent_obj::__new(HX_("error",c8,cb,29,73),null(),null(),null(),null()));
            			}
            			HX_END_LOCAL_FUNC0((void))

HXLINE(  40)			::haxe::Timer_obj::delay( ::Dynamic(new _hx_Closure_1(_gthis)),(int)1);
            		}
            	}
