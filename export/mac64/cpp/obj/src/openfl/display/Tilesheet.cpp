...
HXLINE(  68)		this->_hx___rectTile =  ::openfl::geom::Rectangle_obj::__new(null(),null(),null(),null());
HXLINE(  69)		this->_hx___rectUV =  ::openfl::geom::Rectangle_obj::__new(null(),null(),null(),null());
HXLINE(  70)		this->_hx___point =  ::openfl::geom::Point_obj::__new(null(),null());
            	}
...
HXLINE(  93)		Bool _hx_tmp = hx::IsNull( centerPoint );
...
HXLINE( 105)		Float _hx_tmp1 = rectangle->get_left();
HXDLIN( 105)		Float _hx_tmp2 = ((Float)_hx_tmp1 / (Float)this->_hx___bitmap->width);
HXDLIN( 105)		Float _hx_tmp3 = rectangle->get_top();
HXDLIN( 105)		Float _hx_tmp4 = ((Float)_hx_tmp3 / (Float)this->_hx___bitmap->height);
HXDLIN( 105)		Float _hx_tmp5 = rectangle->get_right();
HXDLIN( 105)		Float _hx_tmp6 = ((Float)_hx_tmp5 / (Float)this->_hx___bitmap->width);
HXDLIN( 105)		Float _hx_tmp7 = rectangle->get_bottom();
HXDLIN( 105)		Float _hx_tmp8 = ((Float)_hx_tmp7 / (Float)this->_hx___bitmap->height);
HXDLIN( 105)		this->_hx___tileUVs->push( ::openfl::geom::Rectangle_obj::__new(_hx_tmp2,_hx_tmp4,_hx_tmp6,_hx_tmp8));
...
Int count = __o_count.Default(-1);
            	HX_STACK_FRAME("openfl.display.Tilesheet","drawTiles",0x3dc16aba,"openfl.display.Tilesheet.drawTiles","openfl/display/Tilesheet.hx",195,0x2fc30619)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC5(Tilesheet_obj,drawTiles,(void))
 ...
 ::openfl::geom::Point Tilesheet_obj::getTileCenter(Int index){
            	HX_STACK_FRAME("openfl.display.Tilesheet","getTileCenter",0x7cc0f032,"openfl.display.Tilesheet.getTileCenter","openfl/display/Tilesheet.hx",201,0x2fc30619)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(Tilesheet_obj,getTileCenter,return )
 ...
 ::openfl::geom::Rectangle Tilesheet_obj::getTileRect(Int index){
            	HX_STACK_FRAME("openfl.display.Tilesheet","getTileRect",0x5dc2d641,"openfl.display.Tilesheet.getTileRect","openfl/display/Tilesheet.hx",208,0x2fc30619)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
...
HX_DEFINE_DYNAMIC_FUNC1(Tilesheet_obj,getTileRect,return )
 ...
 ::openfl::geom::Rectangle Tilesheet_obj::getTileUVs(Int index){
            	HX_STACK_FRAME("openfl.display.Tilesheet","getTileUVs",0x006ddc95,"openfl.display.Tilesheet.getTileUVs","openfl/display/Tilesheet.hx",215,0x2fc30619)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(index,"index")
...
{
{
            	HX_STACK_FRAME("openfl.display.Tilesheet","boot",0xd1f75af9,"openfl.display.Tilesheet.boot","openfl/display/Tilesheet.hx",16,0x2fc30619)
HXLINE(  16)		TILE_SCALE = (int)1;
            	}
{
            	HX_STACK_FRAME("openfl.display.Tilesheet","boot",0xd1f75af9,"openfl.display.Tilesheet.boot","openfl/display/Tilesheet.hx",17,0x2fc30619)
HXLINE(  17)		TILE_ROTATION = (int)2;
            	}
{
            	HX_STACK_FRAME("openfl.display.Tilesheet","boot",0xd1f75af9,"openfl.display.Tilesheet.boot","openfl/display/Tilesheet.hx",18,0x2fc30619)
HXLINE(  18)		TILE_RGB = (int)4;
            	}
{
            	HX_STACK_FRAME("openfl.display.Tilesheet","boot",0xd1f75af9,"openfl.display.Tilesheet.boot","openfl/display/Tilesheet.hx",19,0x2fc30619)
HXLINE(  19)		TILE_ALPHA = (int)8;
            	}
{
            	HX_STACK_FRAME("openfl.display.Tilesheet","boot",0xd1f75af9,"openfl.display.Tilesheet.boot","openfl/display/Tilesheet.hx",20,0x2fc30619)
HXLINE(  20)		TILE_TRANS_2x2 = (int)16;
            	}
{
            	HX_STACK_FRAME("openfl.display.Tilesheet","boot",0xd1f75af9,"openfl.display.Tilesheet.boot","openfl/display/Tilesheet.hx",21,0x2fc30619)
HXLINE(  21)		TILE_RECT = (int)32;
            	}
{
            	HX_STACK_FRAME("openfl.display.Tilesheet","boot",0xd1f75af9,"openfl.display.Tilesheet.boot","openfl/display/Tilesheet.hx",22,0x2fc30619)
HXLINE(  22)		TILE_ORIGIN = (int)64;
            	}
{
            	HX_STACK_FRAME("openfl.display.Tilesheet","boot",0xd1f75af9,"openfl.display.Tilesheet.boot","openfl/display/Tilesheet.hx",23,0x2fc30619)
HXLINE(  23)		TILE_TRANS_COLOR = (int)128;
            	}
{
            	HX_STACK_FRAME("openfl.display.Tilesheet","boot",0xd1f75af9,"openfl.display.Tilesheet.boot","openfl/display/Tilesheet.hx",25,0x2fc30619)
HXLINE(  25)		TILE_BLEND_NORMAL = (int)0;
            	}
{
            	HX_STACK_FRAME("openfl.display.Tilesheet","boot",0xd1f75af9,"openfl.display.Tilesheet.boot","openfl/display/Tilesheet.hx",26,0x2fc30619)
HXLINE(  26)		TILE_BLEND_ADD = (int)65536;
            	}
{
            	HX_STACK_FRAME("openfl.display.Tilesheet","boot",0xd1f75af9,"openfl.display.Tilesheet.boot","openfl/display/Tilesheet.hx",27,0x2fc30619)
HXLINE(  27)		TILE_BLEND_MULTIPLY = (int)131072;
            	}
{
            	HX_STACK_FRAME("openfl.display.Tilesheet","boot",0xd1f75af9,"openfl.display.Tilesheet.boot","openfl/display/Tilesheet.hx",28,0x2fc30619)
HXLINE(  28)		TILE_BLEND_SCREEN = (int)262144;
            	}
{
            	HX_STACK_FRAME("openfl.display.Tilesheet","boot",0xd1f75af9,"openfl.display.Tilesheet.boot","openfl/display/Tilesheet.hx",29,0x2fc30619)
HXLINE(  29)		TILE_BLEND_SUBTRACT = (int)524288;
            	}
{
            	HX_STACK_FRAME("openfl.display.Tilesheet","boot",0xd1f75af9,"openfl.display.Tilesheet.boot","openfl/display/Tilesheet.hx",30,0x2fc30619)
HXLINE(  30)		TILE_BLEND_DARKEN = (int)1048576;
            	}
{
            	HX_STACK_FRAME("openfl.display.Tilesheet","boot",0xd1f75af9,"openfl.display.Tilesheet.boot","openfl/display/Tilesheet.hx",31,0x2fc30619)
HXLINE(  31)		TILE_BLEND_LIGHTEN = (int)2097152;
            	}
{
            	HX_STACK_FRAME("openfl.display.Tilesheet","boot",0xd1f75af9,"openfl.display.Tilesheet.boot","openfl/display/Tilesheet.hx",32,0x2fc30619)
HXLINE(  32)		TILE_BLEND_OVERLAY = (int)4194304;
            	}
{
            	HX_STACK_FRAME("openfl.display.Tilesheet","boot",0xd1f75af9,"openfl.display.Tilesheet.boot","openfl/display/Tilesheet.hx",33,0x2fc30619)
HXLINE(  33)		TILE_BLEND_HARDLIGHT = (int)8388608;
            	}
{
            	HX_STACK_FRAME("openfl.display.Tilesheet","boot",0xd1f75af9,"openfl.display.Tilesheet.boot","openfl/display/Tilesheet.hx",34,0x2fc30619)
HXLINE(  34)		TILE_BLEND_DIFFERENCE = (int)16777216;
            	}
{
            	HX_STACK_FRAME("openfl.display.Tilesheet","boot",0xd1f75af9,"openfl.display.Tilesheet.boot","openfl/display/Tilesheet.hx",35,0x2fc30619)
HXLINE(  35)		TILE_BLEND_INVERT = (int)33554432;
            	}
{
            	HX_STACK_FRAME("openfl.display.Tilesheet","boot",0xd1f75af9,"openfl.display.Tilesheet.boot","openfl/display/Tilesheet.hx",37,0x2fc30619)
HXLINE(  37)		_hx___defaultPoint =  ::openfl::geom::Point_obj::__new((int)0,(int)0);
            	}
}
