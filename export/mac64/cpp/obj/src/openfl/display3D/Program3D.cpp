...
HXLINE(  35)		{
HXLINE(  35)			HX_VARI(  ::lime::graphics::opengl::GLProgram,program) = this->glProgram;
HXDLIN(  35)			program->attach(vertexShader);
HXDLIN(  35)			{
HXLINE(  35)				Int program1 = ( (Int)(program->id) );
HXDLIN(  35)				Int shader = ( (Int)(vertexShader->id) );
HXDLIN(  35)				::lime::graphics::opengl::GL_obj::cffi_lime_gl_attach_shader(program1,shader);
            			}
            		}
HXLINE(  36)		{
HXLINE(  36)			HX_VARI_NAME(  ::lime::graphics::opengl::GLProgram,program2,"program") = this->glProgram;
HXDLIN(  36)			program2->attach(fragmentShader);
HXDLIN(  36)			{
HXLINE(  36)				Int program3 = ( (Int)(program2->id) );
HXDLIN(  36)				Int shader1 = ( (Int)(fragmentShader->id) );
HXDLIN(  36)				::lime::graphics::opengl::GL_obj::cffi_lime_gl_attach_shader(program3,shader1);
            			}
            		}
HXLINE(  37)		{
HXLINE(  37)			Int program4 = ( (Int)(this->glProgram->id) );
HXDLIN(  37)			::lime::graphics::opengl::GL_obj::cffi_lime_gl_link_program(program4);
            		}
HXLINE(  39)		Int program5 = ( (Int)(this->glProgram->id) );
HXDLIN(  39)		Int _hx_tmp = ( (Int)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_program_parameter(program5,(int)35714)) );
HXDLIN(  39)		if ((_hx_tmp == (int)0)) {
HXLINE(  41)			Int program6 = ( (Int)(this->glProgram->id) );
HXDLIN(  41)			HX_VARI( ::String,result) = ( (::String)(::lime::graphics::opengl::GL_obj::cffi_lime_gl_get_program_info_log(program6)) );
