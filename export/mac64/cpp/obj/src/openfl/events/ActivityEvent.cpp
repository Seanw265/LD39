...
::String ActivityEvent_obj::toString(){
            	HX_STACK_FRAME("openfl.events.ActivityEvent","toString",0x46865b26,"openfl.events.ActivityEvent.toString","openfl/events/ActivityEvent.hx",36,0x98f9202a)
            	HX_STACK_THIS(this)
HXLINE(  36)		return this->_hx___formatToString(HX_("ActivityEvent",ab,eb,0c,59),::Array_obj< ::String >::fromData( _hx_array_data_0,4));
            	}
