...
HXLINE(  52)		this->type = type;
HXLINE(  53)		this->bubbles = bubbles;
HXLINE(  54)		this->cancelable = cancelable;
HXLINE(  55)		this->eventPhase = (int)2;
            	}
...
Dynamic Event_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::events::Event Event_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  62)		HX_VARI(  ::openfl::events::Event,event) =  ::openfl::events::Event_obj::__new(this->type,this->bubbles,this->cancelable);
HXLINE(  63)		event->eventPhase = this->eventPhase;
HXLINE(  64)		event->target = this->target;
HXLINE(  65)		event->currentTarget = this->currentTarget;
...
::String Event_obj::formatToString(::String className,::String p1,::String p2,::String p3,::String p4,::String p5){
            	...
            	HX_STACK_ARG(p4,"p4")
            	HX_STACK_ARG(p5,"p5")
HXLINE(  73)		HX_VARI( ::Array< ::String >,parameters) = ::Array_obj< ::String >::__new(0);
HXLINE(  74)		Bool _hx_tmp = hx::IsNotNull( p1 );
HXDLIN(  74)		if (_hx_tmp) {
HXLINE(  74)			parameters->push(p1);
            		}
HXLINE(  75)		Bool _hx_tmp1 = hx::IsNotNull( p2 );
HXDLIN(  75)		if (_hx_tmp1) {
HXLINE(  75)			parameters->push(p2);
            		}
HXLINE(  76)		Bool _hx_tmp2 = hx::IsNotNull( p3 );
HXDLIN(  76)		if (_hx_tmp2) {
HXLINE(  76)			parameters->push(p3);
            		}
HXLINE(  77)		Bool _hx_tmp3 = hx::IsNotNull( p4 );
HXDLIN(  77)		if (_hx_tmp3) {
HXLINE(  77)			parameters->push(p4);
            		}
HXLINE(  78)		Bool _hx_tmp4 = hx::IsNotNull( p5 );
HXDLIN(  78)		if (_hx_tmp4) {
HXLINE(  78)			parameters->push(p5);
            		}
HXLINE(  80)		return ::Reflect_obj::callMethod(hx::ObjectPtr<OBJ_>(this),this->_hx___formatToString_dyn(),::cpp::VirtualArray_obj::__new(2)->init(0,className)->init(1,parameters));
            	}
...
Bool Event_obj::isDefaultPrevented(){
            	HX_STACK_FRAME("openfl.events.Event","isDefaultPrevented",0x5475e94b,"openfl.events.Event.isDefaultPrevented","openfl/events/Event.hx",87,0x7220a03b)
            	HX_STACK_THIS(this)
HXLINE(  87)		return this->_hx___preventDefault;
            	}
...
void Event_obj::preventDefault(){
            	HX_STACK_FRAME("openfl.events.Event","preventDefault",0xdba9c454,"openfl.events.Event.preventDefault","openfl/events/Event.hx",94,0x7220a03b)
            	HX_STACK_THIS(this)
HXLINE(  94)		Bool _hx_tmp = this->cancelable;
HXDLIN(  94)		if (_hx_tmp) {
HXLINE(  96)			this->_hx___preventDefault = true;
            		}
            	}
...
void Event_obj::stopImmediatePropagation(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 105)		this->_hx___isCanceled = true;
HXLINE( 106)		this->_hx___isCanceledNow = true;
            	}
...
void Event_obj::stopPropagation(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 113)		this->_hx___isCanceled = true;
            	}
...
::String Event_obj::toString(){
            	HX_STACK_FRAME("openfl.events.Event","toString",0x6e61ddf7,"openfl.events.Event.toString","openfl/events/Event.hx",120,0x7220a03b)
            	HX_STACK_THIS(this)
HXLINE( 120)		return this->_hx___formatToString(HX_("Event",fa,37,f2,08),::Array_obj< ::String >::fromData( _hx_array_data_0,3));
            	}
...
HXLINE( 129)		HX_VARI( ::String,output) = (HX_("[",5b,00,00,00) + className);
HXLINE( 130)		HX_VARI(  ::Dynamic,arg) = null();
HXLINE( 132)		{
HXLINE( 132)			HX_VARI( Int,_g) = (int)0;
HXDLIN( 132)			while((_g < parameters->length)){
HXLINE( 132)				HX_VARI( ::String,param) = parameters->__get(_g);
HXDLIN( 132)				++_g;
HXLINE( 134)				arg = ::Reflect_obj::field(hx::ObjectPtr<OBJ_>(this),param);
HXLINE( 136)				Bool _hx_tmp = ::Std_obj::is(arg,hx::ClassOf< ::String >());
HXDLIN( 136)				if (_hx_tmp) {
HXLINE( 138)					::String _hx_tmp1 = ((HX_(" ",20,00,00,00) + param) + HX_("=\"",45,35,00,00));
HXDLIN( 138)					::String _hx_tmp2 = ::Std_obj::string(arg);
HXDLIN( 138)					hx::AddEq(output,((_hx_tmp1 + _hx_tmp2) + HX_("\"",22,00,00,00)));
            				}
            				else {
HXLINE( 142)					::String _hx_tmp3 = ((HX_(" ",20,00,00,00) + param) + HX_("=",3d,00,00,00));
HXDLIN( 142)					::String _hx_tmp4 = ::Std_obj::string(arg);
HXDLIN( 142)					hx::AddEq(output,(_hx_tmp3 + _hx_tmp4));
            				}
            			}
            		}
HXLINE( 148)		hx::AddEq(output,HX_("]",5d,00,00,00));
HXLINE( 149)		return output;
            	}
