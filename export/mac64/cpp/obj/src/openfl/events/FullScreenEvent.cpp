...
::String FullScreenEvent_obj::toString(){
            	HX_STACK_FRAME("openfl.events.FullScreenEvent","toString",0x75cac472,"openfl.events.FullScreenEvent.toString","openfl/events/FullScreenEvent.hx",41,0x5d391076)
            	HX_STACK_THIS(this)
HXLINE(  41)		return this->_hx___formatToString(HX_("FullscreenEvent",bf,0f,46,0d),::Array_obj< ::String >::fromData( _hx_array_data_0,5));
            	}
