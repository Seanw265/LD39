...
::String GameInputEvent_obj::toString(){
            	HX_STACK_FRAME("openfl.events.GameInputEvent","toString",0x31f35b01,"openfl.events.GameInputEvent.toString","openfl/events/GameInputEvent.hx",41,0x5318f185)
            	HX_STACK_THIS(this)
HXLINE(  41)		return this->_hx___formatToString(HX_("GameInputEvent",62,3e,f4,2c),::Array_obj< ::String >::fromData( _hx_array_data_0,4));
            	}
