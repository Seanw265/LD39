...
Dynamic MouseEvent_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::events::Event MouseEvent_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  95)		HX_VARI(  ::openfl::events::MouseEvent,event) =  ::openfl::events::MouseEvent_obj::__new(this->type,this->bubbles,this->cancelable,this->localX,this->localY,this->relatedObject,this->ctrlKey,this->altKey,this->shiftKey,this->buttonDown,this->delta,this->commandKey,this->clickCount);
...
::String MouseEvent_obj::toString(){
            	HX_STACK_FRAME("openfl.events.MouseEvent","toString",0x2fb13aae,"openfl.events.MouseEvent.toString","openfl/events/MouseEvent.hx",106,0xd3783172)
            	HX_STACK_THIS(this)
HXLINE( 106)		return this->_hx___formatToString(HX_("MouseEvent",d5,bf,42,8a),::Array_obj< ::String >::fromData( _hx_array_data_0,11));
            	}
