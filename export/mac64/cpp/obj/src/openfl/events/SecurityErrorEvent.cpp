...
::String SecurityErrorEvent_obj::toString(){
            	HX_STACK_FRAME("openfl.events.SecurityErrorEvent","toString",0xccee4db1,"openfl.events.SecurityErrorEvent.toString","openfl/events/SecurityErrorEvent.hx",32,0x4f4e3035)
            	HX_STACK_THIS(this)
HXLINE(  32)		return this->_hx___formatToString(HX_("SecurityErrorEvent",32,ea,b2,a1),::Array_obj< ::String >::fromData( _hx_array_data_0,5));
            	}
