...
Dynamic Point_obj::__Create(hx::DynamicArray inArgs)
{
 ...
 ::openfl::geom::Point Point_obj::add( ::openfl::geom::Point v){
            	HX_STACK_FRAME("openfl.geom.Point","add",0xa6f15dcf,"openfl.geom.Point.add","openfl/geom/Point.hx",25,0x18173b82)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE(  25)		return  ::openfl::geom::Point_obj::__new((v->x + this->x),(v->y + this->y));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Point_obj,add,return )
 ...
 ::openfl::geom::Point Point_obj::clone(){
            	HX_STACK_FRAME("openfl.geom.Point","clone",0x787f468b,"openfl.geom.Point.clone","openfl/geom/Point.hx",32,0x18173b82)
            	HX_STACK_THIS(this)
HXLINE(  32)		return  ::openfl::geom::Point_obj::__new(this->x,this->y);
            	}
...
HXLINE(  39)		this->x = sourcePoint->x;
HXLINE(  40)		this->y = sourcePoint->y;
            	}
...
Bool Point_obj::equals( ::openfl::geom::Point toCompare){
            	HX_STACK_FRAME("openfl.geom.Point","equals",0xa8838351,"openfl.geom.Point.equals","openfl/geom/Point.hx",56,0x18173b82)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(toCompare,"toCompare")
HXLINE(  56)		Bool _hx_tmp;
HXDLIN(  56)		Bool _hx_tmp1 = hx::IsNotNull( toCompare );
HXDLIN(  56)		if (_hx_tmp1) {
HXLINE(  56)			_hx_tmp = (toCompare->x == this->x);
            		}
            		else {
HXLINE(  56)			_hx_tmp = false;
            		}
HXDLIN(  56)		if (_hx_tmp) {
HXLINE(  56)			return (toCompare->y == this->y);
            		}
            		else {
...
void Point_obj::normalize(Float thickness){
            	HX_STACK_FRAME("openfl.geom.Point","normalize",0x05c199bb,"openfl.geom.Point.normalize","openfl/geom/Point.hx",70,0x18173b82)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(thickness,"thickness")
HXLINE(  70)		Bool _hx_tmp;
HXDLIN(  70)		if ((this->x == (int)0)) {
HXLINE(  70)			_hx_tmp = (this->y == (int)0);
            		}
            		else {
...
HXLINE(  76)			Float _hx_tmp1 = ((this->x * this->x) + (this->y * this->y));
HXDLIN(  76)			Float _hx_tmp2 = ::Math_obj::sqrt(_hx_tmp1);
HXDLIN(  76)			HX_VARI( Float,norm) = ((Float)thickness / (Float)_hx_tmp2);
HXLINE(  77)			hx::MultEq(this->x,norm);
HXLINE(  78)			hx::MultEq(this->y,norm);
            		}
            	}
...
void Point_obj::offset(Float dx,Float dy){
            	...
            	HX_STACK_ARG(dx,"dx")
            	HX_STACK_ARG(dy,"dy")
HXLINE(  87)		hx::AddEq(this->x,dx);
HXLINE(  88)		hx::AddEq(this->y,dy);
            	}
...
void Point_obj::setTo(Float xa,Float ya){
            	...
            	HX_STACK_ARG(xa,"xa")
            	HX_STACK_ARG(ya,"ya")
HXLINE( 102)		this->x = xa;
HXLINE( 103)		this->y = ya;
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(Point_obj,setTo,(void))
 ...
 ::openfl::geom::Point Point_obj::subtract( ::openfl::geom::Point v){
            	HX_STACK_FRAME("openfl.geom.Point","subtract",0x95bef2a6,"openfl.geom.Point.subtract","openfl/geom/Point.hx",109,0x18173b82)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE( 109)		return  ::openfl::geom::Point_obj::__new((this->x - v->x),(this->y - v->y));
            	}
...
::String Point_obj::toString(){
            	HX_STACK_FRAME("openfl.geom.Point","toString",0xd61c4e3e,"openfl.geom.Point.toString","openfl/geom/Point.hx",116,0x18173b82)
            	HX_STACK_THIS(this)
HXLINE( 116)		return ((((HX_("(x=",ed,c2,1e,00) + this->x) + HX_(", y=",18,15,2e,1d)) + this->y) + HX_(")",29,00,00,00));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Point_obj,toString,return )
 ...
 ::lime::math::Vector2 Point_obj::_hx___toLimeVector2(){
            	HX_STACK_FRAME("openfl.geom.Point","__toLimeVector2",0x318eb74d,"openfl.geom.Point.__toLimeVector2","openfl/geom/Point.hx",123,0x18173b82)
            	HX_STACK_THIS(this)
HXLINE( 123)		return  ::lime::math::Vector2_obj::__new(this->x,this->y);
            	}
...
Float Point_obj::get_length(){
            	HX_STACK_FRAME("openfl.geom.Point","get_length",0x11c48ac1,"openfl.geom.Point.get_length","openfl/geom/Point.hx",137,0x18173b82)
            	HX_STACK_THIS(this)
HXLINE( 137)		Float _hx_tmp = ((this->x * this->x) + (this->y * this->y));
HXDLIN( 137)		return ::Math_obj::sqrt(_hx_tmp);
            	}
...
HXLINE(  47)		HX_VARI( Float,dx) = (pt1->x - pt2->x);
HXLINE(  48)		HX_VARI( Float,dy) = (pt1->y - pt2->y);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Point_obj,distance,return )
 ...
 ::openfl::geom::Point Point_obj::interpolate( ::openfl::geom::Point pt1, ::openfl::geom::Point pt2,Float f){
            	HX_STACK_FRAME("openfl.geom.Point","interpolate",0x8bd29e6f,"openfl.geom.Point.interpolate","openfl/geom/Point.hx",63,0x18173b82)
            	HX_STACK_ARG(pt1,"pt1")
            	HX_STACK_ARG(pt2,"pt2")
            	HX_STACK_ARG(f,"f")
HXLINE(  63)		return  ::openfl::geom::Point_obj::__new((pt2->x + (f * (pt1->x - pt2->x))),(pt2->y + (f * (pt1->y - pt2->y))));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Point_obj,interpolate,return )
 ...
 ::openfl::geom::Point Point_obj::polar(Float len,Float angle){
            	HX_STACK_FRAME("openfl.geom.Point","polar",0xf6ae22ec,"openfl.geom.Point.polar","openfl/geom/Point.hx",95,0x18173b82)
            	HX_STACK_ARG(len,"len")
            	HX_STACK_ARG(angle,"angle")
HXLINE(  95)		Float _hx_tmp = ::Math_obj::cos(angle);
HXDLIN(  95)		Float _hx_tmp1 = (len * _hx_tmp);
HXDLIN(  95)		Float _hx_tmp2 = ::Math_obj::sin(angle);
HXDLIN(  95)		return  ::openfl::geom::Point_obj::__new(_hx_tmp1,(len * _hx_tmp2));
            	}
