...
HXLINE(  64)					_this->_hx___updateCachedBitmap = true;
HXDLIN(  64)					Bool _hx_tmp3;
HXDLIN(  64)					::Array< ::Dynamic> _hx_tmp4 = _this->get_filters();
HXDLIN(  64)					Bool _hx_tmp5 = hx::IsNotNull( _hx_tmp4 );
HXDLIN(  64)					if (_hx_tmp5) {
HXLINE(  64)						_hx_tmp3 = (_this->get_filters()->length > (int)0);
            					}
            					else {
HXLINE(  64)						_hx_tmp3 = false;
            					}
HXDLIN(  64)					_this->_hx___updateFilters = _hx_tmp3;
HXDLIN(  64)					_this->_hx___renderDirty = true;
...
HXLINE(  77)			return this->_hx___displayObject->_hx___transform->clone();
            		}
...
HXLINE(  90)			return this->_hx___displayObject->_hx___getWorldTransform()->clone();
            		}
...
HXLINE( 139)			return  ::openfl::geom::Matrix3D_obj::__new(::Array_obj< Float >::__new(16)->init(0,matrix->a)->init(1,matrix->b)->init(2,((Float)0.0))->init(3,((Float)0.0))->init(4,matrix->c)->init(5,matrix->d)->init(6,((Float)0.0))->init(7,((Float)0.0))->init(8,((Float)0.0))->init(9,((Float)0.0))->init(10,((Float)1.0))->init(11,((Float)0.0))->init(12,matrix->tx)->init(13,matrix->ty)->init(14,((Float)0.0))->init(15,((Float)1.0)));
            		}
...
HXDLIN( 162)			Float _hx_tmp3 = ::Math_obj::atan2(value->rawData->__get((int)5),value->rawData->__get((int)4));
...
HXLINE( 173)			this->_hx___displayObject->_hx___transform->a = value->rawData->__get((int)0);
HXLINE( 174)			this->_hx___displayObject->_hx___transform->b = value->rawData->__get((int)1);
HXLINE( 175)			this->_hx___displayObject->_hx___transform->c = value->rawData->__get((int)5);
HXLINE( 176)			this->_hx___displayObject->_hx___transform->d = value->rawData->__get((int)6);
HXLINE( 177)			this->_hx___displayObject->_hx___transform->tx = value->rawData->__get((int)12);
HXLINE( 178)			this->_hx___displayObject->_hx___transform->ty = value->rawData->__get((int)13);
HXLINE( 180)			{
