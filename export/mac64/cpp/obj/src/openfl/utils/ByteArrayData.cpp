...
HXLINE( 242)		HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::io::Bytes_obj::alloc(length);
HXLINE( 247)		super::__construct(length,bytes->b);
HXLINE( 250)		this->__length = length;
HXLINE( 251)		this->_hx___endian = (int)0;
HXLINE( 252)		this->position = (int)0;
            	}
...
void ByteArrayData_obj::clear(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 259)		this->__length = (int)0;
...
HXLINE( 269)		Bool _hx_tmp = hx::IsNull( algorithm );
HXDLIN( 269)		if (_hx_tmp) {
HXLINE( 271)			algorithm = (int)2;
            		}
HXLINE( 275)		if (hx::IsEq( algorithm,(int)1 )) {
HXLINE( 277)			HX_VARI(  ::haxe::io::Bytes,bytes) = ::lime::utils::LZMA_obj::encode(hx::ObjectPtr<OBJ_>(this));
HXDLIN( 277)			this->b = bytes->b;
HXDLIN( 277)			this->length = bytes->length;
            		}
            		else {
HXLINE( 281)			Bool _hx_tmp1 = hx::IsNull( algorithm );
HXLINE( 292)			{
HXLINE( 292)				HX_VARI_NAME(  ::haxe::io::Bytes,bytes1,"bytes") = ::haxe::zip::Compress_obj::run(hx::ObjectPtr<OBJ_>(this),(int)8);
HXDLIN( 292)				this->b = bytes1->b;
HXDLIN( 292)				this->length = bytes1->length;
            			}
            		}
HXLINE( 299)		this->__length = this->length;
HXLINE( 300)		this->position = this->__length;
            	}
...
void ByteArrayData_obj::deflate(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 307)		this->compress((int)0);
            	}
...
void ByteArrayData_obj::inflate(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 323)		this->uncompress((int)0);
            	}
...
Bool ByteArrayData_obj::readBoolean(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 330)		Bool _hx_tmp = (this->position < this->length);
HXDLIN( 330)		if (_hx_tmp) {
HXLINE( 332)			Int pos = this->position++;
HXDLIN( 332)			return (this->b->__get(pos) != (int)0);
            		}
            		else {
HXLINE( 336)			HX_STACK_DO_THROW( ::openfl::errors::EOFError_obj::__new());
            		}
...
Int ByteArrayData_obj::readByte(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 346)		HX_VARI( Int,value) = this->readUnsignedByte();
HXLINE( 348)		if ((((int)value & (int)(int)128) != (int)0)) {
HXLINE( 350)			return (value - (int)256);
            		}
            		else {
HXLINE( 354)			return value;
            		}
HXLINE( 348)		return (int)0;
            	}
...
Int length = __o_length.Default(0);
            	...
            	HX_STACK_ARG(length,"length")
HXLINE( 363)		Bool _hx_tmp = (length == (int)0);
HXDLIN( 363)		if (_hx_tmp) {
HXLINE( 363)			length = (this->__length - this->position);
            		}
HXLINE( 365)		Bool _hx_tmp1 = ((this->position + length) > this->__length);
HXDLIN( 365)		if (_hx_tmp1) {
HXLINE( 367)			HX_STACK_DO_THROW( ::openfl::errors::EOFError_obj::__new());
            		}
HXLINE( 371)		Bool _hx_tmp2 = (bytes->__length < (offset + length));
HXDLIN( 371)		if (_hx_tmp2) {
HXLINE( 373)			bytes->_hx___resize((offset + length));
            		}
HXLINE( 377)		bytes->blit(offset,hx::ObjectPtr<OBJ_>(this),this->position,length);
HXLINE( 378)		hx::AddEq(this->position,length);
            	}
...
Float ByteArrayData_obj::readDouble(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 385)		Bool _hx_tmp = ((this->position + (int)8) > this->__length);
HXDLIN( 385)		if (_hx_tmp) {
HXLINE( 387)			HX_STACK_DO_THROW( ::openfl::errors::EOFError_obj::__new());
            		}
HXLINE( 391)		hx::AddEq(this->position,(int)8);
HXLINE( 392)		HX_VARI( Int,pos) = (this->position - (int)8);
HXDLIN( 392)		Bool _hx_tmp1;
HXDLIN( 392)		if ((pos >= (int)0)) {
HXLINE( 392)			_hx_tmp1 = ((pos + (int)8) > this->length);
            		}
            		else {
HXLINE( 392)			_hx_tmp1 = true;
            		}
HXDLIN( 392)		if (_hx_tmp1) {
HXLINE( 392)			HX_STACK_DO_THROW(::haxe::io::Error_obj::OutsideBounds_dyn());
            		}
HXDLIN( 392)		return ::__hxcpp_memory_get_double(this->b,pos);
            	}
...
Float ByteArrayData_obj::readFloat(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 399)		Bool _hx_tmp = ((this->position + (int)4) > this->__length);
HXDLIN( 399)		if (_hx_tmp) {
HXLINE( 401)			HX_STACK_DO_THROW( ::openfl::errors::EOFError_obj::__new());
            		}
HXLINE( 405)		hx::AddEq(this->position,(int)4);
HXLINE( 406)		HX_VARI( Int,pos) = (this->position - (int)4);
HXDLIN( 406)		Bool _hx_tmp1;
HXDLIN( 406)		if ((pos >= (int)0)) {
HXLINE( 406)			_hx_tmp1 = ((pos + (int)4) > this->length);
            		}
            		else {
HXLINE( 406)			_hx_tmp1 = true;
            		}
HXDLIN( 406)		if (_hx_tmp1) {
HXLINE( 406)			HX_STACK_DO_THROW(::haxe::io::Error_obj::OutsideBounds_dyn());
            		}
HXDLIN( 406)		return ::__hxcpp_memory_get_float(this->b,pos);
            	}
...
Int ByteArrayData_obj::readUnsignedByte(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 470)		Bool _hx_tmp = (this->position < this->__length);
...
::String ByteArrayData_obj::readUTFBytes(Int length){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(length,"length")
HXLINE( 532)		Bool _hx_tmp = ((this->position + length) > this->__length);
...
HXLINE( 540)		Int _hx_tmp1 = (this->position - length);
HXDLIN( 540)		return this->getString(_hx_tmp1,length);
            	}
...
void ByteArrayData_obj::uncompress( ::Dynamic algorithm){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(algorithm,"algorithm")
HXLINE( 549)		Bool _hx_tmp = hx::IsNull( algorithm );
HXDLIN( 549)		if (_hx_tmp) {
HXLINE( 551)			algorithm = (int)0;
            		}
HXLINE( 556)		if (hx::IsEq( algorithm,(int)1 )) {
HXLINE( 558)			HX_VARI(  ::haxe::io::Bytes,bytes) = ::lime::utils::LZMA_obj::decode(hx::ObjectPtr<OBJ_>(this));
HXDLIN( 558)			this->b = bytes->b;
HXDLIN( 558)			this->length = bytes->length;
            		}
            		else {
HXLINE( 562)			Bool _hx_tmp1 = hx::IsNull( algorithm );
HXLINE( 573)			{
HXLINE( 573)				HX_VARI_NAME(  ::haxe::io::Bytes,bytes1,"bytes") = ::haxe::zip::Uncompress_obj::run(hx::ObjectPtr<OBJ_>(this),null());
HXDLIN( 573)				this->b = bytes1->b;
HXDLIN( 573)				this->length = bytes1->length;
            			}
            		}
HXLINE( 584)		this->__length = this->length;
HXLINE( 585)		this->position = (int)0;
            	}
...
void ByteArrayData_obj::writeDouble(Float value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 620)		Int _hx_tmp = (this->position + (int)8);
HXDLIN( 620)		this->_hx___resize(_hx_tmp);
HXLINE( 621)		this->setDouble(this->position,value);
HXLINE( 622)		hx::AddEq(this->position,(int)8);
            	}
...
void ByteArrayData_obj::writeFloat(Float value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 629)		Int _hx_tmp = (this->position + (int)4);
HXDLIN( 629)		this->_hx___resize(_hx_tmp);
HXLINE( 630)		this->setFloat(this->position,value);
HXLINE( 631)		hx::AddEq(this->position,(int)4);
            	}
...
HXDLIN( 712)			this->length = bytes->length;
            		}
HXLINE( 713)		this->__length = bytes->length;
            	}
...
HXLINE( 720)		Bool _hx_tmp = (size > this->length);
HXDLIN( 720)		if (_hx_tmp) {
HXLINE( 722)			HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::io::Bytes_obj::alloc(((int)((size + (int)1) * (int)3) >> (int)(int)1));
HXLINE( 723)			bytes->blit((int)0,hx::ObjectPtr<OBJ_>(this),(int)0,this->length);
HXLINE( 724)			{
HXLINE( 724)				this->b = bytes->b;
HXDLIN( 724)				this->length = bytes->length;
            			}
            		}
HXLINE( 728)		Bool _hx_tmp1 = (this->__length < size);
HXDLIN( 728)		if (_hx_tmp1) {
HXLINE( 730)			this->__length = size;
            		}
            	}
...
HXLINE( 740)		this->length = bytes->length;
            	}
...
Int ByteArrayData_obj::get_bytesAvailable(){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","get_bytesAvailable",0x68329f15,"openfl.utils.ByteArrayData.get_bytesAvailable","openfl/utils/ByteArray.hx",758,0xaa5cee4a)
            	HX_STACK_THIS(this)
HXLINE( 758)		return (this->__length - this->position);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ByteArrayData_obj,get_bytesAvailable,return )
 ...
 ::Dynamic ByteArrayData_obj::get_endian(){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","get_endian",0x95dc5cd2,"openfl.utils.ByteArrayData.get_endian","openfl/utils/ByteArray.hx",765,0xaa5cee4a)
            	HX_STACK_THIS(this)
HXLINE( 765)		return this->_hx___endian;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ByteArrayData_obj,get_endian,return )
 ...
 ::Dynamic ByteArrayData_obj::set_endian( ::Dynamic value){
            	HX_STACK_FRAME("openfl.utils.ByteArrayData","set_endian",0x9959fb46,"openfl.utils.ByteArrayData.set_endian","openfl/utils/ByteArray.hx",772,0xaa5cee4a)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 772)		return (this->_hx___endian = value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(ByteArrayData_obj,set_endian,return )
 ...
 ::openfl::utils::ByteArrayData ByteArrayData_obj::fromBytes( ::haxe::io::Bytes bytes){
            	...
            	HX_STACK_ARG(bytes,"bytes")
HXLINE( 314)		HX_VARI(  ::openfl::utils::ByteArrayData,result) =  ::openfl::utils::ByteArrayData_obj::__new(null());
HXLINE( 315)		result->_hx___fromBytes(bytes);
HXLINE( 316)		return result;
            	}
